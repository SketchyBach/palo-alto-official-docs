---
url: https://docs.prismacloud.io/admin-guide/33/compliance/manage-compliance
fetched_at: 2026-09-16T13:37:03Z
source: prisma-cloud
---

# Manage compliance | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Go to Defend > Compliance , select any tab, then click on a resource in the table to open its scan report. You will see a list of checks that have both passed and failed. 

 Previous Compliance Explorer 
