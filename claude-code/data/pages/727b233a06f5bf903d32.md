---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/manage-broker-vm/edit-broker-vm-configuration
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Enable/Disable ssh Palo Alto Networks support team SSH access by using a Cortex Data Security token. 
 ...
 Upload your signed server certificate and key to establish a validated secure SSL connection between your endpoints and the Broker VM. When you configure the server certificate and the key files in the tenant UI, Cortex Data Security automatically updates them in the Broker VM UI, even when the Broker VM UI is disabled. 

 Cortex Data Security validates that the certificate and key match, but does not validate the Certificate Authority (CA). 

 When you are done, Save your changes. 

 Previous Manage Broker VM 

 Next Increase Broker VM storage allocated for data caching 
