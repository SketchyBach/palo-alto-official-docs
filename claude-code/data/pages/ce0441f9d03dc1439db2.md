---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-66
fetched_at: 2026-09-06T11:15:16Z
source: cortex-platform
---

# Splunk User Credential detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Splunk User Credentials grant access to monitoring and logging data. 

 Exposure allows unauthorized access to sensitive operational data and the possibility of altering system configurations and access levels. 
 ...
 Previous Sentry Token detected in code 

 Next Sumo Logic Key detected in code 
