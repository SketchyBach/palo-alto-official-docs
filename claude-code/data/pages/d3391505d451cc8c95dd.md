---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/google/google-cloud-platform/ingest-logs-and-data-from-a-gcp-pub-sub
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collect GCP Pub/Sub data with Cortex Cloud. 
 ...
 As per design, Cortex Cloud does not support storage notifications for the Pub/Sub integration. 
 ...
 xdr_data : Once configured, Cortex Cloud ingests Google Cloud DNS logs as XDR network connection stories, which you can query with XQL Search using the xdr_data dataset with the preset called network_story . 

 Network flow logs 

 google_cloud_logging_raw 

 xdr_data : Once configured, Cortex Cloud ingests network flow logs as XDR network connection stories, which you can query with XQL Search using the xdr_data dataset with the preset called network_story . 
 ...
 Set up log forwarding from GCP to Cortex Cloud. 
 ...
 f. Enter a descriptive Name that identifies the sink purpose for Cortex Cloud, and then Create . 
 ...
 After Cortex Cloud begins receiving information from the GCP Pub/Sub service, you can use the XQL Query language to search for specific data. 
