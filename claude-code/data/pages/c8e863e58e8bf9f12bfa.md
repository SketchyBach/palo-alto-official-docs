---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/hierarchy_match
fetched_at: 2026-09-16T09:04:55Z
source: cortex-platform
---

# hierarchy_match | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The resource ID of a specific hierarchy node — the ID of the deepest container in the path (for example, an OU ID, management-group ID, or folder ID). Use it to unambiguously target a node even when names are duplicated. When provided, it must match the asset's id_path . If omitted, no ID restriction is applied. 
 ...
 Container Levels (org root → node) 

 Leaf (not part of hierarchy path/id_path) 

 Example Path 

 Example id_path (ID of deepest node) 

 AWS 

 Organization → Organizational Unit (OU) 

 Account 

 Acme Corp/Production 

 OU ID: ou-a1b2-prod01 

 Azure 

 Management Group → (nested Management Groups) 

 Subscription 

 Tenant Root Group/Platform 

 Management Group ID: mg-platform 

 GCP 

 Organization → Folder(s) 

 Project 

 acme.com/Production 

 Folder ID: folders/574839201122 
 ...
 Tenant Root Group/Platform/Prod 
