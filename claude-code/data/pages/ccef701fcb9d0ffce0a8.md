---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/7.9-ce/cortex-xdr-agent-7.9-for-mac/troubleshooting-resources-for-mac/cytool-for-mac
fetched_at: 2026-09-16T08:51:41Z
source: cortex-platform
---

# Cytool for Mac | 7.9 CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Traps-Mac:bin Traps$ sudo ./cytool opswat version 6.1.0.1042 Traps-Mac:bin Traps$ sudo ./cytool opswat installed Password: true Traps-Mac:bin Traps$ sudo ./cytool opswat running true Traps-Mac:bin Traps$ sudo ./cytool opswat protected true 
 ...
 ** export [<database name> ` 
 ...
 <action> —Change startup runtime action for an agent component. Options are: start , stop , query . The query option displays the startup status for each component. 
 ...
 <action> —Change startup action for an agent component. Options are: enable , disable , query . The query option displays the startup status for each component. 
 ...
 Next Cortex XDR Agent 7.9 for Linux 
