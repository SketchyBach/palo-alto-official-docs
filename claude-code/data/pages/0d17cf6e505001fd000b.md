---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/configure-cortex-xsiam/automations/playbooks/build-your-playbook/add-objects-from-the-task-library/add-manual-tasks-and-blank-tasks/create-a-conditional-task
fetched_at: 2026-08-13T15:06:49Z
source: cortex-platform
---

# Create a conditional task | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center

Create a conditional task | Cortex Documentation Portal 
 ...
 Previous Create a standard task Next Create a communication task 
