---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-75
fetched_at: 2026-09-16T09:11:22Z
source: cortex-platform
---

# Webflow API Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Webflow API Token grants access to website projects and collections. 

 Exposure can lead to unauthorized access to website projects, exposure of sensitive design data, and potential manipulation of published content. 
 ...
 Previous Vercel API Token detected in code 

 Next Scalr API Token detected in code 
