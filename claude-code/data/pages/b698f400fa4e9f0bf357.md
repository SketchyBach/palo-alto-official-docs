---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/deployment-steps-and-checklist/upgrade-from-prisma-cloud-to-cortex-cloud/copy-content/copy-cortex-cloud-application-security-configurations
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Copy Cortex Cloud Application Security configurations from Prisma Cloud with Upgrade Helper. 
