---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-2110/addressed-issues-in-vm-series-plugin-2110.html
fetched_at: 2026-09-16T12:59:01Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.1.10 Clear
...
Updated on 
 ...
 The following list describes the issue fixed in the VM-Series plugin 2.1.10. 

 PLUG-12041 

 Fixed an issue on the CN-Series deployed on OpenShift that caused the CN-MGMT (MP pod) to
 restart and the template stack push to fail after a commit. 

 PLUG-11425 

 Fixed an issue that caused the service insertion to fail on the VM-Series firewall on
 VMware NSX-T when jumbo frames are enabled. 
