---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/asset-managment/asset-configurations/asset-roles/manage-asset-roles-for-users/honey-user
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure decoy user accounts that alert on suspicious access. 
 ...
 In Inventory → Assets → Configuration → Asset Roles , right click to select Honey User . 
