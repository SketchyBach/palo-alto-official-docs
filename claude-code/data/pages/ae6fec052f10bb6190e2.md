---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-6-threat-intel-management-guides/6.12/configure-indicators/indicator-management/export-indicators/export-an-indicator-to-csv-using-the-utf8-bom-format
fetched_at: 2026-09-06T10:49:55Z
source: cortex-platform
---

# Export an Indicator to CSV Using the UTF8-BOM Format | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Export indicators to UTF8-BOM CSV files in Cortex XSOAR 6.12. 
