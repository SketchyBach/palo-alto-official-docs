---
url: https://docs.prismacloud.io/admin-guide/33/secrets/secrets-manager
fetched_at: 2026-09-16T13:37:05Z
source: prisma-cloud
---

# Secrets manager | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When a user or orchestrator starts a container, Defender injects the secrets you specify into the container. In order for secret injection to work, all Docker commands must be routed through Defender. Refer to Inject Secrets into Containers . There are several moving parts in the solution: 
 ...
 Next Integrate with a secrets store 
