---
url: https://docs.paloaltonetworks.com/ngfw/help/12-1/device/device-certificate-management-certificate-profile
fetched_at: 2026-08-13T16:49:13Z
...
Device > Certificate Management > Certificate Profile 
 ...
 ( Required ) Enter a name to identify the
 ...
 Select the scope in which the profile is available. In
 ...
 If GlobalProtect only uses certificates for portal and
 ...
 Enter the NetBIOS domain so the PAN-OS software can
 ...
 Optionally, if the firewall uses Online Certificate
 ...
 Select this option to use a certificate revocation
 list (CRL) to verify the revocation status of
 certificates. 

 Use OCSP 

 Select this option to use OCSP to verify the
 ...
 Specify the interval (1 to 60 seconds) after which the
 ...
 Select this option if you want the firewall to block
