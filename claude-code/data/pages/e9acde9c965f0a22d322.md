---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/integrations/add-an-integration-instance/fetch-incidents-from-an-integration-instance
fetched_at: 2026-09-06T10:35:34Z
source: cortex-platform
---

# Fetch incidents from an integration instance | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Fetch incidents from an integration instance into Cortex XSOAR 8.10 On-prem. 
