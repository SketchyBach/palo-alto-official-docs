---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-530/addressed-issues-in-panorama-plugin-for-aws-530.html
fetched_at: 2026-09-16T12:59:44Z
source: palo-alto-main
---

# Addressed issues in Panorama Plugin for AWS 5.3.0 Clear
...
Updated on 
 ...
 The following are the fixed issues in the Panorama plugin for AWS 5.3.0: 
 ...
 Fixed an issue where fetching VPCs failed for AWS accounts with cross account assume
 role access. 

 PLUG-17275 

 When multiple tenants are linked to Panorama, only one tenant receives the Data Loss
 Prevention (DLP) tenant ID. 

 PLUG-17484 

 Fixed an issue where a commit failure occurred when you configured a zone protection
 profile using the AWS 5.2.0 plugin then committed the change after upgrading to the AWS
 5.3.0 plugin version. 
