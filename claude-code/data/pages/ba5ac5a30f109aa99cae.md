---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-0/pan-os-upgrade/upgrade-panorama-plugins/upgrade-the-enterprise-dlp-plugin.html
fetched_at: 2026-09-16T10:47:18Z
...
data loss prevention (DLP) plugin version installed on your Panorama™
management server. 
...
displays the Enterprise DLP plugin version you upgraded to. 
 ...
 ( Upgrade to 4.0.0 only ) Edit the Enterprise DLP data filtering
 settings to reduce the Max File Size to 20MB
 or less. 

 This is required when upgrading from Panorama plugin for Enterprise DLP 3.0.3
 or later releases to Enterprise DLP 4.0.0 as this plugin version does not
 support large file size inspection . 
