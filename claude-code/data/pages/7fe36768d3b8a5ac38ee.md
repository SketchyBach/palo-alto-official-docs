---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/standard-data-sources
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Browse supported standard data sources for Cortex XDR. 

 Standard data sources are built-in ingestion mechanisms in Cortex XDR primarily focused on ingesting raw logs and security events. While Cortex XDR is introducing a unified Connector approach, many third-party services and file-based ingestions continue to use standard data sources for core security analysis and normalization. 
