...
Monitoring and Traps 
 ...
 SNMP requests do not return real-time instantaneous values. There is a polling
 sleep interval of up to one minute between when a value changes on the device and
 when it is reflected in an SNMP response. It is recommended that SNMP not be used
 for real-time monitoring of rapidly-changing counters. 
