---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/deploy-defender/defender-types
fetched_at: 2026-09-16T13:35:12Z
source: prisma-cloud
---

# Available Defender Types | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Deploy a container Defender on any host that runs a container workload. Container Defender protects both your containers and the underlying host. Docker or Podman (for Linux Container Defender) must be installed on the host because this Defender type runs as a container. 
 ...
 You can also deploy container Defenders automatically in an entire cluster using kubeconfig . 
 ...
 Previous Deploy the Prisma Cloud Defender 
