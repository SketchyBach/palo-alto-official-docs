---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-410/addressed-issues-in-panorama-plugin-for-aws-410.html
fetched_at: 2026-09-16T12:59:48Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 4.1.0 Clear
...
which is similar to AWS AMI limit of 127 characters. 
 ...
 When an IAM role is created and added
a as part of deployment, the information under the IAM (such as
secret key and access key) can be edited and the changes can be
committed. However, the name of the IAM role cannot be changed on
the UI. 

 PLUG-11476 

 Fixed an issue where the plugin successfully
retrieves information for a VPC endpoint which has a public IP associated
to it, and populates the corresponding IP tags. 

 PLUG-11785 

 Longer VPC names can be added to the
monitoring definition and will now be displayed in the UI. 
