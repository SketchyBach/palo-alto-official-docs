---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/troubleshoot-and-reference/reference/cortex-xsoar-api
fetched_at: 2026-09-16T09:14:08Z
source: cortex-platform
---

# Cortex XSOAR API | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Generate API keys and make API calls in Cortex XSOAR On-prem 8.7 (EoL). 
