---
url: https://docs.paloaltonetworks.com/ngfw/help/10-1/web-interface-basics/threat-details
...
edit the Logging and Reporting setting to Enable Threat
Vault Access ). 

 The default (or custom) Antivirus, Anti-Spyware, and Vulnerability Protection
security profiles are applied to your security policy. 
