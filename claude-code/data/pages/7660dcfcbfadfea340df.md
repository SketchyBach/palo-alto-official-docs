---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-panorama-api/pan-os-xml-api-request-types/pan-os-xml-api-request-types-and-actions/configuration-actions
...
Actions 
 ...
 In addition to the request type that you specify, use
available actions to modify or read configurations using type=config : 
