---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/threat-prevention/metric-dt-tp-30.html
fetched_at: 2026-09-16T11:04:38Z
source: palo-alto-main
---

# Unknown Applications by Destination Ports Clear
...
Updated on 
 ...
 Collects information from traffic logs that involve TCP or UDP traffic, but the application cannot be identified. The traffic's destination port, as well as the number of total bytes in the session are collected. Only traffic logs written as the result of the end of a network session are used. 
 ...
 pan_report_gen -t trsum -n 20 -ac dport -vc count,bytes -s count -c 'Unknown Applications by Destination Ports' -q 'subtype eq end and (app eq unknown-tcp or app eq unknown-udp)' -p last-24-hrs 
