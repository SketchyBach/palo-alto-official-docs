---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs/certificate-issuing-templates/t-Cloud-issuing-templates-edit-delete-OP
fetched_at: 2026-09-16T07:25:03Z
source: palo-alto-main
---

# Editing or Deleting a Request Policy Clear
...
Updated on 
 ...
 Request policies combine the selection of a certificate authority (CA) account with rules that enforce certificate policy in a single location. Request policies can be edited individually, edited in bulk, or deleted. 

 Important: Request Policies belong to the tenant. Editing or deleting one requires the Superuser role and Tenant selected in the workspace switcher; with a workspace selected the page is read only. See Workspace-Scoped Resources . 

 To Copy, Edit, or Delete a Request Policy 
 ...
 To edit a request policy, click the request policy name. 

 To delete a request policy, select the checkbox next to the request policy, and then click Delete . 
