---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-309/addressed-issues-in-vm-series-plugin-309.html
fetched_at: 2026-09-16T12:58:53Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 3.0.9 Clear
...
Updated on 
 ...
 Learn what's been fixed in VM-Series plugin 3.0.9. 
 ...
 Fixed an issue that caused the high availability validation configuration and failover to
 fail on the VM-Series firewall on Azure. 

 PLUG-15879 

 Fixed in VM-Series Plugin 3.0.9 

 The VM-Series firewall on AWS or GCP reboots into maintenance mode after the following
 CLI: 

 request plugins vm_series dpdk-mbuf-config 

 Workaround: Do not execute this command on your VM-Series firewall on AWS or GCP. 
