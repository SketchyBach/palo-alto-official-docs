---
url: https://cortex-docs.paloaltonetworks.com/application-security/code-to-cloud/code-to-cloud
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Retrieve Code-to-Cloud coverage programmatically. See API endpoints for C2C . 

 Previous Reference C: Metric calculations 
