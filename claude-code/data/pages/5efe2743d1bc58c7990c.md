---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/cloud-security/network-exposure-detection/internet-exposure-detection
fetched_at: 2026-09-06T09:35:20Z
source: cortex-platform
---

# Internet exposure detection | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to detect publicly exposed cloud assets in Cortex XSIAM and validate internet exposure through external network scanning. 
 ...
 Server information (Service or daemon connected to an exposed port) 

 Apache, Microsoft IIS, OpenSSH 
 ...
 EKS (Services behind load balancer and ingress) 

 AKS (Services behind load balancer and ingress) 

 GKE (Services behind load balancer and ingress) 
 ...
 cna-example-of-isolated-single-VPC-AWS-NGFW-deployment.png 
 ...
 Previous What is Cloud Network Analyzer? 

 Next Outbound exposure detection 
