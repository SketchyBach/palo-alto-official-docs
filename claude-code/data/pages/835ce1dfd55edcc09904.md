---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-302/fixed-issues-in-panorama-plugin-for-aws-302.html
fetched_at: 2026-09-16T12:59:51Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 3.0.2 Clear
...
Updated on 
 ...
 The following list describes fixed issues in the Panorama
Plugin for AWS 3.0.2. 

 PLUG-9315 

 Fixed an issue that caused an autoscale
deployment to fail with the error IAM-Manager: <> Instance Profile- List attached user policies call to AWS failed . 
