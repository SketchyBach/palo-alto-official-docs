---
url: https://docs.paloaltonetworks.com/globalprotect/user-guide/6-0/globalprotect-app-for-windows/use-connect-before-logon-followed-by-the-authentication-method
...
in the Windows registry . 
 ...
 Create a server profile with settings to the SAML
...
Authentication Configurations ). 
 ...
 When Enforce GlobalProtect Connections for
 Network Access mode is enabled for the GlobalProtect
 app, you must add the fully qualified domains (FQDNs) of the SAML
 authentication page to the exclusion list in the app settings of the
