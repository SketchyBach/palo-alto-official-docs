---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/users-and-roles-management/user-group-management
fetched_at: 2026-09-06T10:35:22Z
source: cortex-platform
---

# User group management | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create user groups and assign roles and users in Cortex XSOAR 8.10 On-prem. 
 ...
 If you have not set up SSO in your tenant, skip this field and add it later. After you have added it, follow the procedure relevant to your IdP. For example, see Task 8. Map SAML Group Memberships to Cortex XSOAR User Groups . 
