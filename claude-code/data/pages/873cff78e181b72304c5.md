---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-clustering/panorama-clustering-plugin-200/whats-new-in-panorama-clustering-plugin-200.html
fetched_at: 2026-09-16T13:01:28Z
source: palo-alto-main
---

# What's New in Panorama Clustering Plugin 2.0.0 Clear
...
Updated on 
 ...
 See the new features that Panorama Clustering Plugin 2.0.0 supports. 

 The Panorama Clustering plugin 2.0.0 provides visibility to the NGFW
 clusters (also known as PA-Series clusters) in PA-7500 Series firewalls. You must
 install the Clustering 2.0.0 plugin on Panorama from Device Plugins to view the PA-Series cluster details under Panorama Firewall Clusters . 

 The Firewall Clusters tab displays a Summary View and
 Monitoring information for the PA clusters. 
