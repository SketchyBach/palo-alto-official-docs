---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/asset-management/vulnerability-assessment
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Assess asset vulnerabilities and associated risk in Cortex XSIAM. 
 ...
 Cortex XSIAM collects all the information about the operating system and the installed applications, and calculates CVE. 
 ...
 Download the certificates provided below. 
 ...
 From Inventory → Endpoints → Host Inventor y, select Applications . 
 ...
 Next Query the asset inventory via XQL 
