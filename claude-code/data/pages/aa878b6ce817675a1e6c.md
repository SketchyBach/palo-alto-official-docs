---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/role-based-access-control/threat-management-permissions/threat-intelligence-permissions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Threat Intelligence permissions in Cortex XSIAM 
...
In XTI, full control to manage indicators and indicator rules. 
 ...
 Strongly Recommended. Enables creating indicator or IOC rules directly from indicators. 

 Allow/Block List 

 Checked 

 Strongly recommended. Add to Block List is a primary action on indicators. 

 EDL 

 View 

 Strongly recommended. Add to EDL is a primary action on IP/domain indicators. 
 ...
 Recommended to manage indicator exclusions. Useful for managing false positive indicators. 
