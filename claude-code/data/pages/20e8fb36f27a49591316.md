---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-1/pan-os-upgrade/upgrade-the-vm-series-firewall/upgrade-the-vm-series-nsx-pan-os-software.html
...
VM-Series firewall during a maintenance window without changing
the OVF URL in the service definition. 

 Upgrade the VM-Series for NSX
without disrupting traffic —use this option to upgrade the
VM-Series firewall without disrupting service to the guest VMs or
changing the OVF URL in the service definition. 
...
an HA pair, upgrade the passive Panorama peer first, followed by the
active HA peer. 
