---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/best-practices/10-0/data-center-best-practices/data-center-best-practice-security-policy/define-the-initial-data-center-to-internet-traffic-security-policy/create-data-center-to-internet-decryption-policy-rules.html
fetched_at: 2026-09-16T13:55:11Z
...
elements in regard to these traffic flows: 
 ...
 When you
create a Decryption policy rule, the objective is to decrypt traffic
so that a Security policy rule can examine it and allow or block
it based on policy. To accomplish that, the Decryption policy rule
must use the same source zone(s) and user(s) as the analogous security policy
rule, and the same destination zone and address (often defined by
a dynamic address group so that as you add
