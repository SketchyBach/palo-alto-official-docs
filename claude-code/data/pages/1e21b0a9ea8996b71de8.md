---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/incident-configuration/create-an-evidence-field
fetched_at: 2026-09-06T10:22:15Z
source: cortex-platform
---

# Create an evidence field | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom evidence fields in Cortex XSOAR 8 SaaS. 
 ...
 Go to Settings & Info → Settings → Object Setup → Incidents → Evidence Fields → New Field . 
 ...
 (Optional) In the Basic Settings tab, define the values according to the selected field type. 
