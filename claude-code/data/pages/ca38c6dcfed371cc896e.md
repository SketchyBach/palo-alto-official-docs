---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/renewing-a-certificate
fetched_at: 2026-09-16T07:25:29Z
source: palo-alto-main
---

# Renewing Certificates Clear
...
Updated on 
 ...
 Important: To preserve remaining validity during renewal, the request policy must use the same CA account as the original certificate. If a different CA account is used, the renewed certificate uses the standard validity period starting from the issuance date. 
