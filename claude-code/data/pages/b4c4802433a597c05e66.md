---
url: https://docs.prismacloud.io/content-collections/runtime-security/cloud-service-providers
fetched_at: 2026-09-16T13:35:18Z
source: prisma-cloud
---

# Cloud Service Providers | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the guided onboarding flow to onboard cloud accounts onto your Prisma Cloud tenant to automatically create service accounts and roles in your cloud provider accounts. Prisma Cloud is then quickly integrated with your cloud providers. 
 ...
 You can review the list of all features and their corresponding permissions . 
