---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-114
fetched_at: 2026-09-06T11:15:29Z
source: cortex-platform
---

# Clarifai API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Clarifai API Key grants access to AI models for image and video recognition. 
 ...
 Previous MonkeyLearn API Key detected in code 

 Next Azure Machine Learning web service API key detected in code 
