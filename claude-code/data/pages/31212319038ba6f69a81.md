---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/troubleshoot-and-reference/reference/user-preferences
fetched_at: 2026-09-06T10:23:18Z
source: cortex-platform
---

# User preferences | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set user preferences in Cortex XSOAR 8 SaaS. 

 Each user can define their own preferences. To configure, click your username, and select User Preferences . These preferences do not affect other users. 

 Details 

 Edit your first and last name and reset your password. 
