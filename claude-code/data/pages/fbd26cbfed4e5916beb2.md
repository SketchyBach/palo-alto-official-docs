---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-523/known-issues-in-the-panorama-plugin-for-azure-523.html
fetched_at: 2026-09-16T12:59:24Z
source: palo-alto-main
---

# Known Issues in the Panorama Plugin for Azure 5.2.3 Clear
...
Updated on 
 ...
 The following list describes known issues in the Panorama plugin for Azure 5.2.3: 

 PLUG-21927 

 In a High Availability (HA) configuration where the Secondary Panorama is
 active, the Panorama IP dropdown in the Cloud Device Group parameters incorrectly
 displays the Public IP of the Secondary Panorama. This results in a mismatch where the
 displayed Public IP belongs to the Secondary peer, while the displayed Private IP
 belongs to the Primary peer. 

 PLUG-21908 

 The Azure plugin 5.2.3 becomes unresponsive if you create a new Cloud Device
 Group (DG) that references a Template Stack already in use by another Cloud DG. This
 configuration causes the commit handler to stall, preventing subsequent operations even
 though the plugin daemon remains running. 
