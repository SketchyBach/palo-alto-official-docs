---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-120/known-issues-in-openconfig-plugin-120.html
fetched_at: 2026-09-16T13:01:41Z
source: palo-alto-main
---

# Known Issues in the OpenConfig Plugin 1.2.0 Clear
...
Updated on 
 ...
 When using an unbundled subscribe request on the following path:

 /components/component/state 

 memory
 parameters are not retrieved. 

 PLUG-12496 

 When using the OpenConfig capabilities request protobuf is not listed. 
