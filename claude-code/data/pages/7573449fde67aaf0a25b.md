---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/monitoring/appsec-tf-1
fetched_at: 2026-09-06T11:12:55Z
source: cortex-platform
---

# Terraform module sources do not use a git url with a commit hash revision misconfiguration detected | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous OCI Compute Instance has monitoring disabled misconfiguration detected in code 

 Next Terraform module sources do not use a git url with a tag or commit hash revision misconfiguration de 
