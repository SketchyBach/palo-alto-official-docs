---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/is_sla_breached
fetched_at: 2026-09-16T09:15:49Z
source: cortex-platform
---

# is_sla_breached | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use is_sla_breached() when you only need a yes/no breach flag; use sla_time_remaining when you need the numeric duration for ranking or aggregation. 
