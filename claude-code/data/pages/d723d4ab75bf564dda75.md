---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin/panorama-software-firewall-license-plugin-120/known-issues-in-the-panorama-software-firewall-license-plugin-120.html
fetched_at: 2026-09-16T13:01:29Z
source: palo-alto-main
---

# Known Issues in the Panorama Software Firewall License Plugin 1.2.0 Clear
...
Updated on 
 ...
 In a high availability (HA) Panorama deployment, the Show Bootstrap
 Parameters Software Firewall License plugin displays incorrect IP addresses for
 Panorama server-1 and Panorama server-2. Additionally, the same incorrect IP address is
 also shown for both Panorama servers. 

 Workaround : 

 Manually change the Panorama server-1 IP address and Panorama server-2 IP
 address to correct IPs when using these bootstrap parameters to bootstrap the firewall.
