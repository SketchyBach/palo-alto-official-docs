---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-20/vm-series-plugin-200.html
fetched_at: 2026-09-16T12:59:15Z
source: palo-alto-main
---

# VM-Series Plugin 2.0.0 Clear
...
Updated on 
 ...
 What’s new in VM-Series plugin 2.0.0 

 The VM-Series plugin 2.0.0 is the minimum version
for VM-Series firewall running PAN-OS 10.0.0. This release of the
plugin adds support for the CN-Series firewall, which also requires
Panorama and the Kubernetes plugin on Panorama. 

 Refer to the Compatibility Matrix for
more information on the minimum PAN-OS version supported on the
