---
url: https://cortex-docs.paloaltonetworks.com/xdr-5-api/cloud-onboarding/cloud-instance-management
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 These APIs enable you to create a cloud instance in pending state and provide a link to download the authentication template to be executed in your CSP. You can get details on the cloud instances currently in Cortex XDR and you can enable, disable, or delete them. You can also edit the cloud instance configuration. 
