---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-aws/troubleshoot-aws-errors
fetched_at: 2026-09-16T13:34:56Z
source: prisma-cloud
---

# Troubleshoot AWS Onboarding Errors | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If you are a Prisma Cloud Administrator who does not have AWS Administrator access, update the externalId used in Create IAM Role using Update Cloud Account API . 
 ...
 If you are a Prisma Cloud Administrator who does not have AWS Administrator access, update the externalId, memberExternalId, memberRoleName, and roleArn used in Create IAM Role using Update Cloud Account API : 
 ...
 Previous AWS APIs Ingested by Prisma Cloud 

 Next Prisma Cloud on AWS China 
