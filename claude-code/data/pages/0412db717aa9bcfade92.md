---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/troubleshoot-and-reference/reference/server-configurations
fetched_at: 2026-09-06T10:23:22Z
source: cortex-platform
---

# Server configurations | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure and troubleshoot Cortex XSOAR 8 SaaS server settings. 
 ...
 audit.log.war.room.user.commands 

 Enables adding commands run in the War Room CLI to the management audit logs, including details such as the analyst name, the command name/details, and command arguments. 

 True 

 audit.log.playground.user.commands 

 Enables adding commands run in the Playground CLI to the management audit logs, including the analyst name, the command name/details, and command arguments. 
