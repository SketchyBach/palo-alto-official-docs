---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-Cloud-discovery-service-sectionOverview/c-Cloud-discovery-other-methods
fetched_at: 2026-08-13T16:38:37Z
source: palo-alto-main
---

# Other Discovery Methods Clear
...
Other Discovery Methods 
 ...
 In addition to the primary discovery services, certificates can enter the system through: 

 Manual imports : You can manually add certificates obtained from third-party sources or other methods. 

 Issuance : Certificates issued directly by Next-Gen Trust Security are added to the inventory automatically. 

 Validations : While not a primary discovery method, the Validate Now feature can help to sniff out any additional TLS server endpoints associated with certificates in your inventory. 

 Related Links 

 Introduction to discovery services 

 Introduction to certificate discovery 
