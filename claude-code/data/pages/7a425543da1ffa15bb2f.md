---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-your-azure-account/update-azure-application-permissions
fetched_at: 2026-09-16T13:34:56Z
source: prisma-cloud
---

# Update Azure Application Permissions | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Navigate to the directory you created during the onboarding process to store the Terraform file. Sample directory names include onboard-tenant-<tenant-name> or onboard–subscription-<subscription-name> . Ensure that the directory contains the terraform.tfstate file created during the terraform apply step. 
 ...
 For Tenant onboarding: Navigate to All Services > Management Groups . Click on Tenant Root Group For Subscription onboarding: Navigate to All Services > Subscriptions . 
 ...
 Previous Authorize Prisma Cloud to access Azure APIs 

 Next View and Edit a Connected Azure Account 
