---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-addressed-issues/pan-os-9-1-3-addressed-issues
fetched_at: 2026-08-13T17:14:20Z
source: palo-alto-main
---

# PAN-OS 9.1.3 Addressed Issues Clear
...
PAN-OS 9.1.3 Addressed Issues 
 ...
 A fix was made to address a Security Assertion
Markup Language (SAML) authentication issue ( CVE-2020-2021 ). 

 PAN-148068 

 Fixed an issue where SSL connections were
...
the incoming log rate was high. 
 ...
 A fix was made to address a buffer overflow
...
Portal or Multi-Factor Authentication interface ( CVE-2020-2040 ). 
 ...
 Fixed an issue where Cortex Data Lake certificates
on the firewall were not automatically renewed after the certificates
expired. 

 PAN-144782 

 Fixed an issue where a configuration audit
...
> SD-WAN > Monitoring ). 
 ...
 Fixed an issue where, after loading a saved
...
settings. 
 ...
 Fixed an issue where running a test security-policy-match API
command truncated the rule name to 31 characters. 

 PAN-143130 

 Fixed an issue where, in Panorama, cloning
...
connection issues with Cortex Data Lake. 
 ...
 Fixed an issue where authentication stopped
...
mmap mode did not work. 
 ...
 Fixed an issue where Slot 8 path monitoring
...
forwarding and Cortex Data Lake. 
 ...
 Fixed an issue where the resolution of FQDN
...
during a commit when Netflow was enabled. 
 ...
 Fixed an issue where a memory leak on a
process ( useridd ) caused multiple processes to restart
during device serial number checks. 

 PAN-140618 

 Fixed an issue on Panorama where SNMP monitoring
of the logging rate per device was incorrect. 

 PAN-140575 

 Fixed an issue where a process ( masterd )
did not restart another process ( logrcvr ) on the Log Forwarding
Card (LFC) after the process ( logrcvr ) crashed. 
...
in forward relocation requests. 
 ...
 Fixed an issue that led to exhaustion of
...
GPRS tunneling protocol (GTP) inspection did not work. 
 ...
 Fixed an issue where unique GlobalProtect
...
the incoming log rate was high. 
 ...
 Fixed an intermittent issue where logs were
...
Services plugin to 1.6.0-h1. 
 ...
 Fixed an issue where a Panorama Custom Report based
...
Additional Authentication Factors selected. 
 ...
 Fixed an issue where URL filtering used
...
speed as 0 for interfaces other than eth0. 
 ...
 ( PA-3000 Series and PA-800 Series firewalls
...
feature. 
 ...
 Fixed an issue where PA-7000 20GXM and PA-7000
...
leaked, which caused the depletion of Work Query Entry (WQE) pools. 
 ...
 Fixed an issue where, when the app-version from
...
restart. 
 ...
 Fixed an issue where dataplane interfaces
...
profile. 
 ...
 Fixed an issue with log collectors on Panorama
...
when the IP addresses changed for those FQDNs. 
 ...
 Fixed an issue where, with a new Panorama
...
character limit. 
 ...
 Fixed an issue where TMP files were not
...
to exit when site-to-site VPNs experienced connectivity interruptions. 
 ...
 Fixed an issue where the Terminal Server
...
was power cycled. 
 ...
 Fixed an issue where reports for URLs were
...
due to MP ARP overflow. 
 ...
 Fixed an issue where packets tagged with
...
(GTP) traffic, which caused the packet processor to terminate. 
 ...
 Fixed an issue where a new GPRS tunneling
...
no longer required parameters. 
 ...
 Fixed an issue where license and content
