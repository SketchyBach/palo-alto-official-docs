---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-81.html
fetched_at: 2026-09-16T11:04:23Z
source: palo-alto-main
---

# Route Table Size Clear
...
Updated on 
 ...
 Identifies the size of the routing table in terms of the number of entries for the Routing Information Base (RIB) and the Forwarding Information Base (FIB). 
 ...
 show routing fib show routing route
