---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-aws/update-aws-account
fetched_at: 2026-09-16T13:34:55Z
source: prisma-cloud
---

# Update an Onboarded AWS Account | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Add AWS Member Accounts 

 Next Update an Onboarded AWS Account to AWS Organization 
