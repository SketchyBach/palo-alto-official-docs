---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-95.html
fetched_at: 2026-09-16T11:03:35Z
source: palo-alto-main
---

# PAN-OS XML API Performance Metrics Clear
...
Updated on 
 ...
 Provides XML API performance metrics, such as the number of requests per second served by the device, and the average response time to service an XML API request. 
 ...
 /var/log/nginx/restapi_metrics.log
