---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/automation/scripts
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create and manage scripts for automation workflows. 

 On the Scripts page, you can view, edit, and create scripts in JavaScript, Python, or PowerShell. When creating a script, you can access all Cortex Cloud APIs, including access to issues and investigations, and share data with the War Room. Scripts can receive and access arguments and can be password-protected. 
