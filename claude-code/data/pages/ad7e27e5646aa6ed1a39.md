---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-98.html
fetched_at: 2026-09-16T11:03:53Z
...
Updated on 
 ...
 For each log type (traffic, threat, system, and so forth), collects the the amount of disk space used as a percentage of the disk space quota configured for the log type, as well as the number of bytes consumed by the log type. Retention period for each log type is also collected, as well as the maximum quota configured for each log type. 
