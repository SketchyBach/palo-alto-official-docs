---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-3
fetched_at: 2026-09-06T11:15:05Z
source: cortex-platform
---

# Azure Storage Account Access Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 An Azure Storage Account Access Key grants full Shared Key authorization to the storage account. 

 Exposure is a Critical Compromise, enabling an attacker to read, write, or delete all data across blobs, queues, and tables, leading to massive data breaches or service disruption. 
 ...
 Previous AWS Credentials detected in code 

 Next Basic Auth Credential detected in code 
