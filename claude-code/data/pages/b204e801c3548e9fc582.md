---
url: https://cortex-docs.paloaltonetworks.com/application-security/software-supply-chain-security/visibililty-and-inventory/supply-chain-assets/software-packages-as-assets
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 SBOM download requirements 

 To download a valid Software Bill of Materials (SBOM), ensure that: 

 Native SCA scanner is enabled: Formal SBOM reports, including CycloneDX and SPDX, are generated only by the native Cortex Cloud SCA scanner during branch periodic scans. Third-party SCA integrations, including Snyk and Semgrep, do not generate these reports. 

 Supported manifest files are present: The repository must contain dependency manifests, such as package.json , pom.xml , or go.mod . The SCA scanner uses them to discover open-source and third-party packages and build the dependency tree. 
 ...
 Previous Troubleshoot repository technology detection 
