---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/playbooks/develop-your-playbook/task-3.-add-tasks/create-a-communication-task
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create communication tasks in Cortex XSOAR 8 SaaS playbooks. 
 ...
 The survey question and the first response are recorded in the incident context data. This enables you to use this response as the input for subsequent playbook tasks. 
