---
url: https://docs.prismacloud.io/content-collections/runtime-security/secrets/secrets-manager
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When a user or orchestrator starts a container, Defender injects the secrets you specify into the container. In order for secret injection to work, all Docker commands must be routed through Defender. Refer to Inject Secrets into Containers . 
