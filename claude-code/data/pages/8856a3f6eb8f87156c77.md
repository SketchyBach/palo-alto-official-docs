---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-ips-signature-converter/panorama-ips-signature-converter-plugin-102/whats-new-in-the-ips-signature-converter-plugin-102.html
fetched_at: 2026-09-16T13:01:32Z
source: palo-alto-main
---

# What’s New in the IPS Signature Converter Plugin 1.0.2 Clear
...
plugin 1.0.2. 
 ...
 The IPS signature converter version 1.0.2
introduces the following capabilities: 

 Feature Description 

 Support for SMB Protocol 
 For coverage of SMB-based threats, you can
now convert Snort and Suricata rules that use the smb protocol. Also,
rules with port 445 now convert to SMB or
MSRPC custom signatures. 

 Support for New Suricata Sticky Buffer Keywords 
 For better coverage of threats identified by
Suricata rules, the converter now supports the following HTTP sticky
buffer keywords: 
 ...
 Learn more in the Suricata documentation . 

 Improved HTTP Signature Conversion 
 You can now convert HTTP-based Snort and
Suricata rules to HTTP-based custom signatures by simply specifying
the port as HTTP_PORTS or by using the protocol http . 
