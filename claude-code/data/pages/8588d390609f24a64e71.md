...
CASB for Prisma Access and NGFW (CASB-X) license 
 ...
 Email DLP Delivery Notifications —Allow the egress IP addresses and
 outbound SMTP server domains required for Enterprise DLP to deliver Email
 DLP delivery notifications to email senders. 
