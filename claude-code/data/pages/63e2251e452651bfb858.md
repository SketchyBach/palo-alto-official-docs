---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-521/what-s-new-in-the-panorama-plugin-for-azure-521.html
fetched_at: 2026-09-16T12:59:25Z
source: palo-alto-main
---

# What's New in the Panorama Plugin for Azure 5.2.1 Clear
...
Updated on 
 ...
 The Panorama plugin for Azure version 5.2.1 introduces the following: 
 Adds permission validation for private endpoint read access. 

 New tags used for monitoring: 
 Private endpoint monitoring tags . A private endpoint represents a
 network interface that uses a private IP address from your virtual
 network (VNET). This interface is used to privately and securely connect
 to a service for your Azure Private Link. The following tags are mapped
 to this private IP address: 
 Private endpoint, for example,
 azure.private-endpoint.myPrivateEndpoint . 

 Azure region, for example,
 azure.region.east-us . 

 Resource group name, for example,
 azure.resource-group.myResourceGroup . 

 User-defined tags for a private endpoint, for example,
 azure.tag.mytag.value . 

 Network interface user-defined tags . If a network interface is
 associated with a virtual machine or a private endpoint, the network
 interface's user-defined tags are collected. For example,
 azure.tag.mytag.value . 
