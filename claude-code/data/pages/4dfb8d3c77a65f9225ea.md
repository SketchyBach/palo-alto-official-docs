---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/top
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Represents the number of top elements to return. If omitted, it defaults to up to 10 elements. 
 ...
 An optional clause to group rows based on specified fields before identifying top elements within each group. 
 ...
 Optional alias to rename the default TOP_COUNT result column. 
 ...
 Optional alias to rename the default TOP_PERCENT result column. 
 ...
 Stages : filter , fields , limit 

 Functions : approx_top 
