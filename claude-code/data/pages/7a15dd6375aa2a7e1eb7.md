---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/playbooks/customize-your-playbook/extend-context
fetched_at: 2026-09-16T09:15:00Z
source: cortex-platform
---

# Extend context | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Extend context in Cortex XSOAR On-prem 8.7 (EoL). 
 ...
 Example 17. Extend context using the CLI with the IBM Qradar v3 integration instance 
