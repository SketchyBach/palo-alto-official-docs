---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/deployment-steps/install-cortex-xdr-agents/guidelines-for-keeping-cortex-xdr-agents-and-content-updated
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Keep Cortex XDR agents and security content current and supported. 
 ...
 Configure the number of parallel upgrades to apply to all endpoints in your organization. 
 ...
 Configure the content update cadence and bandwidth allocation within your organization. To enforce immediate protection against the latest threats, enable minor content updates. Otherwise, the content updates in your network occur only on major releases. 
 ...
 Cortex XDR distributes the installation package to the selected endpoints at the next heartbeat communication with the agent. To monitor the status of the upgrades, go to Investigation and Response → Response → Action Center . 
 ...
 Next Create an installation package 
