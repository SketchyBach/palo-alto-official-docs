---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-vcenter/panorama-plugin-for-vmware-vcenter-100.html
fetched_at: 2026-09-16T13:00:29Z
source: palo-alto-main
---

# Panorama Plugin for VMware vCenter 1.0.0 Clear
...
Updated on 
 ...
 The Panorama plugin for VMware vCenter
enables VM monitoring in your vCenter environment. It allows you
to track the virtual machine inventory within your VMware vCenter
so that you can consistently enforce security policy that automatically
adapts to changes within your vCenter environment. As virtual machines
are provisioned, de-provisioned or moved, this solution allows you
to collect the IP addresses and the associated set of attributes
(or metadata elements) as tags. You can then use the tags to define Dynamic Address Groups and
use them in Security policy. 

 You can download the vCenter plugin for Panorama 9.0.2 or later
from the Customer Support Portal or directly from Panorama Plugins .
Panorama can push the virtual machine attributes that it retrieves
to firewalls running PAN-OS 8.1.0 and later. 

 For more information about using the Panorama plugin for VMware
vCenter, refer to the VM-Series Deployment Guide for
PAN-OS 9.0 . 
