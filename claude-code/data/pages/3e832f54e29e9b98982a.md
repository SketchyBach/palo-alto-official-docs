---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/playbooks/build-your-playbook/configure-script-error-handling-in-a-playbook
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure how a playbook handles errors from script tasks. 
 ...
 You may want to create a separate path when an analyst manually reviews the issue and research is needed outside Cortex XDR. Once an analysis is complete, you can add a task to consider escalating to a customer and, if so, generate a report that can be attached to a ticket system such as Jira or ServiceNow. 
