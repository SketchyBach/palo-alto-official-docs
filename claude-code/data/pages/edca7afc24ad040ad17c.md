---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-nutanix/nutanix-plugin-202/addressed-issues-in-panorama-plugin-for-nutanix-202
fetched_at: 2026-09-16T07:43:36Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Nutanix 2.0.2 Clear
...
Updated on 
 ...
 The following list describes issues addressed in the Panorama plugin for Nutanix
 2.0.2: 

 PLUG-17639 

 Fixed an issue where the IP tags failed to display on Panorama console despite the
 successful installation of the Nutanix plugin. 

 PLUG-18228 

 Fixed an issue that blocked Nutanix plugin downgrade on FIPs Panorama version 10.2.5
 or above due to checksum being deprecated. 

 PLUG-17721 

 Fixed the HA failover and checksum issues on Panorama in FIPS mode. 
