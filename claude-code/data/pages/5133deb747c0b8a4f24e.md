---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/configure-the-agent/set-up-prisma-agent-user-authentication/set-up-saml-authentication-with-cie/prisma-agent-captive-portal-support
fetched_at: 2026-09-16T08:21:17Z
source: palo-alto-main
---

# Prisma Agent Captive Portal Support Clear
...
Updated on 
 ...
 Configure Prisma Agent to Use the Default System Browser for SAML Authentication 
 ...
 Prisma Agent can now detect and handle captive portals to improve connectivity
 ...
 devices require Prisma Agent version 25.3.0.43 and later
 versions 

 iOS 16 and later versions for mobile devices require Prisma Agent version 25.7.0 and later versions 

 Contact your Palo Alto Networks account representative to activate the Prisma Agent feature 

 Prisma Agent captive portal support is designed to improve the connectivity
 experience for mobile users who frequently connect from networks with captive portals,
 such as hotels, cafes, and airports. This feature uses the Prisma Agent embedded
 ...
 Prisma Agent detects a captive portal, the agent launches the embedded
 ...
 When a user logs in successfully and the internet becomes reachable, the Prisma Agent automatically establishes a connection. If the user fails to log in
 to the captive portal, the agent blocks all traffic. 

 By default, Prisma Agent uses the embedded browser for SAML authentication
 and captive portal.
 ...
 login page, Prisma Agent will display a notification indicating the
 presence of a captive portal. Users can tap the notification to manually open
 the captive portal within the Prisma Agent embedded browser and complete
 ...
 refer to Use the Prisma Agent App for iOS
 (Managed Devices) . 
 ...
 airport, the Prisma Agent automatically detects the captive portal. The
 embedded browser within the Prisma Agent 
 then
 ...
 Once the user successfully authenticates through the captive portal, the Prisma Agent automatically establishes a secure connection to the corporate network
 ...
 to connect to Prisma Agent , they will have no connection to the internet.
 ...
 When using Prisma Agents in a per-app configuration on iOS devices, the
 ...
 airports, or cafes, users receive a notification from Prisma Agent indicating
 ...
 within the Prisma Agent 's embedded browser. Within this embedded browser,
 ...
 on the endpoint. If Prisma Agent detects a captive portal, it
