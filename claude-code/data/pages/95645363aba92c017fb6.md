---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-64
fetched_at: 2026-08-13T17:17:07Z
source: palo-alto-main
---

# Log Forwarding Settings Clear
...
Log Forwarding Settings 
 ...
 Identifies the log types (traffic, threat, and so forth) that are being forwarded to an external collector, and the forwarding mechanism in use for each log type (syslog, email, HTTP, and so forth). 
