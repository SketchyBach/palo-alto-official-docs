---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-201/addressed-issues-in-kubernetes-plugin-201.html
fetched_at: 2026-09-16T13:01:16Z
source: palo-alto-main
---

# Addressed Issues in Kubernetes Plugin 2.0.1 Clear
...
Updated on 
 ...
 Addressed issue in the Panorama plugin
for Kubernetes version 2.0.1: 

 PLUG-10502 

 Added a 90 second timeout when a k8 API
calls are made to the watcher daemon. This allows the watcher daemon
to recover after a network outage. 

 PLUG-10046 

 Fixed an issue that cause CN-NGFW pods
to lose their licenses due to an IPSEC connection problem with the
CN-MGMT pod. 
...
of credentials when creating an Openshift cluster definition. 
...
stage and does not receive any new updates. 
 ...
 Fixed a race condition between the watcher and poller
that caused the traffic to stop matching security policy that includes
a dynamic address group after an initial match. 
