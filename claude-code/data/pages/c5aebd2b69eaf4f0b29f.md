---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-501
fetched_at: 2026-09-16T07:43:57Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 5.0.1 Clear
...
Updated on 
 ...
 The Panorama plugin for VMware NSX 5.0.1 includes fixes to known issues. 

 You can download the Panorama plugin for VMware NSX 5.0.1 from the Customer
 Support Portal or directly from Panorama Plugins . Panorama can push the virtual machine attributes that it retrieves to
 firewalls running the versions detailed in the plugin Compatibility Matrix for cloud environments . 
