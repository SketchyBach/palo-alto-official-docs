---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/analyze-and-resolve-cases/additional-case-actions/assign-a-case-team-and-restrict-access
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Assign a team and restrict access to sensitive cases. 
 ...
 Permissions required: To change the scope and access of a case, you must have the Restrict Case Access permission under Cases & Issues . 
