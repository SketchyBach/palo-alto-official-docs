---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.1/cortex-xdr-agent-for-linux
fetched_at: 2026-09-06T10:20:19Z
source: cortex-platform
---

# Cortex XDR Agent for Linux | 9.1 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To install, use, and uninstall the Cortex XDR agent on Linux endpoints, see the references in this topic. 
 ...
 Next Cortex XDR supported Kernel Module versions by distribution 
