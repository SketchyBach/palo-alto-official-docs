---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/data-management/broker-vm/set-up-and-configure-broker-vm
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install and configure a Broker VM to collect data for Cortex Cloud Posture Management. 
...
HTTPS over TCP port 443 
 ...
 Information needed to communicate with your Cortex Cloud tenant. Used by tenants deployed in all regions. 
 ...
 For more information on enabling access to Cortex Cloud, see Enable access to required PANW resources . 
 ...
 Keep in mind that several Broker VM applets have their own dedicated CA certificate bundle. 
...
For example: ssh -i [/path/to/private.key] admin@[broker_vm_address] 
 ...
 If adding a CA certificate to the Broker VM is not possible, ensure that you’ve added the Broker Service FQDNs to the SSL Decryption Exclusion list on your firewalls. See Enable Access to required PANW resources . 
 ...
 (Optional) Collect and Generate New Logs (Requires Broker VM 8.0 and later). Your Cortex Cloud logs will download automatically after approximately 30 seconds. 
