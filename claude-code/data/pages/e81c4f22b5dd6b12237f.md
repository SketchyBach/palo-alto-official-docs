---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-image-installations/set-up-broker-vm-on-microsoft-azure
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to set up your Cortex Data Security Broker virtual machine (VM) on Microsoft Azure. 

 After you download your Cortex Data Security Broker VHD (Azure) image, you need to upload it to Azure as a storage blob. 
...
Additional fields are displayed, which you can define as follows: 
 ...
 From the navigation panel, select the bucket and then container to which you uploaded the Cortex Data Security VHD image. 
