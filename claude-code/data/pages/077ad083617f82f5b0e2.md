---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/presets
fetched_at: 2026-09-06T10:58:40Z
source: cortex-platform
---

# preset | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The specific name of the preset to query (for example, authentication_story , network_story ). 
