---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-trustsec/panorama-plugin-for-cisco-trustsec-102/whats-new-in-the-panorama-plugin-for-cisco-trustsec-102.html
fetched_at: 2026-09-16T13:00:43Z
source: palo-alto-main
---

# What’s New in the Panorama Plugin for Cisco TrustSec 1.0.2 Clear
...
version 1.0.2 introduces the PubSub monitoring mode, which monitors
notifications directly from the Cisco ISE server (the subscription
daemon), parses them, and sends relevant information to the tag processing
daemon (tag-proc). 

 If the Panorama version is 10.0.0 or later, the
plugin enables the PubSub monitoring mode, and if the Panorama version
is earlier than 10.0.0, the plugin enables bulk-sync mode (Get All). 

 The plugin log location is now in plugins-log, and the CLI command
is: 
