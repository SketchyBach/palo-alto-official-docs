---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/automation/playbooks/build-your-playbook/add-objects-from-the-task-library
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add reusable tasks from the Task Library to a playbook. 
 ...
 Add tasks containing a natural language AI prompt with inputs and outputs that interact with the built-in LLM as part of your automation. 
 ...
 AI tasks use natural language prompts to interact with the built-in LLM. You provide the inputs and the LLM generates the outputs. 
