---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/onboard-cortex-xsoar/users-and-roles/authenticate-users-with-saml-2.0/set-up-microsoft-entra-id-as-the-identity-provider-using-saml-2.0
fetched_at: 2026-09-16T08:56:07Z
source: cortex-platform
---

# Set Up Microsoft Entra ID as the Identity Provider Using SAML 2.0 | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Microsoft Entra ID as a SAML 2.0 identity provider for Cortex XSOAR 6.14. 
