---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-104/addressed-issues-in-kubernetes-plugin-104.html
fetched_at: 2026-09-16T13:01:20Z
source: palo-alto-main
---

# Addressed Issues in Kubernetes Plugin 1.0.4 Clear
...
issues in the Panorama plugin for Kubernetes, version 1.0.4. 
...
CN-MGMT pod. 
 ...
 Fixed an issue that prevented changing
the number of tokens configured in the Kubernetes plugin after initial
allocation. 

 PLUG-8019 

 Fixed an issue that prevented the Kubernetes
plugin from retrieving licensing and monitoring information from
clusters. 
