---
url: https://docs.prismacloud.io/admin-guide/32/authentication/oauth2-github
fetched_at: 2026-09-16T13:37:25Z
source: prisma-cloud
---

# GitHub (OAuth 2.0) | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Active Directory Federation Services (SAML 2.0) 

 Next OpenShift (OAuth 2.0) 
