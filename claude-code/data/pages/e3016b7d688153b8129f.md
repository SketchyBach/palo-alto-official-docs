---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/manage-compute-units/compute-units-usage
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex Data Security provides a free daily quota of compute units (CU) allocated according to your license size. Queries called without enough quota will fail. To expand your investigation capabilities, you can purchase additional CU by enabling the Compute Unit add-on. After purchasing the additional CU, you can enable the add-on by selecting Settings → Cortex Data Security License → Addons , hovering over the Extended Compute Units tile and clicking Enable . 
 ...
 To gauge how many CU you require, Cortex Data Security provides a 30-day free trial period with 1/12 of your allocated annual CU quota to run XQL API and Cold Storage queries. You can then track the cost of each XQL API and Cold Storage query responses, and the Compute Unit Consumption page. In addition, Cortex Data Security sends a notification when the Compute Units add-on has reached your daily threshold. 
 ...
 Next What are Cortex Data Security data sources and connectors? 
