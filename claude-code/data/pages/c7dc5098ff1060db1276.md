---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-your-oci-account/add-oci-tenant-to-prisma-cloud
fetched_at: 2026-09-16T13:35:00Z
source: prisma-cloud
---

# Add Your OCI Tenant to Prisma Cloud | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Start using the Prisma Cloud Asset Inventory for visibility. Set the Cloud Type filter as OCI to view the data for the supported services. You can also filter the data based on the OCI Cloud Region and Service Name . 
 ...
 Previous Permissions Required for OCI Tenant on Prisma Cloud 

 Next Manage an Onboarded OCI Account 
