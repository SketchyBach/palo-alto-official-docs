---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/data-management/manage-event-forwarding/endpoints-event-forwarding-includedexcluded-fields-by-event-type
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Endpoints Event Forwarding exports ingested, parsed endpoint data for Cortex XDR Agent and Cloud Endpoints. The exported logs are raw data, without any stories. Cortex XDR exports the data without filtering or configuration options. 
