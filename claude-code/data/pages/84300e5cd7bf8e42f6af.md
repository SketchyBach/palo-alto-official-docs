---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin/panorama-software-firewall-license-plugin-112/addressed-issues-in-the-panorama-software-firewall-license-plugin-112.html
fetched_at: 2026-09-16T13:01:29Z
source: palo-alto-main
---

# Addressed Issues in the Panorama Software Firewall License Plugin 1.1.2 Clear
...
Updated on 
 ...
 License plugin 1.1.2. 

 PLUG-12854 

 Fixed an issue where licensing through the Panorama Software Firewall Licensing
 (SFL) plugin fails while scaling out to deploy a new PA-VM. 

 Workaround : Following an upgrade to SFL 1.1.2, ensure that you commit twice and
 the authorization-code is present at the device group level in the running config. 

 PLUG-12911 

 Fixed an issue where the configd process running high CPU usage showed
 sluggishness in performance in Panorama GUI and CLI. 

 Workaround : Upgrade to Software Firewall Licensing plugin 1.1.2 and turn
 off the device group query by running the following commands: 

 request plugins sw_fw_license dgquery turnoff
 yes 
