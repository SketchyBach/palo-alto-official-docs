---
url: https://docs.paloaltonetworks.com/hardware/pa-7000-hardware-reference/service-the-pa-7000-series-hardware/replace-a-pa-7000-series-front-slot-card/replace-a-pa-7000-series-log-card
fetched_at: 2026-08-13T16:35:27Z
source: palo-alto-main
---

# Replace a PA-7000 Series Log Card Clear
...
Replace a PA-7000 Series Log Card 
 ...
 Learn how to replace a PA-7000 Log Processing Card (LPC)
or a PA-7000 Log Forwarding Card (LFC). 

 Use the following topics to learn how to replace a PA-7000
Series Log Processing Card (LPC) or a PA-7000 Series Log Forwarding
Card (LFC). The LPC has disk drives that must be removed and re-installed,
while the LFC does not contain disk drives. 

 If the device is in FIPS-CC mode, you must power off the firewall
before adding or replacing a log card, otherwise the device will
boot into maintenance mode. 

 Replace
a PA-7000 Series Log Processing Card (LPC) 

 Replace
a PA-7000 Series Log Forwarding Card (LFC) 
