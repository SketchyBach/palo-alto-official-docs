---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-204/addressed-issues-in-panorama-plugin-for-vmware-nsx-204
fetched_at: 2026-09-16T07:43:45Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 2.0.4 Clear
...
in the Panorama plugin for VMware NSX 2.0.4. 
 ...
 Fixed an issue where Panorama displays
only one tag in the DAG match criteria, when the same security group
in NSX Manager is tied to two different service profiles. Service
profiles can be part of the same cluster or different clusters in
NSX. 

 PLUG-1374 

 Panorama now correctly processes NSX
Service List names from NSX Manager that contain non-ASCII characters. 
