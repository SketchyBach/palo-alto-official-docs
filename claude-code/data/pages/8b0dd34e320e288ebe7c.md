---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/transaction
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 One or more fields used to define the groups for the transaction. 
 ...
 Sets a maximum time frame for each transaction (for example, 30m , 1h ). 
 ...
 Defines a specific start time (epoch) for grouping events when using span . 
 ...
 Defines the time zone for the timeshift parameter (for example, "+00:00" ). 
 ...
 A condition defining the event that starts a transaction. 
 ...
 A condition defining the event that ends a transaction. 
 ...
 If true (default), includes transactions that do not have a matching ending event. 
 ...
 Defines the maximum number of events to include per transaction. The default is 100. 
