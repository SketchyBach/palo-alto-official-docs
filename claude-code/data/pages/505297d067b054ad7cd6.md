---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-widget-from-an-indicator
fetched_at: 2026-09-16T09:14:42Z
source: cortex-platform
---

# Create a widget from an indicator | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create indicator widgets in Cortex XSOAR 8.6 (EoL) On-prem. 
