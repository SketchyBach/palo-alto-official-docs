---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.13/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/dashboards/dashboard-overview
fetched_at: 2026-09-16T08:57:07Z
source: cortex-platform
---

# Dashboard Overview | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex XSOAR 6.13 dashboards provide visual data from customizable widgets. Create, edit, import, share, and delete dashboards. 
 ...
 You can generate a report from the dashboard as is, or add new widgets as required. You can set the format, when to run, orientation, etc. To run the report, click Run Now . The Report is generated, and it also appears in the Reports tab, where it can be run again. For more information about creating reports, see Create a Report . 
