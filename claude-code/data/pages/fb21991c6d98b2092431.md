---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/reference-and-developer-docs/role-based-access-control/cloud-security-and-posture-management-permissions/application-security-permissions/application-security-generic-collector-permissions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure permissions for Application Security generic collectors. 

 The Generic Collector is a data source integration type within the Application Security module that allows ingestion of code scan data from external third-party security tools into Cortex XDR. Access the 3rd party AppSec Collector data source by going to Settings → Data Sources & Integrations 
 ...
 Scan results ingested by the collector flow into Cortex XDR require a Cloud Posture Security or Cloud Runtime Security license plus the Application Security add-on. 
