---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-305/addressed-issues-in-vm-series-plugin-305.html
fetched_at: 2026-09-16T12:58:57Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 3.0.5 Clear
...
Updated on 
 ...
 Fixed an issue that caused a commit failure on the CN-Series firewall on Kubernetes
 1.25.5. 

 PLUG-12091 

 Fixed an issue where the VPC endpoints would not appear while using the command show
 plugin vm-series aws gwlb . 
