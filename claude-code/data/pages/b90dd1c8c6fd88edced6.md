---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/onboard-cortex-xsoar/cortex-xsoar-installation/installation-overview
fetched_at: 2026-09-06T11:19:10Z
source: cortex-platform
---

# Installation overview | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review installation options for Cortex XSOAR 8.8 On-prem. 
 ...
 A cluster is a group of three nodes that are managed together and participate in workload management. It is suitable for large-scale data production environments and High Availability and load balancing. 
 ...
 In the Cluster Installation menu, select one node from which to install the cluster, including setting the IP addresses of each node. To implement High Availability, set the FQDN IP address to either a virtual IP or a reverse proxy/ingress controller as a single entry point to distribute traffic across the nodes in the cluster. 
