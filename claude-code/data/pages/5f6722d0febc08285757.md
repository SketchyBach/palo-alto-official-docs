...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When the script finishes, it prints a block of IDs to the terminal. In this step, you copy these IDs, which you will paste into the Bring Your Own Scanner Managed Identities section of the Cortex Cloud outpost creation wizard when you deploy the outpost in the next task, Task 3 . Keep the terminal output open, or save the lines to a temporary file, until you complete the next task. 
