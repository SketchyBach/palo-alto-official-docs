---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/post-deployment-steps/manage-user-roles-and-access-management/manage-access-to-objects/manage-access-to-playbooks-and-scripts
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage access to Cortex Cloud playbooks and scripts using roles and permissions. 
 ...
 Automation objects in Cortex Cloud are categorized by their origin, which dictates how access is managed: 
 ...
 Selecting and running automations : Across all the places in Cortex Cloud where you can select a playbook or script, the list of available automations is filtered. You can only select playbooks or scripts to which you have the required per-object access. 
 ...
 For more information, see Push and pull content. 
 ...
 Pull : When pulling content from a remote repository, Cortex Cloud handles ownership differently depending on whether the content is new or already exists in the environment: 
 ...
 Create Playbooks : Enables all methods for adding playbooks to Cortex Cloud. This includes the Build New Playbook button, as well as the ability to Duplicate or Detach playbooks. The user who performs these actions is automatically designated as the Owner . 
 ...
 Create Scripts : Enables all methods for adding scripts to Cortex Cloud. This includes the New Script button, as well as the ability to Duplicate or Detach scripts. The user who performs these actions is automatically designated as the Owner . 
