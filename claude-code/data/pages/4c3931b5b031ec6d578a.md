---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/wildfire/u-v/wildfire-whats-new/latest-wildfire-cloud-features/wildfire-saudi-arabia-cloud.html
fetched_at: 2026-09-16T11:46:54Z
source: palo-alto-main
---

# WildFire Saudi Arabia Cloud Clear
...
Updated on 
 ...
 Palo Alto Networks now provides access to a WildFire regional cloud in Saudi
 Arabia. 

 A new WildFire regional cloud is now available in Saudi Arabia. The WildFire Saudi
 Arabia cloud provides the best of both worlds for Palo Alto Networks customers
 located in Saudi Arabia — customers can now utilize the WildFire cloud-based threat
 ...
 with our other regional clouds. While submissions stay within the borders of Saudi
 Arabia, customers still benefit from the global security intelligence and updates
 based on the network effect of Palo Alto Networks 42,000+ WildFire customers.
 Sensitive data and submissions are restricted from leaving Saudi Arabia when using
 the WildFire cloud threat analysis service. Samples submitted to the WildFire Saudi
 Arabia cloud and the resulting malware analysis, signature generation and delivery
 occur and remain within the borders of Saudi Arabia. 

 Any firewall with basic WildFire service enabled can forward
 PE (portable executables) samples to the WildFire Saudi Arabia cloud for analysis,
 ...
 WildFire Saudi Arabia portal using your support account credentials to manually
 upload files for analysis and view WildFire analysis reports. 

 You can submit samples to the WildFire Saudi Arabia cloud from the WildFire
 appliance, WildFire Saudi Arabia portal, through the WildFire API, and all Palo Alto
 Networks platforms that support the WildFire security subscription integration. 

 Submit samples to the WildFire Saudi Arabia cloud from the firewall. 

 Log in to the firewall and select Device > Setup >
 WildFire and edit General
 Settings . 

 Enter the URL for the WildFire Saudi Arabia cloud:
 sa.wildfire.paloaltonetworks.com 

 Click OK to save your settings. 

 Submit locally-discovered malware or sample reports to the WildFire Saudi
 Arabia cloud for additional analysis. 

 Enable a WildFire appliance to submit locally-discovered malware or sample
 reports to the WildFire Saudi Arabia cloud for additional analysis and
 signature distribution: 

 Connect the WildFire appliance to the WildFire Saudi Arabia cloud by
 entering the following command from the WildFire appliance CLI: 

 admin@WF-500# set
deviceconfig setting cloud-server sa.wildfire.paloaltonetworks.com 

 Enter the following command to submit malware to the WildFire Saudi
 Arabia cloud: 

 admin@WF-500# set
deviceconfig setting wildfire cloud-intelligence submit-sample yes 

 Manually submit samples to the WildFire Saudi Arabia cloud using the WildFire
 Saudi Arabia portal. 

 You can manually submit samples to the WildFire Saudi Arabia cloud using the
 WildFire Saudi Arabia portal: https://sa.wildfire.paloaltonetworks.com. 

 After uploading files or URLs to the WildFire Saudi Arabia portal, you can
 ...
 Submit a file:
 https://sa.wildfire.paloaltonetworks.com/publicapi/submit/file 

 Submit a file through a URL:
 https://sa.wildfire.paloaltonetworks.com/publicapi/submit/url 

 Submit a URL:
 https://sa.wildfire.paloaltonetworks.com/publicapi/submit/link 

 Submit multiple URLs:
 https://sa.wildfire.paloaltonetworks.com/publicapi/submit/links 

 To get information about your file submissions to
 the WildFire Saudi Arabia cloud, you must also use the base URI that
 corresponds to the WildFire Saudi Arabia cloud. Example:

 https://sa.wildfire.paloaltonetworks.com/publicapi/get/verdict 
