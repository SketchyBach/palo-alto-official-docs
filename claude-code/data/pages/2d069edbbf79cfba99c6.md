---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-211/whats-new-in-the-openconfig-plugin-211.html
fetched_at: 2026-09-16T13:01:38Z
source: palo-alto-main
---

# Whats New in OpenConfig Plugin 2.1.1 Clear
...
Updated on 
 ...
 The OpenConfig plugin version 2.1.1 introduces the following
 capabilities: 

 Feature Description 

 PAN-OS XML API Non-Native OpenConfig Data Model 

 Support for XML API commands through the OpenConfig
 plugin. 

 PAN-OS File-Upload Non-Native OpenConfig Data
 Model Support for uploading debug logs. 

 External client endpoint support Support specific endpoints for dial-out telemetry using
 Fully Qualified Domain Names (Contact Palo Alto Networks Customer
