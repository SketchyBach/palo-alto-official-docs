---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/interconnects/manage-ip-pools/update-ip-pool.html
fetched_at: 2026-09-16T09:54:59Z
source: palo-alto-main
---

# Update IP Pool Clear
...
Updated on 
 ...
 contains instructions to update IP Pool details of an interconnect. 
 ...
 If you had configured Bring Your Own IP , then you can update
 the IP Pool as follows: 

 Go to Telcos SP Interconnects , and select the desired interconnect. 

 Select IP Pool . 

 If you have configured Bring Your Own IP , click
 Update IP Pool to edit the IP Pool. 
