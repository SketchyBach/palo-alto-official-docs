---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-3-0-13/addressed-issues-in-vm-series-plugin-3013.html
fetched_at: 2026-09-16T12:58:49Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 3.0.13 Clear
...
Updated on 
 ...
 Fixed an issue where the Azure Hotplug event caused the system log to incorrectly repeat
 the critical completion message for a single interface instead of generating individual
 recovery messages for each affected interface. 

 PLUG-19486 

 Fixed an issue, where AWS Cloudwatch metrics arrive in different regions
 instead of firewall deployment regions in Cloudwatch when using custom AMI. This issue
 is resolved now. 
