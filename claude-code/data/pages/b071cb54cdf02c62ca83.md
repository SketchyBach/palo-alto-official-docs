---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/onboard-cortex-xsoar/onboard-and-configure-cortex-xsoar/step-2.-set-up-an-engine
fetched_at: 2026-09-06T11:23:20Z
source: cortex-platform
---

# Step 2. Set up an engine | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up an engine on a remote machine in Cortex XSOAR On-prem 8.6 (EoL). 
