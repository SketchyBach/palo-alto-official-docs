---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.9/introduction.md
...
> For the complete documentation index, see [llms.txt](https://cortex-docs.paloaltonetworks.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.9/introduction.md).
...
```
GET https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.9/introduction.md?ask=<question>&goal=<endgoal>
```
