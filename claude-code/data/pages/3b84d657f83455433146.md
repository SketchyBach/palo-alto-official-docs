---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/provision-certificates/provision-certificates-common-keystore
fetched_at: 2026-09-16T07:25:18Z
source: palo-alto-main
---

# Provision to a Common KeyStore Clear
...
Updated on 
 ...
 Select the Common KeyStore machine you want to provision a certificate to. 
 ...
 From KeyStore Type , select one of the following options and complete the required fields. 

 PEM 

 Enter the Certificate Path , Private Key Path , and Certificate Chain Path . 

 (Optional) In Key Password , enter a password if the private key should be encrypted. 

 (Optional) In Service Name , enter the name of the service to restart after provisioning. 
 ...
 Enter the KeyStore Path , Alias , and Store Password . 
 ...
 (Optional) In Key Password , enter a password if it differs from the store password. 
 ...
 Enter the KeyStore Path . 

 Enter the Key Password to protect the keystore. 
