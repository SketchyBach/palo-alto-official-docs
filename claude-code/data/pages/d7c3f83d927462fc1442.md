---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.13/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/widgets/create-a-widget-using-the-widget-builder
fetched_at: 2026-09-06T10:45:52Z
source: cortex-platform
---

# Create a Widget using the Widget Builder | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create widgets in Cortex XSOAR 6.13 with the Widget Builder. Add them to dashboards or reports. 
