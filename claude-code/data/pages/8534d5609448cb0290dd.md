---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/if
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The condition that the function evaluates to either true or false. 
 ...
 The value returned if the boolean expression evaluates to false. If omitted, the function returns NULL . 
 ...
 Stages : alter , filter , fields , limit , config 

 Functions : multiply 

 Previous hierarchy_match 
