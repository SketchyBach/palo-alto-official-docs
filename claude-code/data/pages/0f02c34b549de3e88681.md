---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-managing
fetched_at: 2026-09-16T07:24:44Z
source: palo-alto-main
---

# Managing Your VSatellites Clear
...
Updated on 
 ...
 As VSatellites are designed to be light-weight and disposable (stateless), you can easily add, remove, and reconnect them from the VSatellites page ( Configurations > VSatellites ). 

 You can also monitor the status of connected VSatellites from the VSatellites page. 

 Important: Avoid shutting down any VSatellite for more than 30 days. If a VSatellite is turned back on within this period, it will function normally. However, if a VSatellite remains offline for more than 30 days, it will not be able to rotate its credentials. After 90 days of being offline, the VSatellite will stop functioning, and you'll need to uninstall and reinstall (redeploy) a VSatellite to replace this one. 

 However, do not proceed to redeploy if the dysfunctional VSatellite is your only VSatellite . Learn more 

 Warning: If you delete your final VSatellite, you will permanently lose access to all encrypted key material , regardless of whether you backed up the DEK. 

 What Would You Like to Do? 

 Deploy a new VSatellite 

 Monitor existing VSatellites 

 Rename a VSatellite 

 Delete an existing VSatellite 
