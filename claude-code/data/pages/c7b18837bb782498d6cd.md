---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/install-cortex-xsoar/install-cortex-xsoar-on-a-vm-deployed-on-aws/task-5.-optional-configure-proxy-settings
fetched_at: 2026-09-06T10:29:27Z
source: cortex-platform
---

# Task 5. (Optional) Configure proxy settings | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, configure optional proxy settings. 
