---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-0/pan-os-upgrade/upgrade-the-vm-series-firewall/upgrade-the-vm-series-pan-os-software-standalone.html
...
the following procedure to upgrade a firewall that is not in an
HA configuration. 

 To avoid impacting
traffic, plan to upgrade within the outage window. Ensure the firewall
is connected to a reliable power source. A loss of power during
...
content release version or a later version required for PAN-OS, Check
