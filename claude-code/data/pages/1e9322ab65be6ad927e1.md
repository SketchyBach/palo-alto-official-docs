---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/manage-broker-vm/open-live-terminal
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn more about remotely connecting to a Cortex Data Security Broker VM. 

 Cortex Data Security enables you to connect remotely to a Broker VM directly from Cortex Data Security. 

 In Cortex Data Security, select Settings → Configurations → Data Broker → Broker VMs table. 

 Locate the Broker VM you want to connect to, right-click and select Open Live Terminal. Cortex Data Security opens a CLI window where you can perform the following commands: 
 ...
 Sync with Cortex Data Security: cloud_sync 

 Internal messaging service (RabbitMQ): rabbitmq-server 

 Upload metrics to Cortex Data Security: metrics_uploader 
 ...
 Previous Import Broker VM Configuration 
