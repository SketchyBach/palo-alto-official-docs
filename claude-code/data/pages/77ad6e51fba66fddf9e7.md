---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-widget-from-an-incident
fetched_at: 2026-09-06T10:25:30Z
source: cortex-platform
---

# Create a widget from an incident |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create widgets from incident searches in Cortex XSOAR 8.14 On-prem. 
 ...
 Follow the procedure from in Create a widget using the widget builder . 
