---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/interconnects/manage-ip-pools/add-ip-pool.html
fetched_at: 2026-09-16T09:58:11Z
...
Updated on 
 ...
 Contains instructions to add an ip pool if not configured when creating an
 interconnect. 
 ...
 When setting up the interconnect, if you had chosen to configure IP Pool later then
 you can add the IP pool as follows: 

 Go to Telcos SP Interconnects , and select the desired interconnect. 

 Select IP Pool Add IP Pool . 

 Select IP Pool Type 

 Prisma Access IP : Select this option
 to use a Prisma Access-assigned IP. 
