---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-plugin-for-adem/pan-os-plugin-for-adem-200.html
fetched_at: 2026-09-16T13:01:41Z
source: palo-alto-main
---

# PAN-OS Plugin for ADEM 2.X.X Clear
...
Updated on 
 ...
 Information for the 2.0.0 and beyond releases of the PAN-OS plugin for
 ADEM. 

 Learn about the new features, known issues, or changes to default behavior for the
 plugin. 

 PAN-OS Plugin for ADEM 2.0.0 

 Features Introduced in 2.0.0 

 The ADEM plugin 2.0.0 is released to support the PAN-OS 12.2.2. 
