---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-4-3/addressed-issues-in-panorama-plugin-for-aws-5-4-3.html
fetched_at: 2026-09-16T12:59:41Z
source: palo-alto-main
---

# Addressed issues in Panorama Plugin for AWS 5.4.3 Clear
...
Updated on 
 ...
 The following is an addressed issue in the Panorama plugin for AWS 5.4.3: 

 PLUG-22588 

 Fixed an issue where AWS Auto Scaling Group (ASG) redeployments would enter a
 Failure state if a custom image was used without changes to the AMI or Pin
 ID. In AWS Plugin 5.4.3 , the synchronization logic between Panorama and AWS EC2
 Launch templates has been corrected to ensure accurate version tracking during
 redeployment and scaling operations. 
