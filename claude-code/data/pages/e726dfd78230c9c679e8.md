---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/detect-investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/customize-indicator-fields-and-types/create-an-indicator-field/indicator-field-trigger-scripts
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure scripts that run when indicator fields change in Cortex AgentiX. 
