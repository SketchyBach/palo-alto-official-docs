---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-1011/whats-new-in-vm-series-plugin-1011.html
fetched_at: 2026-09-16T12:59:17Z
source: palo-alto-main
---

# What’s New in VM-Series Plugin 1.0.11 Clear
...
Updated on 
 ...
 The VM-Series plugin 1.0.11 introduces
the following new feature. 

 Deeper Visibility with AWS CloudWatch Enhancement —For
better visibility in to the usage and performance of the VM-Series
firewalls in your high availability pair or autoscaling deployments,
you now have a new endpoint to filter the metrics using the hostname
and AWS instance ID metadata (or dimensions ) of the firewall. 

 When you configure your VM-Series firewalls to publish metrics to an
AWS CloudWatch namespace, an additional namespace with the <namespace>_dimensions endpoint
is automatically created. You continue to use the <namespace> endpoint
for an aggregated view of metrics from all your VM-Series firewalls
in your HA pair or autoscaling deployments, and now use the new <namespace>_dimensions endpoint
for usage and performance details of individual VM-Series firewalls. 
