---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/install-cortex-xsoar/post-installation/optimize-performance-and-robustness-from-the-textual-ui/manage-nodes-in-a-cluster
fetched_at: 2026-09-06T10:26:56Z
source: cortex-platform
---

# Manage nodes in a cluster | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage cluster nodes in Cortex XSOAR 8.13 On-prem. 
 ...
 If you remove one of the original three nodes in the cluster (one of the control planes), you cannot perform actions such as upgradingupgrade or scaling up. When you add a new node, Cortex XSOAR automatically assigns the new node as a control plane with the same IP address as the node that was removed. 
