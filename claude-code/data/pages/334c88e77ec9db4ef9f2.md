---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/acos
fetched_at: 2026-09-16T09:04:52Z
source: cortex-platform
---

# acos | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The numerical value for which to calculate the arccosine. The value must be within the range of -1 to 1 (inclusive). 
 ...
 Functions : cos , asin , atan 

 Datasets : xdr_data 

 Previous Functions list 
