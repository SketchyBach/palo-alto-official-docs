---
url: https://cortex-docs.paloaltonetworks.com/xdr-5-api/aspm-cicd-and-application-security/policies
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 At least one active base license (Cloud Posture Security or Cloud Runtime Security) must be present. The Application Security Add-on must also be purchased in addition to the existing Cloud (Posture or Runtime) license. 
