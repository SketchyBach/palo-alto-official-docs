---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/view
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Indicates the view operation is to highlight specific text. 
 ...
 A comma-separated list of fields in which to search for the value to highlight. 
 ...
 A comma-separated list of string values to highlight within the specified fields. 
 ...
 Indicates the view operation is to generate a graph. 
 ...
 Specifies the type of graph (for example, pie , column , area , bubble , line , map , scatter ). 
 ...
 The field to be used for the X-axis. Must be collatable. 
 ...
 The field to be used for the Y-axis. Must be collatable. 
 ...
 Used for certain graph types (area, bubble, column, line, map, scatter) to group chart results based on this field's values. 
 ...
 Indicates the view operation is to reorder columns. 
 ...
 Displays columns in their original order. 
 ...
 Displays columns with the most non-null values first. 
