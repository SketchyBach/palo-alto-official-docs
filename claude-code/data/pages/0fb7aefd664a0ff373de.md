---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-new-features/wildfire-features/ipv6-address-support-for-the-wildfire-appliance.html
fetched_at: 2026-09-16T10:53:13Z
source: palo-alto-main
---

# IPv6
Address Support for the WildFire Appliance Clear
...
Updated on 
 ...
 IPv6
Address Support for the WildFire Appliance 
...
Address Support for the WildFire Appliance 
 ...
 You can now use IPv6 addresses when you configure your
WildFire ® appliance. 

 The WildFire ® appliance now supports IPv6 connections
so that you can continue to leverage local file analysis as you
introduce more IPv6-addressed devices in your network. To take advantage
of IPv6 address support, simply use an IPv6 address for any connection
between your WildFire appliance and another device, such as when
you: 
 ...
 Connect the firewall to the VM
interface 
