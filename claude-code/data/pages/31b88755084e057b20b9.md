---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/salesforce/ingest-and-run-salesforce-automation-and-remediation
fetched_at: 2026-09-06T10:09:49Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use Salesforce data for Cortex Cloud. 

 Cortex Cloud provides a guided wizard to set up secure configurations, monitor identity risks, and automate threat remediation across your Salesforce environment. 
...
Requires the following OAuth scopes: 
 ...
 Click Add to create the path. Once the status of the path shows as Approved in the Egress Configuration table, Cortex Cloud can successfully authenticate and execute commands against your Salesforce environment. 
...
The new Salesforce connector has the description: Salesforce CRM services for identity management, automation, remediation and SaaS Posture Security. 
 ...
 You can edit and test an existing instance after a successful initial connection between Salesforce and Cortex Cloud by clicking Test. 
