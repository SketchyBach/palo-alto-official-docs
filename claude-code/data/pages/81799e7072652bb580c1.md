---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-303/addressed-issues-in-kubernetes-plugin-303
fetched_at: 2026-09-16T07:43:32Z
source: palo-alto-main
---

# Addressed Issues in Kubernetes Plugin 3.0.3 Clear
...
Updated on 
 ...
 Addressed issues in the Panorama plugin for Kubernetes version 3.0.3: 

 PLUG-16491 

 Fixed an issue where service objects are getting created when a new monitoring
 definition is added even after you disable the service object management option. 

 PLUG-17037 

 Fixed an issue where Kubernetes plugin was sending IP-tag payloads to
 configd.log with IP-tags longer than 128 characters, and then
 resulting in error. 

 PLUG-16809 

 Fixed an issue that caused Kubernetes cluster validation error and failed to
 extract Kubernetes Secrets due to ReadTimeOutError. 
