---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-76.html
fetched_at: 2026-09-16T11:04:22Z
source: palo-alto-main
---

# QoS Configuration Clear
...
Updated on 
 ...
 Identifies whether Quality of Service (QoS) is used on the device, and collects configuration information about it such as the number of QoS policies in use, the number of security policies that have QoS classification, whether QoS is enabled on subinterfaces, the maximum egress bandwidth rate for the device, and the guaranteed bandwidth settings. 
