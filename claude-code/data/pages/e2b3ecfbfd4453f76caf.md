---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aiops/panorama-cloudconnector-plugin-3-0-1
fetched_at: 2026-09-16T07:42:25Z
source: palo-alto-main
---

# Panorama CloudConnector Plugin 3.0.1 Clear
...
Updated on 
 ...
 What's new for Panorama CloudConnector Plugin 3.0.1 (For AIOps and Cloud NGFW for
 AWS) 

 Panorama CloudConnector Plugin 3.0.1 continues to support Panorama
 configuration operations by allowing you to synchronize configuration changes between
 Strata Cloud Manager and on-premises Panorama devices. This synchronization is supported
 for Policy Optimizer and Config Cleanup features in Strata Cloud
 Manager. 
 ...
 Use the below command to enable or disable the synchronization after you enable
...
> request plugins cloudconnector sync enable
 ...
 Here is the support for CloudConnector Plugin 3.0.1. 

 CloudConnector Plugin 3.0.1 Support and Installation 

 Panorama Version Range Installation Method 

 10.2.x 10.2.3 and later 
