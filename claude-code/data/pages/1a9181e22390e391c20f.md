---
url: https://docs.prismacloud.io/release-notes/prisma-cloud-release-information/features-introduced-in-2024/features-introduced-in-august-2024
fetched_at: 2026-09-16T13:36:01Z
source: prisma-cloud
---

# Features Introduced in August 2024 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Prisma Cloud Managed Security Service Provider (MSSP) offering allows you to administer large customer groups efficiently by enabling you to: 
 ...
 With Code to Cloud tracing you can identify all the vulnerabilities found on a runtime container image, match which registry image was used in the deployment, discover what pipeline was used to build it and from where, identify which Dockerfile contains the instructions to build the image, the Package Manager file and packages pulled into it and it’s Base Image. Prisma Cloud scans all the source components to find which ones have the same vulnerability found in runtime and builds the trace. 
 ...
 You can now create custom build Bicep policies through both the Code and Visual editors , offering you the flexibility to align with organizational requirements and preferences. 
 ...
 DSPM enables you to discover, classify, protect, and govern data across your cloud environments. 
 ...
 Update AWS Key Management Service (KMS) 
 ...
 Prisma Cloud Trusted IP List allows administrators to specify a list of IP addresses that are considered trusted or safe. 
 ...
 A new View query parameter is added to the Get Vulnerabilities by RQL API. When searching for vulnerabilities using an RQL query, you can view the details by CVE or Asset. This parameter allows you to get the vulnerabilities details based on the CVE view or Asset view. 
 ...
 Policy Info - GET /policy/{id} 

 List Policies - GET /policy/ 

 List Policies V2 - GET /v2/policy 
 ...
 View Search History - GET /search/history 

 Get Search Query by ID - GET /search/history/{id} 
 ...
 End of Support for Azure Time Series Insights and Azure Data Catalog Services 
 ...
 Previous Features Introduced in September 2024 

 Next Features Introduced in July 2024 
