---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-44
fetched_at: 2026-09-16T09:11:20Z
source: cortex-platform
---

# GitLab Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A GitLab Token (Personal Access Token) is used for API authentication and Git access via HTTP Basic Auth. 

 A leaked token allows an attacker to impersonate the user, gaining access to private repositories, group assets, and the ability to tamper with the software development lifecycle. 
 ...
 Previous GitHub Token detected in code 

 Next Google API Key detected in code 
