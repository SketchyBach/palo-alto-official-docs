---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-203/known-issues-in-panorama-plugin-for-vmware-nsx-203.html
fetched_at: 2026-09-16T13:00:18Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for VMware NSX 2.0.3 Clear
...
& Security Installation Service Deployment . 
...
in Panorama. 
 ...
 Workaround: Select Commit Push to Devices . On the Device
...
on Panorama Managed
Devices Summary displays Failed after
...
on Panorama and add it again. Go to Panorama VMware NSX Steering Rules and
...
configuration. 
 ...
 On the vCenter server, under Networking & Security Installation Service Deployments , the Service
...
in Panorama. 
 ...
 Workaround: Select Panorama VMware NSX Service Managers and
...
Config-Sync to perform a second NSX configuration sync. 
 ...
 In a Panorama HA deployment with VMware
NSX Plugin 2.0.3, after a failover, the device state of the managed
firewalls on the passive Panorama peer may show as Disconnected under Panorama Managed Devices .
However, on the active Panorama peer, the managed firewall device
state is Connected . 
