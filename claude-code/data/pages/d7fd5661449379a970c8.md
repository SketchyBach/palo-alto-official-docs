---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/pan-os-xml-api-request-types/configuration-api/move-configuration.html
fetched_at: 2026-09-16T11:04:43Z
source: palo-alto-main
---

# Move Configuration Clear
...
XML API Request Types 
 ...
 Use action=move to
move the location of an existing configuration object. Use the xpath parameter
to specify the location of the object to be moved, the where parameter
to specify type of move, and dst parameter
to specify the destination path. 
 ...
 Use the following API query to move a security
policy called rule1 to come after rule2 : 
