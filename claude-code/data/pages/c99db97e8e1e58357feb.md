---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-release-notes/pan-os-10-1-9-known-and-addressed-issues/pan-os-10-1-9-known-issues
fetched_at: 2026-08-13T17:03:47Z
source: palo-alto-main
---

# PAN-OS 10.1.9 Known Issues Clear
...
specific to PAN-OS ® 10.1.9. This list includes issues
...
eval or trial license expires and then install the production license. 
 ...
 On an OpenShift cluster, MP pod may crash when the number
...
connecting after you restart the web server with the following command: debug software restart process web-server . 
 ...
 File system checks on the logging drive may take more time depending
 ...
 For VM-Series firewalls leveraging SD-WAN and deployed on VMware ESXi running VMX-13,
...
10.1.9. 
 ...
 Upon upgrade to PAN-OS 10.1.9, the following GlobalProtect settings
 do not work: 
 ...
 When FIPS mode is enabled on VM-Series firewalls in Microsoft Azure
...
and has no impact on the existing session. 
 ...
 only ) The dataplane restarts repeatedly due to internal
 path monitoring failures until a power cycle. 
