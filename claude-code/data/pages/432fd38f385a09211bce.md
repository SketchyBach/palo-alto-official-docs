---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/xdr-collectors/xdr-collector-profiles/ingest-logs-from-windows-dhcp-using-elasticsearch-filebeat
fetched_at: 2026-09-06T10:01:25Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Navigate to the Elasticsearch Filebeat installation directory, and open the filebeat.yml file to configure data collection with Cortex Cloud. We recommend that you use the download example file provided by Cortex Cloud. 
 ...
 After Cortex Cloud begins receiving logs from Windows DHCP via Elasticsearch Filebeat, you can use XQL Search to search for logs in the new microsoft_dhcp_raw dataset. 
