---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs/adding-a-certificate-authority/adding-digicert-ca/using-divisions
fetched_at: 2026-09-16T07:24:57Z
source: palo-alto-main
---

# About Divisions in a CA Account Clear
...
Updated on 
 ...
 This feature allows you to manage billing separately for different units within your organization while using a single DigiCert API key. It also supports least-privilege access by enabling you to assign specific request policies that link CA account divisions to designated users or groups. 
 ...
 Once you create separate CA accounts for the required divisions, you can use these accounts in request policies to control user access. For more information, see Creating request policies . 

 When a user creates a CSR with a request policy linked to a CA account that specifies a division, the certificate and its assigned division will be visible in your DigiCert account. This helps ensure accurate internal billing. 
 ...
 The division assignment does not appear in the CSR or the issued certificate. It is only visible in Next-Gen Trust Security and your DigiCert account portal. 
