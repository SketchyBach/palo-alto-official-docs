---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/stddev_sample_with_windowcomp_stage
fetched_at: 2026-09-16T09:05:23Z
source: cortex-platform
---

# stddev_sample (windowcomp) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Functions : stddev_sample (comp) , stddev_population() , avg() 

 Datasets : xdr_data 

 Previous stddev_sample (comp) 
