---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-249
fetched_at: 2026-09-06T11:15:55Z
source: cortex-platform
---

# Workato API key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Workato API Key grants access to manage recipes, connections, and jobs. 

 Exposure allows an attacker to deploy malicious recipe manifests, compromise on-prem agents, or exfiltrate data managed by connected systems. 
 ...
 Previous Sourcegraph access token detected in code 

 Next Google OAuth2 secret detected in code 
