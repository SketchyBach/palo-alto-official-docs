---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.9/cortex-xdr-agent-for-linux
fetched_at: 2026-09-16T09:13:18Z
source: cortex-platform
---

# Cortex XDR Agent for Linux | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 This mode allows you to leverage the protection provided by Cortex XDR agent on Linux distributions running Kernel 5.0 and above without loading a kernel module. The Linux section of the compatibility matrix provides more information about supported Linux distribution versions. 
