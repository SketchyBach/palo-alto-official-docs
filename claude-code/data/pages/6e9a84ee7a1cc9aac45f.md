---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-6-multi-tenant-guides/6.14/configure-multi-tenant/configure-the-multi-tenant-deployment/run-a-command-on-multiple-tenants
fetched_at: 2026-09-06T10:50:02Z
source: cortex-platform
---

# Run a Command on Multiple Tenants | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run commands on incidents across multiple tenants in Cortex XSOAR 6.14 multi-tenant deployments. 
