---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/threat-management/detection-rules/what-are-detection-rules/whats-a-bioc/bioc-rule-details
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review BIOC rule fields, exceptions, and status for user-defined and global rules. 
 ...
 Status of the Cortex Cloud search for the first 10,000 matches when the BIOC rule was created or edited. Status can be: - Done - Failed - Pending - Queued 

 BACKWARDS SCAN TIMESTAMP 

 Timestamp of the Cortex Cloud search for the first 10,000 matches in your Cortex Cloud when the BIOC rule was created or edited. 

 BACKWARDS SCAN RETRIES 

 Number of times Cortex Cloud searched for the first 10,000 matches in your Cortex Cloud when the BIOC rule was created or edited. 
 ...
 Displays a description of the prerequisites Cortex Cloud requires in order to activate the rule. 
