---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-213/addressed-issues-in-vm-series-plugin-213.html
fetched_at: 2026-09-16T12:59:07Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.1.3 Clear
...
Updated on 
 ...
 The following list describes the issue fixed in the
VM-Series plugin 2.1.3. 

 PLUG-9167 

 Fixed an issue that caused the VM-Series firewall on
GCP to boot in maintenance mode after upgrading from 9.0.13 to 9.1.x. 

 This issue is addressed in VM-Series plugin version 2.1.3. 

 Workaround : Use VM-Series plugin 2.1.3. 

 PLUG-9203 

 An additional bootstrap parameter packet-mirroring = enable is
added as part of firewall instance metadata which helps to bring
up the firewall with the packet mirroring mode enabled. 
