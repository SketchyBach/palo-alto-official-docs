---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/users-and-roles-management/roles-management/role-based-permissions
fetched_at: 2026-09-16T09:14:10Z
source: cortex-platform
---

# Role-based permissions | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review role-based permissions in Cortex XSOAR On-prem 8.7 (EoL). 
