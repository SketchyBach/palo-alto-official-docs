---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/engines/upgrade-an-engine
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Upgrade a Cortex XSOAR 8 SaaS engine on a remote machine. 
 ...
 The upgrade.conf file is available on the engine after it has been upgraded to Cortex XSOAR 8.9 SaaS. Any custom variables you add to the file are applied when you upgrade from Cortex XSOAR 8.9 SaaS to Cortex XSOAR 8.10 SaaS or later. 
