...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create XQL queries in Cortex AgentiX. 
 ...
 Specify the datasets to run your query against by typing either datamodel dataset = <dataset name>... or datamodel dataset in (<dataset name>,...)... . For example: 
 ...
 Press Enter, and then type the pipe character ( | ). Select a stage, and complete the stage syntax using the suggested options. 
