---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/onboard-cortex-xsiam/post-deployment/manage-user-roles-and-access-management/manage-access-to-objects/manage-access-to-playbooks-and-scripts
fetched_at: 2026-08-13T14:13:22Z
source: cortex-platform
---

# Manage access to playbooks and scripts | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center

Manage access to playbooks and scripts | Cortex Documentation Portal 
 ...
 Previous Manage access to report templates Next Manage access to saved queries 
