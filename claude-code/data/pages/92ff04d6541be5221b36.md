---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-5400-hardware-reference/PA-5400-series-firewall-installation/install-the-mandatory-pa-5400-series-firewall-front-slot-cards/install-a-pa-5400-series-firewall-data-processor-card-dpc.html
fetched_at: 2026-09-16T11:51:12Z
source: palo-alto-main
---

# Install a PA-5400 Series Firewall Data Processor Card (DPC) Clear
...
Cards 
 ...
 Install one or more Data Processor Cards (DPCs) to increase
the processing power of the PA-5400 Series firewall. 
...
to rotate into an open position. 
 ...
 The image below shows a Management Processor Card
(MPC); however, the procedure to install the DPC is the same. 
...
card. Gently push the DPC into slot 3 until the card reaches the
end of the slot. 
...
Card (NC). When installing a DPC, you must install it in the correct
slot to pair with the NC. 

 Push on both ejector handles until they lock the card
into place. 

 ( Optional ) Repeat Steps 3 through 5 if you wish
to install additional DPCs. You may install a DPC into slots 2,
4, 5, and 6. 

 Slot 2 is the only slot that can either house a DPC
or a second NC. 
