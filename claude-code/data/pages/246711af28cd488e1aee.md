---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-panorama-api/get-started-with-the-pan-os-rest-api/work-with-address-objects-rest-api.html
fetched_at: 2026-09-16T09:33:23Z
...
Updated on 
 ...
 rules. The firewalls and Panorama support a large number of objects such
 as tags, address objects, log forwarding profiles, and security
 profiles. 
 ...
 curl -X POST \
 'https://10.1.1.4/restapi/v9.1/Objects/Addresses?location=shared&name=web-servers-production' \
 -H 'X-PAN-KEY: LUFRPT0=' \
 -d '{
 "entry": [
 {
 ...
 first create the tag before you can reference it in the address object. 
 ...
 curl -X POST \
 'https://10.5.196.4/restapi/v9.1/Objects/Addresses:rename?location=shared&name=web-servers-production&newname=web-server-publish' \
 -H 'X-PAN-KEY: LUFRPT0=' 
 ...
 curl -X DELETE \
 'https://10.1.1.4/restapi/v9.1/Objects/Addresses?location=shared&name=web-server-production' \
 -H 'X-PAN-KEY: LUFRPT0=' 
 ...
 curl -X GET \
 'https://10.1.1.4/restapi/v9.1/Objects/Addresses?location=vsys&vsys=vsys1' \
 -H 'X-PAN-KEY: LUFRPT0=' 
