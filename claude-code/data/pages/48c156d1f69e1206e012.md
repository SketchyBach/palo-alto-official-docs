---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-243
fetched_at: 2026-09-06T11:15:53Z
source: cortex-platform
---

# Redshift credentials detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Redshift Credentials grant Critical Risk access to the data warehouse cluster. 

 Exposure allows the attacker to execute queries, potentially leading to the theft or manipulation of large, sensitive datasets. 
 ...
 Previous Plaid access token detected in code 

 Next Replicate user access token detected in code 
