---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs
fetched_at: 2026-09-16T07:24:49Z
source: palo-alto-main
---

# Overview: Certificate Issuance Clear
...
Updated on 
 ...
 This capability is intended for network security administrators responsible for managing certificates across infrastructure. It supports organizations that need consistent, policy-compliant certificate issuance at scale. 
 ...
 Request policies : Request policies define how certificates are requested and issued. 

 Certificate inventory : Issued certificates are tracked and managed through the certificate inventory. 

 Next Steps 

 To begin issuing certificates, configure your Certificate Authorities and request policies, then submit certificate requests using the Next-Gen Trust Security interface. 
