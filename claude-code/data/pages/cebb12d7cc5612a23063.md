---
url: https://docs.paloaltonetworks.com/saas-security/sspm/onboard-saas-apps-supported-by-sspm/onboard-a-notta-app-to-sspm
fetched_at: 2026-08-13T17:34:18Z
source: palo-alto-main
---

# Onboard a Notta App to SSPM Clear
...
Onboard a Notta App to SSPM 
 ...
 Learn how you can manually provide SSPM with the configuration values for a Notta
 instance. 
 ...
 The onboarding process for Notta is different from most applications,
 because SSPM does not support scans for Notta. During the onboarding process for
 ...
 Although SSPM does not support scans for Notta, you can still onboard a Notta
 application to SSPM. However, when you onboard a Notta application to SSPM, you
 don’t supply SSPM with any authentication credentials. SSPM does not establish a
 connection to your Notta instance and does not run scans to determine the Notta
 settings. Instead, you will manually enter your Notta instance's settings, which
 ...
 Notta instance, but this tile is isolated to SSPM. SSPM will show rule violations
 for the Notta instance, but SSPM determines the violations based entirely on the
 ...
 To onboard a Notta instance, you complete the following steps: 

 Log in to Notta as an administrator. 
 ...
 Select Configuration SaaS Security Posture Security Applications Add Application and click the Notta tile. 

 On the Posture Security tab, Add New instance. 

 SSPM displays the onboarding page, which lists the Notta configuration
 settings and our recommended configuration values. 

 From your Notta instance, identify the configuration values, and provide these
 configuration values to SSPM. 

 To avoid triggering rule violations in SSPM, you can update the values in
 Notta to match our recommended values. 
 ...
 SSPM adds a tile on the Applications page to represent your Notta instance.
 Based on the values that you entered, SSPM will determine if your Notta
 instance has any rule violations. 

 Because SSPM is not scanning your Notta instance, you must ensure that the
 information that SSPM has about your Notta instance remains accurate. If you
 change a setting value in Notta, manually update that value in SSPM. To do
 this, complete the following steps: 

 Navigate to the Applications page ( SSPM Applications ). 

 Locate the Notta instance's tile and View
 Details . 
