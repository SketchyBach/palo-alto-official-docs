---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/investigate-artifacts-and-assets/investigate-a-user
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In the left panel, review the overview of the user. The displayed information is aggregated by Cortex XDR from cases, Workday, and Active Directory data. 
