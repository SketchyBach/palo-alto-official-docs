---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/saas-security/saas-security/onboard-a-supported-saas-application/onboard-automox
fetched_at: 2026-09-06T10:07:18Z
source: cortex-platform
---

# Onboard Automox | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Connect an Automox instance in Cortex Cloud Posture Management to detect posture risks and compliance violations. 
 ...
 A unique, alphanumeric string that you generate from an Automox account. SaaS Security uses the key to authenticate to the Automox API. The API key inherits the permissions of the Automox account. 

 Organization ID 

 A unique identifier for your organization within the Automox platform. 
 ...
 Previous Onboard Atlassian 

 Next Onboard Businessmap 
