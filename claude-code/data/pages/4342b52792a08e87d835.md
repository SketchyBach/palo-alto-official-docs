---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/managing-discovered-certificates/about-tls-server-endpoints
fetched_at: 2026-09-16T07:25:24Z
source: palo-alto-main
---

# About TLS Server Endpoints Clear
...
Updated on 
 ...
 Access to TLS server endpoints is controlled by the workspace you have selected and by your Strata Cloud Manager (SCM) role permissions: 

 Tenant : You see the TLS server endpoints for every certificate in the tenant, and a Workspace column names the workspace each one belongs to 

 A workspace : You see the TLS server endpoints for that workspace's certificates only, and the Workspace column is dropped because every row would name the workspace you are already in 
 ...
 In the menu bar, click Inventory > TLS Server Endpoints . 
