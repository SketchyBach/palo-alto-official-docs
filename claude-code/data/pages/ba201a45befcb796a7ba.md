---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-40/vm-series-plugin-403-h1/known-issues-in-vm-series-plugin-403-h1
fetched_at: 2026-09-16T07:45:15Z
source: palo-alto-main
---

# Known Issues in VM-Series Plugin 4.0.3-h1 Clear
...
Updated on 
 ...
 The following is a known issue in the VM-Series Plugin 4.0.3-h1. 

 PLUG-11726 

 The VM-Series firewall is unable to process
an RSA private key in PEM format imported from a cloud key management
service (such as Microsoft Key Vault or AWS Secrets Manager) that begins
with ----BEGIN RSA PRIVATE KEY---- and ends with -----END
RSA PRIVATE KEY----- . 

 PLUG-10978 

 The VM-Series firewall goes into maintenance
mode after changing the allocated memory from 124 GB to 128GB. 
