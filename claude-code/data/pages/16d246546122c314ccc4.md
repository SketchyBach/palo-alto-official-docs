---
url: https://docs.prismacloud.io/admin-guide/33/web-application-and-api-security-waas/waas-intro
fetched_at: 2026-09-16T13:37:05Z
source: prisma-cloud
---

# Overview | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
 ...
 *The WAAS serverless offering provides a limited set of defenses compared to the WAAS offerings for containerized and non-containerized web applications. For example, it currently does not include protection against bot attacks or denial of service (DoS) attacks. 
 ...
 Previous Web-Application and API Security (WAAS) 
