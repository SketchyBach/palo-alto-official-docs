---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-3-known-and-addressed-issues/pan-os-11-2-3-addressed-issues
fetched_at: 2026-08-13T17:13:23Z
source: palo-alto-main
---

# PAN-OS 11.2.3 Addressed Issues Clear
...
PAN-OS 11.2.3 Addressed Issues 
 ...
 Fixed an issue where websites with a no-decrypt policy rule were decrypted in the traffic log
 ...
 ( CN-Series firewalls only ) Fixed an issue where communication was broken between the
 ...
 Fixed an issue where a core file was created on the Log Forwarding Card (LFC) due to a
 ...
 Fixed an issue on Panorama where custom role-based admin users with read-only access were able to
 ...
 Fixed an issue where a User Activity Report was not generated by
 ...
 Fixed an issue where Oracle traffic over generic routing encapsulation (GRE) was dropped when the
 ...
 Fixed an issue on the firewall where the Certificate Name character limit was 31 characters
 ...
 Fixed an issue on the firewall where the dataplane went down due to a path monitor failure caused
