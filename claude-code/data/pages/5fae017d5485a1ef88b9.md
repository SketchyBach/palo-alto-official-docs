---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-303/known-issues-in-panorama-plugin-for-aws-303.html
fetched_at: 2026-09-16T12:59:51Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for AWS 3.0.3 Clear
...
Updated on 
 ...
 Unable to see the IP addresses of the pre-existing shared dynamic address
 groups immediately after you upgrade the plugin version 3.0.x to 3.0.3. 

 Workaround : After you upgrade the plugin version 3.0.x to 3.0.3, make a small
 configuration change on Panorama and perform a commit to see the IP addresses of the
 pre-existing shared dynamic address groups immediately. 
