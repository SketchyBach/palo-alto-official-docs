---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/managing-discovered-certificates/requesting-downloading-installing-certificates
fetched_at: 2026-09-16T07:25:24Z
source: palo-alto-main
---

# Requesting, Downloading, and Installing Certificates Clear
...
Updated on 
 ...
 Next-Gen Trust Security lets you request, download, and manually install certificates. The table below outlines the typical certificate lifecycle tasks you can perform in Next-Gen Trust Security. 

 What Are the Steps? 

 Step Description 

 Request and view a certificate Submit a certificate request and monitor its status. 

 Review pending or failed requests Identify and troubleshoot certificate requests that did not complete successfully. 

 Find and download certificates Locate certificates in the inventory and download them for installation. 
