---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-63
fetched_at: 2026-09-06T11:15:15Z
source: cortex-platform
---

# Readme API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Readme API Key grants access to documentation projects and API metrics. 

 Exposure allows for unauthorized access to documentation, API metrics, and potential misuse or alteration of technical documentation. 
 ...
 Previous RapidAPI Key detected in code 

 Next RubyGems API Key detected in code 
