---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-293
fetched_at: 2026-09-06T11:16:04Z
source: cortex-platform
---

# Azure API Management Repository Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Azure API Management Repository Key is a highly sensitive key for internal repository access within APIM (tied to configuration). 

 Exposure grants an attacker isolated administrative access to the APIM management plane, risking unauthorized configuration changes, manipulation of traffic policies, or bypassing security enforcements. 
 ...
 Previous Tencent Cloud Secret ID detected in code 

 Next Azure API Management Subscription Key detected in code 
