---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-release-notes/pan-os-11-1-12-known-and-addressed-issues/pan-os-11-1-12-addressed-issues
fetched_at: 2026-09-16T07:40:18Z
source: palo-alto-main
---

# PAN-OS 11.1.12 Addressed Issues Clear
...
Updated on 
 ...
 PAN-OS 11.1.12 Known and Addressed Issues 
 ...
 Fixed an issue where the firewall generated false positive threat logs during updates to a large
 domain list (EDL) when a DNS lookup for a domain being added or
 removed occurred during the update process. This resulted in a
 threat log being generated for a different, unrelated domain that
 ...
 after upgrading to 11.1.6-h10. Panorama will run for up to an hour
 and then crash. 
 ...
 Fixed an issue where firewalls with the Send handshake messages
 to CTD for inspection setting enabled caused incorrect
 security policy rules to be matched during the TLS handshake.
 Additionally, the expected response page for blocked URLs was not
 displayed. 
