...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To install an XDR Collector for the first time, you must first create an XDR Collector installation package. After you create and download an installation package, you can then install it directly on the collector machine or you can use a software deployment tool of your choice to distribute the software to multiple collector machines. 
 ...
 In Cortex Cloud, select Settings → Configurations → XDR Collectors → Installers. 
 ...
 Next Install the XDR Collector installation package for Windows 
