...
Delete context data from a case | Cortex Documentation Portal 
 ...
 Delete all or selected context data from a case. 
 ...
 Previous Add context data to a case Next Use context data in a playbook 
