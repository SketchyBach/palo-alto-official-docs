---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/configure-cortex-xsoar/users-and-roles-management/user-group-management
fetched_at: 2026-09-16T08:53:28Z
source: cortex-platform
---

# User group management | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage user groups in Cortex XSOAR 8.13 On-prem. 
 ...
 To create a new user group for several different system users or groups, click New Group . 
 ...
 To associate an Active Directory or OpenLDAP group with a Cortex XSOAR user group, you must map the group here so that users inherit the correct role. Enter the full distinguished name (DN) for the group exactly as it appears in your LDAP directory. 
