---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-56
fetched_at: 2026-09-06T11:15:14Z
source: cortex-platform
---

# Okta Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Okta Token grants access to the Okta API on behalf of the user who created it. 

 Exposure can lead to unauthorized user management, authentication bypasses, and compromise of the identity platform. 
 ...
 Previous Notion Integration Token detected in code 

 Next PagerDuty Authorization Token detected in code 
