---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/get-started.html
...
Updated on 
 ...
 Learn about the Strata Multitenant Cloud Manager . 

 The Strata Multitenant Cloud Manager is a single location to access and
 manage aggregated Secure Access Service Edge (SASE) products and services. The key
 capabilities are as follows: 

 Common Services 

 License
activation and subscription management — activate and manage all
your available licenses from one location. 

 Tenant management — the option to create multiple tenants,
build a hierarchy, and share and allocate license subscriptions
for the desired tenants. 

 Identity and access management — centralized authentication
and authorization of user roles and permissions for all applications
and API-based access. 

 Strata Multitenant Cloud Manager — aggregated views for monitoring
