---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/multi-tenant/child-tenant-management/content-management-in-multi-tenant/add-propagation-labels-to-content
fetched_at: 2026-09-06T10:23:30Z
source: cortex-platform
---

# Add propagation labels to content | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add propagation labels to Cortex XSOAR 8 SaaS content for selective synchronization to child tenants. 
 ...
 If you want to create new propagation labels or add existing ones, ensure that you have the required permissions. For more information, see Role-based permissions in Cortex XSOAR . 
