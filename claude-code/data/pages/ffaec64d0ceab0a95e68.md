---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-43
fetched_at: 2026-09-06T11:15:11Z
source: cortex-platform
---

# GitHub Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A GitHub Token (PAT, OAuth, or App Token) is a primary credential for programmatic access to GitHub resources. 

 Compromise of this token enables an attacker to tamper with version control, steal proprietary code, or use the token to escalate privileges within connected organizational resources. 
 ...
 Previous FullStory API Key detected in code 

 Next GitLab Token detected in code 
