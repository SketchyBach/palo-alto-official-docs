---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-77.html
fetched_at: 2026-09-16T11:03:47Z
source: palo-alto-main
---

# ACC and Monitor Query History Clear
...
Updated on 
 ...
 Collects logs created by performing queries in the Application Control Center. For each query performed, information is logged such as the query used, the cache hits and misses, the time taken to perform the query, the number of documents examined in the course of the query, the log database used, and the aggregate values returned as a result of the query. 
