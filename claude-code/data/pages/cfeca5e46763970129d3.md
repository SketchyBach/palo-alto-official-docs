---
url: https://docs.prismacloud.io/release-notes/prisma-cloud-release-information/features-introduced-in-2024/features-introduced-in-december-2024
fetched_at: 2026-09-16T13:36:01Z
source: prisma-cloud
---

# Features Introduced in December 2024 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Action Plans is released in a phased rollout and will be available on all Prisma Cloud stacks by January 8, 2025. 
 ...
 This policy will not report instances created by GKE because some of them have external IP addresses and cannot be changed by editing the instance settings. Instances created by GKE should be excluded. These instances have names that start with 'gke-' and contains 'default-pool'. 
 ...
 Update MLPS 2.0, MLPS 2.0 (Level 2) & MLPS 2.0 (Level 3) 
 ...
 The Alert API Alert Evidence Graph - GET /alert/v1/{id}/graph includes two new properties in the AlertEvidenceGraph response object: 
 ...
 List Action Plans - POST /apm/api/v1/action-plan 

 Update Action Plan Status or Assignee - PATCH /apm/api/v1/action-plan/{action-plan-id}/status-assignee 

 Update Action Plan Feedback - PATCH /apm/api/v1/action-plan/{action-plan-id}/feedback 

 Recommendation Summary - GET /apm/api/v1/action-plan/{action-plan-id}/recommendation-summary 

 List Related Alerts - GET /apm/api/v1/action-plan/{action-plan-id}/related-alerts 

 List Impacted Assets - GET /apm/api/v1/action-plan/{action-plan-id}/impacted-assets 

 Send Notification - POST /apm/api/v1/action-plan/{action-plan-id}/notification/ondemand 

 List Action Plan Names - GET /apm/api/v1/action-plan/names 

 Suggest Filters - POST /apm/api/v1/filter/action-plan/suggest 

 List Filtered Critical Assets - POST /apm/api/v1/critical-asset 

 Set Asset Criticality - POST /apm/api/v1/asset-criticality 

 Check Asset Criticality - GET /apm/api/v1/asset-criticality/{asset-id} 
 ...
 End of support for AWS Polly Voices API 
 ...
 Next Features Introduced in November 2024 
