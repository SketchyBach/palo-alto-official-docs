---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/playbooks/build-your-playbook/configure-playbook-settings
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure playbook settings, triggers, and inputs. 
...
For more information on Automation Rules, see Create an automation rule . 
 ...
 If a playbook input is designed to accept a credential object, users with the Credentials permission set to None will be unable to select pre-saved secrets from the configuration dropdowns. 
 ...
 Previous Choose from existing playbooks or create your own 

 Next Add objects from the Task Library 
