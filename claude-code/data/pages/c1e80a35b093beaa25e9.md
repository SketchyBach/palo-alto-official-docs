---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/integrations/add-an-integration-instance/configure-integration-permissions
fetched_at: 2026-09-16T09:14:59Z
source: cortex-platform
---

# Configure integration permissions | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure integration permissions in Cortex XSOAR On-prem 8.7 (EoL). 
