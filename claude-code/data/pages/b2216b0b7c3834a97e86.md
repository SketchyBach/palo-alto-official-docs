---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-125
fetched_at: 2026-09-06T11:15:32Z
source: cortex-platform
---

# Mailjet Keys ID detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Mailjet Keys ID is the API Key component acting as the unique identifier. 

 Exposure, especially when paired with the Secret, enables a security breach, giving unauthorized access and the ability to send fraudulent emails. 
 ...
 Previous OpenWeatherMap Token detected in code 

 Next Mailjet Keys Secret detected in code 
