---
url: https://docs.prismacloud.io/content-collections/administration/configure-external-integrations-on-prisma-cloud/integrate-prisma-cloud-with-webhooks
fetched_at: 2026-09-16T13:35:08Z
source: prisma-cloud
---

# Integrate Prisma Cloud with Webhooks | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Modify an existing alert rule or create a new alert rule to send alert notifications to Webhook. 

 View the alert POST requests on Webhook. 

 Previous Integrate Prisma Cloud with Tenable 

 Next Prisma Cloud Integrations—Supported Capabilities 
