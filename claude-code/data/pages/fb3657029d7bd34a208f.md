---
url: https://docs.prismacloud.io/content-collections/alerts/view-respond-to-prisma-cloud-alerts
fetched_at: 2026-09-16T13:35:06Z
source: prisma-cloud
---

# View and Respond to Prisma Cloud Alerts | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Send to Jira —When you select the Alert ID link for an alert that is in a snoozed or open state, you can send the alert to your Jira integration. This option enables you to create and assign an action to a user and help them track status in their existing workflows. If the user who set up your Jira integration is no longer with your organization, you have to create a new Jira integration . 
 ...
 Select Resource () to pivot to the cloud resource containing the violation you want to resolve and follow the recommended steps. 
 ...
 Previous Send Prisma Cloud Alert Notifications to Third-Party Tools 

 Next Suppress Alerts for Prisma Cloud Anomaly Policies 
