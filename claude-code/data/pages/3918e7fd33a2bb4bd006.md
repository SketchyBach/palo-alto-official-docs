---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/dashboards-and-reports/monitor-dashboards-and-reports/advanced-configuration/create-custom-widgets/create-script-based-widgets
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create widgets that display data from scripts. 
