---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs/adding-a-certificate-authority/adding-acme-ca/r-dns-azure-acmev2
fetched_at: 2026-09-16T07:24:54Z
source: palo-alto-main
---

# Azure DNS Requirements for Domain Validation Clear
...
Updated on 
 ...
 Tip: Need CNAME delegation for domain validation? If you don't have API access to your primary DNS provider, you can use CNAME delegation to an Azure DNS zone for validation. See CNAME Delegation for Domain Validation . 
