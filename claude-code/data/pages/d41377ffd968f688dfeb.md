---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/engines/install-an-engine
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install, deploy and configure Cortex XDR engines. 
 ...
 Natively running Python or PowerShell integrations/scripts on Windows or Linux is not supported on Cortex XDR engines. 

 Installation types 

 Cortex XDR supports the following file types for installation on the engine machine: 
