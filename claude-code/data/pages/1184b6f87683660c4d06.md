---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/build-xql-queries/overview-of-the-query-center/edit-and-run-queries-in-query-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Edit, test, and run XQL queries in the query builder. 
