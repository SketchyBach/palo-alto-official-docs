---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/role-based-access-control/cloud-security-and-posture-management-permissions/application-security-permissions/application-security-3rd-party-tools-permissions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure third-party tool permissions for Application Security in Cortex XSIAM. 
