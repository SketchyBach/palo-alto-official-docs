---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/onboard-cortex-xsoar/cortex-xsoar-installation/post-installation/optimize-performance-and-robustness-from-the-textual-ui/manage-nodes-in-a-cluster
fetched_at: 2026-09-06T10:34:55Z
source: cortex-platform
---

# Manage nodes in a cluster | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.10 On-prem, manage cluster nodes from the textual UI. 

 If you deployed your Cortex XSOAR environment starting with three nodes, use the textual UI menu in your VM to add a node, taint a node, remove a node, drain a node, and uncordon a node. 
