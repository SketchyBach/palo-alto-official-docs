---
url: https://cortex-docs.paloaltonetworks.com/xdr-5-api/restore-distributions/restore-distributions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A distribution can be deleted via the Delete agent installation packages API or from the Agent Installations screen in Cortex XDR. Restoring the distribution re-enables agent registration. 
