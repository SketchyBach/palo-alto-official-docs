---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent-ios-guide/8.9-agent-ios-guide/administrator-tasks/prepare-for-installation-administrator-task
fetched_at: 2026-09-06T10:20:49Z
source: cortex-platform
---

# Prepare for Installation (Administrator Task) | 8.9 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 On your organization's MDM solution, prepare the configuration required for pushing the Cortex XDR agent app to the iOS endpoints, and for managing them. Include the parameters for the Network Shield module in the payload configuration profile. 
