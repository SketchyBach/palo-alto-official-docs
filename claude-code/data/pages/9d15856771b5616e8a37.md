---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-json-file
fetched_at: 2026-09-16T09:15:01Z
source: cortex-platform
---

# Create a custom widget using a JSON file | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create JSON widgets in Cortex XSOAR On-prem 8.7 (EoL). 
 ...
 The JSON file displays incident severity by type. It creates a bar chart with incidents from the last 30 days. 

 It groups incidents by severity and then type. The bar length shows the incident count. 
 ...
 The query excludes job, archived, and closed incidents. 

 The date range displays the previous 30 days. 

 The groupBy value groups by severity, then type, creating a stacked bar chart. 

 After importing the widget into the Widget Library , the widget appears as widget_incident.png . 

 Incidents are grouped by severity. Bar lengths show incident counts. Colors identify incident types. 
