---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/configure-cortex-xsoar/customize-and-configure-cortex-xsoar/work-with-slas/search-incidents-using-sla-and-timer-fields
fetched_at: 2026-09-06T10:48:35Z
source: cortex-platform
---

# Search Incidents using SLA and Timer Fields | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Search incidents using SLA and timer fields in Cortex XSOAR 6.12. 
