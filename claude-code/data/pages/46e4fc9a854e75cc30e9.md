---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/onboard-and-configure-cortex-xdr/deployment-steps/step-2-pre-installation-steps-for-cortex-xdr-agents/set-up-authentication/set-up-okta-as-the-identity-provider-using-saml-2.0
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A video walkthrough of the procedure is available. This video covers Okta, but the general principles apply to other identity providers as well. 
