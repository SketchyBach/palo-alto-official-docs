---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/storage/appsec-gcp-90
fetched_at: 2026-09-16T09:10:39Z
source: cortex-platform
---

# GCP data flow jobs are not encrypted with Customer Supplied Encryption Keys (CSEK) misconfiguration | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 GCP data flow jobs are not encrypted with Customer Supplied Encryption Keys (CSEK) misconfiguration 
 ...
 resource "google_dataflow_job" "pass" { name = "dataflow-job" template_gcs_path = "gs://my-bucket/templates/template_file" temp_gcs_location = "gs://my-bucket/tmp_dir" parameters = { foo = "bar" baz = "qux" } kms_key_name = "SecretSquirrel" } 

 Previous GCP Big Table Instances are not encrypted with Customer Supplied Encryption Keys (CSEKs) misconfigur 

 Next GCP Dataproc Cluster not configured with Customer-Managed Encryption Key (CMEK) misconfiguration det 
