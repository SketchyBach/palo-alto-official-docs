---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/workday/ingest-report-data-from-workday
fetched_at: 2026-09-06T10:00:42Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest Workday report data into Cortex Cloud. 
 ...
 Create an Integration System User that is designated to access the custom report from Workday for data collection in Cortex Cloud. 
 ...
 Create the Workday credentials for the Integration System User created in Step 1 so that the username and password can be used to access the report in Cortex Cloud. Record these credentials as you will need them when configuring the Workday Collector in Cortex Cloud. 
...
i. Get the URL for the report. 
 ...
 Copy the URL for the report and record them somewhere as this URL needs to be provided when setting up the Workday Collector in Cortex Cloud. 

 j. Complete the report by clicking Done . 

 Configure the Workday collection in Cortex Cloud. 
 ...
 After Cortex Cloud begins receiving report data from Workday, you can use the XQL Search to search for logs in the new dataset ( workday_workday_raw ). 
