---
url: https://docs.paloaltonetworks.com/prisma-sd-wan/ion-cli-reference/use-cli-commands/dump-commands/dump-radius-config
fetched_at: 2026-08-13T17:30:23Z
source: palo-alto-main
---

# dump radius config Clear
...
dump radius config 
 ...
 Use the dump radius config command
to view the RADIUS server configuration. 
 ...
 IP Address : 10.2.15.101
 Authentication Port : 1812
 Accounting Port : 1813
 Priority : 10
 Secondary Radius Server Details:
 IP Address : 10.2.15.102
 Authentication Port : 1812
 Accounting Port : 1813
 Priority : 100 
