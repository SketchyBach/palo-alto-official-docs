---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/configure-cortex-xsoar/playbooks/customize-your-playbook/playbook-polling
fetched_at: 2026-09-16T08:53:36Z
source: cortex-platform
---

# Playbook polling | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure playbook polling in Cortex XSOAR 8.13 On-prem. 
 ...
 Some products cannot handle consecutive requests to query an action status right after the request to act. After you initiate the action, try adding a Sleep task before calling the GenericPolling sub-playbook. 
