---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/post-deployment-steps/manage-user-roles-and-access-management/manage-access-to-objects
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Control Cortex Cloud access to objects using role-based permissions and scope settings. 

 Cortex Cloud enforces least-privileged access by allowing you to manage access for individual instances of custom (user-defined) objects. Access management for these items is handled through a common experience for per-object access, which allows you to treat these tools as distinct objects with their own access settings. 

 What are Objects? 

 Objects are the tools used to visualize, analyze, and interact with information within Cortex Cloud. By managing access at the object level, you can isolate sensitive information between teams (such as SOC vs. Internal Threat) or departments (such as CloudOps vs. SecOps). 

 In Cortex Cloud, objects are functional components or configurations. There are two primary categories of objects: 
