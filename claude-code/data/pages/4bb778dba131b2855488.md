---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-zero-touch-provisioning/panorama-plugin-for-zero-touch-provisioning-30/features-introduced-in-zero-touch-provisioning-30.html
fetched_at: 2026-09-16T13:00:51Z
source: palo-alto-main
---

# Features Introduced in Zero Touch Provisioning 3.0 Clear
...
Updated on 
 ...
 New features introduced in Zero Touch Provisioning 3.0. 

 Here's what's new in Zero Touch Provisioning (ZTP) plugin 3.0. 

 What's New in Zero Touch Provisioning Plugin 3.0.3 

 The Zero Touch Provisioning (ZTP) plugin 3.0.3 release includes minor bug and
 performance fixes. 

 What's New in Zero Touch Provisioning Plugin 3.0.1 

 The Zero Touch Provisioning (ZTP) plugin 3.0.1 release includes minor bug and
 performance fixes. 

 What's New in Zero Touch Provisioning Plugin 3.0.0 

 Zero Touch Provisioning (ZTP) streamlines
 the initial deployment of by minimizing the manual
 ...
 content updates after the firewall establishes a connection to the . 11.2.0 introduces enhancements to the
 ZTP experience that automate these critical post-connection steps. When you add ZTP
 NGFW to the , your security administrator now add the authorization code during the initial configuration phase. This
 enables to automatically activate the necessary licenses on the
 ZTP immediately upon its first connection. 

 Additionally, security administrators can configure to instantly
 push the latest downloaded dynamic content updates when the 
 successfully onboards in the template stack generated by the ZTP plugin. After a
 successful connection to Panorama, activates the applicable
 ...
 associated with large-scale deployments and ensure every new is compliant and up-to-date immediately. 
