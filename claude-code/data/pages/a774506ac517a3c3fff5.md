---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-51/vm-series-plugin-5-1-9/addressed-issues-in-vm-series-plugin-5-1-9.html
fetched_at: 2026-09-16T12:58:32Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 5.1.9 Clear
...
Updated on 
 ...
 The following list describes the issues fixed in the VM-Series plugin 5.1.9. 

 PLUG-20264 

 The PA-VM system logs reported insufficient space to load content to SHM on VM with total
 memory of 5.5 GB This issue is now resolved. 

 PLUG-19949 

 The /var/log/pan/contentd.log displayed a message Not enough
 space to load content to SHM . This issue is now resolved. 
