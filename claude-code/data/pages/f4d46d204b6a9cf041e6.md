---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/configure-the-cortex-agentic-assistant/agents-hub/build-agents
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Build Cortex Agentic Assistant agents for your security workflows. 
 ...
 Click on the agent chat icon in the upper right hand corner, click the side panel icon to expand the menu if needed, and then click the Agents Hub menu item. 

 From the Agents tab of the Agents Hub , click Create agent . 
