...
Ensure the identity that runs the setup script or performs the manual Azure portal steps holds the Application Developer role (or higher) on the tenant. (either by running a script or manually using the Azure portal ). 
