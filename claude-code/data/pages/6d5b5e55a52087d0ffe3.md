---
url: https://docs.prismacloud.io/admin-guide/vulnerability-management/registry-scanning/scan-gcr
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select the GCP credential type and credential level, then paste the JSON token blob from your service account into the Service Account field. Leave the API Token field blank. 
