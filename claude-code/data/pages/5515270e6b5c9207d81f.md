---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/public-exposure/appsec-aws-376
fetched_at: 2026-09-16T09:10:27Z
source: cortex-platform
---

# AWS Elastic Load Balancer with listener TLS/SSL is not configured misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 resource "aws_elb" "example" { ... listener { instance_port = 8000 

 instance_protocol = "http" 

 instance_protocol = "https" lb_port = 80 lb_protocol = "http" } } 

 Previous TLS not enforced in SES configuration set misconfiguration detected in code 

 Next AWS Load Balancer uses HTTP protocol misconfiguration detected in code 
