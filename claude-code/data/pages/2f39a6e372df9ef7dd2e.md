---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-6-multi-tenant-guides/6.14/onboard-multi-tenant/multi-tenant-deployment-installation/upgrade-your-multi-tenant-deployment/multi-tenant-upgrade-procedure
fetched_at: 2026-09-16T08:58:05Z
source: cortex-platform
---

# Multi-Tenant Upgrade Procedure | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Follow the procedure to prepare, upgrade, and validate Cortex XSOAR 6.14 multi-tenant deployments. 
 ...
 Next Get the Host Installer Manually 
