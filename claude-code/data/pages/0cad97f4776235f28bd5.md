---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/broker-vm-data-collector-applets/activate-registry-scanner
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Registry Scanner applet for Cortex Cloud. 
 ...
 Disk Size: Calculate the required disk space by multiplying the average container image size in your environment by 10. This factor accounts for simultaneous operations with a buffer. For example, If your average image size is 500 MB, allocate at least 5 GB of disk space (500 MB * 10 = 5000 MB = 5 GB). 
 ...
 Connection : Shows the app's current connection status. You can also Deactivate the app.To reactivate the Registry Scanner app, do one of the following: 
