---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/c-validating-certificates/t-validating-certs-using-ValidateNow-to-discover-installations
fetched_at: 2026-09-16T07:25:29Z
source: palo-alto-main
---

# Discover TLS Server Endpoints Clear
...
Updated on 
 ...
 In addition to validating certificates, the Validate Now feature can discover additional TLS server endpoints associated with certificates in your inventory. 

 During validation, Next-Gen Trust Security extracts the common name (CN) and DNS subject alternative names (SANs) from selected certificates and identifies other TLS server endpoints where those certificates may be presented. 

 Discovery is automated. Select one or more certificates and run Validate Now to identify additional endpoints. 
 ...
 Locate one or more certificates by doing one of the following: 

 Enter certificate details in the search bar. 

 Click Filter next to the search bar, specify attributes to include, and click Apply . 

 Select one or more certificates, then click Validate Now . 

 After validation completes, click the value in the TLS Server Endpoints column for a certificate to view all discovered endpoints. 
