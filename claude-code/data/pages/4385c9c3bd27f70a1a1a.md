---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/investigate-and-respond-to-threats/threat-intel-management/indicator-management
fetched_at: 2026-09-06T10:31:29Z
source: cortex-platform
---

# Indicator management | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, create, edit, search, export, and delete threat indicators. 
 ...
 Export the selected indicators to a CSV file. By default, the CSV file is generated in UTF8 format. Administrator permission is required to update server configurations, including changing the format. 
