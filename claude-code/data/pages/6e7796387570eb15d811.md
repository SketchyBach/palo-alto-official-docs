---
url: https://docs.prismacloud.io/content-collections/runtime-security/vulnerability-management/scan-reports
fetched_at: 2026-09-16T13:35:20Z
source: prisma-cloud
---

# View Vulnerability Scan Reports | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Periodically, according to the scan interval configured in the Console. By default, images are scanned every 24 hours. 
 ...
 For more information on the Risk Factor details, visit CVSS Scoring . 
 ...
 By default, all vulnerable packages, according to your policy, are listed. Note that the Host Defender only scans running applications. If you are not running all the Ruby applications, those will not be detected. However, you can also examine vulnerabilities specific to an app (systemd service). Use the drop-down list to select an app. Clear the selection to see all vulnerabilities for a host/VM image. 
 ...
 Prisma Cloud uses compliance identification numbers to designate the package type when reporting vulnerabilities in images. Compliance IDs can be found in the CSV and PDF export files and API responses. 
 ...
 Previous Vulnerability Management Policies 

 Next Scan Images for Custom Vulnerabilities 
