---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-220
fetched_at: 2026-09-16T09:11:41Z
source: cortex-platform
---

# Grafana service account token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Grafana Service Account Token grants authenticated access to dashboards and data sources. 
 ...
 Previous Slack Application ID detected in code 

 Next Redis server password detected in code 
