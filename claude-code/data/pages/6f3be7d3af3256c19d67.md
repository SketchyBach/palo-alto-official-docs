---
url: https://docs.paloaltonetworks.com/ngfw/help/11-2/device/device-certificate-management-ssl-decryption-exclusion
...
Device > Certificate Management > SSL Decryption Exclusion 
 ...
 Predefined decryption exclusions allow applications and services that might break
 when the firewall decrypts them to remain encrypted. Palo Alto Networks defines
 and regularly updates the list of predefined decryption exclusions as part of
 ...
 Enter a Hostname to define a custom decryption
 ...
 *.*.*.company.com matches corp.exec.mail.company.com but does
 ...
 Select Shared to share a decryption exclusion
 ...
 ( Optional ) Describe the application that you are excluding
 from decryption, including why the application breaks when
 decrypted. 

 Exclude 

 Exclude the application from decryption. Disable this option to start
 ...
 Enable one or more entries to exclude them
 from decryption. 

 Disable 

 Disable one or more predefined decryption
