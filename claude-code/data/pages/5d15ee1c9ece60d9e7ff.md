---
url: https://docs.paloaltonetworks.com/prisma-access/release-notes/4-0/prisma-access-about
...
Prisma Access Release Information 
 ...
 Prisma Access releases and updates allow you to stay up-to-date and secure your users.
 Some of the updates are managed by Palo Alto Networks, such as Prisma Access
 ...
 of the content update and software update. If you're using Panorama to manage Prisma
 Access (instead of Prisma Access Cloud Management), you decide when to upgrade to the
 latest plugin version, in order to leverage newly-available features that the plugin
 enables for Panorama. 
 ...
 Because Prisma Access includes support for other Palo Alto Networks
