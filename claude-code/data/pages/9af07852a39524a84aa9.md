---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/jobs/create-jobs-to-process-indicators-example
fetched_at: 2026-09-06T11:23:07Z
source: cortex-platform
---

# Create jobs to process indicators example | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create indicator-processing jobs in Cortex XSOAR On-prem 8.6 (EoL). 
