---
url: https://docs.paloaltonetworks.com/compatibility-matrix/reference/supported-cipher-suites/cipher-suites-supported-in-pan-os-12-1/cipher-suites-supported-in-pan-os-12-1-fips-cc
fetched_at: 2026-08-13T15:31:41Z
source: palo-alto-main
---

# PAN-OS 12.1 Cipher Suites Supported in FIPS-CC Mode Clear
...
PAN-OS 12.1 Cipher Suites Supported in FIPS-CC Mode 
 ...
 List of cipher suites supported on firewalls running PAN-OS® 12.1 in FIPS-CC
 mode. 

 The following table lists cipher suites that are supported on firewalls running a PAN-OS®
 12.1 release in FIPS-CC mode. The Cryptographic Algorithm Validation Program has
 additional details regarding the algorithm implementation. 

 If your firewall is running in normal (non-FIPS-CC) operational mode, see Cipher Suites Supported in PAN-OS 12.1 . 
