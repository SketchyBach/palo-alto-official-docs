---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-Cloud-discovery-service-sectionOverview/c-Cloud-Discovering-Private-Internal-certificates
fetched_at: 2026-08-13T16:38:37Z
source: palo-alto-main
---

# Discover Certificates On Private Networks Clear
...
Discover Certificates On Private Networks 
 ...
 So you're ready to search for certificates in your private network. Use Enhanced Discovery to discover
server certificates within your private networks. 

 If you're not sure which one to use, learn more about discovery services here . 

 Tip (Before you begin): During the configuration of either discovery service, you'll need access to end-points where you can install required Next-Gen Trust Security components. So it can be helpful to identify ahead of time where you plan to install the components and be prepared with a command line utility during configuration. 

 Ready to go? 

 How to create an Enhanced discovery service 
