---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/integrations/add-an-integration-instance/fetch-incidents-from-an-integration-instance
fetched_at: 2026-09-16T08:53:01Z
source: cortex-platform
---

# Fetch incidents from an integration instance |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure an integration instance to fetch incidents in Cortex XSOAR 8.14 On-prem. 
 ...
 In some cases, such as a mistake in an integration configuration that leads to an unexpected high level of incoming items, you may want to temporarily disable the integration instance and drop all items waiting in the ingestion queue, for a specific integration instance. Items in the ingestion queue that are dropped do not become incidents in Cortex XSOAR. To clear all queued items for an integration instance, go to Settings & Info → Settings → Integrations → Instances . Under the integration instance, click to Clear all queued items waiting for processing . 
