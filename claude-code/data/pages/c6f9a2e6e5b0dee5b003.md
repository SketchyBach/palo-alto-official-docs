---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-102/addressed-issues-in-vm-series-plugin-102.html
fetched_at: 2026-09-16T12:59:22Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 1.0.2 Clear
...
VM-Series plugin 1.0.2. 
 ...
 After a high availability (HA) failover, the dataplane
interface on a VM-Series firewall on Azure with Accelerated Networking
(SR-IOV) becomes disabled when, as a result of the failover, the
secondary IP address is detached from or attached to the firewall and
moved to its HA peer. 

 This issue was addressed in VM-Series plugin 1.0.2. 
