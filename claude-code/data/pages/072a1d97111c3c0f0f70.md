---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/reference-docs/reference/server-configurations/google-api-server-configuration
fetched_at: 2026-09-06T10:49:31Z
source: cortex-platform
---

# Google API Server Configuration | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Reference Google API server configuration in Cortex XSOAR 6.12. 
