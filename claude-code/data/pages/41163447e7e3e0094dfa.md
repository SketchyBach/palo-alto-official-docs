...
of the firewall’s connection to the User Context cloud service. 
 ...
 Enter the URL of the DNS Security server that you want the
 firewall to use when processing DNS Security and Advanced DNS
 Security requests. Refer to the DNS Security Service
