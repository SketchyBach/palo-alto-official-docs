---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/dataset-management
fetched_at: 2026-09-16T08:58:46Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Dataset Management page enables you to manage your datasets and understand your overall data storage duration for different retention periods and datasets based on your hot and cold storage licenses, and retention add-ons that extend your storage. You can view details about your Cortex Data Security licenses and retention add-ons by selecting Settings → Cortex Data Security License . 

 Important 

 Cortex Data Security enforces retention on all log-type datasets excluding Host Inventory, Vulnerability Assessment, Metrics, and Users. 
 ...
 Only datasets that are already handled as part of the GB license are supported for this license. In addition, the retention configuration is only available in Cortex Data Security, as opposed to the public APIs. 
 ...
 *TOTAL DAYS STORED 
 ...
 Actual number of days that the data is stored in the Cortex Data Security tenant, which is comprised of the HOT RANGE + the COLD RANGE . 
 ...
 *TOTAL SIZE STORED 
 ...
 Actual size of the data that is stored in the Cortex Data Security tenant. This number is dependent on the events stored in the hot storage. For the xdr_data dataset, where the first 31 days of storage are included with your license, the first 31 days are not included in the TOTAL SIZE STORED number. 

 *ADDITIONAL SIZE STORED 

 Actual size of the additional flexible hot storage data that is stored in the Cortex Data Security tenant in GB. This number is dependent on the events stored in the hot storage. 

 *AVERAGE DAILY SIZE 

 Average daily amount stored in the Cortex Data Security tenant. This number is dependent on the events stored in the hot storage. 
 ...
 *TOTAL EVENTS 
 ...
 Number of total events/logs that are stored in the Cortex Data Security tenant. This number is dependent on the events stored in the hot storage. 
