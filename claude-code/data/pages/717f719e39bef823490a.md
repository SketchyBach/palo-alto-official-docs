---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/threat-management/threat-intel-management/indicator-investigation
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Investigate indicators using verdicts, enrichment, relationships, expiration, and exclusions. 
 ...
 You may want to expire an indicator to filter out less relevant issues, allowing analysts to focus on active threats. For more information, see Expire an indicator . 
