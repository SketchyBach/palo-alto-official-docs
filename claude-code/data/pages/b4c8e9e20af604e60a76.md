---
url: https://docs.paloaltonetworks.com/autofocus/autofocus-api/autofocus-api-error-codes
...
Updated on 
 ...
 AutoFocus™ API operations return standard HTTP status
codes as defined by the HTTP/1.1 standard. Where applicable, error
codes also include messages to help you diagnose the nature of the
issue. 
