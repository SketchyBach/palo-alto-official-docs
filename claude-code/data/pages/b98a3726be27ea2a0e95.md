---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/safe_negate
fetched_at: 2026-09-16T09:05:05Z
source: cortex-platform
---

# safe_negate | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Functions : safe_subtract() , safe_add() , subtract() , if() 

 Datasets : xdr_data 

 Previous safe_multiply 
