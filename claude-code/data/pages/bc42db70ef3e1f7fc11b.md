---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-202.html
fetched_at: 2026-09-16T13:00:15Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 2.0.2 Clear
...
Updated on 
 ...
 The Panorama plugin for VMware NSX 2.0.2 does not introduce
any new features. To install plugin version 2.0.2, see Install the Panorama Plugin for
VMware NSX . 

 If you already have a previous version of the Panorama plugin
for VMware NSX, installing the new version of the plugin will overwrite
the previously installed version. After installing version 2.0.1,
perform a manual sync (use NSX Config-Sync )
to synchronize the service definitions configured on Panorama with
the NSX Manager. 

 For more information, refer to the VM-Series 8.0 Deployment Guide or
the VM-Series 8.1 Deployment Guide . 
