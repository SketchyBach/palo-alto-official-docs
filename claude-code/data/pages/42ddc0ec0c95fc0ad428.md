---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-4-2/known-issues-in-panorama-plugin-for-aws-542.html
fetched_at: 2026-09-16T12:59:41Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for AWS 5.4.2 Clear
...
Updated on 
 ...
 The following list describes known issues in the Panorama plugin for AWS 5.4.2. 

 PLUG-22303 

 In the AWS Plugin version 5.4.2, the UI fails to hide unsupported network configuration
 options when a default Cloud NGFW template is selectedIn the AWS Plugin version 5.4.2,
 the UI fails to hide unsupported network configuration options when a default Cloud NGFW
