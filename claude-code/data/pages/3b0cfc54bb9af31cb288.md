---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-release-notes/pan-os-11-1-10-known-and-addressed-issues/pan-os-11-1-10-known-issues
fetched_at: 2026-09-16T07:40:18Z
source: palo-alto-main
---

# PAN-OS 11.1.10 Known Issues Clear
...
Updated on 
 ...
 11.1.10. This list includes issues specific to Panorama™, GlobalProtect™, VM-Series
 ...
 This issue affects PAN-OS 11.1.10-h23, 11.1.10-h24, and
 11.1.10-h25 
 ...
 PAN-307795 This issue affects PAN-OS 11.1.10-h7 through
 11.1.10-h11. 
 ...
 certificates nor Block sessions
 with untrusted issuers is enabled in the
 attached decryption profile. 

 Workaround: Perform one of the following tasks: 

 Enable Log Successful SSL
 Handshake in all no-decrypt decryption
 policy rules. 

 Enable either Block sessions with expired
 certificates or Block sessions with
 untrusted issuers in the decryption profiles
 attached to the no-decrypt decryption policy rules. 
 ...
 When you apply a filter in Network >
 Interfaces and then try to view
 Ethernet interface details using the web
 interface, the web interface becomes unresponsive. 
