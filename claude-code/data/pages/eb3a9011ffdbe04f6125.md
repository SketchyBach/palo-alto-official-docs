---
url: https://docs.prismacloud.io/admin-guide/33/compliance/trusted-images
fetched_at: 2026-09-16T13:37:03Z
source: prisma-cloud
---

# Trusted images | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 After a trust policy update, the image data is only updated as a trusted image when you initiate a re-scan. While, the hostnames with the same image are evaluated as trusted immediately after the policy update. 
