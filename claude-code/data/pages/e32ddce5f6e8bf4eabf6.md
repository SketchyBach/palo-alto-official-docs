...
# Use an assessment profile to run compliance checks on your assets | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create assessment profiles to evaluate selected asset groups against compliance standards in Cortex XSIAM. 
 ...
 Enter one or more report email recipients, clicking enter or 

 Set the cadence for the report generation. 
