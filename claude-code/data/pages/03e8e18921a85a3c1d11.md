---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.13/onboard-cortex-xsoar/marketplace/content-pack-update-notifications
fetched_at: 2026-09-16T08:56:50Z
source: cortex-platform
---

# Content Pack Update Notifications | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Enable content pack update notifications in Cortex XSOAR 6.13. 
 ...
 You can enable content pack update notifications only after the content pack is installed. Go to Marketplace → INSTALLED CONTENT PACKS , search for the content pack, and click (on the upper right). To cancel, click the icon again. 
