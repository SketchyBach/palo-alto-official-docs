---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/create-an-automation-rule
fetched_at: 2026-09-06T09:44:29Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If you want to use a playbook that is not part of your Org Playbooks , show Playbook Catalog for a full list of available playbooks. For more information on playbooks, see Playbooks . 

 The list of available playbooks is filtered based on your access; you will only see playbooks that you own, that have been shared with you, or that are marked as Public . For more information, see Manage access to playbooks and scripts . 
