---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/asset-classes/data-assets
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and manage data assets. 

 Data assets 

 The data assets inventory provides a centralized repository for all data assets within your environment. Powered by the Cortex Cloud Data Security (DSPM) module, it provides continuous visibility into where sensitive data resides, how it is used, and its exposure risk. 
