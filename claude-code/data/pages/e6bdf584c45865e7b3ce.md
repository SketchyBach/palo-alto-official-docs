---
url: https://docs.prismacloud.io/content-collections/runtime-security/authentication/prisma-cloud-user-roles
fetched_at: 2026-09-16T13:35:18Z
source: prisma-cloud
---

# Prisma Cloud user roles | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Prisma Cloud Enterprise Edition, permission groups determine what a user can do and see in Prisma Cloud UI, and the APIs he or she can access. You can assign permission groups to user roles to control their level of access on Prisma Cloud. 
