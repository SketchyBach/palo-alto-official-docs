---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/pan-os-xml-api-request-types/pan-os-xml-api-request-types-and-actions/configuration-actions/actions-for-modifying-a-configuration.html
fetched_at: 2026-09-16T11:04:43Z
source: palo-alto-main
---

# Actions for Modifying a Configuration Clear
...
Type 
 ...
 Move multiple objects in a device group
or virtual system 

 action=multi-move 

 Clone multiple objects in a device group
or virtual system 

 action=multi-clone 

 Show available subnode values and XPaths
for a given XPath. 
...
while edit actions replace configuration nodes. 
 ...
 Set actions are non-destructive and are only additive, while
edit actions can be destructive. 
