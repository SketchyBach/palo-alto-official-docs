---
url: https://docs.prismacloud.io/admin-guide/vulnerability-management/vm-image-scanning
fetched_at: 2026-09-16T13:36:25Z
source: prisma-cloud
---

# Configure VM Image Scanning | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 NOTE: On AWS, when the image field contains a string and a wildcard (e.g. Amazo*), only private AMIs are scanned. When using explicit image names, AWS Marketplace, and community AMIs are scanned as well. Only the AMI names are permitted in the image field. AMI IDs are not supported. 
 ...
 Choose the maximum number of VM images you want to scan, and they will be sorted based on their 'Creation Date.' Scanning begins with the most recently created VM images and proceeds in descending order of creation date. In the case of Azure Marketplace and Managed images, the images are scanned according to their resource ID, in descending lexicographic order (i.e., ID3, then ID2, then ID1). To scan all VM images, set value to 0. 
 ...
 NOTE: VPC ID and subnet ID are mapped 1:1. You can only scope one VPC and subnet for a rule. 
