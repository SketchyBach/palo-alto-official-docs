---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/investigate-endpoints/retrieve-support-logs-from-an-endpoint
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Retrieve endpoint support logs for troubleshooting and analysis. 

 When you need to investigate or share additional forensic data, you can initiate a request to retrieve all the support logs and issue data dump files from an endpoint. After Cortex XDR receives the logs, you can download the log files or generate a secured link to access them on the Cortex XDR server. 
