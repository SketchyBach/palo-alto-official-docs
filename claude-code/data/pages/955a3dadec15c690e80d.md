---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/cloud-security/monitor-and-track-compliance-adherence/choose-compliance-standards-from-the-compliance-catalog/standards-catalog
fetched_at: 2026-09-16T08:36:31Z
source: cortex-platform
---

# Standards catalog | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Browse available compliance standards in Cortex XSIAM. 
 ...
 CIS Amazon Web Services Foundations Benchmark v7.0.0 - Level 1 

 7.0.0 

 CIS Amazon Web Services Foundations Benchmark v7.0.0 - Level 2 
 ...
 CIS Microsoft Azure Foundations Benchmark v.6.0.0 - Level 1 

 6.0.0 

 CIS Microsoft Azure Foundations Benchmark v.6.0.0 - Level 2 
 ...
 Previous Choose compliance standards from the compliance catalog 

 Next Controls catalog 
