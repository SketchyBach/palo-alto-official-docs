---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/deploy-defender/app-embedded/deploy-app-embedded-defender-gcr
fetched_at: 2026-09-16T13:35:15Z
source: prisma-cloud
---

# (Dockerfile method) Deploy App-Embedded Defender in GCR | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous (Dockerfile method) Deploy App-Embedded Defender in ACI 

 Next Default Setting for App-Embedded Defender File System Monitoring 
