---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-3-0-8/addressed-issues-in-vm-series-plugin-3-0-8.html
fetched_at: 2026-09-16T12:58:56Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 3.0.8 Clear
...
Updated on 
 ...
 Fixed an issue where the HA mode across multi availability zones in AWS changed from
 secondary IP to interface mode, following an upgrade from 10.2.3 to 10.2.6-h1 

 PLUG-15844 

 Fixed an issue that prevented custom Palo Alto Networks metrics from being published to
 Azure Application Insights. 

 PLUG-15455 

 Following a HA-failover, it was observed that the vm_series plugin did
 not appear in show system info. This issue is now resolved. 

 PLUG-14382 

 The dpdk-mbuf-config values appeared incorrectly following a reboot of
 the PA-VM. This issue is now resolved. 

 PLUG-14251 

 Fixed an issue where bootstrapping on FIPS-CC was not merging init-cfg 
 parameters to config. 

 PLUG-13110 

 The Azure PA-VM was going to maintenance mode due to azure linuxagent 
 failure. This issue is now resolved. 
