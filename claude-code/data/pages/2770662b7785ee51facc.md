---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.5/troubleshoot-and-reference/troubleshoot/view-guard-rails-warnings-and-errors
fetched_at: 2026-09-16T09:14:18Z
source: cortex-platform
---

# View Guard Rails warnings and errors | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the Cortex XSOAR Guard Rails page to see details about errors or warnings that could affect system performance. 
 ...
 Previous View service limit errors and warnings in the Guard Rails page 
