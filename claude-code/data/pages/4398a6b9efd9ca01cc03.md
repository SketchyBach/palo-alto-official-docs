---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-5400-hardware-reference/service-the-pa-5400-series-hardware/replace-a-pa-5400-series-fan-assembly/replace-a-pa-5450-fan-assembly.html
fetched_at: 2026-09-16T11:52:40Z
source: palo-alto-main
---

# Replace a PA-5450 Fan Assembly Clear
...
firewall. 
 ...
 The PA-5450 has four dual-rotor, single fan assemblies on its rear side. While facing the rear of
 the firewall, the fan assemblies are labeled 1, 2, 3, and 4 from left to right. Each
 single fan assembly can be individually removed and replaced. When a fan is
 functioning as expected, the fan LED on the MPC glows green. If a fan fails, the fan
 LED glows red. If this occurs, replace the fan immediately to avoid service
 interruption. 

 You can replace a failed fan assembly while the firewall is powered on; however,
 there is a time limit of 120 seconds starting when the fan assembly is removed
 to replace it before the thermal protection circuit automatically powers down
 the firewall. 
...
assembly will be red. 
 ...
 Place your thumb under the thumb tab located on the bottom
of the fan assembly. Gripping the fan assembly handle with your
fingers, push up on the thumb tab. 

 While still gripping the fan assembly handle, gently
pull the fan assembly out of its slot. 

 Install the replacement fan by sliding it into the vacant
fan slot, ensuring that the thumb tab is on the bottom. 

 Verify that the new fan assembly is operational by noting the status of the fan
 LED on the MPC. You can also view the status of the fan assemblies by entering
