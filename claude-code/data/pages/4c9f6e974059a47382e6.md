---
url: https://docs.paloaltonetworks.com/ngfw/help/12-2/device/device-certificate-management-certificates/manage-default-trusted-certificate-authorities
...
name, subject, issuer, expiration date and validity status are displayed. 
 ...
 The firewall does not trust intermediate CAs by default because intermediate CAs are not a part
 of the chain of trust between the firewall and the trusted root CA. You must manually
 add any intermediate CAs that you want the firewall to trust, along with any additional
 trusted enterprise CAs that your organization requires ( Device Certificate Management Certificates Custom Certificates ). 
