---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/onboard-cortex-xsoar/single-server-deployment/post-installation-checklist/https-with-a-signed-certificate/create-a-self-signed-certificate
fetched_at: 2026-09-06T10:46:43Z
source: cortex-platform
---

# Create a Self-Signed Certificate | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create a self-signed certificate for Cortex XSOAR 6.12. 
