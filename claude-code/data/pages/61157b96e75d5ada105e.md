---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/limit
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 {"source": {"ip": "172.16.0.1", "port": 5000}, "destination": {"ip": "1.1.1.1", "port": 443}} 
 ...
 {"pipeline": {"id": "P5", "status": "running"}, "data": {"records_in": 1000, "records_out": 950}} 

 [{"step": "parse", "time_ms": 100}, {"step": "filter", "time_ms": 200}, {"step": "enrich", "time_ms": 300}] 
 ...
 {"alert_id": "SEC-001", "severity": "high"} 

 {"actor": {"type": "user", "name": "unknown"}, "target": {"resource": "db_server", "action": "read"}} 

 [{"alert_type": "login_fail", "count": 5}, {"alert_source": "IDS"}] 

 ["security", "attack"] 

 [-12, 24, 68, -59, 37, 80] 

 "Multiple failed login attempts to db_server from external source." 
 ...
 [{"stage": "compress", "time_s": 120}, {"stage": "upload", "time_s": 480}] 
 ...
 {"update_id": "SW-789", "status": "pending"} 
 ...
 "Patch deployment started on webserver01. Expected downtime: 15 min." 
 ...
 Stages : comp , fields , filter , sort 
