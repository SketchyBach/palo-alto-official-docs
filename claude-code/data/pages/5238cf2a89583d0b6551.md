---
url: https://cortex-docs.paloaltonetworks.com/xdr-agent-release-notes/9.1-ce/cortex-xdr-agent-release-information/cortex-xdr-agent-known-issues-91
fetched_at: 2026-09-06T10:53:17Z
source: cortex-platform
---

# Cortex XDR agent known limitations | 9.1-CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The following table describes the known limitations in the Cortex XDR agent 9.1. 
 ...
 The Cortex XDR agent 9.1 on ARM architecture has the following limitations: 
 ...
 Previous Addressed issues in Cortex XDR agent 9.1-CE 
