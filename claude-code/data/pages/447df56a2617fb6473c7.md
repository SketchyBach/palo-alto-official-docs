...
Updated on 
 ...
 Fixed an issue where the GlobalProtect UI unexpectedly appeared a few minutes after a user logged into Windows, even after portal authentication. This occurred when a second instance of the GlobalProtect app was launched, either by a scheduled task or through the Windows Run registry key, causing it to signal the first app instance to display the main UI. 
