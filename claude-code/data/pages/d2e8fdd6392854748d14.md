...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to use the preview Automation Engineer agent in Cortex XSIAM to create, update, and troubleshoot playbooks with natural language. 
...
Revisions can only be applied while in Edit Mode. If you have unsaved manual changes, the system prompts you to confirm before overwriting them. 
 ...
 Next Automation Engineer prompt examples 
