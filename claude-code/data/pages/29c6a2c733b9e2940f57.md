---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-524/known-issues-in-the-panorama-plugin-for-azure-524
fetched_at: 2026-09-16T07:42:54Z
source: palo-alto-main
---

# Known Issues in the Panorama Plugin for Azure 5.2.4 Clear
...
Updated on 
 ...
 The following list describes known issues in the Panorama plugin for Azure 5.2.4: 

 PLUG-329377 

 Tags harvested by the Panorama Azure plugin may not consistently propagate to
 firewalls after a single commit and push operation. This impact is consistent for vNET
 tags (both predefined and user-defined) and for user-defined tags on other resources
 like VMs. 

 Workaround : Running a second commit-all resolves the issue and correctly
 populates the IP mappings. 
