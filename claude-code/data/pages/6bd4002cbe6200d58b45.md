---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/incident-configuration/classification-and-mapping/create-an-incident-classifier
fetched_at: 2026-09-06T11:27:11Z
source: cortex-platform
---

# Create an incident classifier | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create incident classifiers in Cortex XSOAR On-prem 8.7 (EoL). 
