---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-14.html
fetched_at: 2026-09-16T11:04:29Z
source: palo-alto-main
---

# GlobalProtect Operating System Types Clear
...
Updated on 
 ...
 Provides statistics on operating system types in use on the endpoints on which GlobalProtect clients are running. The operating system name and release version is collected, as is the number of endpoints running each operating system. 
 ...
 pan_report_gen -t globalprotect -n 5000 -xc portal -ac client_os -vc count -p last-7-days -q “(eventid eq gateway-connected) and (status eq success)"
