---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/pan-os-xml-api-request-types/configuration-api/view-configuration-node-values-for-xpath.html
...
for multi-vsys firewalls, use the following command: 
 ...
 curl -X GET "https://<firewall>/api/?type=config&action=complete&xpath=/config/devices/entry[@name='localhost.localdomain']/vsys&key=apikey" 
