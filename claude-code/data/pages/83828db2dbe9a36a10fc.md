---
url: https://docs.paloaltonetworks.com/prisma-access/incidents-and-alerts/prisma-access-license-incidents/inc-rn-secondary-wan-proxy-tunnel-flap
fetched_at: 2026-08-13T17:26:25Z
source: palo-alto-main
---

# INC_RN_SECONDARY_WAN_PROXY_TUNNEL_FLAP Clear
...
INC_RN_SECONDARY_WAN_PROXY_TUNNEL_FLAP 
 ...
 Learn about the INC_RN_SECONDARY_WAN_PROXY_TUNNEL_FLAP incident. 

 Synopsis 

 The secondary proxy WAN tunnel <tunnel-name> for the remote network is flapping. 

 Incident Code—INC_RN_SECONDARY_WAN_PROXY_TUNNEL_FLAP 
 ...
 AL_RN_SECONDARY_WAN_PROXY_TUNNEL_FLAP 
 ...
 Perform a ping and traceroute to check for any latency inconsistencies or packet
 loss between the site and Prisma Access location. 
