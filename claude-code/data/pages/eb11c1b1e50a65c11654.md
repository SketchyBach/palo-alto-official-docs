---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/configure-threat-intelligence-management-playbooks-to-process-indicators
fetched_at: 2026-09-16T09:15:01Z
source: cortex-platform
---

# Configure Threat Intelligence Management playbooks to process indicators | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure indicator playbooks in Cortex XSOAR On-prem 8.7 (EoL). 
