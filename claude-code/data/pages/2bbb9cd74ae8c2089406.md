---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/multi-tenant/onboard-cortex-xsoar-multi-tenant/step-4.-set-up-users-and-roles
fetched_at: 2026-09-16T08:54:23Z
source: cortex-platform
---

# Step 4. Set up users and roles | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, configure multi-tenant users, roles, and SAML authentication. 
