---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/reference-docs/reference/server-configurations/users-and-roles-server-configurations
fetched_at: 2026-09-06T10:49:34Z
source: cortex-platform
---

# Users and Roles Server Configurations | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Reference users and roles server configurations in Cortex XSOAR 6.12. 
