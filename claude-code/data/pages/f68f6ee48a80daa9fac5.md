...
# Configure the Multi-Tenant Deployment | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure hosts, tenants, backups, and engines in Cortex XSOAR 6.12 Multi-Tenant deployments. 
