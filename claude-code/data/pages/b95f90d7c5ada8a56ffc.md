...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Import a lookup dataset to use reference data in Cortex AgentiX. 
 ...
 By default, Cortex AgentiX uses the name of the original file as the dataset name. You can change this name to something that will be more meaningful for your users when they query the dataset. For example, if the original file name is mrkdptusrsnov23.json, you can save the dataset as marketing_dept_users_Nov_2023. 
