---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/learn-about-cortex-xsoar/get-started-in-cortex-xsoar/use-the-command-line-interface
fetched_at: 2026-09-06T10:39:30Z
source: cortex-platform
---

# Use the Command Line Interface | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the Cortex XSOAR 6.14 CLI to run system and integration commands, automations, scripts, and user notifications. 
