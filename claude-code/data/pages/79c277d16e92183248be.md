---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/indicator-classification-and-mapping
fetched_at: 2026-09-16T09:15:00Z
source: cortex-platform
---

# Indicator classification and mapping | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure indicator mapping in Cortex XSOAR On-prem 8.7 (EoL). 
