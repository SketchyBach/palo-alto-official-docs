---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/multi-tenant/indicator-management-on-the-main-tenant
fetched_at: 2026-09-16T08:53:17Z
source: cortex-platform
---

# Indicator management on the main tenant |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and take action on indicators on the main tenant in Cortex XSOAR 8.14 On-prem. 
 ...
 Export the selected indicators to a CSV file. By default, the CSV file is generated in UTF8 format. Administrator permission is required to update server configurations, including changing the format, see Export an incident to CSV using the UTF8-BOM format . 
