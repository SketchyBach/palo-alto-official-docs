---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/install-cortex-xsoar/high-availability-for-cortex-xsoar
fetched_at: 2026-09-06T10:29:23Z
source: cortex-platform
---

# High Availability for Cortex XSOAR | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, configure High Availability for reliable operation. 
 ...
 If you deploy a cluster of three nodes and set the Cortex XSOAR IP address access to either a virtual IP or the reverse proxy/ingress controller IP, the system implements built-in high availability. This enables workload distribution and data replication across the nodes, and continuous operation if one node fails. 
