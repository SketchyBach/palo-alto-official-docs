---
url: https://docs.paloaltonetworks.com/pan-os/10-2/pan-os-release-notes/pan-os-10-2-3-known-and-addressed-issues/pan-os-10-2-3-known-issues
fetched_at: 2026-08-13T17:07:16Z
source: palo-alto-main
---

# PAN-OS 10.2.3 Known Issues Clear
...
specific to PAN-OS ® 10.2.3. This list includes issues
...
to a different managed firewall. 
 ...
 view the Detailed Log View in the Data Filtering log ( Monitor Logs Data Filtering <select log> DLP ). 
 ...
 Workaround: Provide a DNS server setting for the firewall ( Device DNS Setup Services ). If you cannot reference a valid DNS server, you can
 add a dummy address. 
