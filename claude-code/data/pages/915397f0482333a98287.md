---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-release-notes/pan-os-11-1-6-known-and-addressed-issues/pan-os-11-1-6-addressed-issues
fetched_at: 2026-09-16T07:40:23Z
source: palo-alto-main
---

# PAN-OS 11.1.6 Addressed Issues Clear
...
Updated on 
 ...
 Fixed an issue on firewalls in high availability (HA) configurations where, when using the Cloud
 Identity Engine (CIE), the firewall experienced consistent memory
 leaks on the active firewall, which caused unexpected failovers. 
 ...
 ( PA-5440 and PA-5445 firewalls only ) Fixed an issue where interrupts were generated at a
 ...
 ( PA-5450 firewalls only ) Fixed an issue where traffic to benign applications was
 impacted by holding TCP sequential segments for MLC inspection and
 not releasing the full chain after a benign verdict was
 received. 
