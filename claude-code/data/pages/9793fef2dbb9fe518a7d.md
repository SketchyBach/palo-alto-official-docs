---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/cloud-keystores-overview/add-cloud-keystore-google
fetched_at: 2026-09-16T07:25:11Z
source: palo-alto-main
---

# Add a Cloud Keystore to Google Cloud Platform Clear
...
Updated on 
 ...
 You need to add a cloud provider first. If you still need to do this, see the following integration guide Configure Google Cloud Platform (GCP) connection . 

 To Add a Cloud Keystore to Google Cloud Platform 
