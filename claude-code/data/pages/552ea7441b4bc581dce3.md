---
url: https://docs.paloaltonetworks.com/sase/prisma-sase-multitenant-platform/manage-bulk-configurations/view-tenant-bulk-config-status
fetched_at: 2026-08-13T17:34:42Z
source: palo-alto-main
---

# View Tenant Bulk Config Status Through the Strata Multitenant Cloud Manager Clear
...
View Tenant Bulk Config Status Through the Strata Multitenant Cloud Manager 
 ...
 Access the 
 Strata Multitenant Cloud Manager , and select Manage Bulk Configuration Tenant Config Status . 
 ...
 Displays the total number of tenants with updates
 available. 

 Tenants Unassigned 

 Displays the total number of tenants with no snippets
 assigned. 

 Tenants Failed 

 Displays the total number of tenants where the Assign
 & Push failed. If you get a failure, you can
 Retry . 
 ...
 Push: Push a snippet to an individual
 tenant. 

 Revert: If the previous push was a success,
 you would not need to revert. 

 Retry: If the previous push was a success, you
 would not need to retry. 

 Remove: You can remove a configuration if the
 previous push was a success and the status is
 synced. You cannot remove a configuration if the
 status is unassigned or in progress. 
