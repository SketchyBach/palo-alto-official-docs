---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/configure-cortex-xsoar/engines/install-an-engine/docker/docker-image-security
fetched_at: 2026-09-16T08:53:59Z
source: cortex-platform
---

# Docker image security | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, secure Docker images used by engines. 

 The project that contains the source Dockerfiles used to build the images and the accompanying files is fully open source and available for review . Cortex XSOAR uses the secure Docker Hub registry for its Docker images . However, in an Engine environment, you can also use the Cortex XSOAR Container Registry . You can view the Docker trust information for each image at the image info branch . 
