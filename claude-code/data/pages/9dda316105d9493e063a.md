---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/playbooks/accelerate-playbook-development-using-the-automation-engineer-agent-preview/automation-engineer-prompt-examples
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use prompt examples with Automation Engineer. 

 The following table provides some use case scenarios and the corresponding prompts used to generate automated response playbooks within Cortex XDR. 
