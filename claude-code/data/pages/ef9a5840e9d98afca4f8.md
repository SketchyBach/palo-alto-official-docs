---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-200-h10/known-issues-in-panorama-plugin-for-cisco-aci-200-h10.html
fetched_at: 2026-09-16T13:00:26Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for Cisco ACI 2.0.0-h10 Clear
...
in the Panorama plugin for Cisco ACI 2.0.0-h10. 

 PLUG-5129 

 After upgrading from the Panorama plugin
for Cisco ACI 1.0.1 to this release, the timestamp displayed in
the Details/Last Sync column under Panorama Cisco ACI Monitoring Definition might
not change after successfully retrieving updates from the APIC. 

 Workaround : Modify the Monitoring Definition description
or disable and enable the Monitoring Definition and the Commit your changes
on Panorama to update the Details/Last Sync information. 
