---
url: https://docs.prismacloud.io/content-collections/application-security/get-started/connect-code-and-build-providers/code-repositories/add-bitbucket-server
fetched_at: 2026-09-16T13:35:37Z
source: prisma-cloud
---

# Bitbucket Data Center/Server | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Grant the Prisma Cloud user the necessary permissions for integrating Prisma Cloud with your Bitbucket Data Center or Bitbucket Server, as specified in User Permissions below. 
 ...
 Paste the Bitbucket PAT generated in step 5 of the prerequisites above in the Bitbucket Personal Access Token field > Register . 
 ...
 Execute the Integration steps above, starting from step 1.3. 

 Next step: See Monitor and Manage Code Build Issues . 

 Manage Integrations 

 Manage integrations from the integration wizard. 

 Access the list of Bitbucket Data Center/ Server integrations - see steps 1,2 of Support for Multiple Integrations above. 
