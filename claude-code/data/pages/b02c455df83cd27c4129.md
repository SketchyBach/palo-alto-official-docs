---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/install-cortex-xsoar/install-cortex-xsoar-on-a-vm-deployed-on-hyper-v/task-3.-configure-tenant-network-and-ip-settings-for-each-node
fetched_at: 2026-09-06T10:23:55Z
source: cortex-platform
---

# Task 3. Configure tenant network and IP settings for each node |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure network and IP settings for each Cortex XSOAR 8.14 On-prem node. 
