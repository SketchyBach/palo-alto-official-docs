---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/manage-bulk-configurations/assign-and-push-bulk-config-snippet.html
fetched_at: 2026-09-16T09:59:15Z
source: palo-alto-main
---

# Assign and Push Bulk Config Snippets Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn how to assign and push Bulk Config Snippets through the Strata Multitenant Cloud Manager 
...
After you add Snippets , you can assign and push a
 snippet to multiple tenants at once. 
 ...
 Select a Snippet from the drop-down. 

 Associate the snippet with one or more folders (such as Global, Prisma Access, or All Firewalls) by selecting them in the Snippet Association option. 

 Select one or more tenants in your hierarchy where you want to apply the config
 snippet. 
