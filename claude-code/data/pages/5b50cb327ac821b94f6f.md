---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/incidr6
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The IPv6 address field (or explicit string literal) to evaluate. 
 ...
 One or more IPv6 CIDR ranges, provided as a comma-separated string enclosed in double quotes (for example, "2001:db8::/32" or "2001:db8::/32, 2001:db8:cafe::/48" ). 
