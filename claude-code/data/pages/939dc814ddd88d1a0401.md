---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-gcp/onboard-gcp-org
fetched_at: 2026-09-16T13:34:59Z
source: prisma-cloud
---

# Onboard Your GCP Organization | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Account groups that are created automatically are indicated with an icon, and cannot be edited on Prisma Cloud. 
 ...
 Previous Prerequisites to Onboard GCP Organizations and Projects 

 Next Onboard Your GCP Project 
