---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/wildfire/u-v/wildfire-api/get-started-with-the-wildfire-api/get-your-api-key/manage-wildfire-appliance-api-keys/disable-or-enable-an-api-key.html
fetched_at: 2026-09-16T11:04:41Z
source: palo-alto-main
---

# Disable or Enable an API Key Clear
...
WildFire Appliance API Keys 
 ...
 Use this command to disable or enable an API
key: 

 Use this command to disable or enable an API key: 

 admin@WF-500> edit
wildfire api-key status [disable | enable] key api-key 

 Example: 

 admin@WF-500> edit
wildfire api-key status disable key <API KEY> 

 In the above command, you can type the first
few unique digits of the key and then hit tab to fill in the remaining digits. 
