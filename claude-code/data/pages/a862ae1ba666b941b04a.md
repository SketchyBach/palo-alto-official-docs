---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-76
fetched_at: 2026-09-16T09:11:23Z
source: cortex-platform
---

# Scalr API Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Scalr API Token grants access to remote operations backend for Terraform. 

 Exposure can lead to unauthorized infrastructure provisioning, modification, and deletion actions managed by Infrastructure-as-Code. 
 ...
 Previous Webflow API Token detected in code 

 Next MongoDB Connection String detected in code 
