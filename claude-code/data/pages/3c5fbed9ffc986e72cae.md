---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/rules-and-policies/about-rules-and-policies
fetched_at: 2026-09-16T09:15:53Z
source: cortex-platform
---

# About Rules and Policies | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Discover how Cortex Cloud detects security risks across your infrastructure, workloads, and container images, and how policies automate the response. 

 Overview 

 Cortex Cloud uses rules and policies to detect security risks and manage responses across your cloud environment. 
 ...
 Detect : Cortex Cloud evaluates rules against your cloud assets, workloads, and images to generate findings. 
 ...
 Cortex Cloud includes both built-in (out-of-the-box) and custom rules and policies. 
 ...
 Previous Manage registry scanning with APIs 
