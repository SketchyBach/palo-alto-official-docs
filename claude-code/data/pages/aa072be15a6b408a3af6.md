---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/iam/appsec-k8s-41
fetched_at: 2026-09-06T11:12:17Z
source: cortex-platform
---

# Default service accounts are actively used misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 ClusterRoleBinding grants that access cluster-wide. To avoid activating the default service account, it should not be used as a subject in RoleBinding or ClusterRoleBinding resources. [source,go] 
 ...
 Previous Service account tokens are not mounted where necessary misconfiguration detected in code 

 Next Default Kubernetes service accounts are actively used by bounding to a role or cluster role misconfi 
