---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources/microsoft/microsoft-office-365/ingest-logs-from-microsoft-office-365
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest Microsoft Office 365 logs into Cortex XDR. 
 ...
 To receive logs from Microsoft Office 365, you must first configure the Data Sources & Integrations settings in Cortex XDR. After you set up data collection, Cortex XDR begins receiving new logs and data from the source. 
 ...
 Cortex XDR supports normalizing Exchange Online audit logs into stories, which are collected in a dataset called saas_audit_logs* . 
 ...
 Cortex XDR supports normalizing SharePoint Online audit logs into stories, which are collected in a dataset called saas_audit_logs* . 
 ...
 Cortex XDR supports normalizing General audit logs into stories, which are collected in a dataset called saas_audit_logs* . 
 ...
 When relevant, Cortex XDR normalizes Azure AD authentication logs and Azure AD Sign-in logs to authentication stories. 
 ...
 When relevant, Cortex XDR normalizes Azure AD audit logs to cloud audit logs stories. 
...
When registering the app for Cortex XDR in the Microsoft Entra ID console, you must assign the permissions listed below. 
 ...
 b. Obtain the Application Client ID and Secret for your Microsoft Entra ID (Azure AD) service from the Microsoft Entra ID console, and specify the values in Cortex XDR. These values enable Cortex XDR to authenticate with your Microsoft Entra ID (Azure AD) service. 
...
The following options are available. 
 ...
 d. Click Test to test the connection settings. To test the connection, you must select one or more log types. Cortex XDR then tests the connection settings for the selected log types. 
