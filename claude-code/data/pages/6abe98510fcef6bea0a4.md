---
url: https://docs.paloaltonetworks.com/hardware/pa-7500-hardware-reference/pa-7500-series-firewall-maintenance/replace-a-pa-7500-series-firewall-interface-card-in-an-ngfw-cluster/replace-a-pa-7500-series-firewall-dpc-in-a-ngfw-cluster
fetched_at: 2026-09-15T15:14:31Z
source: palo-alto-main
---

# Replace a PA-7500 Series Firewall DPC in a NGFW Cluster Clear
...
Updated on 
 ...
 Learn how to remove and replace a PA-7500 DPC in a NGFW clustering
 configuration. 

 Unlock the DPC and remove it from the
 chassis. 

 Install the replacement DPC.

 Verify the slot and serial number of the new DPC using the following CLI
 command: show chassis inventory . 

 Monitor the DPC boot process using the following command: show
 chassis status slot [0] where [0] is the number of the slot in
 which the new DPC is installed. When the DPC is fully online, the
 Card Status reads Up . 
