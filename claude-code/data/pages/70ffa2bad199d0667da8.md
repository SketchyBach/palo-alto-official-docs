---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/service-the-pa-7000-series-hardware/replace-a-pa-7000-series-front-slot-card.html
fetched_at: 2026-09-16T12:08:42Z
source: palo-alto-main
---

# Replace a PA-7000 Series Firewall Front Slot Card Clear
...
Updated on 
 ...
 The PA-7000 Series firewalls require one Switch Management
Card (SMC), one Log Processing Card (LPC), and at least one Network
Processing Card (NPC). The procedures to replace a front slot card
on a PA-7050 and PA-7080 firewall are almost identical. The only
differences are the slot numbers and the handles used to remove
and install the SMC. 

 Replace
a PA-7000 Series Switch Management Card (SMC) 
