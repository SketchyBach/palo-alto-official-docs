---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-gcp/prerequisites-to-onboard-gcp
fetched_at: 2026-09-16T13:34:59Z
source: prisma-cloud
---

# Prerequisites to Onboard GCP Organizations and Projects | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Grant either a new permission serviceusage.services.use or add a new role Service Usage Consumer ( roles/serviceusage.serviceUsageConsumer ) to the service account that Prisma Cloud uses to access GCP APIs. 
 ...
 appengine.applications.get appengine.services.list appengine.versions.list 
 ...
 cloudfunctions.functions.getIamPolicy cloudfunctions.functions.list cloudfunctions.functions.get cloudfunctions.locations.list 
 ...
 iam.serviceAccounts.actAs resourcemanager.projects.get storage.buckets.get storage.objects.create storage.objects.get storage.objects.list See Flow Logs Compression 
 ...
 backupdr.managementServers.list backupdr.managementServers.getIamPolicy 
 ...
 Only required for GCP Organization Project where you have created the service account 
 ...
 biglake.catalogs.list biglake.databases.list biglake.tables.list 
 ...
 bigquery.dataPolicies.list bigquery.dataPolicies.getIamPolicy 
 ...
 integrations.integrations.list integrations.integrationVersions.list 
 ...
 cloudscheduler.jobs.list source.repos.getIamPolicy 
 ...
 alloydb.backups.list alloydb.clusters.list alloydb.instances.list alloydb.users.list 
 ...
 vmwareengine.locations.list vmwareengine.vmwareEngineNetworks.list vmwareengine.networkPolicies.list vmwareengine.privateClouds.list vmwareengine.externalAddresses.list 
 ...
 privateca.caPools.getIamPolicy privateca.caPools.list privateca.certificateAuthorities.list privateca.certificates.list privateca.certificateRevocationLists.list privateca.certificateRevocationLists.getIamPolicy 
 ...
 domains.registrations.list domains.registrations.getIamPolicy 
 ...
 connectors.endpointAttachments.list connectors.customConnectors.list connectors.customConnectorVersions.list 
 ...
 aiplatform.indexes.list aiplatform.datasets.list aiplatform.featurestores.list aiplatform.entityTypes.list aiplatform.entityTypes.getIamPolicy aiplatform.hyperparameterTuningJobs.list aiplatform.deploymentResourcePools.list aiplatform.nasJobs.list aiplatform.batchPredictionJobs.list aiplatform.models.list aiplatform.specialistPools.list aiplatform.modelDeploymentMonitoringJobs.list aiplatform.persistentResources.list aiplatform.studies.list aiplatform.tuningJobs.list 
 ...
 Previous Onboard GCP 

 Next Onboard Your GCP Organization 
