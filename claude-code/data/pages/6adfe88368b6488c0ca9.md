---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-security/data-classification/how-to-create-and-validate-a-custom-data-pattern/custom-data-patterns-guardrails-and-syntax-guide
fetched_at: 2026-09-06T10:51:04Z
source: cortex-platform
---

# Custom data patterns: Guardrails and syntax guide | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Why: In many regex engines, ^ and $ match the start or end of a line. However, in Cortex Data Classification, they match the start or end of the entire text being scanned. Since your target data ( such as an ID or key) is usually embedded in the middle of a file or sentence, using these causes the match to fail. 
 ...
 Rule: Cortex Data Classification does not support the following: 
 ...
 Why: Using the lookaround and backreference entities can lead to exponential execution time. Cortex Data Classification allows lookaround entities using the context words, and it uses the Rust regex engine, which guarantees linear time execution O(n) to prevent ReDoS (Regular Expression Denial of Service) attacks and to ensure predictable performance. 
 ...
 Rule: Cortex Data Classification enforces limits on regex complexity to prevent performance issues. 
 ...
 Impact: If your regex is too complex, Cortex Data Classification rejects it with a validation error. In short, simplify your pattern by reducing nesting or breaking it into smaller components. 
 ...
 Previous How to create and validate a custom data pattern 

 Next How to disable and enable data patterns in Data Classification 
