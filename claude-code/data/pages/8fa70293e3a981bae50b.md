---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/configure-cortex-xsiam/data-management/parsing-rules/parsing-rules-file-structure-and-syntax/ingest/parse_cef
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use `parse_cef` in Cortex XSIAM Parsing Rules. 
