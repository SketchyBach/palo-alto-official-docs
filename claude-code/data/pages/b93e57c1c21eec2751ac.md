---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/readme/in-product-support-case-creation
fetched_at: 2026-09-16T08:43:49Z
source: cortex-platform
---

# In-product support case creation | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 From Cortex XDR, select Help → Submit a Support Case . 
 ...
 When the issue you are opening a support case for is related to the agent, you can select the relevant endpoint. If you select the endpoint, Cortex XDR will create and send the TSF for the agent you selected, when possible. 
 ...
 To submit the support case, click Submit Support Case . 
