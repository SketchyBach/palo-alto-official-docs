---
url: https://docs.prismacloud.io/content-collections/application-security/risk-management/monitor-and-manage-code-build/software-composition-analysis/sca-troubleshoot
fetched_at: 2026-09-16T13:35:44Z
source: prisma-cloud
---

# Troubleshoot Software Composition Analysis (SCA) Issues | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Click the link to copy the file path > navigate to the file, and fix the error according to the solution provided in SCA Error Message Types below. 
 ...
 Previous License Compliance in Software Composition Analysis (SCA) 

 Next Secrets Scanning 
