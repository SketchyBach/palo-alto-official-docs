---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.5/configure-cortex-xsoar/incident-configuration/incident-customization/create-an-incident-field
fetched_at: 2026-09-06T11:27:42Z
source: cortex-platform
---

# Create an incident field | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add the grid field to a layout attached to an incident type. 
