---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-101.html
fetched_at: 2026-09-16T13:00:20Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 1.0.1 Clear
...
Updated on 
 ...
 The Panorama Plugin for VMware NSX version
1.0.1 introduces support for VMware NSX 6.3 with vSphere 6.5a. 

 If you are configuring the VM-Series firewall for VMware NSX
for the first time, install the Panorama Plugin for
VMware NSX . 

 If you already have plugin version 1.0.0, installing the new
version of the plugin will overwrite the previously installed version.
After installing version 1.0.1, perform a manual sync (use NSX
