---
url: https://cortex-docs.paloaltonetworks.com/8.x/8.5-eol/cortex-xdr-agent-8.5-release-information/cortex-xdr-agent-known-issues
fetched_at: 2026-09-06T11:22:18Z
source: cortex-platform
---

# Cortex XDR Agent Known Issues | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 See the list of the known issues in Cortex XDR agent 8.5. 

 The following table describes known issues in the Cortex XDR agent. 
 ...
 Previous Addressed issues in Cortex XDR agent 8.5.0 
