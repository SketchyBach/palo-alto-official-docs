---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-106
fetched_at: 2026-08-13T17:16:31Z
source: palo-alto-main
---

# Configuration Log Contents Clear
...
Configuration Log Contents 
 ...
 Shows the configuration changes made to the device over the previous collection interval. These log records identify the changes made to the device, the person who made the change, plus a time stamp for when each configuration change was made. 
 ...
 pan_logquery -b -t config -n 1500 -i bwd -e last-24-hrs
