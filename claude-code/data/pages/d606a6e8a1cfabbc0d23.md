---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-102
fetched_at: 2026-09-16T07:43:41Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 1.0.2 Clear
...
Updated on 
 ...
 The Panorama plugin for VMware NSX 1.0.2 does not introduce
any new features. 
...
the previously installed version. After installing version 1.0.2,
perform a manual sync (use NSX Config-Sync )
to synchronize the service definitions configured on Panorama with
the NSX Manager. 

 For more information, refer to the VM-Series 8.0 Deployment Guide . 
