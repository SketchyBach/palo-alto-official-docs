...
# Ingest Indicators from the Shared Indicators Index | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure tenants to ingest shared indicators with Elasticsearch Feed in Cortex XSOAR 6.14. 
