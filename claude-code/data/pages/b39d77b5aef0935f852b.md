---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-6-installation-guides/6.12/cortex-xsoar-installation-guide/upgrade-your-installation/upgrade-your-multi-tenant-deployment
fetched_at: 2026-09-16T08:58:37Z
source: cortex-platform
---

# Upgrade Your Multi-Tenant Deployment | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Upgrade a Cortex XSOAR 6.12 multi-tenant deployment from preparation through validation. 
 ...
 Upgrade each host server group at a convenient time. All hosts in the same high-availability group must be upgraded at the same time. All other host server groups can continue to run, and their tenants can be accessed directly through the host. 
