---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/set-up-microsoft-entra-id-as-the-identity-provider-using-saml-2.0
fetched_at: 2026-09-16T08:55:02Z
source: cortex-platform
---

# Set up Microsoft Entra ID as the Identity Provider Using SAML 2.0 | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Microsoft Entra ID SAML 2.0 authentication for Cortex XSOAR 8.10 On-prem. 
