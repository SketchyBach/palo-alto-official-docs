---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/related-documentation/read-product-documentation.html
fetched_at: 2026-09-16T09:58:51Z
source: palo-alto-main
---

# Read Product Documentation Clear
...
Updated on 
 ...
 Find documentation related to the products that you can
access using the Strata Multitenant Cloud Manager 

 After you add a tenant and activate a license for it,
there might be follow-on configuration or monitoring you need to
perform for the products assigned to the tenant. The documentation
describing these products are: 
 ...
 Access products from the
platform and then access the platform to
get back from the products. 
