---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-146
fetched_at: 2026-09-16T09:11:35Z
source: cortex-platform
---

# reCAPTCHA key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The reCAPTCHA Key is a critical security component for protecting websites against bots. 

 Exposure allows for unauthorized use, potentially rendering the reCAPTCHA system ineffective and allowing malicious actors to bypass security measures. 
 ...
 Previous AWS SES client secret detected in code 

 Next Adobe API ID detected in code 
