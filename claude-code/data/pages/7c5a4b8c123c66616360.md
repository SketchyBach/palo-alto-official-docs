---
url: https://cortex-docs.paloaltonetworks.com/google-cloud-platform-manual-onboarding/gcp-manual-onboarding/gcp-manual-onboarding-guide-folder-scope/phase-1-gcp-onboarding-wizard
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Organization: A collection of GCP projects that are managed centrally. 

 Folder: (Selected for this guide) A GCP folder can contain projects, folders, or a combination of both projects and folders. 
 ...
 Instance Name: Enter a unique instance name or leave it empty to be automatically populated. The automatic naming convention is GCP-. Cortex does not prevent you from reusing instance names, but it is best practice to use a unique name for every cloud instance. 
 ...
 The "manual_details" section: These fields are initially empty. During the manual setup in Phase 2, you will retrieve specific values from your GCP environment, such as your Folder ID and Audit Pub/Sub Subscription ID, and input them directly into this section of the file. 
