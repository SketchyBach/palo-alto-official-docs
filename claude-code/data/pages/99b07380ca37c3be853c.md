---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-release-information/known-issues/known-issues-related-to-pan-os-9-1-releases/pan-os-9-1-1-known-issues
fetched_at: 2026-08-13T17:14:37Z
source: palo-alto-main
---

# PAN-OS 9.1.1 Known Issues Clear
...
PAN-OS 9.1.1 Known Issues 
 ...
 Review the known issues specific to the PAN-OS 9.1.1 release. 

 The following list includes all known issues that impact
the PAN-OS® 9.1.1 release. This list includes both outstanding issues
...
IP and Port (DIPP) NAT oversubscription rate is set to 2. 
 ...
 On the Panorama management server, managed firewalls
display as disconnected when installing
a PAN-OS software update ( Panorama Device Deployment Software )
but display as connected when you view
your managed firewalls Summary ( Panorama Managed Devices Summary )
and from the CLI. 
