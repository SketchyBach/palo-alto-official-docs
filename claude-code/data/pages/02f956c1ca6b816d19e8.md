---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-86
fetched_at: 2026-08-13T17:16:49Z
source: palo-alto-main
---

# Data-Management Plane Health Heartbeat Clear
...
Data-Management Plane Health Heartbeat 
 ...
 Collects heartbeat status between internal device components. 
 ...
 show system packet-path-test status debug dataplane packet-path-test test proc dp0 debug dataplane packet-path-test test proc dp1 debug dataplane packet-path-test test proc dp2 debug dataplane packet-path-test test proc cp
