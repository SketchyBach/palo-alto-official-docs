---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/generic-on-premise-data-collectors/xdr-collectors/manage-xdr-collectors/create-an-xdr-collector-installation-package
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To install the XDR Collector software, you must use a valid installation package that exists in your XDR Collectors console. If you delete an installation package, any XDR Collectors installed from this package are not able to register to Cortex XDR . 

 XDR Collectors cannot be moved between Cortex XDR managing servers. In this situation, you need to uninstall the existing collector, and then install a new collector using an installation package from the new managing server. For more information on uninstalling, see Uninstall the XDR Collector . 

 To create a new installation package. 

 In Cortex XDR, select Settings → Configurations → XDR Collectors → Installers. 
