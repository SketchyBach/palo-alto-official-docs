---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/protect-your-endpoints/install-and-manage-endpoints/manage-endpoint-protection/delete-cortex-xdr-agents
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If you have an endpoint that you no longer want to track through Cortex XDR, for example, if the endpoint disconnected from Cortex XDR, or an endpoint where the Cortex XDR agent was uninstalled, you can delete the endpoint from the Cortex XDR tenant views. 
