...
# Classification and mapping | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure classification and mapping in Cortex XSOAR 8.9 On-prem. 
 ...
 (Multi-tenant) You can add propagation labels for propagating the classifier and mapper to the child tenant. 
