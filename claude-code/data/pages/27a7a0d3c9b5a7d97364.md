---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/investigate-and-respond-to-incidents/build-xql-queries/how-to-build-xql-queries/graph-query-results
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select Incident Response → Investigation → Query Builder → XQL . 
