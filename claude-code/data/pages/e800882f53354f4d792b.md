---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/common-services/identity-and-access-access-management/manage-identity-and-access/remove-service-accounts.html
fetched_at: 2026-09-16T09:48:00Z
source: palo-alto-main
---

# Remove a Service Account Through Common Services Clear
...
Updated on 
 ...
 Learn how to remove a Common Services service
account. 

 After you add
 service accounts , Common Services : Identity and Access enables you
 to remove service accounts . 

 Use one of the various ways to access 
 Common Services Identity & Access . 

 Select the tenant for which you want to remove a service
account. 

 Select the service accounts that you want to remove. 

 Remove Identity . 

 When prompted, Remove the service
account. 
