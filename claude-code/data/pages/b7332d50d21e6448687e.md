---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/json_extract_array
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The string that represents a JSON array. To convert a field to a JSON-formatted string, use the to_json_string() function. 
 ...
 The argument that identifies the data of the JSON object you want to extract using dot-notation. In regular syntax, the root is represented by $ . 
 ...
 Functions : to_json_string , arrayindex 
