---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/set-up-azure-ad-as-the-identity-provider-using-saml-2.0
fetched_at: 2026-09-16T09:13:41Z
source: cortex-platform
---

# Set up Azure AD as the Identity Provider Using SAML 2.0 | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Azure AD SAML authentication in Cortex XSOAR On-prem 8.6 (EoL). 
