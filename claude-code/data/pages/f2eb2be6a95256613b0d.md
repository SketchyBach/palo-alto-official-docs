---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-23.html
fetched_at: 2026-09-16T11:03:50Z
source: palo-alto-main
---

# High Availability Interface 1 Clear
...
Updated on 
 ...
 Collects configuration and usage information on the first interface used for the device's High Availability (HA) configuration. The data collected includes the interface's IP address, MAC address, and transmit and receive statistics. 
