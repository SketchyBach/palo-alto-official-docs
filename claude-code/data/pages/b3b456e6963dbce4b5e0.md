---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/users-and-roles-management/roles-management/role-permissions-by-component/investigation-and-response-permissions/automation-exclusion-center-permissions
fetched_at: 2026-09-16T08:50:48Z
source: cortex-platform
---

# Automation Exclusion Center permissions | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Automation Exclusion Center permissions for managing remediation exclusions, assets, policies, and automation controls. 
 ...
 Strongly recommended to understand which playbooks are impacted by exclusions. 

 Scripts 

 Enabled 

 Strongly recommended for Playbooks; exclusions may reference scripts. 

 Cases & Issues 

 View or View/Edit 

 Exclusions applied to cases (need context). View/Edit Recommended to trigger playbooks. Helps manage exclusions effectively. Strongly recommended. 

 Previous Playground permissions 
