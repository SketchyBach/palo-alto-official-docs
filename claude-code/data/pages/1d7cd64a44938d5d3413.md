---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/threat-management/threat-intel-management/indicator-investigation/extract-and-enrich-an-indicator
fetched_at: 2026-09-06T09:34:22Z
source: cortex-platform
---

# Extract and enrich an indicator | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Extract indicators from data and enrich them with context from supported integrations. 
