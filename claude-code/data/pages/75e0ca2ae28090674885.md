---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-51/vm-series-plugin-5-1-13/addressed-issues-in-vm-series-plugin-5-1-13.html
fetched_at: 2026-09-16T12:58:28Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 5.1.13 Clear
...
Updated on 
 ...
 The following list describes the issues fixed in the VM-Series plugin 5.1.13: 

 PLUG-23118 

 Resolved an issue with licenses following a vCPU upgrade for flex licenses on PA-VM in
 ESXI. 

 PLUG-22986 

 Resolved an issue where custom images experienced occasional bootstrap failures. 

 PLUG-22650 

 Following a temporary loss of connectivity, PA-VM firewalls in AWS were not populating
 custom metrics in AWS CloudWatch. This issue is now resolved. 

 PLUG-17437 

 Fixed an issue where the show plugins vm_series azure gwlb command
 displayed the internal VNI and internal port values in reverse. 
