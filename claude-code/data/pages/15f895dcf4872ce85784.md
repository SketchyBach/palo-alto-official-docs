---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/tagging-certificates/tagging-event-logs
fetched_at: 2026-09-16T07:25:30Z
source: palo-alto-main
---

# Viewing Tagging Event Logs Clear
...
Updated on 
 ...
 All tagging-related actions are recorded in the Next-Gen Trust Security event log. You can filter the event log to view specific tagging events. 

 For general information about using the event log, see the Next-Gen Trust Security event log documentation. 

 Tagging Events 

 Use the following event values when filtering the event log to view tagging activity. 

 Tagging event Add Criteria Event 

 New tag created Event Tags Created 

 Tag deleted from the system Event Tags Deleted 

 All tags cleared from a certificate Event Certificate All Tags Deleted 

 Tags replaced on a certificate Event Certificate Tags Replaced 

 Tag cleared from a certificate Event Certificate Tags Deleted 
 ...
 Tag added automatically during certificate renewal Event Tags Assignment on Renew 
