---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/threat-prevention/metric-dt-tp-1.html
fetched_at: 2026-09-16T11:04:36Z
source: palo-alto-main
---

# Unknown TCP or UDP Traffic Clear
...
Updated on 
 ...
 Identifies the percentage of the network traffic that is using TCP or UDP, and the responsible app is not recognized by the firewall. 
 ...
 This metric can be used by applications. This metric can be used by Palo Alto Networks to investigate future feature enhancements. 
 ...
 show session all filter application unknown-udp count yes show session all filter count yes show session all filter application unknown-tcp count yes
