---
url: https://docs.paloaltonetworks.com/sase/prisma-sase-multitenant-platform
fetched_at: 2026-08-13T17:34:32Z
source: palo-alto-main
---

# Strata Multitenant Cloud Manager Clear
...
Strata Multitenant Cloud Manager 
 ...
 Introducing Strata Multitenant Cloud Manager 

 The Strata Multitenant Cloud Manager (sometimes called Prisma SASE Multitenant Platform or Prisma SASE Multitenant Portal or Prisma SASE Portal) is a single location to access and manage aggregated Secure Access Service Edge (SASE) products and services. The key capabilities include: 

 Common Services 

 Common Services include license activation and subscription management, tenant management, and identity and access management. 

 Common Services 

 Strata Multitenant Cloud Manager 

 Provides aggregated views for monitoring information across all of your tenants. 

 Prisma SASE Portal 

 Open APIs 

 Use the Prisma SASE APIs for integration and automation. 
