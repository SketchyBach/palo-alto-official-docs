---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-201/known-issues-in-panorama-plugin-for-azure-201.html
fetched_at: 2026-09-16T12:59:38Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for Azure 2.0.x Clear
...
known issues in the Panorama plugin for Azure version 2.0.1, refer
...
not include special characters. 
 ...
 An empty space in a user-defined tag is replaced with
“/”, allowing the tag to be retrieved. 

 For example, if your
tag is finance and accounts , the tag can
be retrieved. 

 User-defined tags with special characters are ignored and
not retrieved. 

 For example, if your tag is finance&accounts ,
...
Ignoring... 
 ...
 This issue is fixed in the Panorama plugin for Azure, version
2.0.2. 
