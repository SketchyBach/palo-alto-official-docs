---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/ion-1200-s-hardware-reference/install-ion-1200-s/ion-1200-s-wall-mount-template.html
fetched_at: 2026-09-16T09:59:01Z
source: palo-alto-main
---

# ION 1200-S Wall Mount Template Clear
...
Updated on 
 ...
 Print the wall mount template and use it to mark the location on a wall. 

 Download and print the following wall
mount template to secure the template to the wall where you intend
to mount the ION 1200-S device and use it to mark the location for
