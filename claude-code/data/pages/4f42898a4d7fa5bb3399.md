---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/m-300-m-700-appliances-hardware-reference/m-300_m-700-overview.html
fetched_at: 2026-09-16T12:08:56Z
source: palo-alto-main
---

# M-300 and M-700 Appliance Overview Clear
...
Updated on 
 ...
 The Palo Alto Networks® M-300 and M-700 appliances are multi-function
appliances that you can configure to function in Panorama™ Management
mode, Panorama Management-only mode, Panorama Log Collector mode,
or PAN-DB Private Cloud mode ( M-700 only ). 

 First Supported Software Release: Panorama 10.2 

 The following topics describe the hardware features of the M-300
and M-700 appliances. 
