---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-301/addressed-issues-in-panorama-plugin-for-cisco-aci-301.html
fetched_at: 2026-09-16T13:00:20Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco ACI 3.0.1 Clear
...
Updated on 
 ...
 The following list describes addressed issues in the Panorama plugin for Cisco ACI
 3.0.1. 

 PLUG-14476 

 Fixed an issue that caused the Panorama plugin for Cisco ACI from retrieving IP address
 information because non-ASCII characters were used in container names. The Panorama
 plugin for Cisco ACI now correctly processes non-ASCII characters in APIC responses. 

 PLUG-14347 

 Fixed an issue that caused the Panorama plugin for Cisco ACI to incorrectly identify an
 HA state change in Panorama HA pair and believe that the active Panorama became the
 passive peer. 

 PLUG-14288 

 Fixed an issue that caused the Panorama plugin for Cisco ACI monitoring definition to
 fail after a Panorama upgrade or failover event. 

 PLUG-11822 

 Fixed an issue that the caused the Panorama plugin for Cisco ACI monitoring dashboard to
 display no monitoring information although monitoring information was seen when using
 the Panorama CLI. 
