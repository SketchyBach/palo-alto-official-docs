...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn about the Cortex Data Loss Prevention (DLP) module in Cortex XSIAM, which provides a solution to prevent sensitive data exfiltration. 
