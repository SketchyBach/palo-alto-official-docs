---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-your-azure-account/connect-azure-subscription
fetched_at: 2026-09-16T13:34:56Z
source: prisma-cloud
---

# Connect an Azure Subscription | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to Connect Azure Commercial Subscription , Connect Azure Government Subscription , or Connect Azure China Subscription on Prisma Cloud. Onboarding an Azure Subscription connects the resources within your Azure subscription to Prisma Cloud. 
 ...
 Agent-Based Workload Protection allows for automated deployment of Defenders to secure resources such as VMs , containers and Kubernetes orchestrators. Registry scanning, Kubernetes audits and other features required by defenders are also enabled. 
 ...
 Previous Connect an Azure Tenant 

 Next Connect a Microsoft Entra ID Tenant 
