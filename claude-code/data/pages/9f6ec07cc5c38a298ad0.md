---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-520/whats-new-in-panorama-plugin-for-azure-520.html
fetched_at: 2026-09-16T12:59:27Z
source: palo-alto-main
---

# What's New in the Panorama Plugin for Azure 5.2.0 Clear
...
Updated on 
 ...
 What's New in Azure 5.2.0 

 The Panorama plugin for Azure version 5.2.0 introduces an automated work flow for
 maintaining the life cycle of the VM auth key that is required for the new and
 autoscaled firewalls to connect to Panorama. 

 The Panorama plugin for Azure version 5.2.0 will automatically regenerate the VM Auth
 Key 7 days before the expiry date, and then the regenerated VM auth key will be
 communicated to the VM-Series firewall. You no longer have to manually regenerate
 the VM auth key after it expires. 
