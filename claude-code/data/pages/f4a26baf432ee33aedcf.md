...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest logs and data from Google Cloud Pub/Sub into Cortex XDR. 
 ...
 Raw or JSON data can be queried in XQL Search using the google_cloud_logging_raw dataset.Cortex XDR supports logs in single line format or multiline format. For a JSON format, multiline logs are collected automatically when the Log Format is configured as JSON. When configuring a Raw format, you must also define the Multiline Parsing Regex as explained below. 
 ...
 Previous Google Cloud Platform 
