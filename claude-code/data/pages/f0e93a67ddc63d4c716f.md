---
url: https://docs.prismacloud.io/content-collections/application-security/risk-management/monitor-and-manage-code-build/monitor-code-build-issues
fetched_at: 2026-09-16T13:35:44Z
source: prisma-cloud
---

# Monitor Code Build Issues | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Non-Default Branch Scan : Periodic scans performed across repositories on branches other than the default branch, as selected by the user. 

 VCS Pull Request scans : Event driven scans run on branches with open Pull Requests (PR) from your integrated repositories. 
 ...
 Resource Name and Path : Displays the resource name and the code path. If you choose to group issues by Policy then you will see the Policy and the Severity . 
 ...
 Each issue is accompanied by a specific label, providing clear categorization for better organization and understanding. 
 ...
 Package Name and Path : Displays the package name and the code path. If you choose to group issues by Policy then you will see the CVE , Severity and the path of the resource. 
 ...
 Secret Name and Path : Displays the repository name and the code path. If you choose to group issues by Policy then you will see the Secret type with Severity . 
 ...
 Key risk factors are assessed for secrets: 
 ...
 Package Name and Path : Displays the package name and the code path. If you choose to group issues by Policy then you will see the Policy with Severity . 
 ...
 Previous Monitor and Manage Code Build Issues 
