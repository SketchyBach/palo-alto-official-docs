---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-75.html
...
Updated on 
 ...
 Collects details on each of the drives installed in the device's RAID (if any). For each partition configured for the device, collects the status of each relevant disk drive, as well as its sync status. 
