---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/8-1/pan-os-release-notes/pan-os-8-1-addressed-issues/pan-os-8-1-17-addressed-issues.html
fetched_at: 2026-09-16T10:42:16Z
source: palo-alto-main
---

# PAN-OS 8.1.17 Addressed Issues Clear
...
Updated on 
 ...
 Fixed an issue where, on Panorama, context
...
configuration ( Device > Server Profiles > Netflow ). 
 ...
 Fixed an issue where FIB entries were removed
...
problems ingesting logs for older days received at a high rate. 
 ...
 Fixed an issue where the firewall unexpectedly
...
in group mappings caused a process ( useridd ) to exit. 
 ...
 Added an enhancement to reduce the memory
...
with Jumbo Frames enabled on the firewall. 
 ...
 Fixed a rare issue where a dataplane process
stopped responding. 

 PAN-100254 

 Fixed an issue where an incorrect subnet
...
privileges ( CVE-2021-3064 ). 
 ...
 Fixed an issue where Panorama did not set
