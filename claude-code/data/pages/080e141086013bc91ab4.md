...
# Prisma Agent 25.3.1 Known Issues Clear
...
Updated on 
 ...
 Review the known issues in Prisma Agent 25.3.1. 

 Prisma Agent version 25.3.1 has the following known issues: 
 ...
 An issue exists where the Prisma Agent app interface displays
 ...
 An issue exists where the Prisma Agent on Windows fails to
 ...
 An issue exists where the Prisma Agent on Windows blocks
 ...
 in through the Prisma Agent app does not resolve the
 ...
 back in using the Prisma Agent app, after which the agent
