---
url: https://docs.paloaltonetworks.com/strata-cloud-manager/new-features/by-date/strata-cloud-manager/september-2024#cce71921ae4e6cbfaa5553cf1756a6ed
fetched_at: 2026-09-16T07:51:26Z
source: strata-and-sase
---

# New Features - Strata Cloud Manager - September 2024 Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear
...
Focus 
 ...
 Depending on your license for Prisma Browser Standalone or Prisma Browser with Prisma Access Enterprise Bundle , the following new items are available in Strata Cloud Manager for visibility: 
 ...
 New Connect Method = Prisma Browser 

 To see user and device details 

 Insights Activity Insights Users details 
 Select a user to drill down into details to see the new widgets such as the Prisma Browser Event Summary. 

 Insights Activity Insights Applications 
 New column for count of PA Browser Events. 

 Select the number of events and it will redirect you to the Prisma Browser management pages . 
