---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/broker-vm-data-collector-applets/activate-transporter
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Transporter over Broker VM enables secure communication between Cortex Cloud and self-hosted integrations, such as Version Control Systems (VCS) and SonarQube Server. 

 Whether you need a Transporter depends on your domain's accessibility: 
 ...
 Public domains : A Transporter is not needed. Configure an egress rule instead 
 ...
 Set up and configure Broker VM : Set up and configure Broker VM 
 ...
 Next step : After activating the Transporter, proceed to configure the Transporter applet on your self-managed VCS data source instance. For more information, refer to Set up a Transporter on your VCS . 
 ...
 On the Transporter applet configurations page, click on the specific Transporter applet → Disable. This disables the specific integration, but it can be re-enabled. 
