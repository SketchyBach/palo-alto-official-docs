---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-6-known-and-addressed-issues/pan-os-11-2-6-addressed-issues
fetched_at: 2026-08-13T17:13:31Z
source: palo-alto-main
---

# PAN-OS 11.2.6 Addressed Issues Clear
...
PAN-OS 11.2.6 Addressed Issues 
 ...
 ( Firewalls in high availability (HA) configurations only ) Fixed an issue where the
 ...
 Fixed an issue where uploading files that were 5GB or larger to Google Drive or YouTube failed
 ...
 Fixed an issue on the firewall where enabling Inline Cloud Analysis features might cause the
 firewall to unexpectedly reboot, due to an issue related to loopback
 data handling. 
 ...
 ( VM-Series firewalls on AWS environments only ) Fixed an issue where a newly bootstrapped
