---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.11/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-script
fetched_at: 2026-09-16T08:54:46Z
source: cortex-platform
---

# Create a custom widget using a script | 8.11 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom script-based widgets in Cortex XSOAR 8.11 On-prem. 
 ...
 To add a timestamp or use a search query, add the following arguments to a script. 
