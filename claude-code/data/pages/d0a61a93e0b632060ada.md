---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/troubleshoot-prisma-agents/prisma-agent-and-agent-manager-logs/audit-prisma-agent-configuration-activities
