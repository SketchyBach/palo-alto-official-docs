---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/data-management/broker-vm/manage-broker-vm/add-broker-vm-to-cluster
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Right-click a standalone Broker VM, and select Add Broker to Cluster . 2. In the Select Cluster field, choose the cluster that you want this Broker VM to be added to. 

 Clusters tab 

 Right-click a cluster node, and select Add Broker to Cluster . 2. In the Select broker field, choose the standalone Broker VM that you want to add to this cluster. 
