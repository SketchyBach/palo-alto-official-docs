---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/onboard-and-configure-cortex-xdr/deployment-steps/step-1-activate-cortex-xdr
fetched_at: 2026-09-06T09:47:37Z
source: cortex-platform
---

# Step 1: Activate Cortex XDR | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 After the development tenant is activated, you can set up your remote repository. 
