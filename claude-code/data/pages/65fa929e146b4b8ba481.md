---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-script
fetched_at: 2026-09-16T09:14:41Z
source: cortex-platform
---

# Create a custom widget using a script | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create script-based widgets in Cortex XSOAR 8.6 (EoL) On-prem. 
 ...
 dataType : Pivots to the relevant page, such as the Incidents page. 
