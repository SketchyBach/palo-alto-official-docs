---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/xdr-collectors/xdr-collector-profiles/add-an-xdr-collector-profile-for-windows/query-windows-event-log-records
fetched_at: 2026-09-06T10:01:23Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When the XDR Collector forwards Windows Event Log records to Cortex Cloud, the records are available in Cortex Query Language (XQL) through two datasets, depending on the event's source provider. Use the correct dataset and field for your query to ensure you find the expected data. 
