---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-1/pan-os-upgrade/upgrade-pan-os/upgrade-the-firewall-pan-os.html
fetched_at: 2026-09-16T10:00:05Z
source: palo-alto-main
---

# Upgrade the Firewall to PAN-OS 11.1 and Later Releases Clear
...
Updated on 
 ...
 Upgrade options for PAN-OS 11.1 and later releases. 

 How you upgrade to PAN-OS 11.1 and later releases depends on whether you have
 standalone firewalls or firewalls in a high availability (HA) configuration and, for
 either scenario, whether you use Panorama to manage your firewalls. Review the PAN-OS 11.1 Release Notes and then follow the
 procedure specific to your deployment: 
