---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/7.9-ce/cortex-xdr-agent-7.9-for-linux/install-the-cortex-xdr-agent-for-linux
fetched_at: 2026-09-06T10:20:30Z
source: cortex-platform
---

# Install the Cortex XDR Agent for Linux | 7.9 CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Download the Cortex XDR Public Keys. 2. Unzip the public keys by running unzip cortex-xdr-agent-keys.zip . 3. Import the public keys by running rpm --import cortex-xdr-agent1.asc cortex-xdr-agent2.asc 2. Depending on your Linux distribution, install the Cortex XDR agent using one of the following commands: 
