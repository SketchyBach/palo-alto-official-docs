---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-20/vm-series-plugin-207/whats-new-in-vm-series-plugin-207.html
fetched_at: 2026-09-16T12:59:14Z
source: palo-alto-main
---

# What’s New in VM-Series Plugin 2.0.7 Clear
...
Updated on 
 ...
 This release addresses know issues and
introduces support for management interface swap on the VM-Series
firewall for VMware ESXi and KVM. 

 Management Interface Swap on VM-Series on ESXi and KVM 

 By default, the VM-Series firewall assigns ethernet0
as the management interface. If your deployment requires that you must
send dataplane traffic to ethernet0, you can assign ethernet1 as
the management interface using the VM-Series CLI by executing the
command set system setting mgmt-interface-swap enable yes .
Additionally, you can include this as part of a bootstrap init-cfg.txt
file using op-command-modes=mgmt-interface-swap . 
