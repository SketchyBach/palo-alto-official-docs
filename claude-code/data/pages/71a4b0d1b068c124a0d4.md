---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-panorama-api/pan-os-xml-api-request-types/export-files-api/export-certificates-and-keys.html
fetched_at: 2026-09-16T09:36:03Z
...
XML API Request Types 
 ...
 Use the following procedure to export certificates and
keys. 

 To export certificates and keys, specify query parameters certificate-name , format ,
and passphrase : 
