---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/parse_timestamp
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A format string that defines the layout of the input timestamp string (for example, %Y-%m-%d %H:%M:%S ). 
 ...
 An optional time zone specified as an hours offset (for example, +08:00 ) or a time zone name (for example, America/Chicago ). If omitted, the default is UTC. 
 ...
 Functions : to_timestamp , format_string 
