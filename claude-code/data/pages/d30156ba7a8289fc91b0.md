---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/engines/configure-engines
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Cortex XDR engines by editing the d1.conf file or modifying the configuration in the UI (for shell installations). 
 ...
 Modify the file as required. See Common properties when editing an engine configuration below. 

 You can also configure the engine to use a web proxy . 

 Modify the configuration in Cortex XDR (Shell installations only) 
 ...
 In the JSON formatted configuration dialog box, modify the properties as required. For more information, see Common properties when editing an engine configuration below. 

 edit_engine_config.png 

 Common properties when editing an engine configuration 

 The following table describes the common properties when editing an engine configuration using the d1.conf file (located by default at /usr/local/demisto/ ) or in the JSON formatted configuration dialog box in Cortex XDR. 
