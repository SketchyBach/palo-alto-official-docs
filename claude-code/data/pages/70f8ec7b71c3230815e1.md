---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/learn-about-cortex-xsoar/get-started-in-cortex-xsoar/use-the-command-line-interface
fetched_at: 2026-09-06T10:46:34Z
source: cortex-platform
---

# Use the Command Line Interface | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run system and integration commands from the CLI in Cortex XSOAR 6.12. 
