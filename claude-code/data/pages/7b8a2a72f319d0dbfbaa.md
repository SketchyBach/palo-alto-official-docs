---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-panorama-api/pan-os-xml-api-use-cases/query-a-firewall-from-panorama-api.html
fetched_at: 2026-09-16T09:33:46Z
...
language of your choice to store firewall serial numbers and use them
to issue a query to several firewalls. 
...
the API to learn how to construct XML requests. 
 ...
 curl -X POST 'https://panorama/api?key=<key>&type=op&cmd=<show><devices><all></all></devices></show>" 

 If you want to get a list of connected firewalls only,
use 

 curl -X POST 'https://panorama/api?key=<key>&type=op&cmd=<show><devices><connected></connected></devices></show>" 
...
looks like this: 
 ...
 curl -X POST 'https://firewall/api?key=<key>&type=op&cmd=<show><system><info></info></system></show>" 

 To directly target a firewall through Panorama,
append the firewall serial number to the request: 

 curl -X POST 'https://panorama/api?key=<key>&type=op&cmd=<show><system><info></info></system></show>&target=<device-serial-number>" 
