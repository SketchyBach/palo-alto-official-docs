---
url: https://cortex-docs.paloaltonetworks.com/application-security/application-security/onboard-data-sources/integrate-ci-tools/jenkins-for-code-scans/reference-a-jenkins-code-scan-workflow-template-without-checkout
fetched_at: 2026-09-16T08:48:56Z
source: cortex-platform
---

# Reference A: Jenkins code scan workflow template without checkout | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center shield-alt shield-alt
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Reference A: Jenkins code scan workflow template without checkout 

 Configure a Jenkins code scan workflow without repository checkout. 

 This Jenkins workflow automates code scanning using the Cortex CLI. It does not include a repository checkout step. Replace placeholder values and generic terms, such as dev , before use. 
 ...
 Previous Jenkins for code scans 

 Next Reference B: Jenkins code scan workflow template with checkout 
