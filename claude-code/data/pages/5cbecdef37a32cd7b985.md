---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/cluster-context
fetched_at: 2026-09-16T13:35:12Z
source: prisma-cloud
---

# Cluster Context | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For Azure AKS, cluster name detection is not supported for clusters deployed within custom resource groups. As a fallback use the server extracted from the kubeconfig. 
