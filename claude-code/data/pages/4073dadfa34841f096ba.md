---
url: https://cortex-docs.paloaltonetworks.com/agentix-api/cortex-platform-iam/user
fetched_at: 2026-09-06T10:56:28Z
source: cortex-platform
---

# User | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 get https://api-{{fqdn}} /platform/iam/v1/user 
 ...
 get https://api-{{fqdn}} /platform/iam/v1/user/ {user_email} 
 ...
 patch https://api-{{fqdn}} /platform/iam/v1/user/ {user_email} 
