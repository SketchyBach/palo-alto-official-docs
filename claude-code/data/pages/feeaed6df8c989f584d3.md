---
url: https://docs.paloaltonetworks.com/prisma-sd-wan/ion-cli-reference/get-started-with-the-ion-cli
fetched_at: 2026-08-13T17:29:37Z
source: palo-alto-main
---

# Get Started with the ION Device CLI Clear
...
Get Started with the ION Device CLI 
 ...
 To use CLI commands, user roles must be enabled. 

 The Prisma SD-WAN ION device CLI provides
a debugging interface to perform advanced troubleshooting of the
ION devices independent of the console. 
