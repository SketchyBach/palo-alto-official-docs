---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-6-1-x/vm-series-plugin-6-1-0.html
fetched_at: 2026-09-16T12:58:30Z
source: palo-alto-main
---

# VM-Series Plugin 6.1.0 Clear
...
Updated on 
 ...
 The VM-Series plugin 6.1.0 includes new fixes to improve your experience with
 the VM-Series firewall. The VM-Series plugin 6.1.0 version is packaged with PAN-OS
 version 12.1.2. 

 Beginning with PAN-OS 12.1.2, you no longer have to manually
 find and download a compatible VM-Series plugin version before installing it. Compatible
 plugins are now automatically downloaded with the Panorama image, and you can directly
 install the one you need. For more information, see Panorama Plugins . 
