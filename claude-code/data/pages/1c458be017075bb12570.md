---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/c-validating-certificates/t-validating-certs-viewing-status
fetched_at: 2026-09-16T07:25:29Z
source: palo-alto-main
---

# Viewing Certificate Validation Status Clear
...
Updated on 
 ...
 The TLS Server Endpoints page in Next-Gen Trust Security shows the current validation status for each certificate. 

 Sign in to Next-Gen Trust Security. 

 Click Insights > Certificate Inventory > TLS Server Endpoints . 

 The TLS server endpoints table includes a TLS Validation column and a Chain Validation column that display the validation status for each certificate. 

 To search for a specific certificate, enter certificate details in the search bar. 

 To filter the list, click Filter next to the search bar. In the TLS Validation and Chain Validation fields, select the states to include, then click Apply . 
