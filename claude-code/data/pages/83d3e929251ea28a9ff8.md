---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/endpoint-security/endpoint-dlp/configure-dlp-end-to-end
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Predefined applications are indicated by Created by: Palo Alto Networks in the All Applications table. For predefined applications, you do not see details such as URLS/Domains , Process names , Signers . You cannot edit or delete these applications. 
 ...
 Next DLP status in all endpoints 
