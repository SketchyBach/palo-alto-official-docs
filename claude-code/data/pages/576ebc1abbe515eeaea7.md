...
Google Kubernetes Engine | Cortex Documentation Portal 
 ...
 Forward container logs from Google Kubernetes Engine using Elasticsearch Filebeat to Cortex XSIAM using the Custom - Filebeat based Collector data source. 
 ...
 Previous Ingest logs and data from a GCP Pub/Sub Next Ingest logs from Google Kubernetes Engine 
