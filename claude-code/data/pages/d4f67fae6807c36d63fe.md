---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/troubleshoot-and-reference/troubleshoot/management-audit-logs
fetched_at: 2026-09-16T08:54:19Z
source: cortex-platform
---

# Management audit logs | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, view, export, extract, and purge management audit logs. 
 ...
 To export the management audit logs as a tsv text-based file, click the Export to file button. You can also forward management audit notifications to a syslog server. 
 ...
 Includes list subtypes such as add, edit, copy, and delete. 

 Playbook 

 Includes playbook subtypes such as add, edit, upload, and delete. 
