---
url: https://docs.paloaltonetworks.com/ngfw/help/10-1/objects/objects-security-profiles-wildfire-analysis
...
(for example, a URL category defined in the policy). 
 ...
 Use the predefined default profile to forward all unknown files to
WildFire for analysis. In addition, set up WildFire appliance content updates to
