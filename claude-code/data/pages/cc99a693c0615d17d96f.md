---
url: https://cortex-docs.paloaltonetworks.com/application-security/code-security/application-security-scans-management/manage-scans-through-the-tenant-ui/monitor-data-source-instances-health/how-to-view-an-instance-health
fetched_at: 2026-09-16T08:49:30Z
source: cortex-platform
---

# How to view an instance health | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center shield-alt
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Monitor data source instances health 

 Next Manage scans through public APIs 
