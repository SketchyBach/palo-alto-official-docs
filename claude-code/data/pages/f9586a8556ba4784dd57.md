---
url: https://docs.paloaltonetworks.com/ngfw/help/11-2/policies/policies-authentication/building-blocks-of-an-authentication-policy-rule
...
the policy rule. You can export the Audit Comment Archive in CSV format. 
 ...
 Bypass Web Proxy Authentication traffic. 

 If you select this option, you must select an address object that contains the source IP addresses
