---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-clustering/panorama-clustering-plugin/whats-new-in-panorama-clustering-plugin-100.html
fetched_at: 2026-09-16T13:01:38Z
source: palo-alto-main
---

# What’s New in Panorama Clustering Plugin 1.0.0 Clear
...
Updated on 
 ...
 The Clustering plugin 1.0.0 on Panorama provides the visibility to the Hyper
 Scale Security Fabric (HSF) clusters in CN-Series. This plugin is responssible for
 aggregating and presenting the data for clustering related visibility. 

 The Firewall Clusters tab displays Summary View and Monitoring 
 information of the HSF clusters in CN-Series. 

 You must install the Clustering 1.0.0 plugin on Panorama from Device >
 Plugins to view the CN-Series HSF cluster details under the Firewall
 Clusters tab. 
