...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review management audit log types and messages generated by Cortex XDR. 

 Cortex XDR management audit log messages are sent based on the various log types, for example, Action Center, Issue Rules, or Authentication. 
