---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/min_with_comp_stage
fetched_at: 2026-09-16T09:04:58Z
source: cortex-platform
---

# min (comp) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field from which to find the minimum value. 
 ...
 An alias for the output field. If not specified, the output field name defaults to min_<field> . 
 ...
 Functions : max() , min (windowcomp) , least() 

 Datasets : xdr_data 

 Previous median (windowcomp) 
