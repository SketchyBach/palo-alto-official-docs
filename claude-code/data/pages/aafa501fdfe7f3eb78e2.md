---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/saas-security/saas-security/saas-ai-agent-security
fetched_at: 2026-09-06T10:07:37Z
source: cortex-platform
---

# SaaS AI Agent Security | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use SaaS AI Agent Security in Cortex Cloud Posture Management to secure enterprise SaaS AI agents. 
 ...
 Previous Create and monitor tickets 

 Next Setup SaaS Security for AISPM 
