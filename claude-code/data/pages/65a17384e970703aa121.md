---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/onboard-cortex-xsoar/docker/configure-python-docker-integrations-to-trust-custom-certificates
fetched_at: 2026-09-06T10:39:53Z
source: cortex-platform
---

# Configure Python Docker Integrations to Trust Custom Certificates | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Cortex XSOAR 6.14 Python Docker integrations to trust CA-signed and custom certificates. 
