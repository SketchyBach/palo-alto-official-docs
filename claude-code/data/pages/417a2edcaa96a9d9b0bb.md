---
url: https://docs.prismacloud.io/admin-guide/vulnerability-management/registry-scanning/scan-docker-registry-v2
fetched_at: 2026-09-16T13:36:23Z
source: prisma-cloud
---

# Docker Registry v2 (including Docker Hub) | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Repository name , enter the name of the repo to scan. For example, enter library/alpine to scan the official Alpine image. If the repo is part of an organization, use the organization/repository format. For example, bitnami/nginx . 
 ...
 Previous Azure Container Registry 

 Next Scan Images in GitLab Container Registry 
