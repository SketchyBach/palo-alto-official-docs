---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-51
fetched_at: 2026-09-16T07:45:16Z
source: palo-alto-main
---

# VM-Series Plugin 5.1.x Clear
...
Updated on 
 ...
 Learn about the new features and fixes in the VM-Series plugin 5.1.x. 

 Review important information related to each release in version 5.1.x of the
 VM-Series plugin, which enables integration with different public and private cloud
 environments. 
 ...
 The VM-Series plugin version 5.1.8 was not released publicly. This version
 primarily incorporated internal bug fixes and did not introduce new features or
 resolve issues that would impact the VM-Series platform or its users. 
