---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-new-features/sd-wan-features.html
...
Updated on 
 ...
 ( PAN-OS 10.0.3 and later PAN-OS 10.0 releases ) SD-WAN Remove Private AS 

 ( PAN-OS 10.0.3 and later PAN-OS 10.0 releases ) SD-WAN Full Mesh VPN Cluster with DDNS Service 

 ( PAN-OS 10.0.3 and later PAN-OS 10.0 releases ) SD-WAN DIA AnyPath 

 ( PAN-OS 10.0.2 and later PAN-OS 10.0 releases ) SaaS Application Path Monitoring 

 ( PAN-OS 10.0.2 and later PAN-OS 10.0 releases ) SD-WAN Forward Error Correction 

 ( PAN-OS 10.0.2 and later PAN-OS 10.0 releases ) SD-WAN Packet Duplication 
