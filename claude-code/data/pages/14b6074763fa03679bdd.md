---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/learn-about-cortex-xsoar/get-started-with-cortex-xsoar/cortex-xsoar-use-cases
fetched_at: 2026-09-06T11:23:39Z
source: cortex-platform
---

# Cortex XSOAR use cases | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Explore SOC automation use cases in Cortex XSOAR On-prem 8.6 (EoL). 
