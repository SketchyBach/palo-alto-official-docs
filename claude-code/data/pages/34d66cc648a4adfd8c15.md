---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-201/addressed-issues-in-panorama-plugin-for-cisco-aci-201.html
fetched_at: 2026-09-16T13:00:21Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco ACI 2.0.1 Clear
...
issues in the Panorama plugin for Cisco ACI 2.0.1. 

 PLUG-6753 

 Fixed an issue that prevented the Panorama
from retrieving EPG tags when multiple APICs are deployed in an
ACI fabric. 

 PLUG-6564 

 Fixed an issue that caused the Panorama
plugin for Cisco ACI to retrieve are partial list of IP addresses
from the APIC. 

 PLUG-5962 

 Fixed an issue that prevented Panorama
plugin for Cisco ACI from retrieving tags from the APIC and returning
the error message State of ACI fabric is currently changing,
enable to retrieve tags. Will try again next iteration . 

 PLUG-5880 

 Fixed an issue where the Panorama plugin
for Cisco ACI is unable to retrieve tags from the APIC in a highly
dynamic ACI deployment. 

 PLUG-3444 

 Fixed an issue where the Panorama plugin
for Cisco ACI status showed failed in large-scale dynamic environments
(20,000 or more endpoints). 
