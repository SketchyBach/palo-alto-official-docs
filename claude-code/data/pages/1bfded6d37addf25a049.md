---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-521
fetched_at: 2026-09-16T07:42:35Z
source: palo-alto-main
---

# Panorama Plugin for AWS 5.2.1 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 5.2.1 introduces new features for Panorama
 integration with Cloud NGFW for AWS. 

 The Panorama plugin for AWS version 5.2.1 addresses known issues. 

 You can download the AWS plugin for Panorama from the Customer
 Support Portal or directly from Panorama Plugins . Panorama can push the virtual machine attributes that it retrieves to
 firewalls running the versions detailed in the plugin Compatibility Matrix for public clouds . 
