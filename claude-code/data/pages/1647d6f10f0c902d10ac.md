---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/storage/appsec-aws-143
fetched_at: 2026-09-16T09:10:17Z
source: cortex-platform
---

# S3 bucket lock configuration disabled misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Arguments: object_lock_enabled [source,go] 
 ...
 Previous AWS Redshift Cluster not encrypted using Customer Managed Key misconfiguration detected in code 

 Next S3 bucket cross-region replication disabled misconfiguration detected in code 
