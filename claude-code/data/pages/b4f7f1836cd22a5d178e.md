---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/multi-tenant/multi-tenant/onboard-cortex-xsoar-multi-tenant/step-3.-set-up-an-engine
fetched_at: 2026-09-06T10:39:03Z
source: cortex-platform
---

# Step 3. Set up an engine | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up engines in Cortex XSOAR 8.9 On-prem multi-tenant deployments. 
