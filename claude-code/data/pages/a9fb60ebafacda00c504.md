---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-51/vm-series-plugin-516/addressed-issues-in-vm-series-plugin-5-1-6.html
fetched_at: 2026-09-16T12:58:33Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 5.1.6 Clear
...
Updated on 
 ...
 The following list describes the issues fixed in the VM-Series plugin
 5.1.6. 

 PLUG-17319 

 Fixed an issue where the VM-Series firewall in AWS failed to connect to the Redis
 endpoint when the Redis certificate was not provided during the bootstrap. 

 PLUG-16987 

 Fixed an issue where the device certificate was not fetched during the bootstrap on KVM
 environment with Block Storage device. 

 PLUG-18512 

 Fixed an issue where the Secondary IP failed to detach during HA Failover in certain
 Azure environments. The issue is fixed by serializing the Azure API calls. 
