---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-gcp/flow-logs-compression
fetched_at: 2026-09-16T13:34:59Z
source: prisma-cloud
---

# Flow Logs Compression on GCP | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Attach service accounts to Dataflow resources — userinput:[iam.serviceAccounts.actAs] permission 
 ...
 For details on enabling the APIs, see Service Account Permissions and GCP APIs . 
 ...
 Previous Onboard Your Google Workspace 

 Next Enable Flow Logs for GCP Organization 
