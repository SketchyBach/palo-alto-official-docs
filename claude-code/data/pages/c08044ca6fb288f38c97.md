---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-1/pan-os-upgrade/upgrade-the-vm-series-firewall/upgrade-the-vm-series-pan-os-software-using-panorama.html
...
when upgrading Panorama to 9.1. This release includes significant infrastructure
changes, which means that the Panorama upgrade will take longer
...
click Export Panorama and devices config bundle to
generate and export the latest configuration backup of Panorama
