---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/compatibility-matrix/reference/globalprotect/what-features-does-globalprotect-support.html
...
app versions, see Where Can I Install the GlobalProtect App? . 
 ...
 Profile 6.3.3 or later versions — — — — — — 
 ...
 Connect with IPSec Only 6.3.3 or later versions — — — — — — 

 Notification for SSL Fallback 6.3.3 or later versions — — — — — — 
 ...
 Korean Language Support 6.3.3 or later versions — — — — — — 
 ...
 Intelligent Portal 6.3.3 or later versions 6.3 ( Pre-logon (Always On) 
 connect method only ) 
