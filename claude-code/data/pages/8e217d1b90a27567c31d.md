---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/onboard-cortex-xsoar/cortex-xsoar-installation/troubleshoot-your-installation/shut-down-cortex-xsoar
fetched_at: 2026-09-06T10:35:00Z
source: cortex-platform
---

# Shut down Cortex XSOAR | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Shut down Cortex XSOAR 8.10 On-prem from the textual UI. 
 ...
 Do not reboot Cortex XSOAR or do a hard shutdown if it is not working properly. Instead, download a log bundle and perform a graceful shutdown from the textual UI menu. Open a support session for assistance. 
