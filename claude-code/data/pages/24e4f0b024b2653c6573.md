---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/network-queries/network-config-queries
fetched_at: 2026-09-16T13:35:11Z
source: prisma-cloud
---

# Network Configuration Queries | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Network Queries 

 Next Network Flow Queries 
