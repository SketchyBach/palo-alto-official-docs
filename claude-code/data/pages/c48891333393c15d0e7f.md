---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine
fetched_at: 2026-09-16T07:25:12Z
source: palo-alto-main
---

# Create a New Machine Clear
...
Updated on 
 ...
 Creating a machine allows Next-Gen Trust Security to connect directly to application keystores where certificates are installed. After a machine is created, you can provision certificates and manage machine identities throughout their lifecycle. 
 ...
 Click New , then select the machine type you want to create. 

 Enter a Name for the new machine. 

 Continue setup by selecting the appropriate machine type below and following the machine-specific configuration steps. 
 ...
 Select the certificate store where certificates should be discovered. 

 Enable Exclude expired certificates to omit expired certificates from discovery results. 

 Enable Exclude inactive certificates to omit inactive certificates from discovery results. 

 Enable the Schedule toggle to configure discovery scheduling. 

 Under Repeat every , select Daily , Weekly , or Monthly , and choose a time. 

 Note: The schedule toggle must be enabled to configure discovery timing. 
 ...
 Enable the Schedule toggle to configure certificate provisioning. 

 Under Repeat every , select Daily , Weekly , or Monthly , and choose a time. 

 Note: The schedule toggle must be enabled to configure provisioning timing. 
