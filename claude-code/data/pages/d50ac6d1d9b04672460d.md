---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/amazon/amazon-s3/ingest-network-flow-logs-from-amazon-s3
fetched_at: 2026-09-06T09:59:35Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collect network flow logs from Amazon S3 in Cortex Cloud. 
 ...
 Upload a template file: Choose file, and select the cortex-xdr-create-s3-with-sqs-flow-logs.json file that you downloaded from Cortex Cloud. 
 ...
 You can Normalize and enrich flow logs by selecting the checkbox. If selected, Cortex Cloud ingests the network flow logs as network connection stories, which you can query using XQL Search from the xdr_data dataset using the preset called network_story . 
