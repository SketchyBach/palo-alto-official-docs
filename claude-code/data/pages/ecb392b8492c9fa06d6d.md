---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-ips-signature-converter/ips-signature-converter-plugin-for-panorama-100.html
fetched_at: 2026-09-16T13:01:31Z
source: palo-alto-main
---

# Panorama IPS Signature Converter Plugin 1.0.0 Clear
...
Updated on 
 ...
 The IPS Signature Converter for Panorama™ enables you
to convert third-party IPS rules into custom Palo Alto Networks
threat signatures. 
...
enforce policy on the entries contained in the list. 
 ...
 You can download the IPS Signature Converter plugin for Panorama™ 10.0
or later releases from the Customer Support Portal or directly from Panorama Plugins .
Panorama can push the signatures that it converts to firewalls running a PAN-OS ® 10.0 or later release. 
