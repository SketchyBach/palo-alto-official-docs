---
url: https://docs.paloaltonetworks.com/saas-security/sspm/onboard-saas-apps-supported-by-sspm/onboard-a-codeium-app-to-sspm
fetched_at: 2026-08-13T17:34:06Z
source: palo-alto-main
---

# Onboard a Codeium App to SSPM Clear
...
Onboard a Codeium App to SSPM 
 ...
 Learn how you can manually provide SSPM with the configuration values for a Codeium
 instance. 
 ...
 The onboarding process for Codeium is different from most applications,
 because SSPM does not support scans for Codeium. During the onboarding process for
 ...
 Although SSPM does not support scans for Codeium, you can still onboard a Codeium
 application to SSPM. However, when you onboard a Codeium application to SSPM, you
 don’t supply SSPM with any authentication credentials. SSPM does not establish a
 connection to your Codeium instance and does not run scans to determine the Codeium
 settings. Instead, you will manually enter your Codeium instance's settings, which
 ...
 Codeium instance, but this tile is isolated to SSPM. SSPM will show rule violations
 for the Codeium instance, but SSPM determines the violations based entirely on the
 ...
 To onboard a Codeium instance, you complete the following steps: 

 Log in to the Codeium as an administrator. 
 ...
 Select Configuration SaaS Security Posture Security Applications Add Application and click the Codeium tile. 

 On the Posture Security tab, Add New instance. 

 SSPM displays the onboarding page, which lists the Codeium configuration
 settings and our recommended configuration values. 

 From your Codeium instance, identify the configuration values, and provide
 these configuration values to SSPM. 

 To avoid triggering rule violations in SSPM, you can update the values in
 Codeium to match our recommended values. 
 ...
 SSPM adds a tile on the Applications page to represent your Codeium instance.
 Based on the values that you entered, SSPM will determine if your Codeium
 instance has any rule violations. 

 Because SSPM is not scanning your Codeium instance, you must ensure that the
 information that SSPM has about your Codeium instance remains accurate. If
 you change a setting value in Codeium, manually update that value in SSPM.
 To do this, complete the following steps: 

 Navigate to the Applications page ( SSPM Applications ). 

 Locate the Codeium instance's tile and View
 Details . 
