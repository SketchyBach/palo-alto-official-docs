---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-zero-touch-provisioning/panorama-plugin-for-zero-touch-provisioning-20/features-introduced-in-zero-touch-provisioning-20.html
fetched_at: 2026-09-16T13:00:52Z
source: palo-alto-main
---

# Features Introduced in Zero Touch Provisioning 2.0 Clear
...
Updated on 
 ...
 New features introduced in Zero Touch Provisioning 2.0. 

 Here's what's new in Zero Touch Provisioning (ZTP) plugin
2.0. 

 What's
 New in Zero Touch Provisioning Plugin 2.0.6 

 What's New in Zero Touch Provisioning Plugin 2.0.4 

 What's New in Zero Touch Provisioning
 Plugin 2.0.3 

 What’s New in Zero Touch Provisioning Plugin 2.0.2 

 What's New in Zero Touch Provisioning Plugin 2.0.1 

 What's New in Zero Touch Provisioning Plugin 2.0.0 

 What's New in Zero Touch Provisioning Plugin 2.0.6 

 The Zero Touch Provisioning (ZTP) plugin 2.0.6 release includes minor bug and
 performance fixes. 

 What's New in Zero Touch Provisioning Plugin 2.0.4 

 The Zero Touch Provisioning (ZTP) plugin 2.0.4 release includes minor bug and
 performance fixes. 

 What's New in Zero Touch Provisioning Plugin 2.0.3 

 The Zero Touch Provisioning (ZTP) plugin 2.0.3 release includes minor bug and
 performance fixes. 

 What’s
New in Zero Touch Provisioning Plugin 2.0.2 

 The Zero Touch Provisioning (ZTP) plugin 2.0.2 release
includes minor bug and performance fixes. 

 What's New in Zero Touch Provisioning Plugin 2.0.1 

 The Zero Touch Provisioning (ZTP) plugin 2.0.1 release
includes minor bug and performance fixes. 
 ...
 Zero Touch Provisioning Plugin Upgrade 

 Upgrade to the Zero Touch Provisioning (ZTP)
plugin to increase reliability. ZTP Plugin 2.0 is required to upgrade
to PAN-OS 10.2 and is only supported on PAN-OS 10.2 and later releases. 
