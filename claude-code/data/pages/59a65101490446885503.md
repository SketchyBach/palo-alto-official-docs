---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/all-cloud-assets/discovery-engine
fetched_at: 2026-09-06T09:43:12Z
source: cortex-platform
---

# Discovery Engine | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Event Assisted Ingestion (EAI): Using the collection of audit logs (whether enabled as part of the onboarding process or collected separately using a data collector), Cortex XDR analyzes the audit logs and identifies specific events or changes to certain asset types. If a change is identified, it triggers the Discovery Engine to scan that specific resource. This enables near-real-time discovery for specific assets, including VMs and data assets across AWS and GCP. 
 ...
 Infrastructure: The Discovery Engine always performs its functionality from the Cortex XDR tenant, regardless of whether you selected Cloud Scan or Scan with Outpost in the onboarding wizard. 
