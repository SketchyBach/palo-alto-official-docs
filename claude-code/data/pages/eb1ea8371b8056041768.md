---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/application-asset-queries/application-asset-examples
fetched_at: 2026-09-16T13:35:10Z
source: prisma-cloud
---

# Application Asset Query Examples | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Application Asset Queries 

 Next Vulnerability Queries 
