---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-67.html
fetched_at: 2026-09-16T11:04:21Z
source: palo-alto-main
---

# NAT Configuration Clear
...
Updated on 
 ...
 Collects Network Address Translation (NAT) configuration information, such as how many NAT rules are configured for the device, the hit count for each such rule, and the NAT types in use. If Destination NAT is in use, indicates whether dynamic IP is being used. 
