---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-5400-hardware-reference/PA-5400-series-firewall-installation/install-the-mandatory-pa-5400-series-firewall-front-slot-cards.html
fetched_at: 2026-09-16T11:50:53Z
...
to the PA-5400 Series firewall. 
 ...
 The PA-5450 firewalls require a minimum of three cards that you install in the front slots of the
 appliance. These cards are shipped separately from the firewall and include the
 following: The Management Processor Card (MPC) provides management connectivity to the
 appliance and HA connectivity; the Networking Card (NC) enables the firewall to process
 network traffic; and the Data Processor Card (DPC) handles data-plane processing. 
