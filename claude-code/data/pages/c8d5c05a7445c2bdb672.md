---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/interconnects/manage-interconnects.html
fetched_at: 2026-09-16T09:55:16Z
source: palo-alto-main
---

# Manage Service Provider Interconnects Clear
...
Updated on 
 ...
 This section provides guidance on configuring and managing interconnects within the
 service provider environment. It covers how to set up the egress path, configure both
 per-tenant and shared interconnects, and outlines the workflow needed to ensure proper
 connectivity and traffic routing. This section also explains where to view all
 configured interconnects along with their associated details, helping service providers
 monitor, validate, and maintain their interconnect deployments effectively. 
