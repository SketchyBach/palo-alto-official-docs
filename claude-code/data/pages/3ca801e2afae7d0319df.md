---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/onboard-cortex-xsoar/cortex-xsoar-installation/install-cortex-xsoar-on-a-vm-deployed-on-oci
fetched_at: 2026-09-16T09:14:04Z
source: cortex-platform
---

# Install Cortex XSOAR on a VM deployed on OCI | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install Cortex XSOAR On-prem 8.7 (EoL) on an OCI VM. 
 ...
 For first time login, open an external terminal and use the ssh admin<server ip address> command to SSH log in. The default user name and password is admin . 
 ...
 The IPs of all VMs and the virtual IP must use the same subnet. 

 You can only change these values before installation. To change them later, redeploy and reinstall the cluster. Contact Support or Engineering for assistance. 
