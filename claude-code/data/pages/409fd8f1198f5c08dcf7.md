---
url: https://docs.paloaltonetworks.com/oss-listings/pan-os-oss-listings/pan-os-8-0-open-source-software-oss-listing
fetched_at: 2026-08-13T16:58:08Z
source: palo-alto-main
---

# PAN-OS 8.0 OSS Listing Clear
...
PAN-OS 8.0 OSS Listing 
 ...
 Open-Source Software (OSS) licensing for the PAN-OS ® 8.0
software release. 
...
and relay agent 
 ...
 Creating a simple library to support the
...
Java and other languages 
 ...
 A bundle of low-level system libraries in
C language 
...
tools 
 ...
 Downward compatible, touchable, jQuery dial 
 ...
 A jQuery plugin that adds cross-browser
mouse wheel support 
 ...
 A curated set of user interface interactions, effects,
...
files 
 ...
 Shared library linkage, Standalone apps/libraries 

 1 

 Commercial 

 Client software for SafeNet Luna SA hardware security
module (HSM) 
...
Time Protocol (NTP) 
 ...
 Open Virtual Machine Tools for virtual machines hosted
on VMware 
...
language 
 ...
 A simple, lightweight interface to Amazon
Web Services (AWS) 
...
Linux sysfs virtual file system 
 ...
 Simple kernel loader which boots from a
FAT file system 
 ...
 The server for Trivial FTP (TFTP) 
...
HTTP or FTP protocols 
 ...
 A binary file delta generator and an RCS replacement
library 
 ...
 Virtual Machine Monitoring Scripts 
 ...
 Virtual Machine XenStore utilities 
