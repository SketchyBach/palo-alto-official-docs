---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/http-log-collector/set-up-an-http-log-collector-to-receive-logs
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collect HTTP log data in Cortex Cloud. 
 ...
 Create an HTTP Log collector in Cortex Cloud. 
 ...
 Send data to your Cortex Cloud HTTP log collector. 
 ...
 After Cortex Cloud begins receiving logs, use the XQL Search to search your logs. 
