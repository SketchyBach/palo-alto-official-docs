---
url: https://docs.prismacloud.io/content-collections/governance/manage-prisma-cloud-policies
fetched_at: 2026-09-16T13:35:01Z
source: prisma-cloud
---

# Manage Prisma Cloud Policies | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Filter combinations can also be saved as customizable Saved View . Learn more about how you can add new views and modify the existing views available to you. 
 ...
 Previous Create a Custom Policy on Prisma Cloud 

 Next Attack Path Policies 
