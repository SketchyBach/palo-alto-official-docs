---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/integrations/change-the-docker-image-in-an-integration-or-script/connect-your-engine-to-an-image-registry
fetched_at: 2026-09-16T09:14:35Z
source: cortex-platform
---

# Connect your engine to an image registry | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Connect an engine to an image registry in Cortex XSOAR On-prem 8.6 (EoL). 
