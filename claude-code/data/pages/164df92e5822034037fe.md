---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin/panorama-software-firewall-license-plugin-120/addressed-issues-in-the-panorama-software-firewall-license-plugin-120.html
fetched_at: 2026-09-16T13:01:28Z
source: palo-alto-main
---

# Addressed Issues in the Panorama Software Firewall License Plugin 1.2.0 Clear
...
Updated on 
 ...
 The following list describes addressed issues in the Panorama Software Firewall
 License plugin 1.2.0. 

 PLUG-19516 

 Fixed an issue where the Panorama Software Firewall License plugin would not de-activate
 the PA-VM after being disconnected for one hour. 

 PLUG-18642 

 Fixed an issue where Custom Admin users with relevant Role-Based Access Control
 (RBAC) permissions were unable to edit the Software Firewall License plugin. Custom
 Admin users can now view and edit the plugin as expected navigating to Software
 Firewall License > Bootstrap Definitions in Panorama. 

 PLUG-18166 

 Fixed an issue where connection status incorrectly showed as Connected 
 under SW Firewall License > License Managers > Show Devices in
 Panorama even though the device was disconnected. The correct status was previously
 visible only under Panorama > Managed Devices > Summary . The
 connection status now displays accurately in both locations. 
