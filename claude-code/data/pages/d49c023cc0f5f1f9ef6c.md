---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/audit-event-queries/audit-event-query-attributes
fetched_at: 2026-09-16T13:35:12Z
source: prisma-cloud
---

# Audit Event Query Attributes | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Audit Event Queries 

 Next Audit Event Query Examples 
