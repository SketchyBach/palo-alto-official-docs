---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-534/addressed-issues-in-panorama-plugin-for-aws-5-3-4
fetched_at: 2026-09-16T07:42:41Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 5.3.4 Clear
...
Updated on 
 ...
 Learn about fixed issues in the Panorama Plugin for AWS version 5.3.4. 

 The following are the fixed issues in the Panorama plugin for AWS 5.3.4: 

 PLUG-18650 

 Fixed an issue in previous releases where high numbers of tags associated with unused VPC
 IDs were pushed to the VPC monitoring table which caused the Panorama web interface to
 become unresponsive. 

 PLUG-18787 

 Fixed an issue where the Cloud NGFW failed to connect to the Panorama web interface when
 an endpoint connection could not be established. In such cases, a timeout occurred and a
 message appeared indicating that "The server is not responding. Please wait and try your
