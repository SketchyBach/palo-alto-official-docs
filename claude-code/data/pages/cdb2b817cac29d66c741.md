---
url: https://docs.paloaltonetworks.com/hardware/pa-7500-hardware-reference/pa-7500-series-firewall-led-definitions/interpret-the-pa-7500-series-firewall-interface-card-leds/pa-7500-series-firewall-npc-leds
fetched_at: 2026-08-13T16:35:31Z
source: palo-alto-main
---

# PA-7500 Series Firewall NPC LEDs Clear
...
PA-7500 Series Firewall NPC LEDs 
 ...
 Learn how to identify the LEDs on the Network Processing Card. 

 The following table describes how to interpret the status LEDs on a Network Processing
 Card (NPC). 
 ...
 The following table describes how to interpret the LEDs on the NPC ports. 

 LED Description 

 SFP, SFP+, and SFP28 

 The SFP, SFP+ and SFP28 ports have four LEDs each; the LED
 illuminated depends on the transceiver that is installed. 
 ...
 The QSFP+ and QSFP28 ports have four LEDs each. 
