---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/pan-os-xml-api-request-types/import-files-api/import-files.html
...
XML API Request Types 
 ...
 the type of the certificate or key file using the
 category parameter:
 ...
 curl -X GET "https://<firewall>/api/?key=apikey&type=import&category=certificate&certificate-name=<certificate_name>&format=pkcs12 | pem&passphrase=text&vsys=<vsys>" 
 ...
 Import custom logos to different locations based on the
 where parameter:
