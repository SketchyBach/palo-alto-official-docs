---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/mod
fetched_at: 2026-09-06T10:58:31Z
source: cortex-platform
---

# mod | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Functions : divide() , multiply() , if() 

 Datasets : xdr_data 

 Previous min (windowcomp) 
