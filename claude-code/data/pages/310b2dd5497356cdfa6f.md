...
Google Workspace connector | Cortex Documentation Portal 
 ...
 Previous Ingest logs and data from Google Workspace Next Google Workspace Automation and Collection 
