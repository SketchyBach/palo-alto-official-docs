---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/cortex-agentix-data-sources-and-connectors/administration-and-troubleshooting/overview-of-data-ingestion-metrics
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Monitor Cortex AgentiX data ingestion health with metrics and presets. 
 ...
 Maximum delay value from all log entries in a record between log creation at the source and ingestion into Cortex AgentiX (in seconds). 

 data_freshness_median 

 Float 

 Median delay value from all log entries in a record between log creation at the source and ingestion into Cortex AgentiX (in seconds). 

 data_freshness_ninetieth_percentile 

 Float 

 Ninetieth percentile of delay values from all log entries in a record between log creation at the source and ingestion into Cortex AgentiX (in seconds). 
