---
url: https://docs.paloaltonetworks.com/prisma-access/release-notes/5-2/cloud-services-plugin-for-panorama/upgrade-cloud-services-plugin
...
plugin. 
 ...
 example, to upgrade from a 3.0 Preferred plugin to a 5.2 plugin, you must
 first perform interim upgrades to 3.1, 4.0, 4.1, 5.0, and 5.1 before
 upgrading to 5.2. 
