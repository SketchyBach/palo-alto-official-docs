---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/config
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Controls whether field values are evaluated in a case-sensitive manner. Default is false . 
 ...
 Defines the specific time range for the query's execution. 

 number 

 integer 

 Yes (if timeframe used) 

 The duration value for the timeframe. 
 ...
 The unit of time (S, M, H, D, W, MO, Y). Not case-sensitive. 
 ...
 The start of the time range. Can be a relative offset (for example, "-1h"), "begin", or an exact timestamp. 
 ...
 The end of the time range. Can be a relative offset, "now", or an exact timestamp. 
