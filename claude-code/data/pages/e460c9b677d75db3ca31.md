---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-212.html
fetched_at: 2026-09-16T13:01:38Z
source: palo-alto-main
---

# PAN-OS Plugin for OpenConfig 2.1.2 Clear
...
Updated on 
 ...
 Table of contents for the PAN-OS OpenConfig plugin 2.1.2 versions. 

 Review what’s new, known and addressed issues for the OpenConfig plugin 2.1.2. 

 What's new in OpenConfig Plugin 2.1.2 

 Known issues in OpenConfig Plugin 2.1.2 

 Addressed issues in OpenConfig 2.1.2-h2 

 Addressed issues in OpenConfig 2.1.2-h3 
