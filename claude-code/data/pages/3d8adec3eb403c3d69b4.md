---
url: https://docs.koi.ai/api-reference/readme/overview-and-evolution
fetched_at: 2026-09-06T09:17:43.613Z
source: koi-official-browser
capture_method: authenticated official browser
---

# Overview and evolution | API Reference

For the complete documentation index, see llms.txt. This page is also available as Markdown.
Ask
API ReferenceGet Started with Koi API
...
v2 uses snake_case consistently across all request parameters and response fields, aligning with common API standards and database conventions.
