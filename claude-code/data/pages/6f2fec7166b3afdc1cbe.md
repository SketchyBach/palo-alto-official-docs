...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure indicator type profiles, scripts, commands, and expiration in Cortex AgentiX. 
 ...
 Modifies how the indicator displays in Cortex AgentiX. 
 ...
 When an indicator is extracted, the entry data from the command is mapped to the issue context. This path defines where in context the data is mapped. 
