---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/incident-configuration/incident-customization/create-an-incident-field
fetched_at: 2026-09-16T08:52:58Z
source: cortex-platform
---

# Create an incident field |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom incident fields in Cortex XSOAR 8.14 On-prem. 
 ...
 The script dynamically changes the field value when script conditions are met. To appear in the list, the script needs the field-change-triggered-indicator tag. For more information, see Incident field trigger scripts . 

 Run the field triggered script after the new field value is saved 

 Choose whether the script runs before or after the updated field value is saved. 
 ...
 Determines which fields display in forms and the values available for single-select and multi-select fields. 

 Add to all incident types 

 Determines which incident types can use this field. 

 Default display on 

 Determines when the field is available. 
 ...
 Determines whether only the incident owner can edit this field. 

 Indexing: Make data available for search 

 Determines whether field values are available in search. 
