---
url: https://docs.paloaltonetworks.com/globalprotect/user-guide/6-2/globalprotect-app-for-ios/use-the-globalprotect-app-for-ios
...
SSID and gateway IP address/FQDN). 
 ...
 User Credentials , your credentials are automatically saved to the
 GlobalProtect app. When your password expires or a RADIUS or AD administrator requires a
 password change at the next login, you can update your password on the app. This feature
 is enabled only when you are authenticated with a RADIUS server using the Protected
