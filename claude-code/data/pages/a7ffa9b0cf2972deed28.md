---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/downloading-certificates-and-keystores
fetched_at: 2026-09-16T07:25:29Z
source: palo-alto-main
---

# Downloading Certificates, Certificate Chains, and Keystores Clear
...
Updated on 
 ...
 You can download certificates, certificate chains, and keystores from Next-Gen Trust Security after a certificate has been issued. 

 Note (Downloading a keystore): You can download a keystore only when Next-Gen Trust Security generated the key pair. If another system generated the key pair, Next-Gen Trust Security does not have access to the private key and cannot generate a keystore. 

 Sign in to Next-Gen Trust Security. 

 Navigate to Certificate Inventory > Certificates and use filters to locate the certificate. 

 Select the checkbox next to the certificate you want to download. 

 Download Certificate 

 In the local menu bar, click Download . 

 Select Certificate only . 

 From Choose an export format , select one of the following: 
 ...
 From Choose the chain order , select one of the following: 

 End entity only 

 Full chain (end entity first) 
 ...
 Note (Downloading a keystore): Keystore download is available only when Next-Gen Trust Security generated the key pair. 
 ...
 Note (Changed behavior): Next-Gen Trust Security uses a modern encryption algorithm by default when generating PKCS12 keystores. To use the legacy algorithm, select Use legacy algorithm . 
