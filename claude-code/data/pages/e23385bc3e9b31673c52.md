---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/threat-management/threat-intel-management/indicator-configuration/customize-indicator-fields-and-types/create-an-indicator-field/indicator-field-structure
fetched_at: 2026-09-16T08:36:19Z
source: cortex-platform
---

# Indicator field structure | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Understand the structure and settings available for custom indicator fields. 
 ...
 Defines the indicator on Cortex XSIAM. The value is the main key for the object in the system. 
 ...
 The processor architectures (for exmple, x86, ARM) that the malware instance or family is executable on. The values should come from the STIX processor-architecture-ov open vocabulary . 
 ...
 Which type of malware. Values should come from STIX malware-type-ov open vocabulary. 
