---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/indicator-extraction/create-indicator-extraction-rules-for-an-incident-type
fetched_at: 2026-09-06T10:28:44Z
source: cortex-platform
---

# Create indicator extraction rules for an incident type | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create indicator extraction rules in Cortex XSOAR 8.13 On-prem. 
