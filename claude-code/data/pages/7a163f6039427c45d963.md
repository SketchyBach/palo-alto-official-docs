---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/wildcard_match
fetched_at: 2026-09-16T09:05:32Z
source: cortex-platform
---

# wildcard_match | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The input string field or literal value to be evaluated against the pattern. 
 ...
 The pattern string, which can include wildcard characters * and ? . 
