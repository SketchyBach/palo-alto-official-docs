---
url: https://docs.paloaltonetworks.com/sd-wan/help/3-3/panorama-sd-wan-plugin/sd-wan-devices
...
appear consecutively on the list of devices for ease of use. 
 ...
 selecting Enable Multi-VR Support 
 option. 
 ...
 Hybrid SASE Failover 

 (PAN-OS 11.2.11 and later versions, and plugin 3.3.4 and later
 versions) Select the Hybrid SASE Failover checkbox.
 Enabling this checkbox activates the Hybrid SASE Failover
 functionality for your selected branch. This feature requires at
 least two branches with it enabled to function correctly. By
