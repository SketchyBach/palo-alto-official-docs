---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-404/addressed-issues-in-panorama-plugin-for-vmware-nsx-404
fetched_at: 2026-09-16T07:43:55Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 4.0.4 Clear
...
Updated on 
 ...
 The following issues are addressed in the Panorama plugin for VMware NSX 4.0.4. 

 PLUG-12740 

 Fixed an issue where NSX-T security notifications to cause CPU utilization to spike
 unexpectedly. 

 PLUG-12678 

 Fixed an issue that caused the service manager to display no status and commits to fail
 after downgrading from NSX plugin 4.0.3 to NSX plugin 3.2.4. 
