---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/investigate-and-respond-to-threats/incidents-and-indicators-investigation/investigate-an-incident/run-commands-in-the-cli
fetched_at: 2026-09-16T08:54:58Z
source: cortex-platform
---

# Run commands in the CLI | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, run system, integration, and script commands from the CLI. 
