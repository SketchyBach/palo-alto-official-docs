---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-7-known-and-addressed-issues/pan-os-11-2-7-addressed-issues
fetched_at: 2026-08-13T17:13:31Z
source: palo-alto-main
---

# PAN-OS 11.2.7 Addressed Issues Clear
...
PAN-OS 11.2.7 Addressed Issues 
 ...
 ( PA-455 firewalls in active/passive high availability (HA) configurations only ) Fixed an
 ...
 Fixed an issue with intermittent access and slower than expected loading times when accessing
 ...
 Fixed an issue where Panorama stopped forwarding logs to a syslog server after upgrading to
 PAN-OS 11.1.5-h1. 
