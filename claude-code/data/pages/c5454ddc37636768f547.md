---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-33
fetched_at: 2026-09-16T09:11:18Z
source: cortex-platform
---

# Databricks Authentication Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A Databricks Authentication Token (PAT) provides access to Databricks REST APIs for data analytics services. 

 Exposure grants an attacker unauthorized access to analytics data, misuse of data processing capabilities, and potential ability to exfiltrate sensitive business data. 
 ...
 Previous Confluent Key detected in code 

 Next DigitalOcean Token detected in code 
