---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/sum_with_comp_stage
fetched_at: 2026-09-16T09:05:29Z
source: cortex-platform
---

# sum (comp) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The numeric field whose values will be summed. 
 ...
 An alias for the output field. If not specified, the output field name defaults to sum_<field> . 
 ...
 Functions : sum (windowcomp) , count() , avg() 
