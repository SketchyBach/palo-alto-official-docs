---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/logging/appsec-aws-338
fetched_at: 2026-09-06T11:12:38Z
source: cortex-platform
---

# AWS CloudWatch log groups retention set to less than 365 days misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 c95b15e2-3bad-4c39-a04c-014fb6ef7890 
 ...
 resource "aws_cloudwatch_log_group" "example" { name = "example" 

 retention_in_days = 365 } 

 Previous AWS ECS services have automatic public IP address assignment enabled misconfiguration detected in co 

 Next RDS instances have performance insights disabled misconfiguration detected in code 
