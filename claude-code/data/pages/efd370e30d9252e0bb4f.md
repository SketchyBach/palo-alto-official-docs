---
url: https://cortex-docs.paloaltonetworks.com/8.x/8.7ce/cortex-xdr-agent-8.7-ce-release-information/cortex-xdr-agent-known-issues
fetched_at: 2026-09-16T09:00:35Z
source: cortex-platform
---

# Cortex XDR agent known issues | 8.7ce | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 See the list of the known issues in Cortex XDR agent 8.7-CE. 
 ...
 Previous Addressed issues in Cortex XDR agent 8.7.100-CE 
