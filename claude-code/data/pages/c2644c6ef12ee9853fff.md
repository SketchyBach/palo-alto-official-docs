---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/fields
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The name of the field to include in the results. 
 ...
 The alias name to assign to the field using the as clause. 
 ...
 The minus character used to exclude a specific field from the result set. 
 ...
 The clause used to assign an alias to an existing field. 
 ...
 Stages : alter , config , filter , limit 
