---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/detect-threats-and-analyze-data/detection-rules/whats-a-correlation-rule/correlation-rule-details
fetched_at: 2026-09-06T09:48:33Z
source: cortex-platform
---

# Correlation rule details | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If you are assigned a role that enables Investigation → Rules privileges, you can manage all user-defined Correlation Rules from Detection Rules → Correlations . 
 ...
 If a generated alert has severity Medium or above, an incident is automatically opened. Low severity alerts generated by correlation rules are not grouped into incidents. 
 ...
 Previous What's a correlation rule? 

 Next Create a correlation rule 
