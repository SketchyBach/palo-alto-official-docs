---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-5400-hardware-reference/pa-5400-series-module-and-interface-card-information/pa-5400-series-firewall-management-processor-card-mpc.html
fetched_at: 2026-09-16T11:49:20Z
source: palo-alto-main
---

# PA-5400 Series Firewall Management Processor Card (MPC) Clear
...
Updated on 
 ...
 Learn about the PA-5400 Series Management Processor Card. 

 The PA-5400 Series firewall Management Processor Card
(MPC) is a mandatory interface for the PA-5450 that connects to
the PA-5400 Series Firewall Base Card (BC) . The MPC
enables management, logging, and high availability functions via
SFP+ ports and features two system drives and one logging drive. 
