---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/get-started-with-the-pan-os-rest-api/work-with-address-objects-rest-api.html
...
Updated on 
 ...
 request with the following query parameters—name of the object
 name=<name> ,
 l
 ocation=<location> , and the new name
 newname=<name> .
 The following example renames web-servers-production to web-server-publish. 

 curl -X POST \
 'https://10.5.196.4/restapi/v10.0/Objects/Addresses:rename?location=shared&name=web-servers-production&newname=web-server-publish' \
 -H 'X-PAN-KEY: LUFRPT0=' 
 ...
 curl -X DELETE \
 'https://10.1.1.4/restapi/v10.0/Objects/Addresses?location=shared&name=web-server-production' \
 -H 'X-PAN-KEY: LUFRPT0=' 
 ...
 indicated with
 location=vsys&vsys=vsys1 in
 the query parameter. 

 curl -X GET \
 'https://10.1.1.4/restapi/v10.0/Objects/Addresses?location=vsys&vsys=vsys1' \
 -H 'X-PAN-KEY: LUFRPT0=' 
