---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/data-management/broker-vm/set-up-and-configure-broker-vm
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up and configure Broker VM for data collection and integrations. 
...
For example: ssh -i [/path/to/private.key] admin@[broker_vm_address] 
 ...
 If adding a CA certificate to the Broker VM is not possible, ensure that you’ve added the Broker Service FQDNs to the SSL Decryption Exclusion list on your firewalls. See Enable Access to Cortex Cloud . 
