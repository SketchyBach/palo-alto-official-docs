---
url: https://docs.paloaltonetworks.com/ngfw/help/11-1/device/device-virtual-systems
...
or vsys-specific service routes ( Device > Setup > Services ). 
...
if you want to apply DNS proxy rules to this vsys. ( Network > DNS Proxy ). 
...
number of policy-based forwarding (PBF) rules. 
 ...
 Authentication Rules —Maximum number of
