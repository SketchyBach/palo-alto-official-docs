---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.9
fetched_at: 2026-09-16T09:12:38Z
source: cortex-platform
---

# Introduction | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For compatibility with operating systems per agent release versions see Where can I install the Cortex XDR agent? 
