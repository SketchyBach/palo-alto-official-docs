---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7500-hardware-reference/pa-7500-series-firewall-led-definitions/interpret-the-pa-7500-series-firewall-leds.html
fetched_at: 2026-09-16T11:47:58Z
source: palo-alto-main
---

# Interpret the PA-7500 Series Firewall LEDs Clear
...
Updated on 
 ...
 The following table describes the definitions of the LEDs located on the power supplies
 and fan assemblies. For the interface card LED definitions, see Interpret the PA-7500 Series Firewall Interface Card LEDs . 
 ...
 Blinking Green (0.5Hz) Standby mode. AC power is present but only at 12VSB
 (Volts Standby). 
 ...
 Blinking Green (0.5Hz) Standby mode. DC power is present but only at 12VSB
 (Volts Standby). 
 ...
 Red A fan in the fan tray failed (see Replace a PA-7500 Series Firewall Fan Assembly ) 
