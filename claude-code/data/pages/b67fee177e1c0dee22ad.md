---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/multi-tenant/onboard-cortex-xsoar-multi-tenant/step-1.-install-cortex-xsoar-for-multi-tenant
fetched_at: 2026-09-06T10:29:05Z
source: cortex-platform
---

# Step 1. Install Cortex XSOAR for multi-tenant | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install multi-tenant deployments in Cortex XSOAR 8.13 On-prem. 
 ...
 Have a basic understanding of how to deploy OVA, VHD, or QCOW2 file formats. 
...
If you use a custom TLS certificate, it must cover the cluster, API, and external addresses either in the Common Name (CN) or, preferably as Subject Alternative Names (SANs). Using a wildcard certificate (such as *.mycompany.com ) is the simplest option. 
 ...
 Next Step 2. Pair child tenant to main tenant 
