---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/onboard-cortex-xsoar/users-and-roles/authenticate-users-with-saml-2.0/set-up-okta-as-the-identity-provider-using-saml-2.0
fetched_at: 2026-09-06T10:47:33Z
source: cortex-platform
---

# Set up Okta as the Identity Provider Using SAML 2.0 | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Okta SAML authentication in Cortex XSOAR 6.12. 
