---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-release-notes/pan-os-11-1-11-known-and-addressed-issues/pan-os-11-1-11-addressed-issues
fetched_at: 2026-09-16T07:40:18Z
source: palo-alto-main
---

# PAN-OS 11.1.11 Addressed Issues Clear
...
Updated on 
 ...
 Fixed an issue where the dscd process crashed
 continuously on MIPS platforms (for example, PA-850 firewalls) due
 to a runtime error related to an invalid memory address or nil
 pointer dereference. This was caused by a golang library upgrade in
 CIE that is incompatible with the MIPS platform. 
 ...
 Fixed an issue on Palo Alto Networks firewalls running PAN-OS 11.1.6 where the CLI command
 traceroute ipv4 yes host <host> 
 failed with a missing argument error
 message. 
 ...
 Fixed an issue where EW dynamic address groups were not created in Panorama when using NSX plugin
 5.0.1 and NSX manager 4.1.0. 
