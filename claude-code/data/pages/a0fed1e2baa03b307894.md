---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/xdr-collectors/manage-xdr-collectors/define-xdr-collector-machine-groups
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex Cloud , select Settings → Configurations → XDR Collectors → Groups. 
 ...
 Dynamic: Use the filters to define the criteria you want to use to dynamically populate a collector machine group. Dynamic groups support multiple criteria selections and can use AND or OR operators. For collector machine names and aliases, and domains, you can use * to match any string of characters. As you apply filters, Cortex Cloud displays any registered collector machine matches to help you validate your filter criteria. ### Note XDR Collectors only support IPv4 addresses. 

 Static: Select specific registered collector machines that you want to include in the collector machine group. Use the filters, as needed, to reduce the number of results. When you create a static collector machine group from a file, the IP address, hostname, or alias of the collector machine must match an existing Cortex Cloud that has registered with Cortex Cloud .
Note: Disconnecting Directory Sync in your Cortex Cloud deployment can affect existing collector machine groups and policy rules based on Active Directory properties. 
...
At any time, you can return to the XDR Collectors Endpoints page to view and manage your collector machine groups. To manage a group, right-click the group and select the desired action. 
 ...
 Next About Cortex Cloud Collector content updates 
