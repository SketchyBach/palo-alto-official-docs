---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/threat-prevention/metric-dt-tp-9.html
fetched_at: 2026-09-16T11:04:28Z
source: palo-alto-main
---

# Decryption Usage Clear
...
Updated on 
 ...
 Identifies the percentage of total traffic that is using SSL. Also identifies the percentage of total SSL traffic that the firewall is decrypting. 
 ...
 show session all filter ssl-decrypt yes count yes show session all filter application ssl count yes
