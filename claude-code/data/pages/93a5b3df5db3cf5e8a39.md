---
url: https://docs.paloaltonetworks.com/wildfire/u-v/wildfire-whats-new/latest-wildfire-cloud-features/ms-office-analysis-support-for-wildfire-inline-ml
fetched_at: 2026-08-13T17:48:27Z
source: palo-alto-main
---

# MS Office Analysis Support for Wildfire Inline ML Clear
...
MS Office Analysis Support for Wildfire Inline ML 
 ...
 To access the new MS Office file analysis
classification engine for WildFire Inline ML , be
sure to download and install the latest PAN-OS content release.
PAN-OS Applications and Threats content release 8434 and later allows
firewalls operating PAN-OS 10.x and later to detect and prevent
malicious MS Office files from entering your network in real-time.
...
Updates and select the release notes listed under Apps + Threats. 

 WildFire Inline ML now
supports a new MS Office file analysis classification engine. This
enables you to configure your firewall to detect and prevent malicious
MS Office files from entering your network in real-time by applying
machine learning (ML) analytics. WildFire Inline ML dynamically
detects malicious files of specific types by evaluating various
file details to formulate a high probability classification of a
file. This protection extends to currently unknown as well as future
variants of threats that match characteristics that Palo Alto Networks
identified as malicious. If you do not have WildFire Inline ML enabled
on your firewall, refer to WildFire Inline ML for
more information. 

 Update your existing Antivirus Security profile
to enable the MS Office real-time WildFire analysis classification
engine. 
...
an Action Setting for the new WildFire inline
ML model. This enforces WildFire inline ML Actions settings for
each protocol on a per-model basis. In addition to the currently
available classification engines (Windows Executables, PowerShell
Scripts 1, and PowerShell Scripts 2, Executable Linked Format), MSOffice should
now be available. If this model is unavailable, verify that you
have content release 8434 or later installed on the firewall. 
...
is configured to forward MS Office files, false-positives are automatically
corrected as they are received. If you continue to see ml-virus
alerts for files that have been classified as benign by WildFire
Analysis, please contact Palo Alto Networks Support. 
