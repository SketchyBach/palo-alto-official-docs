---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.3/cortex-xdr-agent-for-linux/install-the-cortex-xdr-agent-for-kubernetes-hosts
fetched_at: 2026-09-16T08:51:31Z
source: cortex-platform
---

# Install the Cortex XDR Agent for Kubernetes Hosts | 9.3 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Kernel Mode (KM) is not supported, due to restrictions on loading third-party kernel modules. 
