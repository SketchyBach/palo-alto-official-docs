---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/onboard-cortex-xsoar/deployment-steps/step-5.-install-and-configure-content/set-up-your-use-case-with-the-deployment-wizard
fetched_at: 2026-09-16T08:52:15Z
source: cortex-platform
---

# Set up your use case with the Deployment Wizard | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the Cortex XSOAR 8 SaaS Deployment Wizard to adopt your use case. 
 ...
 In the Select Content Packs window, select one or more content packs from the required categories. You can also install other supportive content packs from other categories if needed. These items will be automatically added to the cart. 
 ...
 You must define the incident type to set the playbook in the next step. 

 A list of "What needs to be done" guides you through the required fetching and integration instance settings configurations. Scroll down to see the complete list. 
 ...
 Step 4: What’s Next - Select Turn on Use Case to start the fetching process and run the playbooks and scripts. 
