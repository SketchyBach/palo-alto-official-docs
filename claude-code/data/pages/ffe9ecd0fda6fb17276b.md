---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/dataset-management/lookup-datasets
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create and manage lookup datasets for Cortex XDR queries. 
 ...
 Query results are saved to a lookup dataset. If saved using the target stage, the Type can be either User or Lookup . 
