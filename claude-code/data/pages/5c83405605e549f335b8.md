---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent-ios-guide/9.3/administrator-tasks/prepare-for-installation-administrator-task/configuration-for-installation-by-mdm-administrator-task/configure-network-filtering-on-supervised-devices-administrator-task
fetched_at: 2026-09-16T08:51:45Z
source: cortex-platform
---

# Configure Network Filtering on Supervised Devices (Administrator Task) | 9.3 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add the distributionId to the payload (supported only on devices running iOS 17 or higher). 

 Important: 

 The distributionId is required for Zero-touch registration. Without it, the device user must onboard the app manually. 
