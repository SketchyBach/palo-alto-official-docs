---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-release-notes/pan-os-10-1-5-known-and-addressed-issues/pan-os-10-1-5-known-issues
fetched_at: 2026-08-13T17:03:42Z
source: palo-alto-main
---

# PAN-OS 10.1.5 Known Issues Clear
...
specific to PAN-OS ® 10.1.5. This list includes issues
...
connecting after you restart the web server with the following command: debug software restart process web-server . 
 ...
 After installing the VM-Series firewall on Azure Stack HCI or
 Hyper-V, the memory usage increases to 70%. 
...
you Preview Changes ( Commit Push to Devices Edit Selections or Commit Commit and Push Edit Selections ). 
 ...
 ( PA-5450 firewall only ) In PAN-OS
10.1.5-h1, a firewall configured with a Policy-Based Forwarding
policy flaps when a commit is performed, even when the next hop
is reachable. 
...
in the same subnetwork can cause routing and connectivity issues. 
 ...
 This issue is
now resolved. See PAN-OS 10.1.6-h3 Addressed Issues . 
 After an upgrade to PAN-OS 10.1.5, Global Find
...
now resolved. See PAN-OS 10.1.6 Addressed Issues . 
 ...
 The PAN-OS web interface table of contents
do not display or the help contents reload continuously. 
