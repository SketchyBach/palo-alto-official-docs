---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-aws/onboard-aws-org
fetched_at: 2026-09-16T13:34:54Z
source: prisma-cloud
---

# Onboard Your AWS Organization | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If you want to selectively assign AWS member accounts to different Account Group on Prisma Cloud, you can modify the account group to include multiple cloud accounts . 
 ...
 Previous Onboard AWS 

 Next Onboard Your AWS Account 
