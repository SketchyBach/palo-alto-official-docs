---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin/panorama-software-firewall-license-plugin-113/known-issues-in-the-panorama-software-firewall-license-plugin-113.html
fetched_at: 2026-09-16T13:01:31Z
source: palo-alto-main
---

# Known Issues in the Panorama Software Firewall License Plugin 1.1.3 Clear
...
Updated on 
 ...
 The following list describes known issues in the Panorama Software Firewall License
 plugin 1.1.3. 
 ...
 A display issue is observed when bootstrap parameters in the Software Firewall
 Plugin License Manager fail to display the “panorama-server=" 
 parameter. 

 Workaround : Obtain the primary panorama ip-address from show system
 info . 

 PLUG-13876 

 It is observed that delicensed VM-Series firewalls continue to have the license number
 following a boot up. 

 PAN-207002 

 If you deactivate a VM-Series firewall
through the Software Firewall Licensing plugin, all other listed
firewalls show a status of Disconnected. However, after five to
ten minutes, the firewall status returns to Connected. 
...
Devices . 
 ...
 In Panorama HA with software firewall licensing plugin 1.1.1, it is observed that
 autoscaling to Panorama fails, as the bootstrapping (licensing and registration)
 parameters fail to synchronise from primary to secondary, when the secondary Panorama is
 active. 

 Workaround: To support autoscaling on HA Panoramas, setup HA before configuring
 SWFW license plugin. 
