---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/investigate-endpoints/overview-of-the-action-center/action-center-reference-information
fetched_at: 2026-09-06T09:55:31Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review available Action Center fields, statuses, and actions. 
 ...
 Failed: Agent reports failed back to the Cortex Cloud server if it was started after more than 10 minutes after restart initiation. 

 Expired: After 4 days. 

 Success: Agent reports success to the Cortex Cloud server if it was started within 10 minutes after restart initiation. 
 ...
 By default, Cortex Cloud assigns a 30-day expiration limit to the following actions: 
 ...
 For Retrieve issue data requests related to Cortex Cloud issues triggered by exploit protection modules, Cortex Cloud can analyze the memory state for additional verdict verification. This field displays the analysis progress and resulting verdict. 
