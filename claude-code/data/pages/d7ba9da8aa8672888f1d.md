---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/7.9-ce/cortex-xdr-agent-7.9-for-windows/cortex-xdr-agent-for-virtual-environments-and-desktops
fetched_at: 2026-09-06T10:20:31Z
source: cortex-platform
---

# Cortex XDR Agent for Virtual Environments and Desktops | 7.9 CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 (Optional for Cortex XDR Pro per Endpoint and Cortex XDR agents 7.2 and later) If you plan to use the Search and Destroy Malicious Files response action, you need to perform an additional scan to map all the files on the endpoint. Run the following commands and wait for them to complete: 
 ...
 Install the Cortex XDR Agent Using Msiexec and include the TS_ENABLED=1 flag. 
 ...
 (For Cortex XDR agent releases up to 7.2.X only) Delete two Cyvera folders. 
