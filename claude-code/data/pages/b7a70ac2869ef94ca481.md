---
url: https://docs.prismacloud.io/content-collections/application-security/get-started/connect-code-and-build-providers/add-private-registries
fetched_at: 2026-09-16T13:35:40Z
source: prisma-cloud
---

# Package Registries | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Jenkins Server 

 Next Third-Party Ingestion 
