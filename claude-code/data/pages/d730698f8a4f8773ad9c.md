---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/deployment-steps-and-checklist/cloud-service-provider-csp-onboarding/troubleshoot-errors-on-cloud-instances
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If the account shows Permission errors, use the side panel to check which permissions are missing. You can click Resolve Permissions Issues or Update Available to download an updated cloud template. Deploy the template in your cloud environment and your error should normally be resolved. 

 Applying Terraform updates: When an Update available notification appears for your cloud instance, download the updated template and execute it from your original local deployment folder. Terraform relies on the state file stored in this directory to update existing cloud resources in place instead of creating duplicates. Learn more about Terraform . 
 ...
 Previous Update cloud permissions after Cortex Cloud release updates 
