---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/engines/engine-requirements
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can deploy a Cortex XDR engine on the following operating systems: 
 ...
 You need to allow the following in the URLs for Cortex XDR engines to operate properly. The URLs are needed to pull container images from public Docker registries. 
