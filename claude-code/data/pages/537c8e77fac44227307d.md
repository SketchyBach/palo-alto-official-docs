---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/replacenull
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The name of the field whose null (or null-equivalent) values you want to replace. 

 replacement_value 

 string, number, boolean, array, JSON, or datetime 

 Yes 

 The value that replaces any NULL (or null-equivalent) occurrences in the specified field. The value must match the data type of the field. Literal strings must be enclosed in double quotes, and complex types must be constructed with the appropriate function (see Usage notes ). 
 ...
 Null-equivalent condition 

 How to specify the replacement value 

 String 

 NULL 

 A quoted string literal, for example "invalid host" . 
 ...
 An array constructed with arraycreate() , for example arraycreate("no-record") . 

 JSON 

 NULL 

 A JSON object, typically an empty object {} or one constructed with object_create() . 

 Datetime 

 NULL 

 A quoted datetime string in a supported format (see below). 
