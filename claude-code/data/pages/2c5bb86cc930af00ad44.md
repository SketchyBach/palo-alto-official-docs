---
url: https://docs.prismacloud.io/content-collections/application-security/get-started/connect-code-and-build-providers/third-party-ingestion/veracode-ingestion
fetched_at: 2026-09-16T13:35:40Z
source: prisma-cloud
---

# Ingest Veracode Data | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Generate and copy a Veracode access key to enable access to Prisma Cloud. The access key includes a key ID and secret. 

 Add the Prisma Cloud IP addresses and hostname for Application Security to Vercode’s allow list to enable access to the Prisma Cloud console. 
 ...
 Previous Ingest SonarQube Data 

 Next Ingest SARIF Data 
