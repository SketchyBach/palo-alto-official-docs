---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/detect-and-respond-to-threats/incidents-and-indicators-investigation/investigate-an-incident/investigate-an-incident-using-the-canvas
fetched_at: 2026-09-16T09:12:57Z
source: cortex-platform
---

# Investigate an incident using the canvas | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Investigate incidents with the canvas in Cortex XSOAR 8.8 On-prem. 
