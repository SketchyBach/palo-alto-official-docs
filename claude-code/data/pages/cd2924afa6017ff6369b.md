---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aiops/panorama-cloudconnector-plugin-3-0-2.html
fetched_at: 2026-09-16T12:59:22Z
source: palo-alto-main
---

# Panorama CloudConnector Plugin 3.0.2 Clear
...
Updated on 
 ...
 What is new for Panorama CloudConnector Plugin 3.0.2 (For AIOps and Cloud NGFW for
 AWS) 

 Panorama® CloudConnector Plugin 3.0.2 introduces support for Strata Cloud Manager-Panorama Configuration Sync , which enables Strata Cloud
 ...
 After installing the CloudConnector Plugin, enable the plugin using the
 following command: 
 ...
 Use the following command to enable or disable the synchronization after you enable
...
> request plugins cloudconnector sync enable
 ...
 You must install CloudConnector Plugin version 3.0.2 to use the Strata Cloud
 Manager-Panorama Configuration Sync feature if your Panorama is running a
 PAN-OS version earlier than 12.1. If you want to use PAN-OS 12.*, you must
 upgrade to 12.1.9, which includes CloudConnector Plugin 3.0.2 bundled into
 it. 
 ...
 To resolve this, uninstall the incorrect version and install the latest
