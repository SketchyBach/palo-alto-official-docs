---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/automations/playbooks/build-your-playbook/choose-from-existing-playbooks-or-create-your-own
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Choose an existing playbook or create a custom playbook in Cortex AgentiX. 
 ...
 You can then configure the playbook settings or add AI prompts, scripts, sub-playbooks, or tasks from the Task Library . 
