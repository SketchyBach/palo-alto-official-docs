---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-json-file
fetched_at: 2026-09-06T10:36:14Z
source: cortex-platform
---

# Create a custom widget using a JSON file | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom JSON widgets in Cortex XSOAR 8.10 On-prem. 
