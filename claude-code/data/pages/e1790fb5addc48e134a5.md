---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/set-up-your-environment/data-and-log-forwarding/forward-logs-and-data-from-cortex-xdr-to-external-services/set-up-email-notifications-for-tenant-updates
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Receive email notifications when Cortex XDR tenant updates are scheduled or complete. 
