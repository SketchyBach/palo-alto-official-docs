---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/sin
fetched_at: 2026-09-16T09:05:19Z
source: cortex-platform
---

# sin | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The angle in radians for which to calculate the sine. Any real number is valid. 
 ...
 Functions : asin() , cos() , tan() , pi() 

 Datasets : xdr_data 

 Previous sign 

 Next sla_time_remaining 
