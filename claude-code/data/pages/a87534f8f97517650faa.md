---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-gcp/gcp-plugin-310.html
fetched_at: 2026-09-16T13:00:00Z
source: palo-alto-main
---

# Panorama Plugin for GCP 3.1.0 Clear
...
Updated on 
 ...
 The Panorama plugin for GCP version 3.1.0 supports monitoring of Shared VPC
 Deployments. You can now create a host project with multiple service projects attached
 to it in GCP. This enhancement enables you to retrieve tags associated with both host
 and service projects in a shared VPC deployment. You can choose which service projects
 to be monitored when configuring Monitoring Definition. 

 You can download the GCP plugin for Panorama from the Customer
 ...
 GCP plugin 3.1.0 is only compatible with PAN-OS 10.2.3 and later. 
 ...
 Compatible Plugin Versions for PAN-OS
 10.2 
