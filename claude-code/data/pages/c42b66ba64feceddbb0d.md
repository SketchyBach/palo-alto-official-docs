---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-image-installations/set-up-broker-vm-on-nutanix-hypervisor
fetched_at: 2026-09-16T08:38:09Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Deploy Broker VM on Nutanix Hypervisor for Cortex XDR data collection. 

 Learn how to set up your Cortex XDR Broker virtual machine (VM) on Nutanix Hypervisor. 

 After you download your Cortex XDR Broker virtual machine (VM) QCOW2 image, you need to upload it to a Nutanix hypervisor. Nutanix AHV 10.3 or later is supported. 
 ...
 Previous Set up Broker VM on Microsoft Hyper-V 

 Next Set up Broker VM on VMware ESXi using vSphere Client 
