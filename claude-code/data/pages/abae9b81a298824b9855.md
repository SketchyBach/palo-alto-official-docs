---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/reference-and-developer-docs/cortex-agentix-xql/build-xql-queries/legacy-query-builder/create-process-query
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create process queries with Legacy Query Builder in Cortex AgentiX. 
