---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-501.html
fetched_at: 2026-09-16T12:59:48Z
source: palo-alto-main
---

# Panorama Plugin for AWS 5.0.1 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 5.0.1 provides enhancements to Panorama integration
 to improve the user experience. 

 The Panorama plugin for AWS version 5.0.1 provides enhancements to Panorama
 integration to improve the user experience. 

 Panorama plugin for AWS version 5.0.1 should only be used for Cloud NGFW
 deployments. Do not use this plugin version for VM-Series firewall
 deployments. 

 You can download the AWS plugin for Panorama from the
 Customer Support Portal or directly from
 Panorama Plugins .
