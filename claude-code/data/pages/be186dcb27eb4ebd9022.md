---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/wildfire/u-v/wildfire-api/get-started-with-the-wildfire-api/get-your-api-key/manage-wildfire-appliance-api-keys.html
fetched_at: 2026-09-16T11:04:41Z
source: palo-alto-main
---

# Manage
WildFire Appliance API Keys Clear
...
WildFire Appliance API Keys 
 ...
 After you create one ore more WildFire API keys on the
WildFire appliance, you can manage them using the WildFire appliance
CLI. For example, you may want to export all of your keys for backup
purposes. 
