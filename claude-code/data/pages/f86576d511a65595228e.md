---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-150
fetched_at: 2026-09-16T09:11:35Z
source: cortex-platform
---

# Pingdom Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Pingdom Token grants access to monitoring and reporting data. 

 An attacker could extract sensitive performance metrics, disrupt monitoring schedules, or disable alerts, masking a real service outage. 
 ...
 Previous DB2 Credentials detected in code 

 Next Redis Credentials detected in code 
