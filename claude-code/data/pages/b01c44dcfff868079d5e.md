---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/prisma-access/activation-and-onboarding/your-prisma-access-license/verify-your-prisma-access-account.html
fetched_at: 2026-09-16T09:37:30Z
source: palo-alto-main
---

# Verify Your Prisma Access (Managed by Panorama) Account Clear
...
This? What Do I Need? 
 ...
 Generate an OTP by going to the CSP , selecting Assets Cloud Services , selecting Generate OTP , selecting the
...
the Prisma Access components and Panorama. 
 ...
 In Panorama, select Panorama Cloud Services Configuration and
click Verify . 

 If Verify is disabled, check that
you have configured a DNS server and NTP server on Panorama Setup Services . 
