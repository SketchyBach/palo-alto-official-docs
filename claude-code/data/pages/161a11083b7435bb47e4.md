---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-301/addressed-issues-in-kubernetes-plugin-301.html
fetched_at: 2026-09-16T13:01:13Z
source: palo-alto-main
---

# Addressed Issues in Kubernetes Plugin 3.0.1 Clear
...
for Kubernetes version 3.0.1: 

 PLUG-11687 

 Fixed an issue that caused the Panorama
plugin for Kubernetes to process only one monitoring definition
during each polling interval, causing one monitoring definition
to become outdated. 

 PLUG-11685 

 Fixed an issue that caused previously
populated dynamic address groups to suddenly become empty. 

 PLUG-10374 

 Fixed an issue, which appears on the
CN-Series deployed as a Kubernetes service, that prevented all IP
addresses showing up in dynamic address groups although the IP addresses
do correctly appear in the dashboard of the Panorama plugin for
Kubernetes. 
