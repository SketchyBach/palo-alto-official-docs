---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/incident-configuration/use-post-processing-scripts-in-an-incident
fetched_at: 2026-09-06T11:24:17Z
source: cortex-platform
---

# Use post-processing scripts in an incident | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use post-processing scripts in Cortex XSOAR On-prem 8.7 (EoL). 
