---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/network-security/security-policy/administration/identify-users-connected-through-a-proxy-server/use-xff-values-for-policies-and-logging-source-users.html
