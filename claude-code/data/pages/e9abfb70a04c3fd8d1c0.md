...
# View attack surface tests | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When Cortex Xpanse released this test. 
 ...
 The number of directly-discovered services owned by your organization that Cortex Xpanse has confirmed vulnerable with this test. 
 ...
 Previous Enable new attack surface tests by default 

 Next View source IP addresses for Attack Surface Testing scans 
