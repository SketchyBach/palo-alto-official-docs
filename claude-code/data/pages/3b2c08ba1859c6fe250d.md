---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-302/addressed-issues-in-kubernetes-plugin-302.html
fetched_at: 2026-09-16T13:01:08Z
source: palo-alto-main
---

# Addressed Issues in Kubernetes Plugin 3.0.2 Clear
...
Updated on 
 ...
 Addressed issues in the Panorama plugin for Kubernetes version 3.0.2: 

 PLUG-12550 

 Fixed an issue that caused Management Pod (MP) to reflect all subscriptions even
 though a Deployment Profile is created with no subscriptions. 

 PLUG-12777 

 Fixed an issue that caused an empty response error when applying
 Kubernetes plugin license information on secondary Panorama. 

 PLUG-13367 

 Fixed an issue that caused Kubernetes plugin watcher to get stuck in
 Initializing state after commit. 

 PLUG-13965 

 Fixed an issue that showed Panorama Kubernetes plugin Monitoring definition status
 on CLI as empty and polling , and watcher status was stuck at
 Initialising state. 
