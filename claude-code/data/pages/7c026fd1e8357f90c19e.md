---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-520/whats-new-in-panorama-plugin-for-aws-520.html
fetched_at: 2026-09-16T12:59:47Z
source: palo-alto-main
---

# What's New in Panorama Plugin for AWS 5.2.0 Clear
...
Updated on 
 ...
 DLP Integration with Cloud NGFW for AWS 

 You can integrate Enterprise Data Loss Prevention (E-DLP) with
 Cloud NGFW for AWS . Using Panorama UI, you can leverage E-DLP and create
 a data filtering profile to your Security
 Policy rule. 

 E-DLP is a set of tools and processes that allow you to protect sensitive information
 against unauthorized access, misuse, extraction, or sharing. E-DLP is a cloud-based
 service that uses supervised machine learning algorithms to sort sensitive documents
 into Financial, Legal, Healthcare, and other categories for document classification
 to guard against exposures, data loss, and data exfiltration. These patterns can
 identify the sensitive information in traffic flowing through your network and
 protect them from exposure. It allows you to protect sensitive data by preventing
 file uploads and non-file based traffic from leaking to unsanctioned web
 application—Discover and conditionally stop sensitive data from being leaked to
 untrusted web applications. 

 E-DLP tools help you to monitor uploads to sanctioned web applications—Discover and
 monitor sensitive data when it’s uploaded to sanctioned corporate applications, and
 inspect content and analyze the data in the correct context so that you can
 accurately identify sensitive data and secure it to prevent incidents. You can
 integrate E-DLP with Cloud NGFW for AWS. Using Panorama UI, you can leverage E-DLP,
 and create a data filtering profile to your Security Policy rule. 

 Cloud NGFW for AWS Rule Usage 

 When you use Panorama to manage rules on your Cloud NGFW resource, you can track and monitor rule usage for
 operations and troubleshooting tasks. On your Panorama console, you can view the
 rule usage at cloud device group to determine if all, some, or none of the Cloud
 NGFW resources have traffic matches. 
