---
url: https://docs.prismacloud.io/content-collections/runtime-security/vulnerability-management/prisma-cloud-vulnerability-feed
fetched_at: 2026-09-16T13:35:19Z
source: prisma-cloud
---

# Prisma Cloud Vulnerability Feed | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 RPM - Red Hat and derived distributions, Amazon Linux 

 dpkg/deb - Debian and derived distributions 

 apk - Alpine Linux packages. 

 Photon OS - VMware’s lightweight Linux distribution. 
 ...
 Prisma Cloud Intelligence Stream uses Red Hat’s image analysis to accurately flag the vulnerable images with the same data such as Severity, Fix Status, and impacted versions as detected in Red Hat Ecosystem Catalog . 

 Vulnerability Assessment Process 

 Prisma Cloud uses the following vulnerability assessment process for applications installed from OS packages: 

 Primary check : Prisma Cloud first checks the vendor feed (OS feed) for any vulnerabilities associated with the OS package. 

 Fallback mechanism : If no vulnerabilities are detected in the vendor feed, Prisma Cloud automatically searches for third-party security data. 

 This dual-check mechanism leverages both OS-specific and third-party vulnerability information, which helps identify vulnerabilities accurately, regardless of their installation source. 
 ...
 Next Image Vulnerability Scanning 
