---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/engines/run-a-script-using-an-engine
fetched_at: 2026-09-06T10:35:16Z
source: cortex-platform
---

# Run a script using an engine | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.10 On-prem, run scripts using engines and load-balancing groups. 
