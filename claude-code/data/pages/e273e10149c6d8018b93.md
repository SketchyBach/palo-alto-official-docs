---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/investigate-and-respond-to-threats/incidents-and-indicators-investigation/incident-management/search-for-incidents
fetched_at: 2026-09-06T10:22:48Z
source: cortex-platform
---

# Search for incidents | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Search for incidents in Cortex XSOAR 8 SaaS. 
 ...
 * 
 ...
 For example, you have incidents with the idle accounts name. When searching for the name: "idle" , it returns any name that contains the word idle (including idle accounts ). Other fields return anything that matches the exact world, idle . 
 ...
 {% hint style="info" %} To edit an existing saved query, create a new query and save it with the exact name of the query you want to replace. {% endhint %} 
