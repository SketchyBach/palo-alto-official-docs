---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin.html
fetched_at: 2026-09-16T13:01:27Z
source: palo-alto-main
---

# Panorama Software Firewall License Plugin Clear
...
features, open issues and workarounds, and issues that are address
in each version of the Panorama Software Firewall License plugin. 

 The Panorama Software Firewall License plugin does not support changing device groups
 after a firewall is connected. To modify device groups, you must manually connect
 the firewalls without using the software firewall license plugin. 
