---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.0-eol/cortex-xdr-agent-8.0-for-linux/install-the-cortex-xdr-agent-for-linux
fetched_at: 2026-09-06T11:28:26Z
source: cortex-platform
---

# Install the Cortex XDR Agent for Linux | 8.0 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Download the Cortex XDR agent Linux installer from Cortex XDR. 
 ...
 Download the Cortex XDR Public Keys. 

 Unzip the public keys by running unzip cortex-xdr-agent-keys.zip . 

 Import the public keys by running rpm --import cortex-xdr-agent1.asc cortex-xdr-agent2.asc 
 ...
 * selinux-policy-devel ... OK 
 ...
 Use to permanently disable the option for Cortex XDR to perform all, or a combination, of the following actions on endpoints running a Cortex XDR agent: initiate a Initiate a Live Terminal Session remote session on the endpoint, Run Scripts on an Endpoint on the endpoint, and from the endpoint to Cortex XDR. Disabling any of these actions is an irreversible action, so if you later want to enable the action on the endpoint, you must uninstall the Cortex XDR agent and install a new package without this flag 
 ...
 (Optional for Kernel Mode only) Load SecureBoot Certificates. 
 ...
 See the Use the Cortex XDR Agent for Linux section for a list of available options, enter the cytool command without any arguments or with -h or --help .. 
