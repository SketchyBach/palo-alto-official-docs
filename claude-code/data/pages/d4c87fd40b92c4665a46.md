---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/manage-services-and-devices/return-devices.html
fetched_at: 2026-09-16T13:54:37Z
source: palo-alto-main
---

# Return Devices Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn about returning a device through the Strata Multitenant Cloud Manager . 
 ...
 Use Return to
send a device back into the available inventory so that you can
allocate it again. To return a device, complete the following steps. 
...
refine your results. 
 ...
 Return a device to Prisma SD-WAN . 

 Select the device state Available
for Client Allocation from the State drop-down. 

 Select Return the device from the ellipsis
 menu. 

 Confirm return of the device. 

 The device returns to the Prisma SD-WAN inventory where the support
 admin can re-allocate the device or the customer support team can
 initiate the RMA process. 

 Select Bulk Actions to return multiple devices
 to Prisma SD-WAN . 
