...
Create an Enhanced Discovery Service 
 ...
 Permissions: You must have the Superuser role in the parent TSG. Discovery services are parent TSG resources and can only be created and configured by parent TSG users. 
