---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/configure-the-agent/configure-global-app-settings-for-the-agent/configure-reauthentication-timers-for-prisma-agent
fetched_at: 2026-09-16T08:21:19Z
source: palo-alto-main
---

# Configure Re-authentication Timers for Prisma Agent Clear
...
Updated on 
 ...
 Configure periodic re-authentication to maintain security compliance for Prisma Agent deployments. 
 ...
 Minimum required Prisma Agent version: 26.1.1 
 ...
 Prisma Agent continuously validates user trust through background
 ...
 re-authenticate only when the Re-authentication Frequency expires. Other settings,
 including Cookie Lifetime and Gateway Session Timeout ,
 control session and token behavior independently and do not trigger
 ...
 enforcement. For Dynamic Privilege Access-enabled Prisma Agents , the
 ...
 Go to the Prisma Agent Settings page. 
