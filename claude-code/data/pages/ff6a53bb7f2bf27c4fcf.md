---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-20/vm-series-plugin-205/whats-new-in-vm-series-plugin-205
fetched_at: 2026-09-16T07:44:39Z
source: palo-alto-main
---

# What’s New in VM-Series Plugin 2.0.5 Clear
...
Updated on 
 ...
 This release addresses known issues and
introduces 1500 MTU for Google Cloud Platform, and SR-IOV access
mode on ESXi. 

 1500 MTU for Google Cloud Platform 

 VM-Series firewall on GCP now supports MTU 1500 on data
ports with PAN-OS 9.1.8 and later or 10.0.5 and later, with VM-Series
plugin 2.0.5 and later. 

 SR-IOV Access Mode on ESXi 

 You can include the bootstrap parameter plugin-op-commands=sriov-access-mode-on in
the init-cfg.txt file. Requires PAN-OS 9.1.5 and later, or 10.0.1
and later, with VM-Series plugin 2.0.5 and later. 
