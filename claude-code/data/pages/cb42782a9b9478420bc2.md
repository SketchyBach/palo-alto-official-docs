---
url: https://cortex-docs.paloaltonetworks.com/xdr-5-api/logging-and-collection-service-management/clcs-management
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Your Cortex XDR API key. 

 Example: {api_key} 

 x-xdr-auth-id string Required 

 Your Cortex XDR API key ID. 
 ...
 Example: {"err_code":400,"err_msg":"Bad Request","err_extra":"Duplicate device IDs found: 01234567890"} 
 ...
 Previous Logging and Collection Service Management overview 
