---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-53
fetched_at: 2026-08-13T17:16:42Z
source: palo-alto-main
---

# PAN-OS REST API Performance Metrics Clear
...
PAN-OS REST API Performance Metrics 
 ...
 Provides REST API performance metrics, such as the number of requests per second served by the device, and the average response time to service a REST API request. 
