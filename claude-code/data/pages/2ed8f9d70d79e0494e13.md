---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-72.html
...
Updated on 
 ...
 Collects session statistics for each dataplane, such as the maximum number of supported sessions, the number of active sessions broken down by session type (TCP, HTTP, SCTP, and so forth), session timeout values, and so forth. 
