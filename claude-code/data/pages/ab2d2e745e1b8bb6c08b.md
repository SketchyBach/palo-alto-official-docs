...
# Manage user acces | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage users in the Cortex XDR tenant 

 Once users are visible in the tenant, perform the following tasks in Cortex XDR to edit permissions, import multiple users, view permissions, or manage user status. 
