---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-303
fetched_at: 2026-09-16T09:11:52Z
source: cortex-platform
---

# EasyPost API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The EasyPost API Key grants programmatic access to shipping and logistics services. 

 Exposure allows an attacker to unauthorizedly use the API (billing fraud), manipulate shipping labels, or access sensitive logistics data. 
 ...
 Previous Azure Search Admin Key detected in code 

 Next MongoDB credentials detected in code 
