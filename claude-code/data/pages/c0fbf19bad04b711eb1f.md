---
url: https://docs.paloaltonetworks.com/prisma-browser/activation-and-onboarding/onboard-the-prisma-browser-connector
...
Updated on 
 ...
 Network Administrator or Superuser Prisma Browser
 Roles . 
 ...
 Click Create a service connection or ZTNA connector.. This section
 defines the infrastructure and specific private applications that the ZTNA
 Connector manages. In the dropdown section, click “Follow the setup
 instructions in the ZTNA Connection Configuration." Go to Configure ZTNA Connector 
 ...
 targets specify the internal private applications (web-based application
 taargets) the ZTNA Connector will make accessible to Prisma Browser
 users. 
 RDP/SSH apps : Configure RDP and SSH targets under
 Remote Connections — navigate to Configuration Policy Objects Applications and select the Remote Connections tab. For more
 information, refer to Prisma Browser Remote Connections. RDP/SSH targets
 do not need to be added to the Private Applications tab." 
 ...
 Select the Add remote connection tab and click Add remote connection
 if you need to add apps that are SSH- RDP, or SMB-based. This
 extends secure access capabilities beyond web-based applications to
 include other crucial enterprise services. 

 The remaining steps are configured in a manner similarly to those in the Prisma
