---
url: https://docs.paloaltonetworks.com/fedramp/autonomous-dem/release-updates-release-notes-doc/known-issues-adem
...
Management (ADEM). 
 ...
 NETVIS-10595 The routing table fails to display. 

 NETVIS-2170 The Executive Summary report fails
 to accurately display licenses for Advanced Threat Prevention, Advanced
 URL Filtering and Advanced Wildfire despite the licenses being active on
 the Security Subscriptions page. 

 DEM-12411 The Global Distribution map fails
 to load; this may be caused by the deprecation of a Google maps
 marker. 
