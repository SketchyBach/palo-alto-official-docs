---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-trustsec/panorama-plugin-for-cisco-trustsec-200/addressed-issues-in-panorama-plugin-for-cisco-trustsec-200.html
fetched_at: 2026-09-16T13:00:39Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco TrustSec 2.0.0 Clear
...
in the Panorama plugin for Cisco TrustSec 2.0.0. 

 PLUG-10719 

 Fixed an issue that cause password-based
pxGrid client account creation and activation to fail. 

 PLUG-6556 

 Fixed an issue that prevented the Panorama
plugin for Cisco TrustSec from retrieving updates from the pxGrid
server. 
