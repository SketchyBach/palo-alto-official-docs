---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/configure-cortex-xsoar/engines/install-an-engine
fetched_at: 2026-09-06T10:29:48Z
source: cortex-platform
---

# Install an engine | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, install, deploy, and configure an engine. 
 ...
 For Amazon Linux 2, use the zip installer in step 4. For other Linux systems, we recommend using the shell installer. 
