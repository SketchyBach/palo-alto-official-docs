---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-managing/co-VSatellite-update-options/t-VSatellite-manual-update
fetched_at: 2026-09-16T07:24:45Z
source: palo-alto-main
---

# Trigger a Manual Update for a VSatellite Clear
...
Updated on 
 ...
 You can manually trigger an update for a VSatellite from the user interface when it is eligible for an update but not yet scheduled. This is useful if an update is pending or previously failed, and you want to initiate it immediately without waiting for the next scheduled window. 

 Prerequisites 

 The VSatellite must have an update status of either UPDATE_PENDING or FAILED . 

 To Trigger a Manual Update 

 Sign in to Next-Gen Trust Security. 

 Locate the VSatellite with status UPDATE_PENDING or FAILED . 

 In the Actions menu--click the ellipsis at the end of the row--and then click Update Now . 

 You should see a confirmation or status message indicating that the update has started. The VSatellite's status will change to reflect the update progress. 
