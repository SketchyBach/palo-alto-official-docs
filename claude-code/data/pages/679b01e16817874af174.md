---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-215.html
fetched_at: 2026-09-16T12:59:06Z
source: palo-alto-main
---

# VM-Series Plugin 2.1.5 Clear
...
Updated on 
 ...
 VM-Series plugin 2.1.5 introduces bug
fixes. 
...
VM-Series plugin version. 
 ...
 Upgrading to VM-Series Plugin 2.1.5 
 ...
 Upgrading
to VM-Series Plugin 2.1.5 

 After installing VM-Series plugin
2.1.5 on your standalone VM-Series firewall, you must reboot your
VM-Series firewall for the changes for PLUG-10024 to
take effect. If your VM-Series firewalls are deployed in an HA pair,
you must complete the upgrade steps in the following order. 

 Download
and install VM-Series plugin 2.1.5 on the Active peer. 

 Download and install VM-Series plugin 2.1.5 on the Passive peer. 

 Reboot the VM-Series firewalls. 

 For detailed
upgrade steps, see Upgrade the VM-Series Firewall . 
