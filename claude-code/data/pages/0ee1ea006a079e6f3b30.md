---
url: https://cortex-docs.paloaltonetworks.com/xsiam-api/cortex-platform/endpoint-management
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Delete selected endpoints. You can delete up to 1000 endpoints. 
 ...
 **Note: ** Once you delete an installation package, it prevents new agents using the package, including VDI, from registering. 
 ...
 Required license: Cortex XSIAM Premium, or any Cortex XSIAM product with the Cloud Runtime Security or Cloud Posture Security add-ons. 
