---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/detect-investigate-and-respond-to-threats/agentic-assistant-chat/chat-with-an-agentic-assistant-agent
fetched_at: 2026-09-16T08:51:31Z
source: cortex-platform
---

# Chat with an Agentic Assistant agent | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use effective prompts with Agentic Assistant chat in Cortex AgentiX. 
 ...
 Open chat, no message sent 

 No context loaded. 

 Send first message 

 Context for the current case is loaded. 

 Switch cases (no active chat) 

 No context is transferred. Agent remains 'blank.' 

 Switch cases (active chat) 

 Agentic Assistant suggests you start a new chat to switch the context to the new case or automatically resumes an existing chat. 

 Switch to a case with chat history 

 Previous chat and context are automatically resumed. 
 ...
 You can quickly jump to different product pages within Cortex AgentiX by typing / in the prompt area. This shortcut is a built-in navigation feature that is available even if the Cortex Agentic Assistant is disabled. 

 Previous Choose an Agentic Assistant agent 

 Next Chat with the Agentic Assistant from Slack 
