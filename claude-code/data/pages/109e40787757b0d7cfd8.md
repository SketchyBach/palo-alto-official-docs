---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-ips-signature-converter/ips-signature-converter-plugin-for-panorama-100/known-issues
fetched_at: 2026-09-16T07:43:13Z
source: palo-alto-main
---

# Known Issues in the IPS Signature Converter Plugin 1.0.0 Clear
...
Updated on 
 ...
 Known issues for the Panorama™ IPS Signature Converter
plugin. 
...
that contain one of the following actions: 
 ...
 The converter supports only rules with headers that
contain one of four protocols: 
...
or file-data custom signature context . 
 ...
 If you assign a firewall that does
not have a Threat Prevention license to an empty Panorama device
group and then add a Threat Prevention license to that firewall,
you are not able to import converted signatures to that device
group and, if you try, the firewall will return the following
error message: 
 Panorama doesn't manage any firewall in device_group_1 device group with Threat Prevention license installed. 

 Workaround: 

 From the Panorama CLI, issue the following command: 

 request batch license refresh devices <device-serial-no> 

 Then retry importing your signatures. 
