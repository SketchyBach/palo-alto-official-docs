---
url: https://docs.paloaltonetworks.com/pan-os/8-1/pan-os-release-notes/pan-os-8-1-addressed-issues/pan-os-8-1-11-addressed-issues
fetched_at: 2026-08-13T17:13:42Z
source: palo-alto-main
---

# PAN-OS 8.1.11 Addressed Issues Clear
...
new address objects. 
 ...
 An enhancement was made to improve firewall
...
packet buffers when links were disconnected from the hypervisor. 
 ...
 ( PA-5200 and PA-7000 Series firewalls
...
driver. 
 ...
 Fixed an issue where a process ( logrcvr ) restarted
during commits. 
...
when you configured QoS. 
 ...
 Fixed an issue where job threads were deadlocked,
...
expressions to take longer than expected to process. 
 ...
 Fixed an issue where eBGP peers connected
...
at the Template-stack level. 
 ...
 Fixed an issue where the firewall sent empty
attributes in the LDAP query when you did not configure Alternate
Username 1 - 3 ( Device User Identification Group Mapping Settings <group-name> User and Group Attributes )
...
URL categories configured for Allow in the URL filtering logs. 
 ...
 An enhancement was made to enable firewalls,
...
update. 
 ...
 Fixed an issue where a process ( mgmtsrvr ) leaked
...
but the firewall did not forward the logs to the syslog server. 
 ...
 Fixed an issue where predict sessions were
...
to drop RTP and RTCP packets. 
 ...
 Fixed an issue where the Username Modifier %USERDOMAIN%\%USERINPUT% enabled you
...
to superusers only. 
 ...
 Fixed an issue on Panorama M-Series and
virtual appliances where Decrypt Mirror ( Objects Decryption Decryption Profile <Device Group-name> )
...
(SFP)/SFP+ module inserted into the firewall. 
 ...
 Fixed an issue where a daemon ( sslmgr )
...
respond after you enabled SSH on ethernet1/1. 
 ...
 Fixed a rare issue where an incorrect User-ID™
...
SIP sessions to fail. 
 ...
 Fixed an issue where a typo in the MIB definition
...
the URL Filtering Profile ( Objects URL Filtering <filter-name> Categories )
...
on the web interface and returned the following error message: test -> credential-enforcement -> allow 'Blocked-Category-Exceptions' is not valid reference test -> credential-enforcement -> allow is invalid . 
 ...
 Fixed an issue where the VPN tunnel operational
status incorrectly displayed “ up " even
though the VPN tunnel is down. 

 PAN-106889 

 Fixed a rare issue on a firewall in an HA
...
a commit job was not pending. 
 ...
 An enhancement was made to enable the firewalls
...
provide a sufficient log history to debug issues. 
 ...
 ( PA-5200 Series and PA-3200 Series firewalls
...
port to traverse HA3 traffic. 
 ...
 Fixed an issue on a firewall where repeated
...
the SAML Identity Provider Server Profile Import ( Device Server Profiles SAML Identity Provider Import )
