---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/detect-investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/customize-indicator-fields-and-types/create-an-indicator-field
fetched_at: 2026-09-16T08:51:21Z
source: cortex-platform
---

# Create an indicator field | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom indicator fields for indicator types in Cortex AgentiX. 
 ...
 | 6. Save the field. 7. (Optional) In the indicator type, map custom indicator fields, so an indicator field is automatically updated, without the analyst having to manually change it. 

 Previous Map custom indicator fields 

 Next Indicator field structure 
