...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 API Keys in Cortex XSOAR 8 - Multi-Tenant 

 Cortex XSOAR 6 API keys are not migrated to Cortex XSOAR 8. 
 ...
 Previous Integration Instance Configuration Changes - Multi-Tenant 

 Next Syslog Configuration - Multi-Tenant 
