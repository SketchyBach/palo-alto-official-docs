---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-6-multi-tenant-guides/6.12/onboard-multi-tenant/multi-tenant-deployment-installation/upgrade-your-multi-tenant-deployment
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Prepare, upgrade, and complete post-upgrade tasks in Cortex XSOAR 6.12 multi-tenant deployments. 
