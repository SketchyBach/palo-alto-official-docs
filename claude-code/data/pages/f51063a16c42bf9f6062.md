---
url: https://docs.prismacloud.io/admin-guide/33/vulnerability-management/vuln-explorer
fetched_at: 2026-09-16T13:36:56Z
source: prisma-cloud
---

# Vulnerability Explorer | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Prisma Cloud Compute > Manage > System > Scan > Scan settings > Running images , when the option Only scan images with running containers is turned off, the image details show the Start time when the Defender first reads the image. This is applicable for all images (deployed and not deployed). 
