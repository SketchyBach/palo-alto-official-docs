---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/role-based-access-control/investigation-and-response-permissions/response-permissions/agent-scripts-library-permissions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage Cortex XSIAM endpoint scripts for response, collection, and automation. 
