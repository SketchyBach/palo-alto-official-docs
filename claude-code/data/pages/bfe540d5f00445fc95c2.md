---
url: https://docs.paloaltonetworks.com/pan-os/8-1/pan-os-release-notes/pan-os-8-1-addressed-issues/pan-os-8-1-13-addressed-issues
fetched_at: 2026-08-13T17:13:45Z
source: palo-alto-main
---

# PAN-OS 8.1.13 Addressed Issues Clear
...
100G AOC cable. 
 ...
 Fixed an issue on the firewalls where some
...
caused high dataplane use and firewall performance issues. 
 ...
 Introduced the clear url-cache all CLI
...
enabled. 
 ...
 Fixed an issue where a process ( reportd ) stopped
...
packets on the respective flows. 
 ...
 Fixed an issue where users saw a page with
...
Regex results was depleted and caused connection failures. 
 ...
 Fixed an issue where offloaded traffic was
...
even when service route was configured. 
 ...
 If an admin user password was changed but
...
was getting corrupted and purging logs. 
 ...
 Fixed an issue in Panorama where after switching
...
temporary directory in PAN-OS ( CVE-2020-2016 ). 
 ...
 Fixed an issue in the firewalls where a
...
in the OSPF Auth profile. 
 ...
 Fixed an issue in Panorama where logs couldn't
be viewed when an additional log collector was configured in the
existing log collector group. 

 PAN-126017 

 Fixed an issue where set application dump on rule CLI
...
PAN-OS session cookie ( CVE-2020-2013 ). 
 ...
 Fixed an issue when Minimum Password Complexity was Enabled for
...
Modify Bearer Request/Response in the GTP-C session. 
 ...
 Fixed an issue on firewalls where a process ( useridd )
...
portal used an outdated getbootstrap version. 
 ...
 Fixed an issue where App-ID signatures failed
to match when there were more than 12 partial App-ID matches within
the same session. 

 PAN-123736 

 Fixed an issue where Create Session Request
...
update occurred simultaneously. 
 ...
 Fixed an issue on the firewalls where enabling SSL Forward
...
Continue Page due to credential phishing detection. 
 ...
 Fixed an issue where ‘show routing bfd‘
...
user mappings populated by the XML API were lost after rebooting. 
 ...
 Fixed an issue in the firewalls where after
...
> High Availability > Election Settings ). 
 ...
 Java Runtime Environment (JRE) was upgraded
to 1.8.0_201. 
...
included with PAN-OS ( PAN-SA-2020-0005 / CVE-2016-10012). 
 ...
 Fixed an issue on the Panorama API where
...
For Panorama, you can specify either the serial number or both the device_name and sessionid . 
 ...
 Fixed an issue where high availability (HA)
...
PA-VM platforms. 
 ...
 Fixed an issue where the dynamic update
...
temporary filename vulnerability ( CVE-2020-1981 ). 
 ...
 Fixed an issue where the IPSec tunnel size
limit set by the customer was not maintained correctly in the system. 

 PAN-102674 

 A fix was made to address a shell command
...
with root privileges ( CVE-2020-2015 ). 
 ...
 Fixed an issue where the ZIP hardware processing
...
the dataplane stopped responding, which made troubleshooting difficult. 
 ...
 Resolved an issue where after enabling debugs
