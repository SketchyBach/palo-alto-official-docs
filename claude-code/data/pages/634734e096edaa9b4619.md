---
url: https://docs.prismacloud.io/content-collections/runtime-security/configure/collections
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For labels, Prisma Cloud supports AWS tags and distro attributes. === Supported Distro Attributes 
 ...
 Prisma Cloud allows rules and collections to be imported/exported between Consoles. === Import Behavior 
