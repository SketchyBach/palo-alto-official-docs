---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-20/vm-series-plugin-205/addressed-issues-in-vm-series-plugin-205
fetched_at: 2026-09-16T07:44:35Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.0.5 Clear
...
Updated on 
 ...
 The following list describes addressed issues in the
VM-Series plugin 2.0.5. 

 PLUG-6796 

 The DPDK memory calculation does not always detect changes
to the ring size or the number of queues. 

 PLUG-6666 

 When a VM-Series firewall with multiple data interfaces
has an interface with multiple secondary IP addresses and an HA
failover occurs, some IP addresses do not move to the secondary
firewall. 
