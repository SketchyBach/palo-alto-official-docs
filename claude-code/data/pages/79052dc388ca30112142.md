---
url: https://docs.prismacloud.io/admin-guide/32/configure/logon-settings
fetched_at: 2026-09-16T13:37:22Z
source: prisma-cloud
---

# Logon Settings | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 With twistcli , you need to use the ' --token ' option to authenticate with the Console for image scanning and other operations that access Console. This is the same token you receive form the /api/v1/authenticate API endpoint. For more information, see the API documentation . 
