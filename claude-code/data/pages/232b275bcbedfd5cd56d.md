---
url: https://docs.paloaltonetworks.com/cortex/cortex-data-lake/log-forwarding-schema-reference/network-logs/network-traffic-log.html
fetched_at: 2026-09-16T09:16:32Z
source: palo-alto-main
---

# Firewall Traffic Clear
...
Updated on 
 ...
 Flag to indicate AIFW traffic error.

 CEF field name: PanOSAIFwdError 

 EMAIL field name: AIFwdError 

 HTTPS field name: AIFwdError 

 LEEF field name: AIFwdError 

 ai_traffic 

 (AI TRAFFIC)

 Flag to indicate AIFW traffic.

 CEF field name: PanOSAITraffic 

 EMAIL field name: AITraffic 

 HTTPS field name: AITraffic 

 LEEF field name: AITraffic 
 ...
 CEF field name: PanOSSDWANFECRatio 
