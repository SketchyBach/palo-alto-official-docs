---
url: https://docs.prismacloud.io/content-collections/alerts/send-prisma-cloud-alert-notifications-to-third-party-tools
fetched_at: 2026-09-16T13:35:06Z
source: prisma-cloud
---

# Send Prisma Cloud Alert Notifications to Third-Party Tools | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Either Create an Alert Rule for Cloud Infrastructure or Create an Alert Rule for Cloud Workloads , or select an existing rule to edit. 
 ...
 If the user who set up your Jira integration is no longer with your organization, you have to create a new Jira integration . 
 ...
 Previous Create an Alert Rule for Cloud Workloads 

 Next View and Respond to Prisma Cloud Alerts 
