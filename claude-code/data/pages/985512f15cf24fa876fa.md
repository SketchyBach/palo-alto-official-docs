---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-61.html
fetched_at: 2026-09-16T11:04:21Z
source: palo-alto-main
---

# Log Forwarding Profiles in Security Rules Clear
...
Updated on 
 ...
 Identifies the percentage of security rules that are configured with a log forwarding profile. Also identifies the percentage of forwarding methods that are in use on the device (syslog, email, HTTP, and so forth). 
 ...
 This metric can be used by applications. This metric can be used by Palo Alto Networks Technical Support. This metric can be used by Palo Alto Networks to investigate future feature enhancements. 
