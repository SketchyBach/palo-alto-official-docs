---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/onboard-cortex-xsoar/cortex-xsoar-installation/install-cortex-xsoar-on-a-vm-deployed-on-aws/task-6.-establish-trust-between-all-nodes-in-a-cluster
fetched_at: 2026-09-06T11:25:29Z
source: cortex-platform
---

# Task 5. Establish trust between all nodes in a cluster | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Establish node trust in a Cortex XSOAR 8.8 On-prem cluster. 
 ...
 Previous Task 4. (Optional) Configure proxy settings 

 Next Task 6. Install Cortex XSOAR on your VM 
