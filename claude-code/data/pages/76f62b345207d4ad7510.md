---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard
fetched_at: 2026-09-16T07:25:27Z
source: palo-alto-main
---

# Start with the TLS Certificates Dashboard Clear
...
Updated on 
 ...
 The TLS Certificates dashboard provides an overview of the overall health of your certificate inventory. 

 Use the dashboard to quickly assess certificate status and identify areas that may require attention, such as certificates that are expired or approaching expiration. 

 You can interact with the dashboard to view certificates in specific segments. For example, under Certificates expired, or about to expire , select a date range to view a filtered list of certificates in the Certificate Inventory. 

 Workspaces and the Dashboard 

 The dashboard reflects the workspace you have selected. Under Tenant it covers the whole tenant, including the certificates held by every workspace; inside a workspace it covers that workspace. The dashboard has no workspace filter of its own, so switch workspaces to change what it covers. 
