---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/what-are-cortex-xdr-data-sources
fetched_at: 2026-09-16T08:38:19Z
source: cortex-platform
---

# What are Cortex XDR data sources and connectors? | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 What are Cortex XDR data sources and connectors? 

 Learn more about Cortex XDR data sources and connectors with a unified approach to integrations. 

 Data sources and connectors are the foundational mechanisms used to ingest security and operational data, including logs, events, and asset metadata, into Cortex XDR for analysis, correlation, and response. By consolidating data from diverse origins like endpoints, network devices, cloud environments, and third-party security tools, Cortex XDR constructs a comprehensive and contextualized "security story" used to identify threats and prioritize risk. 
 ...
 In the Cortex XDR user interface (UI), configuring ingestion involves different areas and terminologies depending on the type of connection and your tenant onboarding date. While the platform is introducing connectors as a new, unified approach to ingestion, traditional data source methods remain supported. 

 In the current intermediate state, it is important to understand how these terms relate to each other: 

 Data sources : Represents the traditional method for any integration that provides data to Cortex XDR. In this documentation, Data Source is used as the category for these traditional ingestion methods, which include: 
 ...
 Connectors : The new, unified mechanism for data ingestion. For supported vendors, a Connector groups multiple security capabilities, such as logs, automation, and Data Security, into a single, uniquely named entry with a guided configuration wizard. 

 While specific components like Data Collectors, Broker VM applets, and Connectors are named explicitly when discussing their unique configuration workflows, they all fall under the foundational goal of ingesting data into Cortex XDR. 

 Why are different data sources and connectors necessary? 

 Cortex XDR enables you to collect data across a vast and varied enterprise landscape. This necessitates distinct data source types and connectors designed for different environments and needs: 
 ...
 Palo Alto Networks Integrations : Cortex XDR provides both standard data sources and new unified connectors for Palo Alto Networks products to ensure deep telemetry ingestion and seamless cross-platform orchestration. 

 Current UI and future direction 

 Cortex XDR is transitioning toward a unified ingestion experience. While different ingestion methods currently involve distinct workflows, the following table summarizes where to manage them: 
 ...
 Previous Cortex XDR Data Sources and Connectors 
