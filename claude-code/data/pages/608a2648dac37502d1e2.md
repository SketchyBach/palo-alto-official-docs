---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-aws/update-aws-org
fetched_at: 2026-09-16T13:34:55Z
source: prisma-cloud
---

# Update an Onboarded AWS Organization | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 (tt:[Optional]) Select a different account group and click Next . 
 ...
 Previous Configure Findings 

 Next Add AWS Member Accounts 
