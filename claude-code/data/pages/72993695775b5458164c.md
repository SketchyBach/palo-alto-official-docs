...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex XSIAM Troubleshooting Data Ingestion 

 Troubleshoot errors on cloud instances 

 You can troubleshoot errors on cloud instances by drilling down on an instance from the Data Sources & Integrations page in Cortex XSIAM. 
 ...
 Previous Update cloud permissions after Cortex XSIAM release updates 
