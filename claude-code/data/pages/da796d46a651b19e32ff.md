---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-500.html
fetched_at: 2026-09-16T12:59:48Z
source: palo-alto-main
---

# Panorama Plugin for AWS 5.0.0 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 5.0.0 introduces Panorama integration with Cloud
 NGFW for AWS. 

 The Panorama plugin for AWS version 5.0.0 introduces Panorama integration with
 Cloud NGFW for AWS. 

 Panorama plugin for AWS
 version 5.0.0 should only be used for Cloud NGFW deployments. Do not use this plugin
 version for VM-Series firewall deployments. 
