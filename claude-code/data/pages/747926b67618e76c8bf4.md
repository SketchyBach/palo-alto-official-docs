---
url: https://docs.prismacloud.io/content-collections/runtime-security/runtime-defense/image-analysis-sandbox
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 --address URL 
Required. URL for Console, including the protocol and port. Only the HTTPS protocol is supported. To get the address for your Console, go to Runtime Security > Manage > System > Utilities , and copy the string under Path to Console . 
