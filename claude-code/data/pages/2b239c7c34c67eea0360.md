---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/configure-cortex-xsoar/incident-configuration/incident-customization/create-an-incident-field/incident-field-trigger-scripts
fetched_at: 2026-09-06T10:27:39Z
source: cortex-platform
---

# Incident field trigger scripts | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure incident field triggers in Cortex XSOAR 8.13 On-prem. 
 ...
 Incident field trigger scripts have the following triggered field information available as arguments (args). See Incident field trigger script arguments . 
