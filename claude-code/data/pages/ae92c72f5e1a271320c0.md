---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/configure-indicator-expiration
fetched_at: 2026-09-06T11:27:28Z
source: cortex-platform
---

# Configure indicator expiration | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure indicator expiration in Cortex XSOAR On-prem 8.7 (EoL). 
