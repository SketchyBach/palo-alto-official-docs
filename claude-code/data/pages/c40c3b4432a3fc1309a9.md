---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-deployNew/r-VSatellite-deployNew-systemreqs
...
Updated on 
 ...
 VSatellite is expected to work on most modern Linux systems (x86_64). However, review the following. 

 Supported 

 Supported means fully tested by QA during the development life cycle. If issues or defects do arise, they'll be resolved by CyberArk. 
 ...
 Tip (RHEL, Oracle, and Rocky Linux installations): 
...
Ensure that your selected operating system is updated with the latest patches. At a minimum, it must be able to retrieve updates from the operating system's standard software repository (for example, using apt-get or yum ). 
 ...
 Important (Disk space requirements for VSatellite installation): Carefully consider the necessary disk space requirements for installing VSatellite, including considerations for both default and custom installations. 
 ...
 You need permission to run commands with root privileges. The following options are available. 
 ...
 If you are already logged in as the root user, you do not need the sudo command.In this case, omit sudo wherever it appears in vsatctl commands in the documentation. 
 ...
 Deploying VSatellite to RHEL: special considerations 

 Manage installed VSatellites 
