---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/rules-and-policies/base-images-rule/create-a-base-images-rule
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create a base image rule to define trusted container image criteria. 
 ...
 Create a base images rule from a registry image asset card 
 ...
 Manage base images rules 

 To manage a base images rule, follow these steps: 
