---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/deploy-defender/host
fetched_at: 2026-09-16T13:35:12Z
source: prisma-cloud
---

# Deploy Host Defender | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 (Optional) Set Assign globally unique names to Hosts to ON when you have multiple hosts that can have the same hostname (e.g., autoscale groups, overlapping IP addresses, etc). 
