---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/engines/use-an-engine-in-an-integration
fetched_at: 2026-09-06T10:24:26Z
source: cortex-platform
---

# Use an engine in an integration |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use engines in Cortex XSOAR 8.14 On-prem to fetch alerts and run integration commands. 
