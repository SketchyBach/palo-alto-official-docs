---
url: https://cortex-docs.paloaltonetworks.com/analytics-alerts/alerts-by-name/download-pattern-that-resembles-peer-to-peer-traffic
fetched_at: 2026-09-06T11:02:33Z
source: cortex-platform
---

# Download pattern that resembles Peer to Peer traffic | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
Palo Alto Networks Firewall traffic Logs OR XDR Agent 
 ...
 Previous Download a script using the python requests module 

 Next DSC (Desired State Configuration) lateral movement using PowerShell 
