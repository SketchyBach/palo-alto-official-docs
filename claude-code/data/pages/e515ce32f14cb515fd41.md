---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/multi-tenant/onboard-cortex-xsoar-multi-tenant/step-4.-set-up-users-and-roles
fetched_at: 2026-09-16T08:53:20Z
source: cortex-platform
---

# Step 4. Set up users and roles |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up users, roles, and authentication in Cortex XSOAR 8.14 On-prem multi-tenant deployments. 
 ...
 To create a new user group for several different system users or groups, click New Group . Add the following parameters: 
