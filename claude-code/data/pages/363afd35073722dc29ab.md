---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/PA-7000-series-firewall-installation/install-the-mandatory-pa-7000-series-firewall-front-slot-cards.html
fetched_at: 2026-09-16T12:08:47Z
source: palo-alto-main
---

# Install the Mandatory PA-7000 Series Firewall Front Slot Cards Clear
...
Updated on 
 ...
 The PA-7000 Series firewalls require a minimum of three cards that you install in the front slots
 of the chassis. These cards are shipped separately from the chassis and include the
 following: The Switch Management Card (SMC) provides management connectivity to the
 chassis and HA connectivity; the Log Processing Card (LPC) or the Log Forwarding Card
 (LFC) handles all log processing; and at least one Network Processing Card (NPC) must be
 installed to enable the firewall to process network traffic. Data Processing Cards
 (DPCs) can be installed for improved data processing performance. 

 Although all front slot cards have protection to prevent damage if they are installed or removed
 when the chassis is powered, only the NPCs and DPCs are intended to be hot-swapped
