---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/max_with_windowcomp_stage
fetched_at: 2026-09-16T09:04:58Z
source: cortex-platform
---

# max (windowcomp) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field from which to compute the maximum value. 
 ...
 Functions : max (comp) , min() , greatest() 
