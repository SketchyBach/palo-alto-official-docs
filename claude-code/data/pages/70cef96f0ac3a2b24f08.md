---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/bitwise_and
fetched_at: 2026-09-06T10:58:22Z
source: cortex-platform
---

# bitwise_and | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The first integer value or field on which to perform the bitwise AND. 
 ...
 The second integer value or field to AND against the first value. 
 ...
 Functions : bitwise_or , bitwise_xor , bitwise_sleft , bitwise_sright , to_integer 

 Previous avg (windowcomp) 
