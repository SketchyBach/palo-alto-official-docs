---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/manage-user-roles-and-access-management/manage-access-to-objects/manage-access-to-report-templates
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Control which users can view and manage report templates. 
 ...
 You can move report templates between different Cortex XDR tenants using the import and export functionality. Access and ownership are handled as follows during this process: 
