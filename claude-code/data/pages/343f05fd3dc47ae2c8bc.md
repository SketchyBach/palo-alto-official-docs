---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/investigate-and-respond-to-incidents/investigate-files/manage-file-execution
fetched_at: 2026-09-06T09:49:18Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If On-write File Examination is enabled, the following file type hashes are also supported in the allow and block lists: WAR, ASP, ASPX. 

 How to add a file to the allow or block list 
