---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/network-security/security-policy/administration/objects/external-dynamic-lists/enforce-policy-on-an-external-dynamic-list.html
