---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-panorama-api/get-started-with-the-pan-os-rest-api/pan-os-rest-api-request-response-structure.html
fetched_at: 2026-09-16T09:33:21Z
...
indicates the start of the query string. The query parameters appear after
the  ? , the parameter are
concatenated with other parameters using the ampersand  &  symbol. 
...
or edit a resource with a PUT request, you include a JSON or XML formatted
request body in which you specify the properties for the resource
