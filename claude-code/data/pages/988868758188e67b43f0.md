---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources/google/google-workspace/ingest-logs-and-data-from-google-workspace
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest logs and data from Google Workspace into Cortex XDR. 
 ...
 Cortex XDR can ingest the following data types: 
...
Authorize the domain-wide authority to your service account. This ensures that your service account now has domain-wide access to the Google Gmail API for all of the users of your domain. 
 ...
 Task 4. Integrate with Cortex XDR 
...
c. Select the types of data that you want to Collect from Google Workspace. 
 ...
 When Cortex XDR begins receiving logs, the app creates a new dataset for the different types of data that you are collecting, which you can use to initiate XQL Search queries. For example queries, refer to the in-app XQL Library. 

 For all logs, Cortex XDR can generate Cortex XDR issues for Correlation Rules only, when relevant from Google Workspace logs. 
