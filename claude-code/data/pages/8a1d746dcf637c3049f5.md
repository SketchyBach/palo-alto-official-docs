---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-0/pan-os-release-notes/pan-os-9-0-addressed-issues/pan-os-9-0-7-addressed-issues.html
fetched_at: 2026-09-16T13:55:56Z
source: palo-alto-main
---

# PAN-OS 9.0.7 Addressed Issues Clear
...
Updated on 
 ...
 ( WF-500 Series only ) Fixed an issue
where high disk use was observed due to an inadequate rotation of
log files. 

 PAN-140090 

 Fixed an issue where HA links were down
...
deployments that are configured in VLAN access mode with SR-IOV. 
 ...
 Fixed an issue where system logs with new
...
(NPC) restarted when processing IPSec tunnel traffic. 
 ...
 A fix was made to address a format string
vulnerability on PA-7000 Series firewalls with a Log Forwarding
Card (LFC) ( CVE-2020-1992 ). 

 PAN-135089 

 Fixed an issue where the CPU for a process ( ikemgr )
...
due to missing routes or next hops. 
 ...
 Fixed an issue where connections proxied
...
message: proxy decrypt failure . 
 ...
 Fixed an issue in the firewalls where some
Dynamic Address Groups pushed from Panorama were missing member
IP addresses. 

 PAN-133440 

 Fixed an issue where fragmented traffic
...
the appliance to stop file analysis. 
 ...
 Fixed an issue where a process ( reportd )
...
Panorama ( CVE-2020-2009 ). 
 ...
 Fixed an issue where the Panorama VM rebooted
...
> Logs > Traffic > To Zone ) for multicast sessions. 
 ...
 Fixed an issue where firewalls dropped HTTP
...
the password change timestamp in the database. 
 ...
 Fixed an issue in Panorama where, after
...
was actively working in the interface. 
 ...
 Fixed an issue where you could not push FQDN Minimum
Refresh Time from Panorama to managed firewalls. 

 PAN-127438 

 Fixed an issue where GlobalProtect portal
configuration selection based on certificate template OID failed. 

 PAN-127219 

 Fixed an issue where you could not select
...
with root privileges ( CVE-2020-2014 ). 
 ...
 Fixed an issue where a push operation ( Commit
...
firewalls in a high availability (HA) pair. 
 ...
 Fixed an issue where the Panorama Template
...
was able to execute arbitrary OS commands with root privileges ( CVE-2020-2010 ). 
 ...
 Fixed an issue where a burst of VLAN-tagged
...
authentication to fail. 
 ...
 Fixed an issue where a Microsoft Access
...
from Azure. 
 ...
 Fixed an issue where LACP connectivity issues
were observed due to high CPU utilization when multiple dataplanes
were used. 

 PAN-124628 

 Fixed an issue where REST API queries were
...
Bearer Request/Response in the GTP-C session. 
 ...
 Fixed an issue on firewalls where a process ( userid )
...
update occurred simultaneously. 
 ...
 Fixed an issue where user group membership
...
Agent Setup ). 
 ...
 Fixed an issue where enabling SSL
...
This issue was most closely associated with servers presenting ECDSA certificates. 
 ...
 Fixed an issue where the Aggregate Ethernet
...
condition with the Neighbor Discovery Protocol (NDP). 
 ...
 Fixed an issue with certificate authentication
...
of PAN-OS ( CVE-2020-1990 ). 
 ...
 Fixed an issue where some SSLv3 session
...
up Later ( Monitor > Manage Custom Reports ). 
 ...
 ( PA-5000 and PA-3000 Series firewalls
...
and CVE-2013-0337). 
 ...
 Fixed an issue where user mappings populated
by the XML API were lost after a reboot. 

 PAN-117043 

 Fixed an issue where using special characters
...
error message when committing or pushing a configuration: group-tag is invalid . 
 ...
 Fixed an issue where, after enabling a Cortex
...
process restarts due to an out-of-memory (OOM) condition. 
 ...
 Fixed an issue where invalid packet header content drop
...
tunnel with latency. 
 ...
 Fixed an issue where an incorrect optimization
could cause IP address-to-user mapping to not update within 60 seconds. 

 PAN-115562 

 Fixed an issue where superuser CLI permissions
...
of filename vulnerability in the command processing of PAN-OS ( CVE-2020-2003 ). 
 ...
 Fixed an issue where, after enabling debugging
