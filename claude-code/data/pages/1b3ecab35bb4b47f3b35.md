---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/configure-the-agent/configure-forwarding-profiles-to-manage-agent-traffic/traffic-enforcement-for-non-tcp-and-non-udp-protocols
...
Updated on 
 ...
 Configure Prisma Agent to block non-TCP and non-UDP traffic when connected to
 ...
 Traffic enforcement for non-TCP and non-UDP protocols extends Prisma Agent capabilities beyond traditional TCP and UDP traffic control to provide
 ...
 When enabled, Prisma Agent can block any non-TCP and non-UDP traffic
 ...
 agent traffic. Once configured, these settings are pushed to the Prisma Agent on your endpoints, which then enforces the policies at the
 ...
 To configure Prisma Agent to block non-TCP and non-UDP protocols, complete the
 following steps. 
 ...
 endpoints where the Prisma Agent is deployed. 
