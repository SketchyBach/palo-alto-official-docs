---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/7.9-ce/cortex-xdr-agent-7.9-for-linux
fetched_at: 2026-09-06T10:20:30Z
source: cortex-platform
---

# Cortex XDR Agent 7.9 for Linux | 7.9 CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To install, use, and uninstall the Cortex XDR agent 7.9 on Linux endpoints, see the references in this topic. 
