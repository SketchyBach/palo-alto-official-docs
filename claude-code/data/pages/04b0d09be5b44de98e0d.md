---
url: https://docs.paloaltonetworks.com/prisma-access-agent/administration/deploy-prisma-access-agents/deploy-prisma-access-agents-using-microsoft-intune/deploy-prisma-access-agents-to-macos-endpoints-using-microsoft-intune/deploy-endpoint-dlp-profile-for-prisma-access-agent-using-microsoft-intune
...
Updated on 
 ...
 sensitive data by deploying two system extensions alongside the Prisma Access Agent : an endpoint security extension
 ...
 profile to your target device groups before running the Prisma Access Agent 
 installer. 
...
<dict>
 ...
 the same groups targeted by your Prisma Access Agent 
 deployment. 
