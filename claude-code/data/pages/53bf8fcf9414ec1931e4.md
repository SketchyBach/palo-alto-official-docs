---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-release-notes/pan-os-10-1-7-known-and-addressed-issues/pan-os-10-1-7-addressed-issues
fetched_at: 2026-09-16T07:35:40Z
source: palo-alto-main
---

# PAN-OS 10.1.7 Addressed Issues Clear
...
Card (LFC) failed to forward logs to the syslog server. 
 ...
 Fixed an issue where commits failed due
...
an issue where jumbo frames were dropped. 
 ...
 Fixed an issue where restarting the NPC
...
the pan_comm process during SNMP polling. 
 ...
 Fixed an issue where using the show routing protocol bgp loc-rib-detail CLI
...
due to conflicting duplicate flows. 
 ...
 Fixed an issue where PBP Drops (8507) threat
...
address and caused an HA path monitoring failover. 
 ...
 ( Bootstrapped VM-Series firewalls in Microsoft Azure environments only ) Fixed an issue
...
the IPSec tunnel did not gray out after disabling it. 
 ...
 Fixed an issue where CPU stalls resulted
in a slot restart. 
...
a searched item. 
 ...
 Fixed an issue where multicast packets were
...
flagged. 
 ...
 Fixed an issue where a full routing table
...
instead of the configured log interface to be used for forwarding. 
 ...
 interface and in the PAN-OS Administrator’s Guide. 

 PAN-190493 

 Fixed an issue where decrypted VLAN traffic
...
connection state. 
 ...
 Fixed an issue where, when logging in to
...
during the first zone transfer when DNS security was enabled. 
 ...
 Fixed an issue where the Panorama appliance didn't display logs or generate reports for a device
...
or uninstalled after disabling jumbo frames on the firewall. 
 ...
 Fixed an issue where Device Group and Template
...
down, which caused an HA failover. 
 ...
 Fixed an issue where, when modifying a DNS
...
(VM-FLEX-4 and higher), HA clustering was unable to be established. 
 ...
 Fixed an issue where the Strata Logging Service connection incorrectly displayed as
...
or destruction. 
 ...
 Fixed an issue where the maximum session
...
was incorrectly shown as up instead of down. 
 ...
 Fixed an issue where the command to show
...
drivers. 
 ...
 Fixed an issue where the show ntp CLI
...
caused network latency. 
 ...
 Fixed an issue on the firewall where a script
to send XML API queries to update the block list caused the sslmgr process
to restart. 

 PAN-183888 

 Fixed an issue on Panorama appliances with
...
licensing. 
 ...
 ( M-200 and M-600 appliances in Log Collector
...
the dataplane to restart. 
 ...
 Fixed an issue where report generation did
...
Inline ML section was disabled. 
 ...
 Fixed an issue with User ID redistribution
...
failed with the following error message: statistics-service is invalid . 
 ...
 Fixed an issue in the template stack where
...
> Satellite > Network Settings . 
 ...
 Fixed a source user mismatch issue that
...
group. 
 ...
 Fixed an issue where logs were not displayed
...
they were displayed in the Monitor tab. 
 ...
 Fixed an issue where, after a local user
...
on Panorama caused during multi-clone operations for rules. 
 ...
 Fixed an issue where LDAP connections over
...
Server Certificate for SSL sessions option was not selected. 
 ...
 Fixed an issue where GlobalProtect was unable
...
to a non-configuration error. 
 ...
 Fixed an issue where path MTU discovery
