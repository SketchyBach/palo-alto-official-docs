---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/threat-prevention/metric-dt-tp-6.html
fetched_at: 2026-09-16T11:04:28Z
source: palo-alto-main
---

# Content and Threat Detection State Clear
...
Updated on 
 ...
 Collects information about the device's Content and Threat Detection (CTD) engine state. This information includes version information, including the latest version of threat, app, virus, WildFire, and WildFire Public Cloud that is in use by the device. Also include engine configuration status such as whether the bloom filter is in use, query time out values, how many packets are sent for threat packet captures, and other similar settings of internal interest to CTD. Data usage totals (CTD and Custom Allocator) are also captured. 
 ...
 /var/log/pan/content_telemetry.log
