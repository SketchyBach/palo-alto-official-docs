---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-software-firewall-license-plugin/panorama-software-firewall-license-plugin-100.html
fetched_at: 2026-09-16T13:01:32Z
source: palo-alto-main
---

# Panorama Software Firewall License Plugin 1.0.0 Clear
...
Updated on 
 ...
 The Panorama Software Firewall License
plugin allows you to automatically license a VM-Series firewall
when it connects to Panorama. If your VM-Series firewalls are located
in the perimeter of your deployment and do not have connectivity
to the Palo Alto Networks licensing server, the Panorama Software
Firewall License plugin simplifies the license activation process by
using Panorama to license the VM-Series firewall. 
