---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-2111/addressed-issues-in-vm-series-plugin-2111.html
fetched_at: 2026-09-16T12:59:04Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.1.11 Clear
...
Updated on 
 ...
 The following list describes the issue fixed in the VM-Series plugin 2.1.11. 

 PLUG-12510 

 VM-Series firewalls deployed in the public cloud running PAN-OS 10.1.6 or lower and
 VM-Series plugin 2.1.10 fail to send PAN-OS metrics to cloud monitoring tools, such as
 Azure Application Insights. 

 Fixed in VM-Series Plugin 2.1.11. 
