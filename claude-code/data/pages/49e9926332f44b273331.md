---
url: https://docs.prismacloud.io/content-collections/multitenant-management/multitenant-management-sso
fetched_at: 2026-09-16T13:35:54Z
source: prisma-cloud
---

# Configure SSO for User Onboarding | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Follow the steps below to configure Microsoft Entra IdP for SSO Access to the Multitenancy console. Microsoft Entra is third-party software, specific procedures, and screenshots may change without notice. We encourage you to also review the Microsoft Entra documentation . 
 ...
 Previous Create and Manage Policy Groups 
