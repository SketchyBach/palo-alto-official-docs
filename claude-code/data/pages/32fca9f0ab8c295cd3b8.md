---
url: https://docs.paloaltonetworks.com/advanced-ip-defense/activation-and-onboarding/introducing-advanced-ip-defense
...
Updated on 
 ...
 profile rules to use the Alert (Permit and Log) action
 before switching to Block (Drop & Log) .
