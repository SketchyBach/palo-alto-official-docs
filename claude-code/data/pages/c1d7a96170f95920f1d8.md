---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/learn-about-cortex-xdr-5.x/agentic-ai-in-cortex-xdr/agentic-assistant-use-cases
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Discover how Cortex XDR can streamline your security operations by exploring some key use cases. 
 ...
 Slack chats with the Agentic Assistant bridge the gap between where your team collaborates and where security operations happen by enabling you to interact with agents directly within you daily communication workflow without needing to log in to Cortex XDR. For more information on interacting with an agent from Slack, see Chat with the Agentic Assistant from Slack . 

 The following is an example scenario describing how you can monitor shift priorities, track SLAs, and review pending automations in Cortex XDR directly from Slack. 

 1 

 Initiation 

 Check the daily queue by opening your team's Slack channel and tagging @Cortex Assistant with the prompt, "What are the top issues I should prioritize today and show me all issues with an overdue SLA?". 
