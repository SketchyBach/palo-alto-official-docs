---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-1.html
fetched_at: 2026-09-16T11:04:25Z
source: palo-alto-main
---

# Threatening SaaS Traffic Clear
...
Updated on 
 ...
 Identifies the percentage of SaaS application traffic that the firewall is categorizing as threatening in some way. For example, because the traffic appears to be generated by a virus or spyware. 
 ...
 pan_logquery -b -t threat -n 5000 -e last-7-days -q '(characteristic-of-app eq is-saas) and ((subtype eq spyware) or (subtype eq virus) or (subtype eq vulnerability) or (subtype eq wildfire-virus))'
