---
url: https://cortex-docs.paloaltonetworks.com/application-security/application-security/onboard-data-sources/integrate-ci-tools/terraform-enterprise-run-tasks/terraform-workflow-for-run-tasks-enforcement
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Next CLI pipeline code snippets 
