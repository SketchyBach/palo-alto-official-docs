---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/next-gen-trust-security/next-gen-trust-security/about-vaas/gs-Cloud-Discovery
...
Updated on 
 ...
 TLS Certificates dashboard Use the dashboard to get a high-level view of certificate health, including expired and expiring certificates. From the dashboard, you can drill into filtered views of the certificate inventory to investigate issues. 

 Certificate inventory The certificate inventory is the central place to view all certificates available to you. From here, you can search, filter, and open individual certificates to review details and take action. 
 ...
 Tag certificates Use tags to group certificates by application, team, environment, or purpose. Tags make it easier to filter the inventory and manage ownership. 

 Use reports Use built-in and custom reports to review certificate usage, expiration trends, and other certificate-related data directly in the UI. 
