---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-deployNew
fetched_at: 2026-09-16T07:24:41Z
source: palo-alto-main
---

# Deploying VSatellites Clear
...
When deploying your first VSatellite, you must choose how the Data Encryption Key (DEK) is protected: 
 ...
 Tip: 
It's helpful to have both the VSatellites page open in Next-Gen Trust Security ( Settings > VSatellites ) and a command line utility connected to your target computer before you begin. You'll be using both. 

 About the Generated Installation Command 

 When you deploy a VSatellite using the installation wizard, Next-Gen Trust Security generates an installation command that includes placeholders for required values. 
 ...
 Backing up and restoring VSatellites 
