---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-90
fetched_at: 2026-08-13T17:17:13Z
source: palo-alto-main
---

# Most Recent Threat Exceptions for all Threat Signatures Clear
...
Most Recent Threat Exceptions for all Threat Signatures 
 ...
 Identifies the most recently created threat exceptions for all threat signatures (vulnerability, spyware, and antivirus). Collects the date and time, and the PAN-OS content version in use when the exception was created. 
