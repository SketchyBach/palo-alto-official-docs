---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-cli-quick-start/get-started-with-the-cli/find-a-command.html
...
find command keyword displays all commands that contain the specified keyword. 

 You can also view a complete listing of all PAN-OS 9.0 Operational Commands and Configure Commands or
view the CLI Changes in PAN-OS 9.1 . 
