---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/monitoring/appsec-tf-2
fetched_at: 2026-09-16T09:09:25Z
source: cortex-platform
---

# Terraform module sources do not use a git url with a tag or commit hash revision misconfiguration de | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Terraform module sources do not use a git url with a tag or commit hash revision misconfiguration de 
 ...
 If you are using a remote module, use the Git URL with a git tag or commit hash. [source,go] 
 ...
 azs = ["eu-west-1a", "eu-west-1b", "eu-west-1c"] private_subnets = ["10.0.1.0/24", "10.0.2.0/24", "10.0.3.0/24"] public_subnets = ["10.0.101.0/24", "10.0.102.0/24", "10.0.103.0/24"] 

 enable_nat_gateway = true enable_vpn_gateway = true 

 tags = { Terraform = "true" Environment = "dev" } } 

 Previous Terraform module sources do not use a git url with a commit hash revision misconfiguration detected 

 Next GuardDuty is not enabled to specific org/region misconfiguration detected in code 
