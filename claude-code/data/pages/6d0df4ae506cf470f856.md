---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/configure-cortex-xsiam/cortex-xsiam-data-sources/cloud-service-provider-csp-onboarding/outpost-onboarding/outpost-cloud-service-provider-csp-permissions/amazon-web-services-aws-outpost-permissions
fetched_at: 2026-08-13T15:00:32Z
...
Amazon Web Services (AWS) outpost permissions | Cortex Documentation Portal 
 ...
 List of Amazon Web Services (AWS) permissions for use during Cortex XSIAM outpost onboarding to enable continuous monitoring in your cloud environment. 
 ...
 * Volumes in the specified account with the request tag: managed_by: paloaltonetworks 
 ...
 Previous Outpost Cloud Service Provider (CSP) permissions Next Microsoft Azure outpost permissions 
