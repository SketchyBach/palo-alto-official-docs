---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-5400-hardware-reference/service-the-pa-5400-series-hardware/replace-a-pa-5400-series-base-card-bc/replace-a-pa-5450-base-card-bc.html
fetched_at: 2026-09-16T11:54:25Z
source: palo-alto-main
---

# Replace a PA-5450 Base Card (BC) Clear
...
pulling it out from the appliance. 
 ...
 With the ejector handles on the replacement BC pointing outwards, slide the
 replacement BC into the appliance. 

 Close the BC ejector handles and fasten both of the BC retaining screws. 

 Re-install the fan drawer by locking its ejector handles into their previous
 positions and then tightening the two screws on the ejector handles. 
