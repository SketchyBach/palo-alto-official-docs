---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/slas/configure-a-playbook-to-run-timersslas
fetched_at: 2026-09-06T11:23:09Z
source: cortex-platform
---

# Configure a playbook to run Timers/SLAs | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure playbooks to run SLAs in Cortex XSOAR 8.6 (EoL) On-prem. 
