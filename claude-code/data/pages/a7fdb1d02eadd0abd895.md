...
# Understanding string manipulation in XQL | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Wildcards using the asterisk (*) return every sequence of characters that contains the specified sequence of characters. 

 Escape sequences, such as \n (new line) or \t (tab), are not processed and are treated as plain characters. 

 Example: "*test" returns test, atest, testb, abtestcd , etc. 
 ...
 Example : """*test""" returns atest, 123test , etc. 
 ...
 Previous How to filter for empty values in the results table 
