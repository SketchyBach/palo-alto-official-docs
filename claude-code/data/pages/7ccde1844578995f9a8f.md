---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-deployNew/t-VSatellite-proxy-server-considerations
fetched_at: 2026-09-16T07:24:43Z
source: palo-alto-main
---

# Using Proxy Servers with VSatellite Clear
...
Updated on 
 ...
 Important: VSatellite supports a basic network proxy, but TLS MITM proxies are not supported and will prevent the installation from working. 
...
export no_proxy=localhost,127.0.0.0/8,0.0.0.0,10.0.0.0/8,192.168.0.0/16,172.16.0.0/12 
 ...
 Note: If you're using sudo to install VSatellite, add the -E flag ( sudo -E ./vsatctl install ) to preserve the environment variables during the installation process. 
