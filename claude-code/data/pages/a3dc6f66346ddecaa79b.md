---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/endpoint-security/install-and-manage-endpoints/set-up-endpoint-protection/harden-endpoint-security/host-firewall/host-firewall-for-windows
fetched_at: 2026-09-16T08:44:07Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 After you create the host firewall extensions profile, you can perform additional actions. The changes take effect on the next heartbeat. From Endpoints → Policy Management → Extensions → Policy Rules , right-click to: 
