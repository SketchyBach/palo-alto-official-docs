---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-json-file
fetched_at: 2026-09-06T10:22:47Z
source: cortex-platform
---

# Create a custom widget using a JSON file | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create JSON widgets in Cortex XSOAR 8 SaaS. 
 ...
 You can see the incidents are grouped by severity, and the number of incidents is displayed by the length of the bar, which is colored according to type. 
