---
url: https://docs.paloaltonetworks.com/autofocus/autofocus-admin/autofocus-tags/tag-concepts/tag-status
...
Tag Status 
 ...
 On the Tags page, view the status for a specific tag;
optionally, select Sort by: Status to sort
tags based on the status of the tag. 
 ...
 Enabled tags generate alerts when matched
...
also sent for enabled tags. 
 ...
 Disabled tags are tags that have been disabled
...
tags are not applied to future samples. 
 ...
 The tag owner has deleted the tag, but the
...
removed from the AutoFocus system. 
 ...
 The tag owner has modified the tag visibility
