---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-62
fetched_at: 2026-09-06T11:15:16Z
source: cortex-platform
---

# RapidAPI Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The RapidAPI Key grants access to APIs via the marketplace. 

 Exposure can lead to misuse or abuse of API services and consumption of allocated API limits, resulting in billing fraud. 
 ...
 Previous Python Package Index Key detected in code 

 Next Readme API Key detected in code 
