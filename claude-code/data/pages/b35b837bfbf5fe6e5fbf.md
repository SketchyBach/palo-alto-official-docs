...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If a user manually updates a field, that field is "detached" from future automatic updates to preserve the user's input. 

 The system visually flags this field as "Out of Sync," and users can select "Revert to Automatic Update" if they want to unlock it and resync with the latest upstream threat intelligence. 
