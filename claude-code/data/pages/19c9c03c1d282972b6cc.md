---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/m-300-m-700-appliances-hardware-reference/service-m-300_m-700/interpret-port-leds-m-300_m-700.html
fetched_at: 2026-09-16T12:09:06Z
source: palo-alto-main
---

# M-300 and M-700 Appliance Port LEDs Clear
...
Updated on 
 ...
 Learn how to interpret the port LEDs on an M-300 and
M-700 appliance. 

 The following table describes how to interpret the status
of port LEDs on M-300 and M-700 appliances. The only difference
between the port LEDs on these appliances is that the M-700 appliance
has two additional SFP+ port LEDs. 

 For information on interpreting the front-panel system LEDs,
see M-300 Appliance Front Panel or M-700 Appliance Front Panel descriptions. 
