---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/managing-discovered-certificates/viewing-failed-pending-csrs
fetched_at: 2026-08-13T16:39:12Z
source: palo-alto-main
---

# Viewing Failed or Pending Certificate Signing Requests (CSRs) Clear
...
Viewing Failed or Pending Certificate Signing Requests (CSRs) 
 ...
 After you submit a certificate signing request (CSR), you can track its status to determine whether the request is pending, failed, or successful. Reviewing failed or pending requests helps you identify issues and correct them before resubmitting. 

 To View Failed and Pending CSRs 

 Sign in to Next-Gen Trust Security. 

 Click Insights > Certificate Requests > Certificate Requests . 

 The Certificate Requests list is filtered by default to show requests with a Pending or Failed status. 

 Tip: To view successful certificate requests, clear the status filter. 

 Click a certificate request to view its details and see why the request did not succeed. 

 Correct any errors, then resubmit the certificate request. 
