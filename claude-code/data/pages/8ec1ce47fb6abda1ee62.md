---
url: https://cortex-docs.paloaltonetworks.com/xsiam-data-model-schema/fields/source/host
fetched_at: 2026-09-06T10:56:47Z
source: cortex-platform
---

# xdm.source.host | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 xdm.source.host.os_distribution 

 Description 

 The operating system distribution of the source host that initiated the activity. 
 ...
 xdm.source.host.os_release 

 Description 

 The operating system distro release of the source host that initiated the activity. 
 ...
 xdm.source.host.state 

 Description 

 The state of the source host that initiated the activity. 
 ...
 xdm.source.host.found_in_vm_image 

 Description 

 Whether a finding present on of the source host that initiated the activity. 
