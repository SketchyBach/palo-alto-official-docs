---
url: https://docs.prismacloud.io/admin-guide/32/vulnerability-management/vmware-tanzu-blobstore
fetched_at: 2026-09-16T13:37:28Z
source: prisma-cloud
---

# Configure VMware Tanzu Blobstore Scanning | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 (Optional) In Foundation , specify the foundation of the blobstore to scan. The foundation name will then be added as a label to the droplets scanned on this blobstore, which allows you to use it as a criteria for Collections . 
 ...
 In Application name , specify the droplets to scan. Wildcards are supported only at the beginning and at end of the application name. To scan all droplets, enter a single wildcard ( * ). 

 In Cap , specify the maximum number of droplets to scan. To scan all droplets, enter 0. 
 ...
 Previous Configure Serverless Function Scanning 

 Next Scan App-Embedded Workloads 
