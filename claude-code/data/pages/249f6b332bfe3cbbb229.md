---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/asset-managment/asset-classes/external-surface-assets/service-assets
fetched_at: 2026-09-06T09:54:50Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Track exposed internet services, classifications, and inferred vulnerabilities. 
 ...
 A Business Unit is a designation to classify assets. Cortex Cloud tracks business units as a means to identify owning organizations of these assets. Business units become extremely important when an organization has subsidiaries and groups established through M&A activities. 

 Discovery type 

 Services are identified with one of the following two discovery types, depending on the level of confidence Cortex Cloud has in attributing it to your organization. 
 ...
 No — indicates the service is inactive, which means Cortex Cloud no longer sees it on the internet. 
 ...
 The application-level protocol on the public internet over which Cortex Cloud validated the service. 
