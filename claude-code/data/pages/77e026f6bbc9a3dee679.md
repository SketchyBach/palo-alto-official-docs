---
url: https://docs.paloaltonetworks.com/pan-os/10-2/pan-os-release-notes/pan-os-10-2-0-known-and-addressed-issues/pan-os-10-2-0-known-issues
fetched_at: 2026-08-13T17:06:58Z
source: palo-alto-main
---

# PAN-OS 10.2.0 Known Issues Clear
...
See PAN-OS 10.2.1 Addressed Issues . 

 On the Panorama management server, edits
...
current status of connected WildFire appliances. 
 ...
 When upgrading a ZTP firewall from PAN-OS 10.2 to PAN-OS
 ...
 unable to modify or add filters to profiles under Panorama Network Routing Routing Profiles Filters , despite having the necessary read and write
 privileges. 
...
you Preview Changes ( Commit Push to Devices Edit Selections or Commit Commit and Push Edit Selections ). 
 ...
 During the CN-Series firewall deployment
on Oracle OKEplatform, when you delete the deployment by deleting yamls,
the MP/DP pods are stuck in Terminating state. 
...
now resolved. See PAN-OS 10.2.3 Addressed Issues . 
 ...
 The Traffic Activity and SSL/TLS widgets
...
in the PAN-OS Administrator’s Guide. 
 ...
 This issue is
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
...
now resolved. See PAN-OS 10.2.2 Addressed Issues . 
 ...
 Running any version of PAN-OS 10.2 on a
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 Panorama is unable to distribute antivirus
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 On deploying the HA with 10.2.0-98 in Packet-mmap mode,
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 When the Advanced Threat Prevention license
...
to install under Device Dynamic
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 Device Group and Template administrator
roles don't support a context switch between the Panorama and firewall web
interface. 

 Workaround: Use a Superuser or Panorama administrator
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 On the Panorama management server, you must
...
latest ZTP Plugin 1.0 version. 

 Workaround: Before you
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 After successful upgrade to PAN-OS 10.2,
...
upgraded displays the following error: 
...
web interface after upgrading to PAN-OS 10.2. 
 ...
 Close the browser and log in to the
firewall or Panorama web interface from an entirely new browser session. 

 Clear your browser cache for the browser from which you upgraded
the firewall or Panorama. 

 Log in to the firewall or Panorama web interface from the browser
in Incognito mode. 
 If you upgraded the firewall or Panorama from
a browser in Incognito mode, close the browser and log in to the
firewall or Panorama web interface from an entirely new browser
session. 
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 On the Panorama management server, a selective
push ( Commit Push
to Devices Push Changes Made By and Commit Commit and Push Commit and Push Changes Made By )
...
version for the Shared Policy and Template configuration ( Panorama Managed Devices Summary ) are 20 version or more
older than the current local running configuration on Panorama. 

 To
determine the current configuration version, select Panorama Config Audit and expand
the Local Running config menu to review the
list of Panorama configuration versions. 
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 Individual configuration objects cannot
be viewed when you commit selective configuration changes ( Commit Commit Changes Made By )
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 The management interface of the PA-3400
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 On the Panorama management server, you must download
...
does not display the ZTP plugin until you install ZTP Plugin 2.0. 
...
search for the ztp plugin. 

 Download and Install ZTP
Plugin 2.0. 
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 The WildFire analysis report cannot be viewed
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 On the Panorama management server, a selective
push ( Commit Push
to Devices Push Changes Made By and Commit Commit and Push Commit and Push Changes Made By to managed
...
the renamed device group, template, or template stack. 

 Workaround: After
you rename the existing device group, template, or template stack, Push ( Commit Push to Devices all
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 The URL filtering logs generated by traffic
...
now resolved. See PAN-OS 10.2.1 Addressed Issues . 
 ...
 The Activity (ACT) LEDs on the RJ-45 ports
...
example, tunnel.1). 
 ...
 No results are displayed when
you Show Application Filter for a Security
policy rule ( Policies Security Application Value Show Application Filter ). 
