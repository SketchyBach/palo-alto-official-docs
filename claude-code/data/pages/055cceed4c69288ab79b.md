---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/playbooks/build-your-playbook/add-objects-from-the-task-library/add-manual-tasks-and-blank-tasks/create-a-communication-task
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Communication tasks let you send surveys and collect issue data. 
...
NOTE: Only enter an Effective time if you want the same exact time recorded every time the playbook task executes. 
 ...
 Using selects an integration instance. Leave it empty to use all instances. 
