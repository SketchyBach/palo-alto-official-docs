---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-105
fetched_at: 2026-08-13T17:16:54Z
source: palo-alto-main
---

# PAN-OS XML API Usage Clear
...
PAN-OS XML API Usage 
 ...
 Indicates whether the PAN-OS XML APIs are in use on the device, and the frequency by which the device is responding to XML API requests. 
