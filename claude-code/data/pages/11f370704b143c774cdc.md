---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin.html
fetched_at: 2026-09-16T13:01:36Z
source: palo-alto-main
---

# PAN-OS OpenConfig Plugin Clear
...
Updated on 
 ...
 Automate configuration and telemetry retrieval using the OpenConfig plugin. 
...
retrieval. To Learn more about OpenConfig, visit OpenConfig . The OpenConfig
interface uses gRPC Network Management Interface (gNMI) protocol
for configuration management, telemetry based on the OpenConfig
data models, and gRPC Network Operations Interface (gNOI) for operational
services defined by OpenConfig. 

 Review important information about new features, open issues
and workarounds, and addressed issues: 
 ...
 PAN-OS Plugin for OpenConfig 2.0.0 
