---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/8-1/pan-os-release-notes/pan-os-8-1-addressed-issues/pan-os-8-1-16-addressed-issues.html
fetched_at: 2026-09-16T10:42:16Z
source: palo-alto-main
---

# PAN-OS 8.1.16 Addressed Issues Clear
...
Updated on 
 ...
 Fixed an issue where the timeout for downloading
a PDF of a WildFire analysis report was too short, which caused
missing reports and 404 errors. 

 PAN-151978 

 A fix was made to address an insecure configuration
...
the GlobalProtect Agent settings. 
 ...
 Fixed an issue where the log export query
...
(LPC) after a commit push from Panorama due to a race condition. 
 ...
 Fixed an issue where the TCP timestamp was
...
a process ( varrcvr ) attempted to register to the cloud. 
 ...
 In accordance with the latest NIST Revision,
