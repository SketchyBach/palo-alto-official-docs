---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/data-management/data-ingestion/palo-alto-networks-integrations/ingest-data-from-next-generation-firewall
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collection of firewall data from multiple accounts is supported. Super User permissions on both the Cortex XDR tenant accounts and the NGFW or Panorama accounts are required for this use case. This is only supported for users logged in via the Customer Support Portal (CSP) and not SSO. 
 ...
 Note : Cross CSP (Customer Support Portal) is supported only within the same SFDC hierarchy. Consequently, MSSP use cases where the customer owns one end of the solution are not supported. 
 ...
 On the Collection Integrations page, locate your NGFW data source and select Add Instance to begin a new connection. 
