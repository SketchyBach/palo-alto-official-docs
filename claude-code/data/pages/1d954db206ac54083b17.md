---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/pa-7000-series-module-and-interface-card-information/pa-7000-series-network-processing-cards-npcs/pa-7000-100g-npc/interpret-the-pa-7000-100g-npc-leds.html
fetched_at: 2026-09-16T12:09:05Z
source: palo-alto-main
---

# Interpret the PA-7000 100G NPC LEDs Clear
...
the LED dashboard and port LEDs on the PA-7000 100G Network Processing
Card (NPC). 
...
the current port speed. The LED blinks continuously as long as there
is network activity. 

 As of PAN-OS 9.0, only the first LED on a port illuminates.
For example, if port 25 is connected at 100Gbps, LED 9 illuminates
blue. 
