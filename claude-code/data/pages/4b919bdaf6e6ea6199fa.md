...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure the Database Collector applet for Cortex XSIAM. 
...
If the environment does not meet all Kerberos prerequisites, the applet will automatically fall back to attempting the legacy NTLM authentication mechanism. 
 ...
 Product : Set automatically as db_collector followed by the dataset name configured, such as db_collector_<dataset name> . 
 ...
 Previous Activate CSV Collector 
