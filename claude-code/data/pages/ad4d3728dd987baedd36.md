---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/wildfire/u-v/wildfire-whats-new/latest-wildfire-cloud-features/real-time-wildfire-verdicts-and-signatures-for-pdf-and-apk-files.html
fetched_at: 2026-09-16T11:47:00Z
source: palo-alto-main
---

# Real Time WildFire Verdicts and Signatures for PDF and APK
Files Clear
...
Files 
 ...
 WildFire protections and verdicts for PDF (portable
document format) and APK (android application package) files are
now available immediately after the WildFire cloud completes static
analysis. Products and services that integrate with WildFire can
also access the immediate verdicts to coordinate enforcement to
prevent successful attacks. Additional information about a malicious
file is available in the WildFire sample analysis report when WildFire
