<!-- KOI source: https://docs.koi.ai/guides/protect-ai-tools-with-koi/agent-activity/dev-container-integration-guide.md -->

> For the complete documentation index, see [llms.txt](https://docs.koi.ai/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.koi.ai/guides/protect-ai-tools-with-koi/agent-activity/dev-container-integration-guide.md).
...
```
GET https://docs.koi.ai/guides/protect-ai-tools-with-koi/agent-activity/dev-container-integration-guide.md?ask=<question>&goal=<endgoal>
```
