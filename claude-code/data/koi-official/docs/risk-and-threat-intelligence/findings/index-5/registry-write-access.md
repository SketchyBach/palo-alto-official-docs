<!-- KOI source: https://docs.koi.ai/risk-and-threat-intelligence/findings/index-5/registry-write-access.md -->

> For the complete documentation index, see [llms.txt](https://docs.koi.ai/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.koi.ai/risk-and-threat-intelligence/findings/index-5/registry-write-access.md).
...
1. **Validate Registry Write Access**:
...
```
GET https://docs.koi.ai/risk-and-threat-intelligence/findings/index-5/registry-write-access.md?ask=<question>&goal=<endgoal>
```
