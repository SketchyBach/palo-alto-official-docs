---
url: https://docs.paloaltonetworks.com/ngfw/help/12-2/panorama-web-interface/panorama-templates/panorama-templates-template-variable
...
address. 
 ...
 Hostname —Label or human readable name
 assigned to a device connected to the network. 

 IPv4 Subnet —Subnet for IPv4 IP addresses.
 For example, 1.1.1.0/24 . 

 IPv6 Subnet —Subnet for IPv6 IP addresses.
 For example, 5555::00/24 . 

 Pre Shared Key —Security key for
 authentication when configuring a VPN tunnel. Up to 255
 ASCII or non-ASCII keys are supported. 
