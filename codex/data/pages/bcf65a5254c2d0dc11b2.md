---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-managing/t-VSatellite-delete/c-VSatellite-LastVSat-deleting-implications
fetched_at: 2026-09-16T07:24:48Z
source: palo-alto-main
---

# About Deleting Your Last Available VSatellite Clear
...
Updated on 
 ...
 Before you delete your very last VSatellite, you should consider the implications
carefully. 

 Warning: Deleting the final VSatellite will cause permanent and unrecoverable loss of access to all private key material, even if you have a backup DEK. 

 Impact of Deleting the Last VSatellite 

 The impact of deleting your last available VSatellite depends on the DEK protection mode used by your tenant. 

 Software-Based DEK 

 If you delete the last VSatellite: 

 The DEK is permanently lost. 

 Encrypted data becomes unrecoverable, even if you previously backed up the DEK. 
 ...
 Data access depends on whether the DEK still exists in the configured HSM partition. 

 If the DEK is removed from the HSM, encrypted data becomes unrecoverable. 

 The Recovery wizard is not supported in this mode. 
