---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-interconnect-plugin/interconnect-plugin-110/features-introduced-in-panorama-interconnect-plugin-110.html
fetched_at: 2026-09-16T13:00:32Z
source: palo-alto-main
---

# Features Introduced in Panorama Interconnect Plugin 1.1.0 Clear
...
Updated on 
 ...
 Key features introduced with the Panorama Interconnect
plugin 1.1.0 release: 

 New Panorama Interconnect Feature Description 

 Selective Push to Panorama Nodes 

 Panorama Interconnect now allows you to selectively
push device groups, template stacks, and some common Panorama configurations
from the Panorama Controller to the Panorama Nodes. This enables
you to avoid pushing extraneous configurations to Panorama Nodes
to minimize configuration bloat and operational delays across your
Panorama Interconnect deployment. 
