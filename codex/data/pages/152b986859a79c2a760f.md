---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/renewing-a-certificate/t-run-auto-renewal-manually
fetched_at: 2026-09-16T07:25:30Z
source: palo-alto-main
---

# Running Auto-Renewal and Auto-Provisioning Manually Clear
...
Updated on 
 ...
 By default, auto-renewal runs once per day. You can also run auto-renewal and optional auto-provisioning manually at any time. 

 Prerequisite 

 You must have appropriate administrative permissions to run auto-renewal manually. 

 To Run Auto-Renewal Manually 
 ...
 Review or update your auto-renewal settings if needed: 

 Ensure Enable auto-renewal is enabled 

 Review the Set a global window (in days) 

 Verify the Set a default request policy selection 

 Check whether Automatically provision renewed certificates is enabled 

 Click Save . 

 Click Run Now . 

 After the process starts, Next-Gen Trust Security evaluates all eligible certificates and renews them based on the configured settings. 
