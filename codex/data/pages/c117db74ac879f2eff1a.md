---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-script
fetched_at: 2026-09-06T10:25:29Z
source: cortex-platform
---

# Create a custom widget using a script |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom script-based widgets in Cortex XSOAR 8.14 On-prem. 

 You can use scripts in custom widgets to create dynamic widgets for more complex calculations. For examples of creating widgets using scripts, see the script-based widget examples in this section. 
