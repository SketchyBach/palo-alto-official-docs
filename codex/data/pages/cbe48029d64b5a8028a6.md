---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-vcenter/panorama-plugin-for-vmware-vcenter-210/known-issues-in-panorama-plugin-for-vmware-vcenter-210.html
fetched_at: 2026-09-16T13:00:28Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for VMware vCenter 2.1.0 Clear
...
in the Panorama plugin for VMware vCenter 2.1.0. 

 PLUG-10124 

 Validating the VMware vCenter plugin
setup on Panorama returns an error message even if the credentials
are valid if the password contains & character. 

 Workaround: After entering the credentials, click OK ,
then click Validate . 

 Plug-12020 

 Downgrading from version 2.1.0 to version
1.0.1/1.0.0 fails to display the warning message: Installation
of vmware_vcenter-1.0.1 failed: The plugin cannot be installed.
Please download and install plugin vmware_vcenter with version 2.0.0
or higher. 

 PLUG-12125 

 The vCenter tag contains: 

 vcenter.<vcentername>_<folder>_<datacenter>_<folder>_<cluster>_<tag type>.<tag value> 

 This
string should not exceed 128 characters. 

 Non-user defined tags have the following format: vcenter.<vcenter name>_<folder>_<datacenter>_<folder>_<cluster>_<tag
type>.<tag value>. User-defined tags have the following format:
vcenter.<vcenter name>_<folder>_<datacenter>_<folder>_<cluster>_<tag
category>.<user-defined-tag>. 
