---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-212/whats-new-in-vm-series-plugin-212.html
fetched_at: 2026-09-16T12:59:07Z
source: palo-alto-main
---

# What’s New in VM-Series Plugin 2.1.2 Clear
...
Updated on 
 ...
 The VM-Series plugin 2.1.2 introduces
two new enhancements—boostrapping support for NUMA performance optimization
and Azure Stack API endpoint access. 

 Bootstrapping Support for NUMA Performance Optimization 

 You can now enable NUMA performance optimization as
part of a bootstrap init-cfg.txt file. 

 plugin-op-commands=numa-perf-optimize:enable 

 Azure Stack API Endpoint Access 

 To successfully deploy the VM-Series firewall in high
availability (HA) in Azure Stack, you must provide a Resource Manager
URL when setting up Azure HA. This field should not be populated
when deploying the VM-Series firewall in non-Azure Stack deployments. 
