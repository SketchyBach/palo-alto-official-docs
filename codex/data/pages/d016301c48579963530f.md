---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/service-the-pa-7000-series-hardware/replace-a-pa-7000-series-front-slot-card/replace-a-pa-7000-series-data-processing-card-dpc.html
fetched_at: 2026-09-16T12:08:44Z
source: palo-alto-main
---

# Replace a PA-7000 Series Data Processing Card (DPC) Clear
...
Updated on 
 ...
 You do not have to power off the firewall to install or remove DPCs The procedure to
 replace an NPC is the same for both the PA-7050 and PA-7080 firewalls. 

 The following topics describe how to replace a DPC in a single chassis and in a high
 availability (HA) configuration and provides details on checking the card slot
 status. 
