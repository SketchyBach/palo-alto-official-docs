---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources/fortinet/fortinet-fortigate
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use Fortinet FortiGate data with Cortex XDR. 
 ...
 If you use Fortinet Fortigate firewalls, you can forward network connection logs to Cortex XDR using the Broker VM Syslog Collector applet in a CEF format. 
 ...
 The FortiManager content pack enables managing Fortinet devices through a single console central management system and provides data normalization for FortiManager event logs ingested via Syslog into Cortex XDR. It contains the Fortinet FortiManager Modeling Rule , the Fortinet FortiManager Parsing Rule , and the FortiManager - Install Policy Package on Device playbook. It also includes the following integration: 
