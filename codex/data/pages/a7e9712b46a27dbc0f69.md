---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/onboard-cortex-xsoar/deployment-steps/step-4.-set-up-users-and-roles
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up users, permissions, and predefined roles in Cortex XSOAR 8.14 On-prem. 
 ...
 You can create users locally or by using SAML Single Sign-On (SSO) or LDAP in the tenant. Users authenticate by doing one of the following: 
 ...
 LDAP authentication: Users can be authenticated using their Active Directory or OpenLDAP directory credentials. 
