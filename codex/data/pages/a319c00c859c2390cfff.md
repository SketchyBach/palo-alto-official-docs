---
url: https://docs.prismacloud.io/content-collections/runtime-security/alerts/alert-mechanism
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up once on the platform under for all the supported integrations and use the same integration for sending both CSPM and Runtime Security alerts. 

 Set it up on Runtime Security > Manage > Alerts > Manage for integrations that are only available on Compute. For example, if you want to use the IBM Cloud Security Advisor, or Cortex as your alert provider. 
 ...
 Google Cloud Security Command Center - Only available for onboarded accounts . 

 AWS Security Hub - Only available for onboarded accounts . 
