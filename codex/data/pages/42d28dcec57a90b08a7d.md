---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/deploy-defender/host/auto-defend-host
fetched_at: 2026-09-16T13:35:12Z
source: prisma-cloud
---

# Auto-defend Hosts | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Auto-defend is supported only on Linux hosts. All hosts must meet the system requirements and have either wget or curl installed. Host must be able to communicate to Console on port 443. 

 Auto-defend is supported only for stand-alone hosts, and not for hosts that are part of any GCP-managed instance group or clusters. For hosts that are part of clusters, use one of the cluster-native install options (e.g., DaemonSets on Kubernetes). 
