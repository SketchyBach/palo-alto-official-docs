---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-api/cortex-platform-identity-and-access-management-iam/roles
fetched_at: 2026-09-06T10:54:57Z
source: cortex-platform
---

# Roles | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center arrow-counterclockwise
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 get https://api-cortex.paloaltonetworks.com /platform/iam/v1/role 

 This endpoint retrieves a list of roles and returns their attributes. This API does not list permissions for said roles. To receive that information, please leverage the existing Get-Roles API. Note: 'role_id' refers to the immutable role ID, while 'pretty_name' refers to the display name. 
 ...
 post https://api-cortex.paloaltonetworks.com /platform/iam/v1/role 
 ...
 delete https://api-cortex.paloaltonetworks.com /platform/iam/v1/role/ {role_id} 
 ...
 get https://api-cortex.paloaltonetworks.com /platform/iam/v1/role/permission-config 
