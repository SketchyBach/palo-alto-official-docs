---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.5/troubleshoot-and-reference/troubleshoot/integration-logs
fetched_at: 2026-09-06T11:25:19Z
source: cortex-platform
---

# Integration logs | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To view all integration logs, navigate to Settings & Info → Settings → Integrations → Integration Logs . 
