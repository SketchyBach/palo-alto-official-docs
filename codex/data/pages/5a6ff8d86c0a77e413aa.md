---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-gcp/panorama-plugin-for-gcp-311/addressed-issues-in-panorama-plugin-for-gcp-311.html
fetched_at: 2026-09-16T12:59:56Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for GCP 3.1.1 Clear
...
Updated on 
 ...
 The following are the fixed issues in the Panorama plugin for GCP 3.1.1. 

 PLUG-15635 

 It was observed that the total time to retrieve DAGs by GCP Plugin 3.1.0 was increasing
 by 3-4 minutes after new service projects were added. This issue is resolved by
 improving performance, and retrieving DAGs now takes less than 30 seconds. 

 PLUG-16110 

 Whenever a service project is deleted from a GCP instance, it was observed that the GCP
 plugin 3.1.0 stopped discovering GCP instances for all service projects. This issue is
 now resolved with improvised error handling for Service Projects tag retrieval
 failure. 
