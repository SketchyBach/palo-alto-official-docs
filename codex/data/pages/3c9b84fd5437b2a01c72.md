---
url: https://docs.paloaltonetworks.com/prisma-browser/administration/the-prisma-browser-extension
...
Updated on 
 ...
 File types - set the that need to match this
 rule. 
 ...
 File types - Set the file types that need to match
 this rule. 
