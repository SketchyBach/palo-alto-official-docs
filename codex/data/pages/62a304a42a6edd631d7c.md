---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/onboard-cortex-xsoar/onboard-and-configure-cortex-xsoar/post-deployment/user-communication
fetched_at: 2026-09-16T09:14:35Z
source: cortex-platform
---

# User communication | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Plan user communication for Cortex XSOAR On-prem 8.6 (EoL). 
 ...
 The Slack content pack enables you to send messages and notifications to your Slack team and integrates with Slack's services to execute create, read, update, and delete operations for employee lifecycle processes. For more information, see Content packs . For more information about Microsoft Teams, see Content packs . 
