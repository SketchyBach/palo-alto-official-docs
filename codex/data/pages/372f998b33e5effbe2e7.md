---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/build-xql-queries/how-to-build-xql-queries/useful-xql-user-interface-features
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the query builder interface to create and run XQL queries. 
