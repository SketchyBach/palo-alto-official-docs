---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-43.html
fetched_at: 2026-09-16T13:56:40Z
source: palo-alto-main
---

# GlobalProtect Gateway Failure Details Clear
...
Updated on 
 ...
 Provides GlobalProtect connection failure details, such as the user who attempted to establish the connection, the portal used, the operating system and version on which the client is running, the client version, the connection method, the login duration, IP and IPv6 values, and the error and error code that is reported by the connection failure. This information is gathered on a per customer, per gateway, and per user basis. 
 ...
 pan_report_gen -t globalprotect -n 5000 -p last-7-days -q "status eq failure" -ac srcuser,portal,client_os,client_os_ver,client_ver,connect_method,public_ip,public_ipv6,error,error_code -s nunique-of-users 
