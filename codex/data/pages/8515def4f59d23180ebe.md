---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-512/whats-new-in-panorama-plugin-for-azure-512.html
fetched_at: 2026-09-16T12:59:27Z
source: palo-alto-main
---

# What's New in the Panorama Plugin for Azure 5.1.2 Clear
...
Updated on 
 ...
 What's New in Azure 5.1.2 

 Loopback zone in Panorama Policy Configuration Zone List 

 The Panorama plugin for Azure 5.1.2 adds support for configuring your
 security policy with service route traffic from Loopback zone to Private or Public
 zone. 

 DNS Proxy Setting Visible in Panorama 

 The Panorama plugin for Azure 5.1.2 introduces support for DNS proxy
 setting display in the Panorama console. Go to the Networks tab in Panorama,
 and then click DNS proxy to view the DNS proxy settings of your cloud device
 group. 
