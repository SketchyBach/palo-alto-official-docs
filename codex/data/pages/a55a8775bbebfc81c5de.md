...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the COLLECT command to collect parsed data. 
 ...
 COLLECT syntax is derived from Cortex Query Language (XQL) with a few modifications as explained in Parsing Rules file structure and syntax . In addition, COLLECT rules contain the following syntax add-ons: 
 ...
 While the XQL stages alter and fields are permitted in COLLECT rules for various vendors and products, you should avoid using them for supported vendors that can be used for Analytics as these stages can disrupt the operation of the Analytics Engine. For a list of these vendors, see the Complete data source catalog . 
