---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/engines/troubleshoot-engines
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 After installing the engine, check that the engine is connected to the Cortex XDR tenant and that it is running. 
 ...
 To check the connectivity from the engine to the Cortex XDR tenant, see Troubleshoot engine connectivity below. 
 ...
 Ensure that the engine can reach the endpoint by running the following command on the engine server. 
 ...
 This error might occur when a connection is established between an engine and the Cortex XDR tenant, because, by default, Linux does not allow processes to listen on low-level ports. 
 ...
 This error can occur in the engine logs relating to a bad handshake on the engine trying to connect to a Cortex XDR tenant. 
