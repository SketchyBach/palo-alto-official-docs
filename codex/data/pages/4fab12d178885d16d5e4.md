---
url: https://docs.prismacloud.io/content-collections/application-security/get-started/manage-roles-permissions
fetched_at: 2026-09-16T13:35:35Z
source: prisma-cloud
---

# Manage Roles and Permissions | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn more about the roles and permissions when Application Security subscription is enabled. To know more about roles and permissions on Prisma Cloud see Prisma Cloud Administrator Permissions 
 ...
 For further details see, Create Custom Prisma Cloud Groups . 
 ...
 Previous Application Security License Types 
