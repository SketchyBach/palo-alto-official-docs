---
url: https://docs.paloaltonetworks.com/sase/prisma-sase-multitenant-platform/monitor-alerts
fetched_at: 2026-08-13T17:34:49Z
source: palo-alto-main
---

# Monitor Security Alerts Through the Strata Multitenant Cloud Manager Clear
...
Monitor Security Alerts Through the Strata Multitenant Cloud Manager 
 ...
 If you activate a SASE license or a Prisma Access license
for your tenant, you can view detailed reports on the security and
network alerts seen by your tenants. To view this information, access
the Strata Multitenant Cloud Manager and select Alerts
& Alarms Security Alerts . 

 You can view the alert information for a specific tenant and
all its children or for all tenants. You can also specify the time
range for which you want the reports to display, the alert type
that you want to see, and the alert severity level. 
...
convenience. 
 ...
 Displays the total number of alerts and
the distribution of alerts by their severity category: 
 ...
 Displays a graph of the number of network
alerts seen over time. 

 Network Alerts 

 Displays details about alerts seen tenant
by tenant including information such as the number of critical alerts
seen by the tenants, and the total number of tunnel down events.
You can use the column picker to show and hide columns and to set
