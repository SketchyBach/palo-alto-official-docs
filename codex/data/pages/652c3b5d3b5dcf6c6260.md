---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/generic-on-premise-data-collectors/xdr-collectors/xdr-collector-profiles/ingest-windows-dns-debug-logs-using-elasticsearch-filebeat
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In the Log file section, for File path and name , enter the file path and log name of your Windows DNS logs, such as c:\Windows\System32\dns\DNS.log . This path will also be configured in your filebeat.yml file, as explained in a later step (see Example 83, “Example” ). 
 ...
 Next Add an XDR Collector profile for Linux 
