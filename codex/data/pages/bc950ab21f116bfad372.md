---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/monitor-tenant-devices.html
fetched_at: 2026-09-16T12:47:36Z
source: palo-alto-main
---

# Monitor Tenant Devices Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn how to monitor tenant devices in the Strata Multitenant Cloud Manager . 

 If you activate a Prisma SD-WAN license for
your tenant, you can view detailed reports on the devices seen by
your Prisma SD-WAN tenants. To view this information, access the Strata Multitenant Cloud Manager and select Monitor Devices . 

 You can view
the device information for a specific tenant and all its children. 
...
devices. 
 ...
 The Devices to Controller Connectivity widget depicts the number of online
 and offline devices connected to the Prisma SD-WAN Controller for a branch
 and data center site across your tenants. 

 Tenant
Device Metrics 

 The Tenant Device Metrics widget
displays the number of online and offline devices for individual
tenants. Click a tenant to view the details for the online and offline
devices for the tenant. 

 You can sort devices for branches
and data centers based on their connectivity to the controller by
clicking Online or Offline on
