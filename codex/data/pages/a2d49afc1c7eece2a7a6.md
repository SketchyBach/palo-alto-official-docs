---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-interconnect-plugin/interconnect-plugin-100
fetched_at: 2026-09-16T07:42:22Z
source: palo-alto-main
---

# Panorama Interconnect Plugin 1.0.0 Clear
...
Updated on 
 ...
 Keeping multiple Panorama configurations
in sync to ensure consistency of policies introduces operational
delays and increases security risks related to human errors. Panorama
Interconnect provides centralized management capabilities for operational
ease and scalability. If you have multiple Panorama management servers
that are each managing 1,000 firewalls with identical configurations,
Panorama Interconnect enables you to manage the configuration of
all Panorama management servers from a single location rather than
configuring each Panorama management server individually. For more
information about the Panorama Interconnect plugin, see Panorama Administrator’s Guide . 
