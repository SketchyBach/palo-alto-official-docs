---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-Cloud-discovery-service-sectionOverview/c-Cloud-discovery-service
fetched_at: 2026-09-16T07:24:24Z
source: palo-alto-main
---

# Discovery Services Clear
...
Updated on 
 ...
 Note: Network Discovery is configured for the tenant as a whole, so the page appears only when Tenant is selected in the workspace switcher. Select any other workspace and it disappears from the menu and its URL stops resolving, which means discovery services cannot be created, edited, or run from inside a workspace. Users must have the appropriate Strata Cloud Manager (SCM) role permissions to manage discovery services, and Built-In Accounts must have them to perform API actions on Network Discovery configuration. Certificates that a discovery finds arrive unclaimed: they belong to no workspace until somebody claims them, and a user working inside a workspace can claim them there. See Workspace-Scoped Resources . 
