...
# Set the Default Theme for New Users | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set the default color theme for new Cortex XSOAR 6.14 users with server configuration settings. 
