---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/panorama-plugin-for-azure-320/addressed-issues-in-panorama-plugin-for-azure-320.html
fetched_at: 2026-09-16T12:59:37Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Azure 3.2.0 Clear
...
Updated on 
 ...
 The following list describes issues addressed in the
Panorama plugin for Azure 3.2.0. 

 PLUG-10134 

 Fixed an issue where the Retry logic
failed intermittently with HTTP Error 429 during monitoring. 

 PLUG-8744 

 Fixed an issue when multiple subscriptions
are monitored and few are in failed state while others in success
state, the plugin was only processing the last subscription updates
and sending to Panorama. 
