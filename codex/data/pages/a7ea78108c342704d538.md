---
url: https://docs.prismacloud.io/content-collections/administration/network-security/container-network-exposure/container-network-exposure-overview
fetched_at: 2026-09-16T13:35:09Z
source: prisma-cloud
---

# Overview of Container Network Exposure | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Container Network Exposure 

 Next Pre-requisites and Supported Objects and Platforms for Satellite Deployment 
