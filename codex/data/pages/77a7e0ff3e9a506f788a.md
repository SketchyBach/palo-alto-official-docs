---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/investigate-and-respond-to-threats/incidents-and-indicators-investigation/investigate-an-incident/run-commands-in-the-cli
fetched_at: 2026-09-06T10:25:39Z
source: cortex-platform
---

# Run commands in the CLI |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run system, integration, and script commands from the Cortex XSOAR 8.14 On-prem CLI. 
 ...
 The CLI is not available in the Main Account in a multi-tenant deployment. You can run commands from the Main Account. 
