---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/strata-cloud-manager/aiops/manage-incidents/incident-settings-framework.html
...
Updated on 
 ...
 Strata Cloud Manager records every configuration change to incident settings and
 publishes each modification to the Strata Logging Service log viewer . Click
 Settings Change Log to open Log Viewer, pre-filtered to
 incident settings entries. 
