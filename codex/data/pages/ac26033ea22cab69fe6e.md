...
Windows DHCP via Elasticsearch Filebeat | Cortex Documentation Portal 
 ...
 Previous Ingest logs from Elasticsearch Filebeat Next Ingest logs from Windows DHCP using Elasticsearch Filebeat 
