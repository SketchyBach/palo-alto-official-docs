---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/protect-your-endpoints/endpoint-protection/caas-workloads
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Protect container-as-a-service workloads with Cortex XDR endpoint security. 
...
For User Identity deployment, user must also define the following environment variables: 
 ...
 Create the Cortex XDR container-embedded agent Dockerfile via API: 
 ...
 Upload your Dockerfile. Cortex XDR validates your Dockerfile against the prerequisites. 
