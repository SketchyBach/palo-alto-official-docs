---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/configure-cortex-xsoar/playbooks/customize-your-playbook/extend-context
fetched_at: 2026-09-16T08:54:08Z
source: cortex-platform
---

# Extend context | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, extend context with integration and command data. 
 ...
 Example 22. Extend context using the CLI with the IBM Qradar v3 integration instance 
