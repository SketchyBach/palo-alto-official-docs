---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-managing/co-VSatellite-update-options/t-VSatellite-maintenance-window
fetched_at: 2026-09-16T07:24:45Z
source: palo-alto-main
---

# Define a Maintenance Window for VSatellite Updates Clear
...
Updated on 
 ...
 You can configure a recurring time window when updates to your VSatellites are allowed to run. This helps you manage updates during preferred maintenance hours, minimizing disruption to your environments. 

 Prerequisite 

 You must have one or more deployed VSatellites in your tenant. 

 To Define a Maintenance Window 

 Sign in to Next-Gen Trust Security. 

 In the left navigation pane, select Configurations > VSatellites . 

 At the top right of the VSatellites table, select Edit Maintenance Window . 

 In the modal that appears: 

 From the Repeat dropdown, select how often updates should be allowed—either Day (daily) or one or more days of the week. 

 Under Starts , choose the UTC start time for the window. 

 Under Duration , select how long the window should remain open. Available options are 8 hours , 12 hours , or 24 hours . 

 Review the local time summary displayed under the fields to confirm when the updates will occur in your time zone. 

 (Optional) To revert to the default (24-hour daily window), select Reset To Default . When set to the default, updates occur as they become available. 

 Select Save . 

 You should now see your maintenance window settings applied to all VSatellites in your tenant. Updates and retries will only occur during this configured window unless triggered manually. 
