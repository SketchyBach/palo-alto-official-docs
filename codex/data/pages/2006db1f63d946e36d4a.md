---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine/palo-alto-panorama
fetched_at: 2026-09-16T07:25:17Z
source: palo-alto-main
---

# Create a Palo Alto Networks Panorama Machine Clear
...
Updated on 
 ...
 IP address or hostname of the Palo Alto Networks Panorama 

 Minimum required credentials on Palo Alto Networks Panorama: Choose between user credentials or shared credentials. 
 ...
 A Palo Alto Networks Panorama user with the minimum required permissions to access the XML API.The user must be assigned to an Admin Role Profile with: 
 ...
 If you choose Enter Credentials , enter your Palo Alto Networks Panorama admin credentials in the Username and Password fields. 
