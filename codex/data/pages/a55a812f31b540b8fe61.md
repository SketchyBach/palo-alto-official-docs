---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-script
fetched_at: 2026-09-06T10:38:31Z
source: cortex-platform
---

# Create a custom widget using a script | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create script-based widgets in Cortex XSOAR 8.9 On-prem. 
