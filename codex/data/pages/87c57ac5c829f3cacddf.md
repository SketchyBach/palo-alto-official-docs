---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-45.html
fetched_at: 2026-09-16T13:56:39Z
source: palo-alto-main
---

# GlobalProtect Gateway Connection Performance Clear
...
Updated on 
 ...
 Provides tunnel latency statistics for the GlobalProtect gateway, including the user who established the tunnel, the portal used for the tunnel, and the number of unique users of the tunnel. 
 ...
 pan_report_gen -t globalprotect -n 5000 -p last-7-days -q "eventid eq gateway-tunnel-latency" -ac srcuser,portal,opaque -s nunique-of-users
