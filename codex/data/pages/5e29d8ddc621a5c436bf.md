---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-cli-quick-start/cli-changes/deleted-show-commands.html
...
Updated on 
 ...
 Command line interface 'show' commands that are removed in PAN-OS 9.1: 

 The following commands are no longer available in the 9.1 release. 

 show deviceconfig system update-schedule url-database
show deviceconfig system update-schedule url-database recurring
show deviceconfig system update-schedule url-database recurring none
