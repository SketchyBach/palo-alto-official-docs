---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/reference-and-developer-docs/cortex-agentix-xql/build-xql-queries/query-builder-templates/run-a-free-text-query
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run free-text queries with Query Builder in Cortex AgentiX. 
