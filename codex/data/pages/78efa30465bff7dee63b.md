...
# Enable Available Add-Ons for Prisma Access (Managed by Strata Cloud Manager) and Add-Ons Through Common Servicess Clear
...
Updated on 
 ...
 Enable Available Add-Ons for Prisma Access (Managed by Strata Cloud Manager) and Add-Ons Through Common Services s 
 ...
 After you activate a license, allocate a license , and plan service connections , continue to enable
 the available add-ons. 

 Products or Add-ons are enabled
 ...
 For the CASB Bundle, SaaS Security Inline URL
 Subnet is the URL to launch the corresponding service
 web interface. 

 For IoT Security, enter a unique App Subdomain 
 ...
 Add your Strata Logging Service for storing tenant data such as
