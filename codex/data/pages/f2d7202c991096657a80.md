---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/cloud-service-provider-csp-onboarding/amazon-web-services-cloud-onboarding/grant-cross-account-kms-key-access-for-control-tower-byob-log-collection
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex role name: The exact name of the IAM role created by the Cortex XDR CloudFormation template in the Log Archive account (e.g., cortex-logs-ingestion-access-* ). You can retrieve this from the Outputs tab of the deployed CloudFormation stack. 
