---
url: https://docs.paloaltonetworks.com/prisma-access/incidents-and-alerts/ai-powered-adem-incidents/incident-inc-globalprotect-portal-auth-timeout-failures-count-exceeded-above-baseline-per-pa-location
...
INC_GLOBALPROTECT_PORTAL_AUTH_ TIMEOUT_FAILURES_COUNT_EXCEEDED_
 ...
 Learn about the
 INC_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED_ABOVE_BASELINE_
 PER_PA_LOCATION incident. 

 Synopsis 

 Portal authentication timeout failures are higher than twice the baseline for
 location <location-name>. 

 Incident
 Code—INC_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED_ABOVE_BASELINE_
 PER_PA_LOCATION 
 ...
 AL_GLOBALPROTECT_GW_USER_AUTH_SUCCESS_COUNT_DROPPED_BELOW_BASELINE_PER_
 PA_LOCATION 
