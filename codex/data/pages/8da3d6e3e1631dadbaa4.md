...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Connection status of the cluster according to the statuses and colors explained in the CLUSTER NAME field above. 
 ...
 List of active applets and the connectivity status for each. 
