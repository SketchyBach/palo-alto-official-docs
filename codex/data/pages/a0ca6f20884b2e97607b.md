---
url: https://docs.prismacloud.io/content-collections/runtime-security/tools/twistcli
fetched_at: 2026-09-16T13:35:32Z
source: prisma-cloud
---

# twistcli | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 3 Twistcli supports scanning Windows images on Windows Server 2016 and Windows Server 2019 hosts. If you need to scan Linux images on a Windows machine, you must install Docker Machine on Windows with the Microsoft Hyper-V driver. Twistcli does not yet support scanning Linux images on Windows hosts using Docker for Windows . 
