...
# Send the Audit Trail to an External Log Service | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Send the Cortex XSOAR 6.13 audit trail to an external log service using server configurations. 
