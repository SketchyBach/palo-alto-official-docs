---
url: https://docs.prismacloud.io/content-collections/cloud-and-software-inventory/cdem-unmanaged-assets-inventory
fetched_at: 2026-09-16T13:35:01Z
source: prisma-cloud
---

# Unmanaged Assets Inventory | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Unmanaged Assets Inventory page is only available if you have subscribed to Discovery and Exposure Management on Prisma Cloud. See Subscribe to Discovery and Exposure Management for more details. 
 ...
 Next Compute Workloads Inventory 
