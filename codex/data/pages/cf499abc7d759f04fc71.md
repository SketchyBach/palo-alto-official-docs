---
url: https://docs.paloaltonetworks.com/sd-wan/help/2-0/panorama-sd-wan-plugin/sd-wan-vpn-clusters
...
between the branch and hub locations. In a full mesh topology ( SD-WAN
Plugin 2.0.1 and later 2.0 releases ), associate SD-WAN branch
firewalls with each other (and optionally with SD-WAN hubs). When
you associate branches and hubs in an SD-WAN VPN cluster, the firewall
creates the required IKE and IPSec VPN connections between the sites
based on the type of VPN cluster you specify. 
...
to the target branch. 
 ...
 Mesh ( SD-WAN Plugin 2.0.1 and later
2.0 releases )—SD-WAN topology that uses hubs and branches,
