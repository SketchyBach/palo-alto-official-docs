---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-520/known-issues-in-the-panorama-plugin-for-azure-520.html
fetched_at: 2026-09-16T12:59:27Z
source: palo-alto-main
---

# Known Issues in the Panorama Plugin for Azure 5.2.0 Clear
...
Updated on 
 ...
 The MongoDB synchronization fails between primary and secondary nodes while storing the
 vm auth key, pin-id, and pin-value. Also, the failover to the secondary node requires
 regeneration of the registration string. 

 DIT-40519 

 The vm_auth_key used by the firewall to connect with Panorama, upon expiration, deletion,
 or invalidation, does not let any new firewalls to connect with Panorama. 
