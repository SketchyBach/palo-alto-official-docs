---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/ci-cd-security/dependency-chains/appsec-cicd-170
fetched_at: 2026-09-16T09:10:55Z
source: cortex-platform
---

# Azure repository missing NPM lock file | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Secrets found in NPM dependency download URL in BitBucket repository 

 Next Unencrypted channel used in Azure repository to download dependencies from NPM registry 
