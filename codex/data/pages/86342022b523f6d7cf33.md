---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/c-VSatellite-BackupRestore-about/c-about-vsat-disaster-recovery/t-disaster-recovery-vsats
fetched_at: 2026-09-16T07:24:39Z
source: palo-alto-main
---

# Recovering Lost VSatellites Clear
...
Updated on 
 ...
 ONLY if you are doing disaster recovery : 

 Issue the following command: 

 sudo ./vsatctl uninstall --force 
 ...
 After the command completes, click Test to verify that the VSatellite is online. 

 If the test fails, ensure the recovery command completed successfully, then rerun the test. 

 Click Done to close the wizard. 

 The restored VSatellite should now appear in Active state on the Next-Gen Trust Security dashboard and resume communication with the control plane. 
