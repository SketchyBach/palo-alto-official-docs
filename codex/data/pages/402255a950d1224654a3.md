---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/endpoint-security/install-and-manage-endpoints/manage-endpoint-protection/move-agents-between-managing-servers
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Log in to Cortex XDR on the target management server, then navigate to Endpoints → Agent Installations . 
 ...
 Right-click + Alt to open the options menu in advanced mode, and select Endpoint Control → Change managing server . This option is available only for an administrator in Cortex XDR and for Cortex XDR agent 7.2 and later. 
