---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.5/configure-cortex-xsoar/marketplace/set-up-your-use-case-with-the-deployment-wizard
fetched_at: 2026-09-16T09:14:12Z
source: cortex-platform
---

# Set up your use case with the Deployment Wizard | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Deployment Wizard guides you step-by-step to quickly adopt your use case in Cortex XSOAR 8.5 (EoL). 
