---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/install-cortex-xsoar/post-installation/https-with-a-signed-certificate
fetched_at: 2026-09-06T10:24:03Z
source: cortex-platform
---

# HTTPS with a signed certificate |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure HTTPS with a signed certificate in Cortex XSOAR 8.14 On-prem and concatenate the certificate chain. 
 ...
 If you apply a custom TLS certificate, it must cover all three tenant hostnames (the cluster, API, and external addresses) either in the Common Name (CN) or, preferably as Subject Alternative Names (SANs). Using a wildcard certificate (such as *.mycompany.com ) is the simplest option. 
 ...
 For more information, see the prerequisites for the Install Cortex XSOAR on your VM task for your deployment type. 
 ...
 set_ssl_certificate --key noPwd.key --cert example.crt 
 ...
 Example: Export External Dynamic Lists (EDLs) to a firewall 
