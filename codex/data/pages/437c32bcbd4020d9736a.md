---
url: https://docs.prismacloud.io/admin-guide/32/vulnerability-management/registry-scanning/scan-google-artifact-registry
fetched_at: 2026-09-16T13:37:28Z
source: prisma-cloud
---

# Google Artifact Registry | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create GCP credentials (service account) with, at minimum, the Artifact Registry Reader role( roles/artifactregistry.reader ) . 
 ...
 Previous Scan Images in GitLab Container Registry 

 Next Google Container Registry 
