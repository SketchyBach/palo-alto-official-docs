---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.11/onboard-cortex-xsoar/back-up-and-restore-cortex-xsoar/common-backup-and-restore-limitations-and-fixes
fetched_at: 2026-09-16T08:54:29Z
source: cortex-platform
---

# Common backup and restore limitations and fixes | 8.11 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Troubleshoot backup and restore issues in Cortex XSOAR 8.11 On-prem. 
 ...
 The backup Cortex XSOAR version must be the same exact version as the currently installed version. For example, if the backup version is 8.11.0.28, you can restore only to 8.11.0.28. 
 ...
 The new cluster must have the same number of nodes as the previous cluster. 
