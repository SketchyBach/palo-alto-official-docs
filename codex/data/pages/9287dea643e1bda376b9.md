---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/iam/appsec-aws-287
fetched_at: 2026-09-06T11:12:04Z
source: cortex-platform
---

# IAM policies allow exposure of credentials misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 resource "aws_iam_policy" "example" { name = "example" path = "/" description = "An example policy" 

 policy = <<EOF { "Version": "2012-10-17", "Statement": [ { "Action": [ "ec2:Describe*" ], "Effect": "Allow", "Resource": "*" } ] } EOF } 

 resource "aws_iam_role_policy_attachment" "test-attach" { role = aws_iam_role.test_role.name policy_arn = aws_iam_policy.example.arn } 

 Previous AWS IAM Policy permission may cause privilege escalation misconfiguration detected in code 

 Next IAM policies allow data exfiltration misconfiguration detected in code 
