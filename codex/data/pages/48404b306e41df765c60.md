---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-upgrade/upgrade-pan-os/troubleshoot-pan-os-upgrade
...
upgrade to 9.0. 
 ...
 This issue occurs due to a network connectivity
...
After Clicking On Check Now Button . 
 ...
 In PAN-OS 9.1 and later versions, a device
certificate must be installed. To install the certificate: 

 Log
in to the Customer Support Portal. 
...
firewall by establishing a new connection to the update server. 
...
to it by the DHCP server. 
 ...
 Configure a security policy rule allowing the
