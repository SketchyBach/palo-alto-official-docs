---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-102/addressed-issues-in-panorama-plugin-for-vmware-nsx-102.html
fetched_at: 2026-09-16T13:00:19Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 1.0.2 Clear
...
in the Panorama plugin for VMware NSX 1.0.2. 

 PLUG-246 

 Fixed an issue that prevented Panorama
and the NSX Manager from successfully establishing a connection.
With this fix, the connection is successful, and Panorama displays
the connection status as Registered to indicate
that Panorama and the NSX Manager are in sync. 
