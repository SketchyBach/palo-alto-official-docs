...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Explore Cortex XSIAM custom issue field types, including text, selection, date, grid, HTML, Markdown, timer, and URL fields. 
 ...
 Previous Manage Cortex XSIAM issue fields 

 Next Create custom issue fields 
