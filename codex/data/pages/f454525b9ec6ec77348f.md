---
url: https://docs.prismacloud.io/content-collections/runtime-security/agentless-scanning/agentless-scanning-modes
fetched_at: 2026-09-16T13:35:16Z
source: prisma-cloud
---

# Agentless Scanning Modes | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Scales only within the hub account, overall scan duration is longer. This effect is because agentless can only scale across the maximum number of scanners defined on the hub account, regardless of the number of accounts or regions scanned. Note: In addition, encrypted volumes in AWS are required to be copied, so scaling in hub mode is bottle-necked by the concurrent snapshot copy limit in AWS, which is 20 by default . 
 ...
 Previous Configure Agentless Scanning for OCI 
