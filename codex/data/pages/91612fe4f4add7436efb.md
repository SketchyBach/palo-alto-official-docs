---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-347
fetched_at: 2026-09-06T11:16:13Z
source: cortex-platform
---

# Alchemy API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Alchemy API Key connects DApps to the blockchain via RPC nodes. 

 Exposure is a High Risk allowing an attacker to spam the node endpoint, exhaust compute units (CUs), and effectively take your decentralized application offline. 
 ...
 Previous Langfuse Credentials detected in code 

 Next Alchemy API Key V2 detected in code 
