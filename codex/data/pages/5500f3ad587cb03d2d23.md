---
url: https://docs.paloaltonetworks.com/hardware/pa-7000-hardware-reference/pa-7000-series-module-and-interface-card-information/pa-7000-series-firewall-log-cards/pa-7000-series-log-processing-card-lpc/interpreting-the-pa-7000-series-amc-leds
fetched_at: 2026-08-13T16:35:21Z
source: palo-alto-main
---

# Interpret the PA-7000 Series Firewall AMC LEDs Clear
...
the LED dashboard located on the front of the AMC. The Log Processing
Card (LPC) does not have LEDs. If there is a hardware issue with
the LPC, the LOG LED on the Switch Management Card (SMC) changes
to red and the firewall generates a system log. 
 ...
 The LED is red if a drive is missing or
faulty. 
