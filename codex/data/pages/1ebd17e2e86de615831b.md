---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/cortex-cloud-data-sources-and-connectors/standard-data-sources
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Standard data sources are built-in ingestion mechanisms in Cortex Cloud primarily focused on ingesting raw logs and security events. While Cortex Cloud is introducing a unified Connector approach, many third-party services and file-based ingestions continue to use standard data sources for core security analysis and normalization. 
 ...
 Standard data sources are configured using the Data Source Onboarder. Unlike the multi-capability connector wizard, the onboarder is focused on a specific stream of data, such as Okta logs. 
