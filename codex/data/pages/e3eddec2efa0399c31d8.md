---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine/f5-big-ip-ltm
fetched_at: 2026-09-16T07:25:13Z
source: palo-alto-main
---

# Create an F5 BIG-IP LTM Machine Clear
...
Updated on 
 ...
 Creating a machine enables Next-Gen Trust Security to connect directly to an F5 BIG-IP LTM so certificates can be provisioned to its keystores. After creating the machine, you can provision certificates to it. 

 Before You Begin 

 Hostname or IP address of the F5 BIG-IP LTM. 

 Port number, if the F5 uses a port other than 443. 

 Credentials with administrative permissions on the F5 BIG-IP LTM. 

 Supported F5 BIG-IP LTM versions: 13.1.x, 14.1.x, 15.1.x, 16.1.x, and 17.1.x. 

 In F5 BIG-IP LTM Address/Hostname , enter the hostname or IP address of the F5. 

 If the F5 uses a port other than 443, enter the port number in Port . 

 From Credential Type , select one of the following: 
 ...
 Enter the required F5 BIG-IP LTM credentials. 
