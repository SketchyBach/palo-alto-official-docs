---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/users-and-roles-management/manage-access-to-objects/manage-access-to-report-templates
fetched_at: 2026-09-06T10:17:43Z
source: cortex-platform
---

# Manage access to report templates | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage report template sharing, role permissions, ownership, generated report access, and scoped data in Cortex AgentiX. 
 ...
 You can move report templates between different Cortex AgentiX tenants using the import and export functionality. Access and ownership are handled as follows during this process: 
 ...
 Previous Manage access to custom dashboards 

 Next Manage access to playbooks and scripts 
