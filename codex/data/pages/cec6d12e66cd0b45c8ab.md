---
url: https://docs.paloaltonetworks.com/strata-cloud-manager/new-features/by-date/strata-cloud-manager/may-2026#410304991f80f0db03723e4980508ef7
fetched_at: 2026-09-16T07:51:21Z
source: strata-and-sase
---

# New Features - Strata Cloud Manager - May 2026 Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear
...
Focus 
 ...
 Organizations that manage device compliance through a mobile device management (MDM) solution such as Microsoft Intune can now use that compliance status to control whether the Prisma® Agent is authorized to establish a tunnel to Prisma Access, closing a gap where customers are required to maintain MDM as a separate, unsynchronized source of truth. 

 For this feature, the Endpoint Manager will integrate directly with MDM solutions like Microsoft Intune to query device attributes at pre-defined polling intervals. Upon successful user authentication, the Prisma Agent performs pre-defined device authorization checks against Microsoft Intune to determine whether to allow or block the tunnel to Prisma Access. Tunnel establishment to NGFW or Prisma Access gateways is allowed only if the endpoint meets the following criteria: 
 ...
 The Prisma® Agent pre-logon device tunnel addresses security gaps when endpoint management depends solely on user login by establishing secure connectivity before user authentication. Previously, pre-logon functionality operated as a separate connection method with limited transition options. The pre-logon tunnel now works with both always-on and on-demand connections, allowing you to manage device and user connectivity independently. 
 ...
 Site Management: Export, Onboarding Rule Visibility, Pagination, and More 

 Release Date: May 2026 
 | 
 Last Updated: September 2026 

 Site Management in Strata Cloud Manager includes the following updates for large-scale NGFW onboarding: 

 Export resolution results —You can export preview resolution results directly from the Preview Resolution view for offline review or sharing. 

 Export the sites list —You can export the claimed sites list from the Sites page for auditing and reporting. 

 Onboarding rule visibility —Site Property Groups now show which onboarding rule matches each device model family, so you can verify rule coverage before deployment. 

 Netmask support in Bitwise Expression variables —The Bitwise Expression variable resolution type now supports netmasks within the 32-bit segment builder, giving you precise control over subnet mask assignment during IP address generation. 

 Pagination for the Sites list —The Sites list now paginates, making it easier to navigate large site inventories. 

 To set up and use Site Management, see Onboard NGFWs with Site Management . 
