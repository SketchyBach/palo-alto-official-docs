---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/engines/remove-an-engine
fetched_at: 2026-09-16T09:13:31Z
source: cortex-platform
---

# Remove an engine | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Remove an engine from Cortex XSOAR On-prem 8.7 (EoL). 
