---
url: https://docs.paloaltonetworks.com/service-providers/11-0/mobile-network-infrastructure-getting-started/gtp/mobile-network-protection-profile
...
associations or sessions. 
 ...
 Enables correlation between the subscriber
ID and equipment ID to user equipment (UE) IP-based traffic for GTP-U
contentinspection. 
...
results. 
 ...
 Select the source you want to use to correlate
the information. 
 ...
 Log UEIP correlation events when the firewall allocatesan
