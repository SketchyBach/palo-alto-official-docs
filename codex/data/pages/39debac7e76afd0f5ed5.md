...
```
GET https://cortex-docs.paloaltonetworks.com/xdr-agent-release-notes/9.1-ce/cortex-xdr-agent-release-information.md?ask=<question>&goal=<endgoal>
```
