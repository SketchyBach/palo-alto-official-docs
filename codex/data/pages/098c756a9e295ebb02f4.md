---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/pan-os-device-telemetry-overview/collection-frequency.html
fetched_at: 2026-09-16T13:56:30Z
source: palo-alto-main
---

# Collection Frequency Clear
...
Palo Alto Networks next-generation firewalls collect telemetry data on different intervals, but sends data once every four hours.

 PAN-OS collects and sends telemetry data on fixed intervals. Collection is defined on a
 metric by metric basis, and can be one of:
 ...
 Telemetry is collected into data bundles. Each bundle is an aggregation of all the data
 collected up to the point of data transmission. These bundles are stored on the device
 until a transmission event, which occur hourly. When the device successfully sends a
 bundle to Palo Alto Networks, the device deletes the bundle from its local storage. 
