---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/asset-management/manage-asset-scores
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and investigate user and host risk scores in Cortex XSIAM. 
 ...
 Represents the Cortex XSIAM high-risk user score. The score is updated continuously as new alerts are associated with incidents. 

 User name 

 Name of the user as provided by Cortex XSIAM. 
 ...
 Last date and time the user accessed Cortex XSIAM. 
