---
url: https://cortex-docs.paloaltonetworks.com/cortex-xpanse/learn-about-cortex-xpanse/scanning/scanning-ports-and-protocols
fetched_at: 2026-09-06T10:52:19Z
source: cortex-platform
---

# Scanning ports and protocols | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex Xpanse detects protocol-validated services on the IPv4 and IPv6 space of the internet. 

 Cortex Xpanse detects protocol-validated services on the IPv4 and IPv6 space of the internet through a series of specialized payloads that target specific port-protocol pairs. Following are examples of some of the protocols and ports on which Cortex Xpanse checks for active services throughout a standard global scan. 
 ...
 Previous Known Assets Monitoring 
