---
url: https://docs.paloaltonetworks.com/network-security/security-policy/administration/objects/custom-objects
fetched_at: 2026-08-13T16:38:27Z
source: palo-alto-main
---

# Policy Object: Custom Objects Clear
...
Policy Object: Custom Objects 
 ...
 Predefined —Use the predefined data patterns to scan
 files for social security and credit card numbers. 

 Regular Expression —Create custom data patterns using
 regular expressions. 

 File Properties —Scan files for specific file
 ...
 Select Configuration NGFW and Prisma Access Security Services Data Loss Prevention Detection Methods Data Patterns to define the categories of sensitive information that you may
 want to filter. 

 Also, be sure to learn about defining data filtering profiles 

 Select Add Data Patterns Custom and configure the settings in this table to add your custom data
 pattern: 
 ...
 for Anti-Spyware profiles . Configuration NGFW and Prisma Access Security Services Anti-Spyware 

 Use the Custom Vulnerability Signature page to define
 signatures for Vulnerability Protection
 profiles . Configuration NGFW and Prisma Access Security Services URL Access Management 
 ...
 must be included for a negate condition to be
 ...
 Go to Configuration NGFW and Prisma Access Security Services URL Access Management , and Add Category to create your custom
