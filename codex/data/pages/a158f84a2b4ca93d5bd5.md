---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-addressed-issues/pan-os-9-1-2-addressed-issues
fetched_at: 2026-08-13T17:14:19Z
source: palo-alto-main
---

# PAN-OS 9.1.2 Addressed Issues Clear
...
Appliance to stop responding. 
 ...
 Fixed an issue where performing private
...
appliance was displayed in cleartext when using the CLI in PAN-OS ( CVE-2020-2048 ). 
 ...
 Fixed an issue where a process ( rasmgr )
...
read another process ( mongod ). 
 ...
 Fixed an issue where dynamic DNS (DDNS)
...
to PAN-OS 9.1.0. 
 ...
 Fixed an issue with a process ( snmpd )
and booting errors. 
...
of the targeted device instead of the hostname. 
 ...
 Fixed an issue with GPRS tunneling protocol
(GTP) event packet capture (pcap) where enabling Packet Capture did
not work. 

 PAN-136453 

 Fixed an issue where performing a private
...
failed due to incorrect parsing of the HTML webpage. 
 ...
 Fixed an issue where connections leading
...
machine. 
 ...
 Fixed an issue where management access to
...
expired Large Scale VPN (LSVPN) certificates. 
 ...
 Fixed an issue where configuration related
...
due to failed LDAP over SSL (LDAPS) requests. 
 ...
 Fixed an issue where Resolve in
...
enabled after an application change. 
 ...
 Fixed an issue where DNS security incorrectly
...
IP addresses. 
 ...
 A fix was made to address a NULL pointer
...
the URL database caused high device-server CPU usage. 
 ...
 Fixed an issue where the API key limit in
...
validation. 
 ...
 Fixed an issue where a nullification method
...
import of software, content, and plugins. 
 ...
 Fixed an issue where performing a factory
