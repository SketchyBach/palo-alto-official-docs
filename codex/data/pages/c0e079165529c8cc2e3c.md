---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-2/pan-os-upgrade/upgrade-pan-os/upgrade-the-firewall-pan-os/upgrade-an-ha-firewall-pair.html
...
you are upgrading HA peers from PAN-OS 10.0 to PAN-OS 10.2. You
must upgrade both HA peers to PAN-OS 10.1 before you can continue
upgrading to the target PAN-OS 10.2 release. When HA peers are two
...
content release version or a later version required for PAN-OS 10.2, Check
...
verifies that HA failover is functioning properly before you upgrade. 
 ...
 Install
PAN-OS 10.2 on the suspended HA peer. 
...
are displayed. For example, if the PAN-OS 10.2 is installed on the
firewall, then only PAN-OS 10.2 releases are displayed. 
...
to transition to Active state. 
 ...
 Install
PAN-OS 10.2 on the secondary HA peer. 
