---
url: https://docs.paloaltonetworks.com/prisma-browser/administration/manage-prisma-browser-policy-profiles/configure-prisma-browser-data-controls/webpage-element-removal
...
Updated on 
 ...
 When you identify elements to remove, you need to be aware that
 the CSS selector tool cannot be used to target elements embedded within
 iframes or elements rendered inside a Shadow DOM. Target elements
 must be part of the main Document Object Model (DOM). 
