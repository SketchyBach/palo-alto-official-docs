---
url: https://cortex-docs.paloaltonetworks.com/8.x/8.8-eol/cortex-xdr-agent-8.8-release-information/cortex-xdr-agent-known-issues
fetched_at: 2026-09-16T09:13:37Z
source: cortex-platform
---

# Cortex XDR agent known issues | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 See the list of the known issues in Cortex XDR agent 8.8. 

 The following table describes known issues in the Cortex XDR agent 8.8. 
 ...
 Previous Addressed issues in Cortex XDR agent 8.8.0 
