---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates/considerations-for-using-query-builder-templates
fetched_at: 2026-09-06T09:33:03Z
source: cortex-platform
---

# Considerations for using Query Builder templates | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review Cortex XSIAM Query Builder template requirements and limitations. 
 ...
 Previous Get started with Query Builder templates 

 Next Create a query from a template 
