---
url: https://docs.prismacloud.io/content-collections/administration/add-a-resource-list-on-prisma-cloud
fetched_at: 2026-09-16T13:35:07Z
source: prisma-cloud
---

# Add a Resource List on Prisma Cloud | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Target Compute workloads—hosts and container images—for which you want to trigger alerts using an alert rule with workload protection policies . 
 ...
 When you Create Prisma Cloud Roles and attach the resource list to the role, verify that the role is assigned at least one account group or is enabled for access to data from On-prem/ Other cloud providers . 
 ...
 Previous Set up Just-in-Time Provisioning on OneLogin 

 Next Create and Manage Saved Views 
