---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/pa-7000-series-firewall-overview/pa-7080-front-and-back-panel-descriptions/pa-7080-back-panel-dc.html
fetched_at: 2026-09-16T12:09:07Z
source: palo-alto-main
---

# PA-7080 Back Panel (DC) Clear
...
Front and Back Panel Descriptions 
 ...
 The following image shows the back panel of the PA-7080 firewall
(with DC power supplies installed). 

 The only differences between the back panel AC model and the
back panel DC model is that the DC model has two DC Power Entry
Modules (PEMs) instead of two AC PEMs. Each DC PEM contains two
terminal strips, which connect eight wires (4 red positive and 4
black negative). The DC PEMs are field replaceable. For information
on replacing a DC PEM, see Replace
a PA-7080 DC PEM and for descriptions of the back panel components,
see PA-7080
Back Panel (AC) . 
