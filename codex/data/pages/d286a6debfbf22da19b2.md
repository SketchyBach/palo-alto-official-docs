---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/pan-os-device-telemetry-overview/telemetry-tiers.html
fetched_at: 2026-09-16T13:56:31Z
source: palo-alto-main
---

# Telemetry Tiers Clear
...
Updated on 
 ...
 Learn about the telemetry tiers. 

 Beginning with PAN-OS 10.2.17, 11.1.11, 11.2.8, 12.1.2, and later releases, the telemetry autoenablement feature configures
 ...
 controlled through . This centralized approach ensures consistent
 telemetry settings across your entire environment. Metrics are automatically streamed to
 your data residency region, eliminating the need for manual configuration. You can manage telemetry settings from either your hub
 or Strata Cloud Manager. 

 To ensure regulatory compliance and streamline telemetry enablement, telemetry
 is categorized into two tiers: 

 Diagnostic tier: Provides crucial information which enables users to
 determine system operational status and identify immediate causes of system
 failures. It includes features essential for basic operational awareness,
 effective troubleshooting of common issues, and monitoring critical system
 aspects. 

 Full tier: Expands upon the diagnostic tier by providing specialized,
 granular, and feature-rich capabilities. This tier facilitates deep analysis,
 performance tuning, and proactive system optimization, moving beyond immediate
 problem resolution. 
