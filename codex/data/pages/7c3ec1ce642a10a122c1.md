---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-posture-management/serverless-function-posture-security/serverless-function-posture-rules/create-a-network-exposure-rule-for-serverless-functions
fetched_at: 2026-09-16T08:48:02Z
source: cortex-platform
---

# Create a network exposure rule for serverless functions | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Cortex Cloud Posture Management rules that detect serverless function network exposure. 
 ...
 Previous Create a configuration rule for serverless functions 

 Next Serverless function posture policies 
