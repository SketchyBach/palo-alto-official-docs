---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/set-up-your-environment/configure-security-settings
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure login sessions, access restrictions, and user expiration settings. 

 You can configure security settings such as how long users can be logged in Cortex XDR, and from which domains and IP ranges users can log in. 
