---
url: https://docs.prismacloud.io/content-collections/runtime-security/waas/waas-custom-rules
fetched_at: 2026-09-16T13:35:27Z
source: prisma-cloud
---

# Custom Rules | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
Selector operator. Selects a specific value by key from a map. Headers, cookies, body params, and query params are maps. The selection operation template is as following: 
 ...
 Custom rules are defined in Runtime Security > Defend > Custom rules > WAAS . WAAS policy rules are defined in Runtime Security > Defend > WAAS > {Container | Host | App-Embedded | Agentless} > {In-line | Out-Of-Band} . 
 ...
 Prerequisites: You have already set up WAAS to protect an app, and there’s a rule for it under Runtime Security > Defend > WAAS > {Container | Host | App-Embedded | Agentless} > {In-line | Out-Of-Band} . For more information about setting up an app, see Deploy WAAS . 
 ...
 Previous API Definition Scan 

 Next Unprotected Web Apps 
