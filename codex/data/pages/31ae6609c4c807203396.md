---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/response-actions/manage-external-dynamic-lists
fetched_at: 2026-09-06T09:45:05Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create and manage external dynamic lists for enforcement. 
 ...
 You do not need to perform an additional commit or make any subsequent configuration changes for the firewall to enforce the EDL as part of your security policy; even as you update the EDL, the firewall will enforce the list most recently retrieved from Cortex XDR . 
