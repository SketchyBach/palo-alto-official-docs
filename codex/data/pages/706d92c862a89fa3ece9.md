---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/approx_quantiles
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The name of the field for which to calculate approximate quantiles. 
 ...
 An integer specifying the number of quantiles to compute. The output array will contain <number> + 1 elements. 
 ...
 Determines whether to consider only distinct values ( true ) or all values ( false ). If omitted, the default is false . 
 ...
 Functions : approx_count , approx_top 
