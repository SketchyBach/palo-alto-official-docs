---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/incidents/incident-de-duplication/automatic-de-duplication-using-scripts
fetched_at: 2026-09-16T08:56:14Z
source: cortex-platform
---

# Automatic De-Duplication Using Scripts | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Automate Cortex XSOAR 6.14 incident de-duplication with scripts. 
 ...
 For each candidate, concatenate the name and details incident fields [textFields=name,details] into a text document. 
 ...
 Check for a candidate with the same Email/from label, or similar Email/subject label: 
