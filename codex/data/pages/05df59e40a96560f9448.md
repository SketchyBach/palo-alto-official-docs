---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-upgrade/upgrade-pan-os/upgrade-the-firewall-pan-os/upgrade-an-ha-firewall-pair
...
you are upgrading HA peers from PAN-OS 9.1 to PAN-OS 10.1. You must
upgrade both HA peers to PAN-OS 10.0 before you can continue upgrading
to the target PAN-OS 10.1 release. When HA peers are two or more
...
release through which you pass as part of your upgrade path. 
 ...
 ( Best Practices ) If you are leveraging Strata Logging Service , install the device certificate on each
 HA peer. 
...
verifies that HA failover is functioning properly before you upgrade. 
 ...
 Install
PAN-OS 10.1 on the suspended HA peer. 
...
to transition to Active state. 
 ...
 Install
PAN-OS 10.1 on the secondary HA peer. 
