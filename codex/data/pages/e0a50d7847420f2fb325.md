---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.13/back-up-and-restore-cortex-xsoar/common-backup-and-restore-limitations-and-fixes
fetched_at: 2026-09-16T08:53:24Z
source: cortex-platform
---

# Common backup and restore limitations and fixes | 8.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Resolve backup and restore issues in Cortex XSOAR 8.13 On-prem. 
 ...
 The backup Cortex XSOAR version must be the same exact version as the currently installed version. For example, if the backup version is 8.13.0.28, you can restore only to 8.13.0.28. 
