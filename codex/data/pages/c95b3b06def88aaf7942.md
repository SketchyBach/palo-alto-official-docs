---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/integrations/integration-use-cases
fetched_at: 2026-09-16T09:14:03Z
source: cortex-platform
---

# Integration use cases | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Explore integration use cases in Cortex XSOAR On-prem 8.7 (EoL). 
