---
url: https://docs.prismacloud.io/admin-guide/32/technology-overviews/radar
fetched_at: 2026-09-16T13:37:19Z
source: prisma-cloud
---

# Radar | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can filter the data based on an entity to narrow down your search. For example, filters can narrow your view to just the serverless functions in your Azure development team accounts. 
