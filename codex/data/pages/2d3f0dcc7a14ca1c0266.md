...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 While case grouping is active, Cortex XDR can continue to link new issues to a case, however, to keep cases manageable, specific grouping thresholds are enforced. For more information see Case thresholds . 
