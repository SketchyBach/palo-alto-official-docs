---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.2/cortex-xdr-agent-for-macos/install-the-cortex-xdr-agent-for-mac/install-the-cortex-xdr-agent-manually
fetched_at: 2026-09-06T10:20:14Z
source: cortex-platform
---

# Install the Cortex XDR Agent Manually | 9.2 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When you are installing the Cortex XDR agent, this warning will be seen twice: first for the Security Extension and then for the Network Extension. However, in both warnings, the operating system displays System Extension Blocked . 
