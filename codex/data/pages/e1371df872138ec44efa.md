...
between Next-Gen Trust Security and that CA. That connection enables Next-Gen Trust Security to manage certificate life-cycles. 
 ...
 Note: Certificate Authorities are parent TSG resources. Only users in the parent TSG can create or configure CA connections. Child TSGs can use CAs for certificate issuance through shared request policies. 
