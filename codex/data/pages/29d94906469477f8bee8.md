---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/parsing-rules/parsing-rules-file-structure-and-syntax
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Understand Parsing Rules file structure, syntax, and commands. 
 ...
 You can't create parsing rules for Next-Generation Firewall (NGFW) datasets that are in the format panw_ngfw_<text>_raw 
