---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/wildfire/u-v/wildfire-api/submit-files-and-links-through-the-wildfire-api.html
fetched_at: 2026-09-16T11:04:41Z
source: palo-alto-main
---

# Submit
Files and Links through the WildFire API Clear
...
Files and Links through the WildFire API 
 ...
 You can use the WildFire™ API to automate submission
of files and links to the WildFire public cloud or WildFire appliance
for analysis. Use these resources to submit supported file types and
links to WildFire for analysis: 
