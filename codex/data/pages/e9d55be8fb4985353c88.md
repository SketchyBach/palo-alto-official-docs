---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/role-based-access-control/investigation-and-response-permissions/search-permissions/host-insights-permissions
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage access to Cortex XSIAM's endpoint inventory, host details, and hygiene data. 
