---
url: https://docs.prismacloud.io/admin-guide/33/authentication/saml-google-g-suite
fetched_at: 2026-09-16T13:36:49Z
source: prisma-cloud
---

# Google G Suite (SAML 2.0) | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In the Username field, enter the G Suite email address the user you want to add. Select a role, then click Save . Be sure Create user in local Prisma Cloud account database is Off . 
