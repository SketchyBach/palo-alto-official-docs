---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/11-1/pan-os-upgrade/upgrade-panorama/install-content-and-software-updates-for-panorama/upgrade-panorama-and-managed-devices-in-fips-cc-mode.html
...
and WildFire appliances in FIPS-CC mode. 
 ...
 On successful upgrade to PAN-OS 11.1, all managed devices in FIPS-CC mode and any managed device
...
your managed devices to Panorama management. 
 ...
 Upgrade Panorama and managed devices to PAN-OS 11.1. 
 ...
 After successful upgrade to PAN-OS 11.1, review the system logs on Panorama to
 identify which managed devices in FIPS-CC mode are unable to connect to
 Panorama. 
 ...
 running a PAN-OS 11.1 release and is irreversible. This step has no impact on
 the connectivity status of firewalls added when running PAN-OS 10.0 or earlier
 release that are upgraded to PAN-OS 11.1. 
