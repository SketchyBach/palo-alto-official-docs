---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/detect-and-respond-to-threats/threat-intel-management/indicator-configuration/configure-threat-intel-feed-integrations
fetched_at: 2026-09-16T09:13:41Z
source: cortex-platform
---

# Configure Threat Intel feed integrations | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure threat intel feeds in Cortex XSOAR 8.8 On-prem. 
 ...
 If you have a TIM licens,e you can set up unlimited feeds. If not, you are limited to 5 active feeds and 100 indicators. For more information, see Understand Cortex XSOAR licenses . 
 ...
 Configure the Threat Intel integration by going to Settings → Settings & Info → Integrations → Instances , search for your integration, and click Add Instance . 
 ...
 Previous Configure indicator expiration 
