---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/install-cortex-xsoar/install-cortex-xsoar-on-a-vm-deployed-on-kvm/task-3.-configure-tenant-network-and-ip-settings-for-each-node
fetched_at: 2026-09-06T10:29:34Z
source: cortex-platform
---

# Task 3. Configure tenant network and IP settings for each node | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, configure tenant network and IP settings for each node. 
