---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-2111/whats-new-in-vm-series-plugin-2111
fetched_at: 2026-09-16T07:45:09Z
source: palo-alto-main
---

# What's New in VM-Series Plugin 2.1.11 Clear
...
Updated on 
 ...
 The VM-Series Plugin 2.1.11 introduces two new features: High availability for the
 VM-Series firewall on Oracle Cloud Infrastructure (OCI). in FIPS mode and full
 bootstrapping support for the VM-Series firewall on OCI. 

 HA Support for the VM-Series on OCI in FIPS Mode 

 Starting with VM-Series plugin 2.1.11, you can now deploy your FIPS-mode VM-Series
 firewall on OCI in an HA pair. 

 Full Bootstrap Support for the VM-Series on OCI 

 You can now deploy the VM-Series firewall on OCI using a bootstrap package saved in an Object
 Storage Bucket in your OCI deployment. Bootstrapping allows you to quickly deploy
 new instances of the VM-Series firewall using the configuration defined in the
 bootstrap package. See Bootstrap the VM-Series Firewall on OCI 
