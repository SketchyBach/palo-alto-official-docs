---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin--2-1-3/addressed-issues-in-openconfig-plugin-2-1-3.html
fetched_at: 2026-09-16T13:01:37Z
source: palo-alto-main
---

# Addressed Issues in OpenConfig Plugin 2.1.3 Clear
...
Updated on 
 ...
 The following are addressed issues in the OpenConfig 2.1.3 version of the plugin. 

 PAN-282265 

 Fixed an issue where data models were added to achieve parity with currently
 supported SNMP OIDs. 

 PLUG-17224 

 Fixed an issue where incomplete interface information displayed when a subscription
 request was executed using GNMI. 

 PAN-297754 

 Fixed an issue where you could not update the routing policy prefix name. 

 PLUG-21333 

 Transport IPv6 dial support added. 
