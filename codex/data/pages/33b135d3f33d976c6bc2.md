---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-531/addressed-issues-in-panorama-plugin-for-aws-5-3-1.html
fetched_at: 2026-09-16T12:59:44Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 5.3.1 Clear
...
Updated on 
 ...
 Learn about fixed issues in the Panorama Plugin for AWS version 5.3.1. 

 The following are the fixed issues in the Panorama plugin for AWS 5.3.1: 

 PLUG-17709 

 Improved the scale numbers of IP/Tags that are viewable on the dashboard. Fixed an issue
 where the browser was unresponsive. 

 PLUG-18021 

 Fixed an upgrade issue where the monitoring status appeared in a failed state. 

 PLUG-18120 

 Improved performance by reducing the retrieval time for monitoring definitions between
 Panorama and the Cloud NGFW for AWS. 
