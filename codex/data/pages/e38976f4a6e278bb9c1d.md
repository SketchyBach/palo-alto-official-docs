---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/post-deployment-steps/set-up-your-environment/data-and-log-forwarding/data-and-log-notification-formats/management-audit-log-notification-format
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review the Cortex Cloud Management Audit log notification format for external event processing. 
 ...
 Previous Agent Audit log notification format 

 Next Log format for IOC and BIOC issues 
