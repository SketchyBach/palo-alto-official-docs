...
# Integration logs | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and export integration logs in Cortex XSOAR 8 SaaS. 
 ...
 Use Notifications to send Integration logs to an email distribution list and/or a syslog server. For more information, see Configure log and notification forwarding . 

 Previous Configure log and notification forwarding 
