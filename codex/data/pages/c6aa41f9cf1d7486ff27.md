---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/deployment-steps-and-checklist/upgrade-from-prisma-cloud-to-cortex-cloud/migrate-cortex-cli
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install the Cortex CLI . You can find the installation instructions in Installation workflows 
