---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-14
fetched_at: 2026-09-16T09:11:16Z
source: cortex-platform
---

# Slack Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Slack Token grants authentication for API requests to a Slack workspace. 

 Exposure allows an attacker to send messages, access private channels, retrieve user information, or potentially exfiltrate sensitive workspace data. 
 ...
 Previous Private Key detected in code 

 Next SoftLayer Credential detected in code 
