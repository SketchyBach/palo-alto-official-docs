---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/endpoint-security/install-and-manage-endpoints/set-up-endpoint-protection/set-up-endpoint-profiles-and-exception-rules/set-up-exception-profiles-and-rules/add-a-disable-prevention-rule
fetched_at: 2026-09-06T09:48:12Z
source: cortex-platform
---

# Add a disable prevention rule | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
