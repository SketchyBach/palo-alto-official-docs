...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install the Cortex MCP server for natural-language case and issue management in Cortex AgentiX. 
 ...
 From the Cortex MCP Server page in Cortex AgentiX, click the link to open the page to create a new API key. 
