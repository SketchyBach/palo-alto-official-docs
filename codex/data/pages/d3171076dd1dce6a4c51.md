---
url: https://docs.prismacloud.io/content-collections/runtime-security/waas/waas-api-discovery
fetched_at: 2026-09-16T13:35:26Z
source: prisma-cloud
---

# API Discovery | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Endpoints with sensitive data such as Credit card, PII, ID query parameter, Session cookies, and so on. The sensitive data is defined under Runtime Security > Defend > WAAS > Sensitive data . 
