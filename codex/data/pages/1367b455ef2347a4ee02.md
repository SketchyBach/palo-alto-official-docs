---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/connectors
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Browse supported connectors for Cortex XDR data ingestion. 

 Connectors represent the new, strategic approach for integrating third-party services and data sources into Cortex XDR. A connector consolidates all of a vendor's security capabilities, such as log collection and automation and remediation, into a single, uniquely named entry with a guided configuration wizard. 
...
You can configure and save vault credentials under Settings → Configurations → Integrations → Credentials . 
 ...
 When using a unified connector, you follow a guided wizard within Cortex XDR. 
