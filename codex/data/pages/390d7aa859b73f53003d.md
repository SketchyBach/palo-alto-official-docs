---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/incidr
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field containing the IPv4 address (or a string literal) to evaluate. 
 ...
 A string literal containing one or more IPv4 ranges in CIDR notation (for example, "192.168.1.0/24"), separated by commas. 
