---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/incident-configuration/export-an-incident-to-csv-using-the-utf8-bom-format
fetched_at: 2026-09-06T10:35:46Z
source: cortex-platform
---

# Export an incident to CSV using the UTF8-BOM format | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Export incidents to UTF8-BOM CSV in Cortex XSOAR 8.10 On-prem. 
