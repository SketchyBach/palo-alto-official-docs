---
url: https://docs.prismacloud.io/admin-guide/33/web-application-and-api-security-waas/waas-app-firewall
fetched_at: 2026-09-16T13:37:05Z
source: prisma-cloud
---

# App firewall | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For further details on configuring API protection please refer to the API Protection help page. 
 ...
 cookie - specify the name of the cookie to be excluded in the form of a regular expression ( re2 ), e.g. ^sessionID$ . 
 ...
 In the App firewall menu click on the icon for one of the OWASP Top-10 protections. 
