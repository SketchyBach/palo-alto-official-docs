---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources/microsoft/microsoft-office-365-email/ingest-logs-and-data-from-microsoft-365
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest Microsoft 365 email logs and data into Cortex XDR. 
 ...
 Cortex XDR prioritizes data privacy while maintaining security visibility. The following rules apply to ingested email data: 

 Storage and encryption : Cortex XDR stores email metadata as plain text, but the email subject and body are always encrypted. 
 ...
 Previous Microsoft Office 365 (email) 
