---
url: https://docs.prismacloud.io/admin-guide/32/vulnerability-management/registry-scanning/configure-registry-scanning
fetched_at: 2026-09-16T13:37:27Z
source: prisma-cloud
---

# Configure Registry Scans | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When you remove an image from the registry or the registry scan setting is removed, Prisma Cloud maintains the scan results for a specific number of days. You can configure the number of days under Manage > System > Scan > Registry scan results . After the specified number of days, the scan results are purged. 
