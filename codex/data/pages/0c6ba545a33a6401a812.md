---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-6-1-x/vm-series-plugin-6-1-3/addressed-issues-in-vm-series-plugin-6-1-3.html
fetched_at: 2026-09-16T12:58:26Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 6.1.3 Clear
...
Updated on 
 ...
 The following issue is addressed in the VM-Series plugin 6.1.3. 
 ...
 The PA-VM, deployed with the PAN-OS 11.2.4-h8 image, encountered considerable delays
 during its configuration process. This issue is now resolved. 

 PLUG-21114 

 Using Let's Encrypt Certificate with AWS secrets manager triggered
 commit errors on VM. This issue is now resolved. 
 ...
 It was observed that the custom metrics were not displayed in Azure Application Insights.
