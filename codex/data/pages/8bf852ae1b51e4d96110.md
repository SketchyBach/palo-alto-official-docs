---
url: https://docs.paloaltonetworks.com/dns-security/getting-started/dns-security-service-domains
fetched_at: 2026-08-13T15:31:58Z
source: palo-alto-main
---

# Regional Service Domains Clear
...
Regional Service Domains 
 ...
 Palo Alto Networks maintains a high-availability infrastructure of global and regional
 service domains dedicated to supporting DNS Security and Advanced DNS Security operations.
 These domains provide instantaneous access to a massive, continuously updated DNS
 signature database. By offloading complex computations to these specialized service
 nodes, the NGFW can perform deep inspection of DNS traffic without the
 hardware overhead required for local signature storage, ensuring that even the newest
 malicious domains are identified within seconds of their creation. 

 These service domains do more than just host signatures; they operate as real-time DNS
 request analyzers that leverage Precision AI™ to identify sophisticated threats.
 When an NGFW intercepts a DNS query, it communicates with these regional
 service points to receive a verdict—such as benign, phishing, or C2—based on behavioral
 heuristics and global threat intelligence. This cloud-dependent functionality allows the
 firewall to stay ahead of rapidly evolving evasion techniques that traditional, static
 blocklists often miss. 

 To ensure uninterrupted protection, the firewall automatically connects to the closest
 regional service domain to minimize latency, falling back to global nodes if a regional
