---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-addressed-issues/pan-os-9-1-4-addressed-issues
fetched_at: 2026-08-13T17:14:22Z
source: palo-alto-main
---

# PAN-OS 9.1.4 Addressed Issues Clear
...
to be lost. 
 ...
 Fixed an issue for Amazon Web Services (AWS)
...
between the URL filtering profiles. 
 ...
 Fixed an issue where delicensing a large
...
when a GlobalProtect license was installed and valid. 
 ...
 Fixed an issue where traffic did not match
...
changed. 
 ...
 Fixed an issue where application-based SD-WAN
policy match did not work if application traffic was subjected to
SSL decryption. 

 PAN-141515 

 Fixed an issue where a service object with
...
due to a loop in DoS protection source-destination IP address classification. 
 ...
 Fixed an issue where certain packets destined
...
public) on an additional Ethernet interface. 
 ...
 Fixed an issue where GTP-U tunnel session
...
if the firewall was in line for the S1-U interface. 
 ...
 Fixed an issue where the firewall kept its
...
match to the respective LDAP group caused a security policy mismatch. 
 ...
 Fixed an issue where, when DHCP requests
