...
# Update the Ignored CVEs, Asset Groups, and Assets policy | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Update the ignored CVEs, asset groups, and assets policy to prevent matching vulnerability findings from creating issues. 
 ...
 Previous Create a vulnerability policy 
