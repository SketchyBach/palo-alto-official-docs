---
url: https://docs.paloaltonetworks.com/prisma-access/incidents-and-alerts/prisma-access-license-incidents/inc-rn-secondary-wan-proxy-tunnel-down
fetched_at: 2026-08-13T17:26:24Z
source: palo-alto-main
---

# INC_RN_SECONDARY_WAN_PROXY_TUNNEL_DOWN Clear
...
INC_RN_SECONDARY_WAN_PROXY_TUNNEL_DOWN 
 ...
 Learn about the INC_RN_SECONDARY_WAN_PROXY_TUNNEL_DOWN incident. 

 Synopsis 

 Remote network site <site-name> secondary WAN proxy tunnel <tunnel-name> is
 down for at least 10 minutes. 

 Incident Code—INC_RN_SECONDARY_WAN_PROXY_TUNNEL_DOWN 
 ...
 The remote network user count when the proxy tunnel went down
 (does not increase or decrease when the incident is in the
 raised state). 

 Raise condition 

 The proxy tunnel is down for at least 10 minutes. 

 Clear condition 

 The proxy tunnel is up for at least 8 minutes. 

 Correlated Alerts 

 AL_RN_SECONDARY_WAN_PROXY_TUNNEL_DOWN 
