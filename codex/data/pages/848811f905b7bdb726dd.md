---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/users-and-roles-management/user-group-management
fetched_at: 2026-09-06T11:22:39Z
source: cortex-platform
---

# User group management | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create user groups and assign roles in Cortex XSOAR On-prem 8.6 (EoL). 
