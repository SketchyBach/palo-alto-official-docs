---
url: https://docs.prismacloud.io/admin-guide/32/runtime-defense/custom-runtime-rules
fetched_at: 2026-09-16T13:37:30Z
source: prisma-cloud
---

# Custom runtime rules | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
process, file system, or network 
 ...
 Outgoing IP address. The following expression looks for outbound connections to a range of IP addresses: net.outgoing_ip ⇒ "1.1.1.1" and net.outgoing_ip ⇐ "1.1.1.9" 
 ...
 Prisma Cloud doesn’t support the action Prevent on write operations to existing files. For example, consider the following expression: 
 ...
 Next Import and export individual rules 
