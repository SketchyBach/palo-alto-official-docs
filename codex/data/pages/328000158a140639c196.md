---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/network-queries/network-flow-query-attributes
fetched_at: 2026-09-16T13:35:11Z
source: prisma-cloud
---

# Network Flow Query Attributes | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can also define your own network with a set of IP addresses/CIDRs to see traffic from/to your internal public [non-RFC1918] networks and use them in network RQL query. If you belong to the System Admin permission group, you can set up trusted IP addresses in Settings > Trusted IP Addresses . 
 ...
 threat.tag.group Use the threat.tag.group , when the threat.source is AutoFocus, to query for specific tag groups . Tag groups are genres of malware families as categorized by the Unit 42 threat research team . 
 ...
 Previous Network Configuration Query Examples 

 Next Network Flow Query Examples 
