---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/sort
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Sorts records in ascending order (lowest to highest). 
 ...
 Sorts records in descending order (highest to lowest). 
 ...
 Specifies one or more fields to sort by. If multiple fields are provided, records are sorted in the order the fields are specified. 
 ...
 Stages : limit , join , union 

 Functions : to_number , to_integer 
