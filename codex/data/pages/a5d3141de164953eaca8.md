---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-98.html
fetched_at: 2026-09-16T11:04:26Z
source: palo-alto-main
---

# User-ID Mapping Sources Clear
...
Updated on 
 ...
 Identifies the sources that the firewall is using to map user IDs (such as through Active Directory, or Global Protect, and so forth). A count is also kept of the number of user IDs that are mapped using any given source. 
