---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/pan-os-device-telemetry-overview.html
fetched_at: 2026-09-16T13:56:29Z
source: palo-alto-main
---

# PAN-OS Device Telemetry Overview Clear
...
Updated on 
 ...
 Palo Alto Networks next-generation firewalls write performance,
configuration, and health metrics to Palo Alto Networks cloud. 

 This document identifies all of the metrics that PAN-OS
can collect and forward to Palo Alto Network's cloud for use by
telemetry powered applications. The primary purpose of this document
is to identify the privacy considerations for each of the metrics
that PAN-OS device telemetry can collect and forward. 

 The information in this document is relevant only for devices
