---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/protect-your-endpoints/install-and-manage-endpoints/set-up-endpoint-protection/set-up-endpoint-profiles-and-exception-rules/set-up-restrictions-prevention-profiles
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure restrictions profiles to limit risky endpoint activity. 
 ...
 If you want to create custom indicator rules for prevention purposes, you enable their use here in the profile, and then create them in the Detection & Threat Intel area of Cortex XDR. 
