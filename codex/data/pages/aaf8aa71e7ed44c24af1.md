---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-5-0/addressed-issues-in-panorama-plugin-for-aws-5-5-0.html
fetched_at: 2026-09-16T12:59:41Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 5.5.0 Clear
...
Updated on 
 ...
 The following is an addressed issue in the Panorama plugin for AWS 5.5.0: 

 PLUG-22588 

 After upgrading the AWS plugin from version 5.4.1 to 5.4.2, the AWS Auto Scaling Group
 (ASG) was observed to be failing to redeploy. This issue is now resolved. 

 PLUG-22261 

 Resolved an issue where the Data Filtering Profiles (DFP), which are located under the
 security profiles in the security policy, were not displayed. 

 PLUG-22211 

 Fixed an issue causing duplicate IP addresses to be erroneously logged in the
 plugin_aws_ret.log file. 

 PLUG-22142 

 When managing a multi-vsys firewall through Panorama after upgrading to PAN-OS 11.1.11
 version, the location option was unavailable for selection during
 zone configuration. This issue is now resolved. 
