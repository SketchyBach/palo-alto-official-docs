---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-2/pan-os-new-features/panorama-features/increased-device-management-capacity-for-the-panorama-virtual-appliance.html
fetched_at: 2026-09-16T10:53:19Z
source: palo-alto-main
---

# Increased Device Management Capacity for the Panorama Virtual Appliance Clear
...
Updated on 
 ...
 Manage up to 5,000 Palo Alto Networks Next-Generation Firewalls (NGFW) with the
 Panorama virtual appliance configured for increased device management capacity. 

 To ease the operational burden of managing the configuration of your large-scale firewall deployments , the Panorama
 virtual appliance installed on VMware ESXi in Management Only mode now supports
 management of up to 5,000 Palo Alto Networks Next-Generation Firewalls (NGFW) when
 running PAN-OS 10.2.5 or later release. To use a single Panorama virtual appliance
 installed on ESXi to manage up to 5,000 Next-Generation firewalls you must install the Panorama virtual appliance with
 the minimum virtual resources required to support
