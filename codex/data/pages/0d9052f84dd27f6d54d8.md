---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-0/pan-os-release-notes/pan-os-9-0-addressed-issues/pan-os-9-0-1-addressed-issues.html
fetched_at: 2026-09-16T13:55:59Z
source: palo-alto-main
---

# PAN-OS 9.0.1 Addressed Issues Clear
...
traffic logs ( Monitor Traffic <traffic-name> Export to CSV ). 
...
8.1.6 to manage a WF-500 appliance that was running PAN-OS 8.1.3). 
 ...
 Fixed an issue where source ( Object Dynamic Lists <list-name> Create List ) URLs, which contained
...
when configured with HTTP Header Insertion ( Objects Security Profiles URL Filtering <filter-name> HTTP Header Insertion ). 
...
sent to the Log Collector but did not display in the web interface ( Monitor Traps ESM ). 
