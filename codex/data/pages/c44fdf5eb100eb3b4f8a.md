---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/manage-user-roles-and-access-management/manage-access-to-objects/manage-access-to-playbooks-and-scripts
fetched_at: 2026-09-06T09:39:01Z
source: cortex-platform
---

# Manage access to playbooks and scripts | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Control which users can view and manage playbooks and scripts. 
 ...
 Automated execution : Actions performed by automation rules are executed as "system" and are governed by the defined scope and permissions of the involved integrations, regardless of the configured access of the user who created or modified the rule. As such, they should be carefully crafted such that they will affect only the intended data. 

 For more information on defining SBAC, see Manage user scope . 

 Automation objects 

 Automation objects in Cortex XDR are categorized by their origin, which dictates how access is managed: 
 ...
 Selecting and running automations : Across all the places in Cortex XDR where you can select a playbook or script, the list of available automations is filtered. You can only select playbooks or scripts to which you have the required per-object access. 
 ...
 Invoking the playbook in the Automation Playground utilizing the ! command. 

 Utilizing the setPlaybook command within the War Room by manually entering the exact playbook name as a string. 
 ...
 Create Playbooks : Enables all methods for adding playbooks to Cortex XDR. This includes the Build New Playbook button, as well as the ability to Duplicate or Detach playbooks. The user who performs these actions is automatically designated as the Owner . 
 ...
 Create Scripts : Enables all methods for adding scripts to Cortex XDR. This includes the New Script button, as well as the ability to Duplicate or Detach scripts. The user who performs these actions is automatically designated as the Owner . 
 ...
 Previous Manage access to report templates 

 Next Manage access to saved queries 
