---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/parse_epoch
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Defines the layout of the input timestamp string (for example, %Y-%m-%d %H:%M:%S ). 
 ...
 The string containing the timestamp to be parsed. 
 ...
 An optional time zone specified by hours offset (for example, +08:00 ) or name (for example, America/Chicago ). The default is UTC. 
 ...
 Specifies the granularity of the returned integer (SECONDS, MILLIS, MICROS). The default is SECONDS. 
