---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/onboard-cortex-xsoar/cortex-xsoar-installation/install-cortex-xsoar-on-a-vm-deployed-on-oci/task-3.-validate-tenant-network-and-ip-settings
fetched_at: 2026-09-16T09:14:22Z
source: cortex-platform
---

# Task 3. Validate tenant network and IP settings | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Validate network and IP settings for Cortex XSOAR 8.8 On-prem. 
 ...
 Previous Task 2. Deploy your virtual machine on OCI 

 Next Task 4. (Optional) Configure proxy settings 
