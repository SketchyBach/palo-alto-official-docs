---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.13/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/incidents/incident-access-control-configuration
fetched_at: 2026-09-06T10:44:56Z
source: cortex-platform
---

# Incident Access Control Configuration | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure incident access control in Cortex XSOAR 6.13. 
 ...
 If using the XSOAR Read-Only field in the Incident Summary page, you need to add the field when customizing incident layouts . You can change the XSOAR Read-Only field manually or automate the process by creating a custom incident field using incident field trigger scripts , or create a script and add a new field button. 
