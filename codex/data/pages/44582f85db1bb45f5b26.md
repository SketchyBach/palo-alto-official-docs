---
url: https://cortex-docs.paloaltonetworks.com/7.x/7.5ce-eol/cortex-xdr-agent-7.5-ce-release-information/changes-to-default-behavior-in-cortex-xdr-agent-7.5-ce
fetched_at: 2026-09-06T11:22:27Z
source: cortex-platform
---

# Changes to Default Behavior in Cortex XDR Agent 7.5 CE | 7.5ce (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Features Introduced in Cortex XDR Agent 7.5.102 

 Next Changes to Default Behavior in Cortex XDR Agent 7.5.100 
