---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/onboard-cortex-xsoar/back-up-and-restore-cortex-xsoar/set-up-access-to-an-external-storage
fetched_at: 2026-09-16T08:55:25Z
source: cortex-platform
---

# Set up access to an external storage | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure external storage access in Cortex XSOAR 8.9 On-prem. 
