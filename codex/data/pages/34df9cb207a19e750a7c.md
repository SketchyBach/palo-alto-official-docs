---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/troubleshoot-and-reference/reference/how-to-search-in-cortex-xsoar
fetched_at: 2026-09-16T09:14:08Z
source: cortex-platform
---

# How to search in Cortex XSOAR | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Search Cortex XSOAR On-prem 8.7 (EoL) with queries and search tools. 
 ...
 * 
 ...
 For example, you have several incidents with the idle accounts name. When searching for name: "idle" , it returns any name that contains the word idle , including idle accounts . Other fields return anything that matches the exact word, idle . 

 For exact matches for name, type, and phase fields, add raw to the search field. For example, enter rawName:"idle" . {% endhint %} 
 ...
 For precise results when searching long text, phase, name, reason, details, or type, set the Server Configuration incident.search.exact.match.only to true. For example, if you search for type:Phish Mail , results include the exact text Phish Mail rather than each word separately. Alternatively, add raw before the query. For example, enter rawType:"Phish Mail" . {% endhint %} 
