---
url: https://docs.prismacloud.io/content-collections/runtime-security/runtime-defense/event-aggregation
fetched_at: 2026-09-16T13:35:23Z
source: prisma-cloud
---

# Event Aggregation | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Event monitoring: Defender monitors for audit events. 

 Grace period and throttle period check: 
 ...
 Activation of aggregation mode: 
 ...
 Previous Runtime Defense for App-Embedded 

 Next Aggregation of Events by Defender 
