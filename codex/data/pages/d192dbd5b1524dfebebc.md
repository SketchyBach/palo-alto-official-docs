---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/next-gen-trust-security/next-gen-trust-security/about-vaas/c-Cloud-discovery-service-sectionOverview
fetched_at: 2026-09-16T11:15:22Z
source: palo-alto-main
---

# Discovery Overview Clear
...
Updated on 
 ...
 Certificate discovery is essential for identifying and managing digital certificates within your organization's network and on public-facing servers. This process helps ensure that all certificates are accounted for, reducing the risk of outages and security vulnerabilities. 

 In this section, you will learn the various methods and features for discovering and adding internal and external server certificates to Next-Gen Trust Security. The primary TLS certificate discovery is done using Enhanced and Internet Discovery services. However, there are also other methods by which certificates can enter Next-Gen Trust Security, such as manual imports and automated processes. 

 Understanding these concepts will help you efficiently manage your certificate inventory and maintain a secure environment. 

 Related Links 

 Overview: Discovery Services 

 Other methods for getting certificates into Next-Gen Trust Security 
