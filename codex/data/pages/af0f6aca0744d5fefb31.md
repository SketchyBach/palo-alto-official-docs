...
# Cortex API Documentation | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cloud security posture, runtime protection, and workload security APIs. Covers CSPM, CWP, DSPM, CIEM, AppSec, compliance, and more. 

 Cortex XDR 

 Extended detection and response APIs for endpoint, network, and cloud data. 
 ...
 Unified security operations APIs for ingestion, AI-driven threat prioritization, and automated response. 

 Cortex XSOAR 

 Security orchestration, automation, and response APIs for playbooks, integrations, and incident management. 
 ...
 APIs for AI security workflows, analyst automation, and guided actions. 

 Cortex Xpanse 

 Attack surface management APIs for asset discovery, exposure identification, and attack-surface remediation. 
