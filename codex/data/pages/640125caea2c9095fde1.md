---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-107
fetched_at: 2026-08-13T17:16:54Z
source: palo-alto-main
---

# Zone Protection Adoption Clear
...
Zone Protection Adoption 
 ...
 Identifies the percentage of zones and security policies that have zone protection enabled using Zone Protection Profiles. Also identifies the specific types of zone protection that are configured for the Zone Protection profiles (Flood, Reconnaissance, and so forth). Also identifies the connections-per-second (CPS) threshold rate that is set when Flood protection is used, and the frequency at which this threshold is reached. 
