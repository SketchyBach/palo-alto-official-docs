---
url: https://docs.prismacloud.io/admin-guide/authentication/saml
fetched_at: 2026-09-16T13:36:20Z
source: prisma-cloud
---

# Okta (SAML 2.0) | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Grant access to Prisma Cloud Console by group. Each group must be assigned a role . 
 ...
 Grant access to Prisma Cloud Console by user. Each user must be assigned a role . 
 ...
 Previous OpenID Connect 

 Next Google G Suite (SAML 2.0) 
