---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-163
fetched_at: 2026-09-06T11:15:40Z
source: cortex-platform
---

# FTP Password detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The FTP Password grants High Risk access to the FTP server. 

 Exposure grants unauthorized access to the server, allowing an attacker to compromise file systems and steal proprietary business data. 
 ...
 Previous FTP User Name detected in code 

 Next AMQP User Name detected in code 
