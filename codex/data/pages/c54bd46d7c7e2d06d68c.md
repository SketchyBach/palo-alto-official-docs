---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/automation/engines/install-an-engine
fetched_at: 2026-09-06T09:56:11Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use DEB and RPM installation when the shell installation is not available. You need to manually install [Docker](/spaces/mxWuY3s7AUvWfzCV9p1A/pages/wJ2UpnDjDMBKvPmpjL7f) or [Podman](/spaces/mxWuY3s7AUvWfzCV9p1A/pages/xPcxHuK7r0EWQX4CobN9) and any dependencies. 
