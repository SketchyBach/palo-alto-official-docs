---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/cortex-agentix-data-sources-and-connectors/vendor-specific-data-sources-and-connectors/twilio/twilio
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use Twilio data for Cortex AgentiX. 
 ...
 Integrate with Twilio to send SMS text messages. 

 This connector includes the following sub-capabilities (Marketplace integrations link to PAN DEV for more information): 

 Twilio : Send SMS notifications. This connector is available with any active Cortex XSIAM or Cortex AgentiX license. 
