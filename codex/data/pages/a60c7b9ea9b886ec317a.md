---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/set-up-your-environment/data-and-log-forwarding/forward-logs-and-data-from-cortex-xdr-to-external-services/configure-notification-forwarding
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select Cortex XDR notifications and configure where to forward them. 
 ...
 For example, for a filter set to Severity = Medium, Category = Configuration , Cortex XDR sends the issues or events matching this filter as a notification. 
 ...
 Choose whether you want Cortex XDR to provide an auto-generated subject or enter your own subject. 
