---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/onboard-cortex-xsoar/single-server-deployment/upgrade-the-cortex-xsoar-server
fetched_at: 2026-09-06T10:46:44Z
source: cortex-platform
---

# Upgrade the Cortex XSOAR Server | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Prepare, upgrade, and complete post-upgrade tasks for Cortex XSOAR 6.12. 
 ...
 Obtain a list of integrations that are in a failed state by running the !FailedInstances command in the CLI. This is useful to compare after the upgrade. 
