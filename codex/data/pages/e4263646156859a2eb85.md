---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/automations/playbooks/build-your-playbook/customize-your-playbook/transformer-considerations-categories-and-built-in-transformers
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Understand transformer categories, considerations, and built-in transformers in Cortex AgentiX. 
 ...
 Returns a string with some or all matches of a regex pattern, and replaces them with a specified string. 

 regex: A regex pattern to replace with the replaceWith argument. 

 replaceWith: The replacement string. The default is an empty string. Use RE2 regex syntax. 
