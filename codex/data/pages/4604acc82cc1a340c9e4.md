---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine/kemp-loadmaster
fetched_at: 2026-09-16T07:25:14Z
source: palo-alto-main
---

# Create Kemp Virtual LoadMaster Machine Clear
...
Updated on 
 ...
 Creating a machine enables Next-Gen Trust Security to connect directly to a Kemp LoadMaster so certificates can be provisioned to its keystores. After creating the machine, you can provision certificates to it. 

 Before You Begin 

 Hostname or IP address of the Kemp LoadMaster. 

 Port number, if the LoadMaster uses a port other than 443. 

 Credentials with administrative permissions on the Kemp LoadMaster. 

 In Kemp LoadMaster Address/Hostname , enter the hostname or IP address of the LoadMaster. 

 If the LoadMaster uses a port other than 443, enter the port number in Port . 
 ...
 Enter the required Kemp LoadMaster credentials. 
