---
url: https://docs.paloaltonetworks.com/panorama/administration/manage-wildfire-appliances/configure-basic-wildfire-appliance-settings-on-panorama/configure-authentication-for-a-wildfire-appliance
fetched_at: 2026-08-13T17:17:57Z
source: palo-alto-main
---

# Configure Authentication for a WildFire Appliance Clear
...
Configure Authentication for a WildFire Appliance 
 ...
 Create and configure enhanced authentication for your WildFire appliance by
 configuring local administrative users with granular authentication parameters, as well
 as leveraging RADIUS, TACAS+, or LDAP for authorization and authentication. 
...
users who access the WildFire appliance CLI. 
...
for LDAP authentication are required to have Superuser admin role privileges
to successfully configure authentication for the WildFire appliance. 
...
add admin1 as both a local and Panorama administrator. 
 ...
 Configure
new administrators unique to the WildFire appliances. These administrators
are specific to the WildFire appliance for which they are created
...
configured and managed on Panorama and imported to WildFire appliance. 
 ...
 Add an existing Panorama administrator 
