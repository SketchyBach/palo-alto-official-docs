---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/playbooks/customize-your-playbook/filter-and-transform-data
fetched_at: 2026-09-06T11:23:28Z
source: cortex-platform
---

# Filter and transform data | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Filter and transform data in Cortex XSOAR On-prem 8.6 (EoL). 
 ...
 Transformers try to cast the transformed value (and arguments) to the necessary type. Tasks will fail if casting fails, for example {“some”: “object”} To upper case => Error . 
