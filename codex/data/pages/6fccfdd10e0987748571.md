---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/strata-logging-service/log-reference/network-logs/network-url-log.html
...
Updated on 
 ...
 URL logs are written by next-generation firewalls whenever network traffic matches a 

 URL Filtering Profile 
 attached to one or more security rules. For example, the firewall generates a log if a
 rule blocks access to specific web sites or web site categories, or the firewall is
 configured with a rule to generate an alert when a user accesses a web site.
...
service has already scanned and generated a Cloud Report ID for. 
 ...
 The HTTP headers used in the web request.

 CEF field name: PanOSHTTPHeaders 

 EMAIL field name: HTTPHeaders 

 HTTPS field name: HTTPHeaders 

 LEEF field name: HTTPHeaders 

 http_method.​value 

 (HTTP METHOD)

 The HTTP Method used in the web request.

 CEF field name: requestMethod 
 ...
 A verdict that identifies the nature of the threat based on the Inline ML model used to analyze the webpage.

 CEF field name: PanOSInlineMLVerdict 

 EMAIL field name: InlineMLVerdict 

 HTTPS field name: InlineMLVerdict 

 LEEF field name: InlineMLVerdict 
 ...
 Packet that triggered the firewall to generate this URL log record.
 ...
 The web page URL identified in the HTTP REFERER header field.
 ...
 The fully qualified domain name used in the HTTP REFERER header field.
 ...
 The port used in the HTTP REFERER header field.

 CEF field name: PanOSHTTPRefererPort 
 ...
 The protocol used in the HTTP REFERER header field.

 CEF field name: PanOSHTTPRefererProtocol 
 ...
 (HTTP REFERER URL PATH)

 The URL path used in the HTTP REFERER header field.

 CEF field name: PanOSHTTPRefererURLPath 
 ...
 The Uniform Resource Identifier (URI) used in the web request.
 ...
 The list of associated URL categories.
 ...
 Source/Destination user. If neither is available, source.
 ...
 The IP address of the user who requested the web page.
