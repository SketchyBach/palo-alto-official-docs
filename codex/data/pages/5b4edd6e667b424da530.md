---
url: https://docs.paloaltonetworks.com/openconfig/1-2/openconfig-admin/openconfig-models/network-instances
...
openconfig-network-instances model with the PAN-OS openconfig plugin: 
