---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-51/vm-series-plugin-5-1-9.html
fetched_at: 2026-09-16T12:58:30Z
source: palo-alto-main
---

# VM-Series Plugin 5.1.9 Clear
...
Updated on 
 ...
 The VM-Series plugin 5.1.9 includes new fixes to improve your experience with
 the VM-Series firewall. 

 The VM-Series plugin 5.1.9 version is packaged with PAN-OS version 11.2.8
 and is compatible with PAN-OS versions 11.2.8 and 11.1.11. 

 The VM-Series plugin versions 5.1.8 was not released publicly. This version primarily
 incorporated internal bug fixes and did not introduce new features or resolve issues
 that would impact the VM-Series platform or its users. 
