---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/configure-cortex-xsiam/cortex-xsiam-data-sources/vendor-specific-data-sources-and-connectors/salesforce
fetched_at: 2026-08-13T14:49:51Z
source: cortex-platform
---

# Salesforce | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center

Salesforce | Cortex Documentation Portal 
 ...
 Salesforce connector : Ingests data using the Salesforce content pack to provide full CRM services for data security, automation and remediation, security posture, and identity posture. Includes the following integrations: 

 Salesforce IAM: Performs Identity Lifecycle Management operations. 

 Salesforce: Provides CRM services. 

 Previous runZero Next Ingest logs and data from Salesforce 
