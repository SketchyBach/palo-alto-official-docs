---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/xdr-collectors/apply-profiles-to-collection-machine-policies
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Enable a Cortex Cloud Collector profile by mapping it to a policy. Each policy that you create must apply to one or more collector machines or collector machine groups. 

 In Cortex Cloud, do one of the following: 
