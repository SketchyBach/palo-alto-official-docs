---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-162
fetched_at: 2026-09-06T11:15:39Z
source: cortex-platform
---

# FTP User Name detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The FTP User Name is a required component for FTP authentication. 

 If the corresponding password is also exposed, an attacker can gain unauthorized access to the server, leading to data manipulation or theft. 
 ...
 Previous MySQL Password detected in code 

 Next FTP Password detected in code 
