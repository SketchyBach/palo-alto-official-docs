---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-image-installations/set-up-broker-vm-on-amazon-web-services
fetched_at: 2026-09-06T10:51:35Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to set up your Cortex Data Security Broker virtual machine (VM) on AWS. 

 After you download your Cortex Data Security Broker VMDK image, you can convert the image to an Amazon Web Services (AWS) Amazon Machine Image (AMI) using the AWS CLI. The task below explains how to do this on Linux. 

 Prerequisite 

 Download a Cortex Data Security Broker VM VMDK image. For more information, see the virtual machine compatibility requirements in Set up and configure Broker VM . 
