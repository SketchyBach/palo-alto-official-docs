---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-71.html
fetched_at: 2026-09-16T11:03:38Z
source: palo-alto-main
---

# Session Distribution Clear
...
Updated on 
 ...
 Collects information on network sessions organized by dataplane. For each dataplane, statistics are collected on the number of active sessions, number of dispatched sessions (that is, number of sessions the dataplane processed), and the dispatched rate per second. These counters are reset only at device reboot. 
