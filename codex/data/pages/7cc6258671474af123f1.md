---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-202/addressed-issues-in-panorama-plugin-for-aws-202.html
fetched_at: 2026-09-16T12:59:57Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for AWS 2.0.2 Clear
...
in the Panorama plugin for AWS 2.0.2. 

 PLUG-4491 

 Fixed an issue that caused the use of
the Validate button on the Panorama plugin
for AWS to fail, although the Panorama logs state that validation
was successful. 

 PLUG-4819 

 Fixed an issue that caused the Panorama
plugin for AWS to fail to monitor changes in a VPC due to the error
message Pan_decrypt error; unable to handle the decryption for
the secret-key . 
