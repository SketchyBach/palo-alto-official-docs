---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/renewing-a-certificate/c-overview-auto-renewal
fetched_at: 2026-09-16T07:25:30Z
source: palo-alto-main
---

# Automated Certificate Renewal Clear
...
Updated on 
 ...
 Enable or disable automated renewal per workspace 

 Configure a renewal window per workspace to control when certificates are eligible for renewal 

 Set a default request policy for renewed certificates 

 Automatically provision renewed certificates to their target locations 
 ...
 Automated certificate renewal is intended for administrators responsible for maintaining certificate availability across your inventory. 
 ...
 Maintaining consistent certificate lifecycle behavior for all certificates 

 Automating certificate provisioning after renewal to reduce deployment time 
 ...
 Learn how to configure automated renewal settings and review renewal behavior. 
