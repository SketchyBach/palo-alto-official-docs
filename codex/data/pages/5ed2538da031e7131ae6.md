---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-4-known-and-addressed-issues/pan-os-11-2-4-known-issues
fetched_at: 2026-09-16T07:40:40Z
source: palo-alto-main
---

# PAN-OS 11.2.4 Known Issues Clear
...
Updated on 
 ...
 11.2.4. This list includes issues specific to Panorama™, GlobalProtect™, VM-Series
 ...
 This issue is now resolved. See PAN-OS 11.2.7-h10 Addressed Issues and 
 ...
 VM-Series firewalls deployed behind an AWS GWLB might
 experience 100% dataplane CPU utilization when an Anti-Spyware profile
 ...
 VM-Series firewalls deployed behind an AWS GWLB might
 display an incorrect or empty Source User field in traffic logs and
 session details. 
 ...
 DNS Security intermittently logs malicious domain URLs as
 alert instead of taking a sinkhole action, even
 ...
 VM-Series firewalls deployed behind an AWS GWLB might
 crash and reboot unexpectedly if tunnel sessions are moving through the
 firewall. 
 ...
 trying to install configurations to a managed firewall from the Managed Devices Summary Install , even after selecting the update type and file from
 ...
 Workaround : Disable any Inline Cloud Analysis features on the
 firewall (e.g. Advanced Threat Prevention Inline Cloud Analysis,
 WildFire Inline Cloud Analysis, App-ID Cloud Engine, etc) on the
 firewall. 
 ...
 Remove the profile setting group manually in the UI by
 changing the Profile Group to
 None , and then, perform a partial
 commit. 
