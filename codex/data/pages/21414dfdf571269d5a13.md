---
url: https://docs.prismacloud.io/content-collections/administration/configure-iam-security/azure-cloud-identity-inventory
fetched_at: 2026-09-16T13:35:09Z
source: prisma-cloud
---

# Azure Cloud Identity Inventory | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select Create New Azure Role to generate a file with code to create a new Custom policy, including all used permissions. Supported policy types include Custom, and Inline. The following output formats are avaiable: *JSON *Terraform *Cloud Formation 
 ...
 Previous AWS Cloud Identity Inventory 

 Next IAM Investigations on Prisma Cloud 
