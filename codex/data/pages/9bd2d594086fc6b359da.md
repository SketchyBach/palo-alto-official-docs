---
url: https://docs.prismacloud.io/content-collections/runtime-security/tools/twistcli-scan-images
fetched_at: 2026-09-16T13:35:33Z
source: prisma-cloud
---
...
Forces twistcli to use Podman. To call podman from its default install path, specify podman . Otherwise, specify an explicit path. 
 ...
 The following procedure is true even if IP whitelisting feature is enabled in Prisma Cloud. You can use your username:password from PC or Access Key / Secret Key created by a user as username:password in twistcli calls. 
 ...
 Next Scan IaC Files with twistcli 
