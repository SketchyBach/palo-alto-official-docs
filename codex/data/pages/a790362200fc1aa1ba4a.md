---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/safe_subtract
fetched_at: 2026-09-16T09:05:11Z
source: cortex-platform
---

# safe_subtract | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Functions : subtract() , safe_add() , safe_negate() , coalesce() 

 Datasets : xdr_data 

 Previous safe_negate 
