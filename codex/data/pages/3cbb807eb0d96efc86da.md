---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-addressed-issues/pan-os-9-1-12-addressed-issues
fetched_at: 2026-08-13T17:14:09Z
source: palo-alto-main
---

# PAN-OS 9.1.12 Addressed Issues Clear
...
was used in a Security policy. 
 ...
 A CLI command was added to set the virtual
...
to continue sending traffic. 
 ...
 ( 5200-Series firewalls only ) Fixed
...
the subsequent connection on the user session. 
 ...
 Fixed an issue where a process ( mgmtsrvr ) wasn't
...
interface, and then, prior to reboot, run the following CLI command: debug mongo clear instance mdb . 
 ...
 Fixed an issue where multiple operations
...
process stopped responding, which caused authentication to fail. 
 ...
 Fixed an issue where packed-based zone protection
...
92 or higher. 
 ...
 Fixed an issue where Panorama commits were
slower than expected and the configd process stopped
responding due to a memory leak. 

 PAN-174894 

 Fixed an issue where, when the time-to-live
...
address group. 
 ...
 Fixed an issue on the Panorama interface
...
from a 9.0 release version to a 9.1 release version. 
 ...
 Fixed an issue in Panorama where the configd process
...
drop-down when creating a custom combination signature. 
 ...
 Fixed an issue where the internal interface
...
plane CPU was incorrectly reported to be high. 
 ...
 Fixed an issue in active/active HA configuration
...
the detection of duplicate MAC addresses. 
 ...
 Fixed a memory leak on the configd process
...
to the devsrvr process that caused the process to stop responding. 
 ...
 Fixed an issue on firewalls with offload
...
the original email link. 
 ...
 Fixed an issue where, even when there was
...
idle timeout expired. 
 ...
 Fixed an issue where the focus was not set
on the free text field when requesting a token code on the Authentication
Portal. 

 PAN-166686 

 Fixed an issue where EDNS responses dropped
...
the GlobalProtect gateway. 
 ...
 Fixed an issue with snmpv3 trap not processed
...
policy-based forwarding (PBF) keepalive responses. 
 ...
 Fixed an intermittent issue where Cortex
...
DHCP. 
 ...
 Fixed an issue where, when there was a high
...
was automatically configured as Any . 
 ...
 Fixed an issue where email header from fields
...
Detection (BFD) INIT state. 
 ...
 Fixed an issue where the show high-availability all output
...
the 32-bit integer. 
 ...
 Fixed an issue where authentication via
...
update was successful. 
 ...
 ( PA-7050 firewalls only ) Fixed
an issue where a process ( all_pktproc ) stopped responding
after an upgrade. 

 PAN-156478 

 Fixed an issue where a process ( allpktproc ) restarted
while processing SMTP traffic. 

 PAN-155448 

 Fixed an issue where credential detection
...
for Oracle Application Server traffic. 
 ...
 Fixed an issue where lookup of a security
...
the beginning the category name. 
 ...
 Fixed an issue where the user was able to
...
module (HSM) were lost after upgrading to a new major PAN-OS release. 
 ...
 Fixed an issue where an application's domain
...
an incorrect total utilization value. 
 ...
 Fixed an issue where Windows-1252 encoded
filenames triggered an Unknown Binary File (52081) type signature. 

 PAN-129147 

 Fixed an intermittent issue on the web interface
...
> Security Profiles > Vulnerability Protection > Exceptions ). 
 ...
 Fixed an issue where connection collisions
...
that caused the packets to be dropped. 
 ...
 Fixed an issue where ECMP strict-source-path did
not work with IPSec. 
