---
url: https://cortex-docs.paloaltonetworks.com/analytics-alerts/alerts-by-name/granting-access-to-an-account
fetched_at: 2026-09-06T11:04:00Z
source: cortex-platform
---

# Granting Access to an Account | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Google Workspace user authentication information changed 

 Next Hidden Attribute was added to a file using attrib.exe 
