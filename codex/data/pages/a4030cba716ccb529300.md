---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-clustering/panorama-clustering-plugin-200/known-issues-in-panorama-clustering-plugin-200.html
fetched_at: 2026-09-16T13:01:24Z
source: palo-alto-main
---

# Known Issues in Panorama Clustering Plugin 2.0.0 Clear
...
Updated on 
 ...
 The following list describes known issues in the Panorama Clustering plugin 2.0.0: 

 PAN-232315 

 In PA-Series clusters, the Summary View displays Node Status (the status of a node upon a
 state machine change), which is delayed by a maximum of five minutes; it is not the
 status in real time. 

 PLUG-16068 

 The CLI command request plugins clustering report doesn't return
