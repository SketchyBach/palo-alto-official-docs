---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/asset-managment/asset-classes/code-and-ci-cd-assets/software-package-assets
fetched_at: 2026-09-06T09:54:42Z
source: cortex-platform
---

# Software package assets | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Programmatic SBOM export: To support supply chain auditing and compliance workflows, the dependency data inventoried here can be programmatically exported as a machine-readable Software Bill of Materials (SBOM). For automation details, refer to SBOM Management . 

 The software package asset is the foundational unit of supply chain governance in Cortex Cloud. The software package inventory provides the identity, dependency context, operational risk, and vulnerability telemetry needed to manage every third-party dependency as a governed asset, from discovery through remediation. 
 ...
 Cortex Cloud models the following relationships between the software package asset and other asset categories:: 
 ...
 Displays operational risk indicators like deprecation status and low maintenance activity, alongside license compliance violations. Refer to Package integrity issues for more information 

 Execute asset actions 

 After reviewing the package health, you can perform the following operations from the Actions menu in the side panel or directly from the inventory tablet. 
 ...
 Previous CI/CD instances assets 
