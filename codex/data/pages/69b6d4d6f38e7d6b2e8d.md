---
url: https://cortex-docs.paloaltonetworks.com/cortex-cli/cortex-cli-for-code-security
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For more information about the output flags, refer to Cortex CLI Application Security command line reference . 
 ...
 CA Certificate : Use the --ca-certificate flag or the $CORTEX_CA_CERTIFICATE environment variable to provide your CA certificate for proxies that perform TLS inspection. The flag is now global and must appear before code scan . It is currently limited to the Application Security CLI. 

 Previous Cortex CLI for Cloud Workload Protection 

 Next Cortex CLI usage for Application Security 
