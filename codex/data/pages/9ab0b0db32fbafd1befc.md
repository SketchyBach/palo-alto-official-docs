---
url: https://docs.paloaltonetworks.com/autofocus/autofocus-admin/autofocus-search/artifact-types/mac-artifacts
fetched_at: 2026-09-15T15:08:19Z
...
Updated on 
 ...
 Mac artifacts are artifacts that WildFire associates
with samples after analyzing the samples in a Mac OS analysis environment. 
...
a Mac app bundle. Details for an embedded file can include the SHA256
and name of the installer or bundle, the file’s SHA1 hash, filename,
file format, file location, SHA256 hash, the signature associated
with the file and the name of the signer, the SHA1 hash for the
signature, signature status, and the file size in bytes. 
