---
url: https://docs.paloaltonetworks.com/autofocus/autofocus-admin/autofocus-alerts/alert-types
...
Alert Types 
 ...
 An alert is a notification about samples that match
a set of defined criteria. When you Create
Alerts in AutoFocus, you have the option to receive the notifications
by email or over HTTP. You can also View
Alerts in AutoFocus for a complete log of alerts that have
been sent to you. 

 AutoFocus generates alerts for grayware and malware samples from
all Upload
Source as long as they match the alert criteria. 
