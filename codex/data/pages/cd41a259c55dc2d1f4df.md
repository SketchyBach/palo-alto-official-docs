---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-your-azure-account/troubleshoot-azure-account-onboarding
fetched_at: 2026-09-16T13:34:58Z
source: prisma-cloud
---

# Troubleshoot Azure Account Onboarding | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select Blobs > Blob Service and navigate through the folders to find the .json files. These are the flow logs that Prisma Cloud ingests. 
 ...
 Previous View and Edit a Connected Azure Account 

 Next Microsoft Azure APIs Ingested by Prisma Cloud 
