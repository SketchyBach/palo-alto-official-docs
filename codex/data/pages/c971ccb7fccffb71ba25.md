...
# Set up Your Use Case with the Deployment Wizard | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure a use case with the Deployment Wizard in Cortex XSOAR 6.12. 
 ...
 Return to Install a Content Pack . 
