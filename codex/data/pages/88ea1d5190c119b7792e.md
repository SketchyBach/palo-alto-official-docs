---
url: https://docs.prismacloud.io/content-collections/runtime-security/runtime-defense/event-aggregation-event-types-table
fetched_at: 2026-09-16T13:35:23Z
source: prisma-cloud
---

# Detailed Aggregation Event Types | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 NetworkFirewallAttackTypeUnexpected 

 Indicates an unexpected connection detected by the network firewall. 
 ...
 Previous Aggregation of Events by Defender 

 Next Custom Runtime Rules 
