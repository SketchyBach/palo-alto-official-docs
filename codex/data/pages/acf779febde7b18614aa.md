---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/protect-your-endpoints/install-and-manage-endpoints/set-up-endpoint-protection/set-up-endpoint-profiles-and-exception-rules/set-up-exception-profiles-and-rules/add-an-ioc-or-bioc-rule-exception
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create exceptions for IOC and BIOC rules on selected endpoints. 
 ...
 Cortex XDR only supports exceptions with one attribute. See Add an issue exclusion rule to create advanced exceptions based on your filtered criteria. 
 ...
 Previous Add an issue exclusion rule 

 Next Add a disable prevention rule for endpoints 
