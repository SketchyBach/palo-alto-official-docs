---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/last_value
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field from which to retrieve the value. 
 ...
 Partitions the data into distinct groups. The last_value() function operates independently within each of these partitions. 
 ...
 Defines the order of rows within each partition. This order is crucial for correctly identifying the "last" row for the last_value() calculation. 
 ...
 Defines a "window frame" (a specific range of rows) relative to the current row. If omitted, the default window (typically the entire partition) is used. 
