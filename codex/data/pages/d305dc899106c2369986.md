---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine/imperva-waf
fetched_at: 2026-09-16T07:25:14Z
source: palo-alto-main
---

# Create an Imperva WAF Machine Clear
...
Updated on 
 ...
 Creating a machine enables Next-Gen Trust Security to connect directly to an Imperva WAF so certificates can be provisioned to its keystores. After creating the machine, you can provision certificates to it. 

 Before You Begin 

 Hostname or IP address of the Imperva WAF. 

 Port number, if the WAF uses a port other than 443. 

 Credentials with administrative permissions on the Imperva WAF. 

 Imperva API credentials required for certificate operations. 

 In Imperva Address/Hostname , confirm the default value ( my.imperva.com ) or enter the hostname or IP address for your Imperva WAF. 

 If the Imperva WAF uses a port other than 443, enter the port number in Port . 
 ...
 Enter the required Imperva WAF credentials. 
 ...
 Enter the Imperva API ID . 

 Enter the Imperva API Key . 
