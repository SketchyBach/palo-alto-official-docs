---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-141
fetched_at: 2026-09-06T11:15:36Z
source: cortex-platform
---

# Zoom API Keys detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Zoom API Key (Client ID) is the public identifier. 

 If the corresponding Client Secret is also exposed, it allows unauthorized parties to obtain an Access Token to make API requests or modify resources. 
 ...
 Previous Zoom API JWT Secrets detected in code 

 Next Zoom API Secrets detected in code 
