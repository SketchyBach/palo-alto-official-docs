---
url: https://docs.prismacloud.io/content-collections/runtime-security/vulnerability-management/registry-scanning/scan-artifactory
fetched_at: 2026-09-16T13:35:21Z
source: prisma-cloud
---

# JFrog Artifactory Docker Registry | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 This setting is available only when Version is set to JFrog Artifactory . Specify at least one of the repository types (local, remote, virtual) hosted by JFrog. 

 To scan only cached images in a repo, use virtual repo . 
 ...
 The Console selects the available Defenders from the scope to execute the scan job according to the Number of scanners setting. For more information, see deployment patterns . 
 ...
 For a complete explanation of Cap , see the table in registry scan settings . 
 ...
 In your Prisma Cloud registry scan settings, the version must be set to JFrog Artifactory . If you set the version to Docker V2 , Prisma Cloud uses the Docker API, which doesn’t offer the same support. 
 ...
 Previous IBM Cloud Container Registry 
