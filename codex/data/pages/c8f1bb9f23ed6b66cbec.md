---
url: https://cortex-docs.paloaltonetworks.com/analytics-alerts/alerts-by-name/a-user-accessed-an-uncommon-appid
fetched_at: 2026-09-06T10:59:23Z
source: cortex-platform
---

# A user accessed an uncommon AppID | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
Palo Alto Networks Firewall EAL Logs OR Palo Alto Networks Firewall threat Logs OR Palo Alto Networks Firewall traffic Logs
XDR Agent 
 ...
 Previous A user accessed an abnormal number of remote shared folders 

 Next A user accessed multiple time-consuming websites 
