---
url: https://docs.paloaltonetworks.com/pan-os/10-2/pan-os-release-notes/pan-os-10-2-7-known-and-addressed-issues/pan-os-10-2-7-h3-addressed-issues
fetched_at: 2026-08-13T17:07:21Z
source: palo-alto-main
---

# PAN-OS 10.2.7-h3 Addressed Issues Clear
...
PAN-OS 10.2.7-h3 Addressed Issues 
 ...
 Fixed an issue on Amazon Web Services (AWS) Gateway Load Balancer
 (GWLB) deployments with overlay routing enabled where, when a single
 firewall was the backend of multiple GWLBs, packets were re-encapsulated
 with an incorrect source IP address. 
