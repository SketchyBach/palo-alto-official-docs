---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-107/addressed-issues-in-vm-series-plugin-107.html
fetched_at: 2026-09-16T12:59:19Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 1.0.7 Clear
...
in the VM-Series plugin 1.0.7. 

 PLUG-2637 

 PLUG-2637—Data Plane Packet Buffer Utilization and GlobalProtect
Gateway Utilization values was floored to 0 in case the value was
between 0-0.9%. 

 ( This issue is fixed in VM-Series plugin 1.0.7 ) With
this fix, the percentage values for custom metrics are not rounded
off. 

 PLUG-2763 

 PLUG-2763—On upgrading the VM-Series firewall on ESXi
on reboot if you have more than two dataplane interfaces (vNICs),
the firewall resets to using only two dataplane interfaces. 

 ( This issue is fixed in VM-Series plugin 1.0.7 ) With
this fix, on reboot the dataplanes interface configuration is retained. 
