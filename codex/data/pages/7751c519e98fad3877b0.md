---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/7.9-ce/cortex-xdr-agent-7.9-for-mac/use-the-cortex-xdr-agent-for-mac
fetched_at: 2026-09-06T10:20:30Z
source: cortex-platform
---

# Use the Cortex XDR Agent for Mac | 7.9 CE | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select Generate Support File . Cortex XDR agent aggregates the logs into a compressed file. Save it, and then send the file to your support representative. For remote endpoints, you can also retrieve support logs from an endpoint . 
 ...
 The agent can communicate with Cortex XDR using the system proxy server that you define for the endpoint. For information on How to Enter Proxy Settings , see the documentation for your Mac operating system version. If you prefer to use an application proxy, set an application proxy for Cortex XDR agents . 
