---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/detect-investigate-and-respond-to-threats/agentic-assistant-chat/create-and-run-xql-queries-with-agentic-assistant-chat
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Interact with Cortex Agentic Assistant agents to build and run XQL queries in Cortex AgentiX. 
