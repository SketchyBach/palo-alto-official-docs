---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-new-features/virtualization-features/panorama-support-for-multiple-ip-tag-sources.html
fetched_at: 2026-09-16T10:53:14Z
source: palo-alto-main
---

# Panorama Support for Multiple IP-Tag Sources Clear
...
Updated on 
 ...
 You can now install multiple Panorama plugins for monitoring changes in different cloud
environments and enforcing security policies from a single Panorama
Virtual appliance or hardware appliance effectively. Additionally,
you can place firewalls from different environments in the same device group , to apply
consistent security policy across a distributed enterprise set up. 
