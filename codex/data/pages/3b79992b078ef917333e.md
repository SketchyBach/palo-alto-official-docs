---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.3-ce/cortex-xdr-agent-for-windows/install-the-cortex-xdr-agent-with-installer-and-content-update-package
fetched_at: 2026-09-16T09:13:55Z
source: cortex-platform
---

# Install the Cortex XDR Agent with Installer and Content Update Package | 8.3 CE (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
