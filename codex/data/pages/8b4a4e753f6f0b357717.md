---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/engines/install-an-engine/podman/troubleshoot-podman
fetched_at: 2026-09-16T09:14:40Z
source: cortex-platform
---

# Troubleshoot Podman | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Troubleshoot Podman in Cortex XSOAR On-prem 8.6 (EoL). 
 ...
 Check that your system complies with the engine requirements , and view general system information such as host architecture, CPU, OS, registries, container storage path, etc., by running the following command: 
 ...
 If the container storage directory is not owned AND exclusively used by the demisto user, scripts will fail to run. See Change container storage directory for information about assigning ownership of the storage directory. 
