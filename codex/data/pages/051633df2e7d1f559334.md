---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/endpoint-security/install-and-manage-endpoints/set-up-endpoint-protection/harden-endpoint-security/host-firewall/host-firewall-for-macos
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 From Endpoints → Policy Management → Extensions Profiles → Profiles , select + New Profile or Import from File . Select the Platform and click Host Firewall → Next . 
 ...
 From Endpoints → Policy Management → Extensions → Policy Rules , select +New Policy or Import from File . 
