---
url: https://docs.paloaltonetworks.com/hardware/pa-7000-hardware-reference/PA-7000-series-firewall-installation/pa-7000-series-firewall-rack-install/install-the-7080-firewall-front-mount
fetched_at: 2026-08-13T16:35:13Z
source: palo-alto-main
---

# Install the PA-7080 Firewall in the Front-Mount Position Clear
...
types (mid-mount and front-mount) are preinstalled. For a front-mount
install, you must remove the mid-mount brackets. 
...
Series Firewall Rack Install Safety Information . 
 ...
 Remove 16 screws from each mid-mount bracket (one left
and one right) and then remove the brackets. 
...
fiber optic cables. To access the lower bracket screw holes, open
the door located at the front of the bracket as shown in the image. 
