---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-4-1/whats-new-in-panorama-plugin-for-aws-5-4-1.html
fetched_at: 2026-09-16T12:59:44Z
source: palo-alto-main
---

# What's New in Panorama Plugin for AWS 5.4.1 Clear
...
Updated on 
 ...
 AWS Shared VPC set up enables you to share and manage VPC subnets with
 multiple AWS accounts and deploy resources in a shared and centrally managed
 network. Configure multiple monitoring definitions with the same VPC-ID and with
 different AWS credentials. This enables you to track IPs from multiple accounts
 within the shared VPC enhancing the security and network management. 

 If you try setting up a monitoring definition using the same VPC-ID
 with the same credentials, the configuration window in Panorama throws an
