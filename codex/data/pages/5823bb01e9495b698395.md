---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/troubleshoot-and-reference/reference/cortex-xsoar-api
fetched_at: 2026-09-06T10:31:38Z
source: cortex-platform
---

# Cortex XSOAR API | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, generate an API key and make API calls. 
 ...
 Select Settings & Info → Settings → Integrations → API Keys → New Key . 
 ...
 Go to Settings & Info → Settings → Integrations → API Keys . 
 ...
 Example 35. Create an incident - Standard key cURL example 
 ...
 Next Telemetry in Cortex XSOAR 
