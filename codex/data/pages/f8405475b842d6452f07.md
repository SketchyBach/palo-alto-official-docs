---
url: https://docs.paloaltonetworks.com/pan-os/10-2/pan-os-release-notes/pan-os-10-2-17-known-and-addressed-issues/pan-os-10-2-17-known-issues
fetched_at: 2026-08-13T17:07:11Z
source: palo-alto-main
---

# PAN-OS 10.2.17 Known Issues Clear
...
PAN-OS 10.2.17 Known Issues 
 ...
 10.2.17. This list includes issues specific to Panorama™, GlobalProtect™, VM-Series
 ...
 Workaround: Configure an App Override policy to bypass
 application inspection for all SIP traffic destined to the call
 ...
 configured on the dataplane interfaces are incorrectly sent using
 the management interface's MAC address. This causes Received
 conflicting ARP messages to appear continuously in the
 system logs. 
