---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/multi-tenant/multi-tenant/what-is-cortex-xsoar-multi-tenant
fetched_at: 2026-09-06T11:21:57Z
source: cortex-platform
---

# What is Cortex XSOAR multi-tenant? | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn about multi-tenant deployments in Cortex XSOAR 8.8 On-prem. 
 ...
 The main tenant communicates over a secure SSL channel. If the child tenant has a self-signed certificate, you can use it for secure communication instead of SSL. For more information, see Use a signed certificate instead of SSL . 
