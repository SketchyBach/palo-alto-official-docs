---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/broker-vm/manage-broker-vm/open-live-terminal
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Locate the Broker VM you want to connect to, right-click and select Open Live Terminal. Cortex XDR opens a CLI window where you can perform the following commands: 
