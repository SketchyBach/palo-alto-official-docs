---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/onboard-and-configure/csp-onboarding/microsoft-azure-cloud-onboarding/microsoft-azure-offboarding-overview/offboard-terraform-based-azure-deployments-all-scopes
fetched_at: 2026-09-06T10:51:21Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 How to offboard all Terraform-based Microsoft Azure scopes from Cortex Data Security: A step-by-step technical guide to safely running Terraform destroy and cleaning up policy-deployed resources. 

 Follow this procedure to offboard all Terraform-based Microsoft Azure scopes (subscription, management group, or tenant) and cleanly decommission all Cortex Data Security resources from Microsoft Azure. Fo 
 ...
 In your local terminal within the directory containing your Cortex Data Security Terraform configuration and run the following command to retrieve the unique resource suffix: 
