...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure centralized exception rules for Cortex Cloud protection and prevention actions. 
 ...
 Configure centralized support exception rules for Cortex Cloud protection and prevention actions. 
 ...
 Use Cortex Cloud recommended fields to define precise exception criteria. 
 ...
 Select at least one parameter. Cortex Cloud validates entered values. Wildcards are supported, but use specific values. Some parameters are not editable. 
 ...
 Advanced Analysis provides secondary validation for exploit protection issues. Cortex Cloud analyzes issue data sent by the Cortex XDR agent. When an issue is benign, Cortex Cloud can automatically create exceptions and distribute updated policy to endpoints. 
