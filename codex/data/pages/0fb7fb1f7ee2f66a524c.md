---
url: https://docs.prismacloud.io/content-collections/runtime-security/install/deploy-defender/app-embedded/install-app-embedded-defender-fargate
fetched_at: 2026-09-16T13:35:14Z
source: prisma-cloud
---

# (Dockerfile method) Deploy App-Embedded Defender for Fargate | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Deploy App-Embedded Defender in Google Cloud Run 

 Next (Dockerfile method) Deploy App-Embedded Defender in ACI 
