---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/rank_with_windowcomp_stage
fetched_at: 2026-09-06T10:58:32Z
source: cortex-platform
---

# rank (windowcomp) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 One or more fields to define the order within each partition (equivalent to SQL ORDER BY ). Required for numbering functions. Defaults to ascending. 
 ...
 Functions : row_number() , dense_rank() 

 Datasets : xdr_data 

 Previous range_bucket 
