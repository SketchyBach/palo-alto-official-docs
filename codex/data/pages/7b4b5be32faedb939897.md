...
# Audit Prisma Agent Logs and Management Logs Clear
...
Updated on 
 ...
 Lean how to audit Prisma Agent logs and management logs using the log
 ...
 You can use the auditing and logging features of the Prisma Agent to help
 ...
 Prisma Agent logs and management logs are generated and sent to Strata Logging Service . The logs are viewable in the log viewer or Strata Logging Service , where you can use the capabilities of the log viewer to filter and
 ...
 failing, including: 
 Did the Prisma Agent receive an authentication response from
 ...
 Did Prisma Agent send a reply to the Prisma Agent 
 app? 
 ...
 you can audit the Prisma Agent log to look for the
 Tunnel Type of
 ...
 To troubleshoot
 this, you can audit the Prisma Agent log to look for the
 Event ID Value of
 gateway-switch-to-ssl and validate
 whether the event succeeded or failed. 

 Receiving notifications when a Prisma Agent is tampered with through file
 downloads, process, or registry changes. 
 To troubleshoot this, you can audit the
 Prisma Agent log to look for logs with the
