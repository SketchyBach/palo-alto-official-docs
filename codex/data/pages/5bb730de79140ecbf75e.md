---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-Cloud-discovery-service-sectionOverview/c-Cloud-Discovering-Private-Internal-certificates/t-discovery-create-Enhanced-discovery
fetched_at: 2026-09-16T07:24:23Z
source: palo-alto-main
---

# Create an Enhanced Discovery Service Clear
...
Updated on 
 ...
 Create and run an Enhanced Discovery service to perform certificate discoveries inside of your company's network. You can schedule Enhanced Discovery services to run according to a fixed schedule, or run your service immediately and anytime you need to. 

 Enhanced Discovery takes advantage of Venafi's VSatellites to extend the reach of your Next-Gen Trust Security account beyond public networks to discover certificates within your on-premise/private networks and machines. 

 This discovery service validates discovered certificates automatically. 

 Before You Begin 

 Permissions: You must have the Superuser role, and you must have Tenant selected in the workspace switcher. Network Discovery is configured for the tenant as a whole, so the page is not available while a workspace is selected. See Workspace-Scoped Resources . 

 VSatellite: Make sure you have a healthy VSatellite ready for use with your new discovery service. VSatellite helps you discover certificates on endpoints in your private network using either a schedule or by running your enhanced discovery service manually. 
 ...
 Click New > Enhanced discovery and follow the remaining prompts. 

 When prompted to select a VSatellite, choose a primary VSatellite that is part of a high availability (HA) group if you want this service to benefit from HA. The system will automatically use any healthy VSatellite in the group to initiate future discovery operations. Learn more 

 After your new service is created, you can choose to run it immediately . 

 What's Next? 

 Learn more about how to manage your existing VSatellites . 
