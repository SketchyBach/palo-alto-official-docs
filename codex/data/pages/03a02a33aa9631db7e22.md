---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs/adding-a-certificate-authority.html
fetched_at: 2026-09-16T13:57:07Z
source: palo-alto-main
---

# Adding a Certificate Authority Clear
...
Updated on 
 ...
 When you add a certificate authority (CA) to Next-Gen Trust Security, you create a connection
between Next-Gen Trust Security and that CA. That connection enables Next-Gen Trust Security to manage certificate life-cycles. 
 ...
 Make sure you have the Superuser role, and select Tenant in the workspace switcher before you start. 

 Note: Certificate Authorities is available only when Tenant is selected. Inside a workspace the menu entry isn't shown and the page can't be opened, so every procedure linked below has to be carried out under Tenant . A workspace still issues certificates from your CAs: it does so through a request policy that names the CA account and has been shared with that workspace. See Workspace Availability by Page . 
