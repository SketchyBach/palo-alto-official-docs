---
url: https://docs.prismacloud.io/content-collections/runtime-security/compliance/visibility/prisma-cloud-compliance-checks
fetched_at: 2026-09-16T13:35:23Z
source: prisma-cloud
---

# Prisma Cloud Compliance Checks | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
Checks the integrity of package binaries in an image. During an image scan, every binary’s checksum is compared with its package info. If there’s a mismatch, a compliance issue is raised. 
 ...
 Agentless scanning scans your workloads for malware by using an integration with Palo Alto Networks Advanced WildFire , the industry’s leading malware scanning feed. 
 ...
 When agentless scanning checks your hosts and container images for security risks, it calculates the MD5 signatures of the relevant files for malware analysis. Agentless malware detection uses the following process. 
 ...
 By default, Prisma Cloud only reports files flagged as malware and you can enable flagging of grayware . 
 ...
 Go to Runtime Security > Monitor > Compliance to find the malware scanning results in the Prisma Cloud Compliance Explorer after an agentless scan was completed successfully. 
 ...
 Defenders also check your container images for malware . 

 Previous Custom Compliance Checks 
