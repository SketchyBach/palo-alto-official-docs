---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-4-3
fetched_at: 2026-09-16T07:42:45Z
source: palo-alto-main
---

# Panorama Plugin for AWS 5.4.3 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 5.4.3 introduces support for an automated
 firewall software version compatibility check on Panorama and includes fixes
 for known issues. 

 You can download the AWS plugin for Panorama from the Customer
 Support Portal or directly from Panorama > Plugins . Panorama can push
 the virtual machine attributes that it retrieves to firewalls running the versions
 detailed in the plugin Compatibility Matrix for public clouds . 
