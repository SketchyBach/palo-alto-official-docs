---
url: https://docs.prismacloud.io/content-collections/governance/prisma-cloud-threat-detection
fetched_at: 2026-09-16T13:35:01Z
source: prisma-cloud
---

# Prisma Cloud Threat Detection | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Network Event —A set of RQL based policies that monitor network activities in your environment. To view all of the Network policies available, apply a filter for Policy Type and select Network . Refer to Create a Network or Audit Event Policy to learn how to create custom net#work event policies. 
 ...
 Previous Workload Protection Policies 

 Next Create an IAM Policy 
