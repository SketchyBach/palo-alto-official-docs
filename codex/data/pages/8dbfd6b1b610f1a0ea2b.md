---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-108.html
fetched_at: 2026-09-16T12:59:18Z
source: palo-alto-main
---

# VM-Series Plugin 1.0.8 Clear
...
Updated on 
 ...
 VM-Series plugin version 1.0.8 release notes 

 The VM-Series plugin version 1.0.8 includes
general plugin fixes, fixes for the VM-Series plugin on Azure and
Azure GovCloud, and fixes for Google Cloud Platform (GCP). 

 Consult the Compatibility Matrix to
correlate the VM-Series plugin version with the minimum PAN-OS version. 

 See the 9.0 VM-Series Deployment Guide for
more information about upgrading the VM-Series plugin. 
