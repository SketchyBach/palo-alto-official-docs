---
url: https://docs.prismacloud.io/admin-guide/33/technology-overviews/defender-architecture
fetched_at: 2026-09-16T13:36:46Z
source: prisma-cloud
---

# Defender architecture | 33 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 By default, Defender connects to Console with a websocket on TCP port {port-ws}. All traffic between Defender and Console is TLS encrypted. 
 ...
 Defender has no ability to interact with Console beyond the websocket. Both Console’s API and web interfaces, served on port {port-api} (HTTPS), require authentication over a different channel with different credentials (e.g. username and password, access key, and so on), none of which Defender holds. 
 ...
 Defender enforces WAAS policies and monitors layer 4 traffic (CNNS). In both cases, Defender creates iptables rules on the host so it can observe network traffic. For more information, see WAAS architecture . 

 Previous Prisma Cloud rules guide for Docker 

 Next Host Defender architecture 
