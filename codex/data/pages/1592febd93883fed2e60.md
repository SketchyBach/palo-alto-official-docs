...
Updated on 
 ...
 For completed scan reports, you can
 override the judge's verdict and re-evaluate the Risk
 Score ,
 Attack Success Rate (ASR), and related metrics to accurately reflect your team's
 validated findings. 
 ...
 To correct an incorrect
 system-assigned
 verdict, select the edit icon next to the verdict
 and update the
 verdict .
 The
 system-assigned
 ...
 Re-Evaluate
 Score in the report header to recalculate the Risk
 Score, ASR, category reports, subcategory reports, technique
 reports, and compliance framework scores based on your corrections.
 When you download the report, the CSV and
 PDF
 exports include the original verdict, the corrected verdict, your
 user identity, and the timestamp for each
 correction. 
