---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/build-xql-queries/how-to-build-xql-queries
fetched_at: 2026-09-06T09:45:10Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Cortex Query Language (XQL) enables you to query data ingested into Cortex XDR for rigorous endpoint and network event analysis. To help you create an eﬀective XQL query with the proper syntax, the query ﬁeld in the user interface provides suggestions and deﬁnitions as you type. 
 ...
 When you have more than one dataset or lookup, you can change your default dataset by navigating to Settings → Configurations → Data Management → Dataset Management , right-clicking on the appropriate dataset, and selecting Set as default . For more information about setting default datasets, see Dataset management . 
