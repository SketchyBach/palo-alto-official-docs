---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/deployment-steps-and-checklist/cloud-service-provider-csp-onboarding/update-cloud-permissions-after-cortex-release-updates
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Filter or sort by this column to quickly identify all instances marked as Update Available . The message on the page indicates the number of instances that need updating. 
