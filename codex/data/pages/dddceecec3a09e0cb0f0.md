---
url: https://docs.paloaltonetworks.com/wildfire/u-v/wildfire-whats-new/latest-wildfire-cloud-features/real-time-wildfire-verdicts-and-signatures-for-pe-and-elf-files
fetched_at: 2026-09-16T07:54:26Z
source: palo-alto-main
---

# Real Time WildFire Verdicts and Signatures for PE and ELF
Files Clear
...
Files 
 ...
 WildFire protections and verdicts for PE (portable executable)
and ELF (executable and linkable format) files are now available
immediately after the WildFire cloud completes static analysis.
Products and services that integrate with WildFire can also access
the immediate verdicts to coordinate enforcement to prevent successful attacks.
Additional information about a malicious file is available in the
WildFire sample analysis report when WildFire completes dynamic
analysis. 
