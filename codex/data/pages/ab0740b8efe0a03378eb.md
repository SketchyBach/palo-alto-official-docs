---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/scripts
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create and manage scripts for automated workflows. 

 On the Scripts page, you can view, edit, and create scripts in JavaScript, Python, or PowerShell. When creating a script, you can access all Cortex XDR APIs, including access to issues and investigations, and share data with the War Room. Scripts can receive and access arguments and can be password-protected. 
