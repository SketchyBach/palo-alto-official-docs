---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-531.html
fetched_at: 2026-09-16T12:59:43Z
source: palo-alto-main
---

# Panorama Plugin for AWS 5.3.1 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 5.3.1 addresses issues for Panorama integration
 with Cloud NGFW for AWS. 

 The Panorama plugin for AWS version 5.3.1 addresses known issues. 
 ...
 If
 your Panorama includes device groups that use the prefix
 cngfw-aws , downgrading the Panorama plugin for AWS from
 version 5.3.1 isn't supported. 

 Addressed issues in Panorama Plugin for AWS
 5.3.1 

 Known issues in Panorama Plugin for AWS
 5.3.1 
