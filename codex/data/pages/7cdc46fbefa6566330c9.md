---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/engines/install-an-engine/docker/change-the-docker-installation-folder
fetched_at: 2026-09-06T11:28:11Z
source: cortex-platform
---

# Change the Docker installation folder | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Change the Docker folder in Cortex XSOAR On-prem 8.6 (EoL). 
