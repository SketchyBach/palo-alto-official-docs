---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-205.html
fetched_at: 2026-09-16T13:00:11Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 2.0.5 Clear
...
bug fixes and two new features—Bypass Proxy Server between NSX Manager
and Panorama and Configurable Curl Timeout. To install plugin version
2.0.5, see Install the VMware NSX Plugin . 

 Do not downgrade from VMware NSX plugin 2.0.5 directly to plugin
1.0.x. If you must downgrade, first go to plugin 2.0.4 before moving
to plugin 1.0.x. 

 For more information on the VM-Series NSX Integration Configuration
through Panorama, refer to the VM-Series 8.1 Deployment Guide or
the VM-Series 9.0 Deployment Guide . 
