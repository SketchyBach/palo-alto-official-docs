---
url: https://docs.paloaltonetworks.com/pan-os/10-2/pan-os-release-notes/pan-os-10-2-13-known-and-addressed-issues/pan-os-10-2-13-addressed-issues
fetched_at: 2026-08-13T17:07:06Z
source: palo-alto-main
---

# PAN-OS 10.2.13 Addressed Issues Clear
...
PAN-OS 10.2.13 Addressed Issues 
 ...
 ( VM-Series firewalls on Microsoft Azure environments only ) Fixed an issue where, when
 Accelerated Networking was enabled, traffic was dropped because of
 the flow_parse_ip_hdr counter related
 ...
 ( WF-500-B appliances only ) Fixed an issue where the WildFire
 appliance failed to fetch device certificates due to a syntax error
 in the system database format. 
