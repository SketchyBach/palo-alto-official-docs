---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/public-exposure/appsec-openapi-7
fetched_at: 2026-09-16T09:10:06Z
source: cortex-platform
---

# The path scheme is supports unencrypted HTTP connections misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Cleartext credentials over unencrypted channel should not be accepted for the operation misconfigura 

 Next Global schemes use 'httpa' protocol instead of 'https' misconfiguration detected in code 
