---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-107
fetched_at: 2026-09-06T11:15:28Z
source: cortex-platform
---

# OpenAI API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The OpenAI API Key authenticates requests to costly and proprietary AI models. 
 ...
 Previous Clojars Deploy Token detected in code 

 Next Samsara API Key detected in code 
