---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-release-information/known-issues/known-issues-related-to-pan-os-9-1-releases/pan-os-9-1-2-known-issues
fetched_at: 2026-08-13T17:14:44Z
source: palo-alto-main
---

# PAN-OS 9.1.2 Known Issues Clear
...
PAN-OS 9.1.2 Known Issues 
 ...
 Review the known issues specific to the PAN-OS 9.1.2 release. 

 The following list includes all known issues that impact
the PAN-OS® 9.1.2 release. This list includes both outstanding issues
...
Template Values ( Commit Push to Devices Edit Selections ). 
 ...
 On the Panorama management server, hub and branch
firewall latency, jitter, and packet loss data is not updated when
monitoring SD-WAN link performance ( Panorama SD-WAN Monitoring ). 
