---
url: https://docs.paloaltonetworks.com/prisma-browser/deployment/prisma-browser-end-of-life-policy
...
Updated on 
 ...
 policy: 
 Stable Channel (default): Receives weekly updates that include
 security patches, with a new major version including new features
 approximately every two weeks. 

 Long-Term Support (LTS) Channel : Receives weekly security patches and
 new Prisma Browser and Chromium features only during major version updates,
