---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-42
fetched_at: 2026-09-16T09:11:20Z
source: cortex-platform
---

# FullStory API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The FullStory API Key grants access to user session replay services. 

 Exposure leads to unauthorized access to user session data, potentially exposing sensitive PII and privacy violations. 
 ...
 Previous Fastly Personal Token detected in code 

 Next GitHub Token detected in code 
