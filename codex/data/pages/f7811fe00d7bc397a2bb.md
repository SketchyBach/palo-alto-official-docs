---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-120/whats-new-in-the-openconfig-plugin-120.html
fetched_at: 2026-09-16T13:01:41Z
source: palo-alto-main
---

# Whats New in the OpenConfig Plugin 1.2.0 Clear
...
Updated on 
 ...
 The OpenConfig plugin version 1.2.0 introduces the following
 capabilities: 

 Feature Description 

 Protobuf is now a supported format for subscribe requests. 

 This enables you to specify the universal format protobuf, or
 protocol buffer, to give you more flexibility with formatted values
 in a typed format. 

 Unbundling support for specific time sensitive
 nodes. Using the cli command set deviceconfig plugins
 openconfig bundling off can enable the OpenConfig plugin to
 uncouple certain nodes giving you more timely updates to your subscribe
 requests. 
