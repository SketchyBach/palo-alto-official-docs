---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/cortex-data-security-data-sources-and-connectors/vendor-specific-data-sources-and-connectors/okta/ingest-logs-and-data-from-okta
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Okta log and data collection for Cortex Data Security. 
 ...
 To receive logs and configuration data from Okta, configure the Data Sources & Integrations settings in Cortex Data Security. Once enabled, the system immediately begins ingesting activity logs activity logs and identity configuration metadata, according to your configuration settings. 
 ...
 Copy the Org URL, such as https://example.okta.com , and save it for the Okta Domain field in Cortex Data Security. 
 ...
 Your token is successfully created. Copy the Token Value and record it immediately. You will need this for the TOKEN field in Cortex Data Security. Once you close the dialog box by clicking Ok, got it , you won't be able to access the token again and will have to create a new one if you didn't record it. 

 Step 2: Configure the Okta Collector in Cortex Data Security 
 ...
 Integrate the Okta authentication service with Cortex Data Security: 
