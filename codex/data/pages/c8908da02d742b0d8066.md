...
fetched_at: 2026-08-13T15:09:47Z
...
Configure the engine to call the server without using a proxy | Cortex Documentation Portal 
 ...
 Previous Configure the engine to use a web proxy Next Use NGINX as a reverse proxy 
