---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-124
fetched_at: 2026-09-06T11:15:32Z
source: cortex-platform
---

# OpenWeatherMap Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The OpenWeatherMap Token grants access to global weather data and forecasts. 

 Exposure allows an attacker to make unauthorized requests, leading to billing fraud and unexpected service charges. 
 ...
 Previous Elastic Cloud Credentials detected in code 

 Next Mailjet Keys ID detected in code 
