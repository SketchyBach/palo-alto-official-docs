---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.13/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/incidents/classification-and-mapping/create-a-mapper
fetched_at: 2026-09-06T10:44:58Z
source: cortex-platform
---

# Create a Mapper | 6.13 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create a mapper in Cortex XSOAR 6.13. 
 ...
 For indicators ingested with a Feed Integration , indicator classification and mapping is done in the integration code and not in the Cortex XSOAR Settings > OBJECTS SETUP > Indicators & Mapping tab. For example, see the FeedUnit42v2 integration. 
