---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-159
fetched_at: 2026-09-16T09:11:35Z
source: cortex-platform
---

# MySQL Password detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The MySQL Password grants Critical Risk access to the database. 

 Exposure allows an attacker to access, modify, or delete sensitive data, leading to potential data breaches and data integrity loss. 
 ...
 Previous MySQL User Name detected in code 

 Next FTP User Name detected in code 
