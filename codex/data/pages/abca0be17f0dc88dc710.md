...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collect Google Workspace data with Cortex Cloud. 
...
Authorize the domain-wide authority to your service account. This ensures that your service account now has domain-wide access to the Google Gmail API for all of the users of your domain. 
 ...
 Record the email of this user as you will need it in Cortex Cloud . 
 ...
 Integrate the applicable Google Workspace service with Cortex Cloud. 
...
c. Select the types of data that you want to Collect from Google Workspace. 
 ...
 When relevant, Cortex Cloud normalizes Admin Console audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes Enterprise Group audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes Login audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes Rules audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes Google drive audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes Token audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
 ...
 When relevant, Cortex Cloud normalizes SAML audit logs into authentication stories. All SaaS audit logs are collected in a dataset called saas_audit_logs and specific relevant events are collected in the authentication_story preset for the xdr_data dataset. 
