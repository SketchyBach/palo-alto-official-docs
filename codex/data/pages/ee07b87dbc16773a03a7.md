---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/generic-on-premise-data-collectors/broker-vm-data-collector-applets/activate-local-agent-settings
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Supported with all XDR Collector versions. Broker VMs can act as as a proxy for routing XDR Collector traffic to the Cortex Cloud tenant. The Broker VM does not cache XDR Collector installers. 
