---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/generic-on-premise-data-collectors/xdr-collectors/xdr-collector-profiles/add-an-xdr-collector-profile-for-linux
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cortex XDR provides YAML templates for XDR Collector Logs, Linux (RHEL/CentOS), NGINX (Linux), Linux (Debian/Ubuntu), and any templates added by the content packs installed from the XDR Marketplace. 

 In Cortex XDR, select Settings → Configurations → XDR Collectors → Profiles → +Add Profile → Linux. 
 ...
 Next Apply profiles to collection machine policies 
