---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/configure-cortex-xsiam/cortex-xsiam-data-sources/cloud-posture-and-runtime-security-data-sources/container-registry-scanning/connect-harbor-registry
fetched_at: 2026-08-13T15:04:33Z
source: cortex-platform
---

# Connect Harbor registry | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center

Connect Harbor registry | Cortex Documentation Portal 
 ...
 (Optional) Expand Show advanced settings and then enter a custom CA certificate in PEM format for Cortex to validate the Harbor registry. Ensure that the Custom CA certificate that you use is not revoked by the issuing authority. 
 ...
 Previous Manage a GitLab Container Registry connector Next Manage a Harbor connector 
