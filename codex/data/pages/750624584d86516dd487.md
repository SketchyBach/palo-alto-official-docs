---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/strata-cloud-manager/getting-started/insights-scm/activity-insights/activity-insights-threats.html
fetched_at: 2026-09-16T09:42:07Z
...
Updated on 
 ...
 threat. This column is available only with the Strata Cloud Manager Pro
 licensing tier. 
 ...
 that the traffic matched against before the threat was detected. This column
 is available only with the Strata Cloud Manager Pro licensing tier. 
 ...
 by the threat, and action taken (allowed or blocked) on the threat. This
 column is available only with the Strata Cloud Manager Pro licensing tier. 

 Actions —Log history of the threat in the Log
 Viewer to aid in threat investigations. 

 The following filters are available only with Strata Cloud Manager Pro licensing
 tier: Username, Application, Source Location, Dest Location, Protocol, Application
 Type, Source Type, Port Type, Sanctioned App, Application Tags, GenAI Use case, and
 GenAI Application. 
