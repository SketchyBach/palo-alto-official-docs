---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/onboard-cortex-xsoar/deployment-steps/step-5.-install-and-configure-content/set-up-your-use-case-with-the-deployment-wizard
fetched_at: 2026-09-06T10:23:42Z
source: cortex-platform
---

# Set up your use case with the Deployment Wizard |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the Deployment Wizard in Cortex XSOAR 8.14 On-prem to configure and adopt a security use case. 
