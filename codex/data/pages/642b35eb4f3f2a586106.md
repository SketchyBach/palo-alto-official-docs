---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.3/cortex-xdr-agent-for-macos/install-the-cortex-xdr-agent-for-mac/install-the-cortex-xdr-agent-manually
fetched_at: 2026-09-16T08:51:30Z
source: cortex-platform
---

# Install the Cortex XDR Agent Manually | 9.3 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 If prompted to confirm the destination, select Continue . 

 Select Install to begin the installation. 

 Enter the User Name and Password of the administrator with access to install software on the endpoint, and then select Install Software . 
 ...
 Go to System Settings → Privacy & Security, and select Details . 

 Select both Cortex XDR System Extensions and select OK to allow them. Ignore the message informing that The system needs to be restarted before it can be used since this step is not required. 
 ...
 Select Options , and then select Allow . 

 CortexMacOs_Install13.png 

 If the system notification is no longer visible, you can approve permissions in System Settings → Notifications . Select Cortex XDR agent and select Allow Notifications . 

 Verify the Cortex XDR agent connection and protection status. 

 To open the Cortex XDR agent console, select the agent icon in the menu bar, and select Open Console . 

 Select Check In Now to initiate a connection with your Cortex XDR tenant. If successful, the Connection field updates to display your Cortex XDR tenant, and the Last Check In field updates to display the last check in date and time. 
