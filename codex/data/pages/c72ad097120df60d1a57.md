---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.11/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-widget-using-the-widget-builder
fetched_at: 2026-09-16T08:54:43Z
source: cortex-platform
---

# Create a widget using the widget builder | 8.11 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create widgets with Widget Builder in Cortex XSOAR 8.11 On-prem. 
 ...
 Example 27. Limit the number of results 
 ...
 Example 28. Group data into two teams 
