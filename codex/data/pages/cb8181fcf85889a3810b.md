---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/t-VSatellite-managing/renaming-a-vsatellite
fetched_at: 2026-09-16T07:24:47Z
source: palo-alto-main
---

# Renaming VSatellites Clear
...
Updated on 
 ...
 You can easily rename a VSatellite from the Details page.
When renaming a VSatellite, you must give it a unique name.
After renaming a VSatellite successfully, there's nothing
else you need to do. 
 ...
 Click Configuration > Certificate Integrations > VSatellites . 

 Select the VSatellite you want to rename. 

 In the General Information section, click in the Name field and modify or replace the current name.
Be sure to enter a unique name, one that is not already in use by another existing VSatellite. If the name you use is not unique, you'll be prompted to type a different name. 
