---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/post-deployment-steps/manage-user-roles-and-access-management/manage-access-to-objects/manage-access-to-custom-dashboards
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Control which users can view and manage custom dashboards. 
 ...
 System Widgets : Standard system widgets provided by Cortex XDR remain Public and accessible to all users by default; their access cannot be restricted. 
