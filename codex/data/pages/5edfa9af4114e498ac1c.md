---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-300.html
fetched_at: 2026-09-16T12:59:01Z
source: palo-alto-main
---

# VM-Series Plugin 3.0.0 Clear
...
Updated on 
 ...
 What’s new in VM-Series plugin 3.0.0 

 The VM-Series plugin 3.0.0 is the minimum version
for VM-Series firewall running PAN-OS 10.2.0. This release of the
plugin introduces enhanced Instance Metadata Service (IMDSv2) for
securing instances AWS and OCI. The plugin also adds support for the
CN-Series firewall, which also requires Panorama and the Kubernetes
plugin on Panorama. 
