---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/onboard-cortex-xsoar/onboard-and-configure-cortex-xsoar/plan-your-deployment
fetched_at: 2026-09-06T11:23:19Z
source: cortex-platform
---

# Plan your deployment | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review deployment considerations and onboarding steps in Cortex XSOAR On-prem 8.6 (EoL). 
 ...
 If you deploy a cluster of three nodes, you can implement out-of-the-box high availability (HA) by replicating data between the nodes in the cluster. For more information, see High Availability for Cortex XSOAR . You can also implement load balancing. For more information, see Manage engines . 
