---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-data-collector-applets/activate-files-and-folders-collector
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 During the file scanning process, the system is configured to traverse directories up to a maximum depth of 10 levels. Files located in subdirectories beyond this depth will not be scanned. 
 ...
 * matches any character or set of characters, including no character. 
 ...
 The name of a dataset created from a tsv file must always include the extension. If the original file name is mrkdptusrsnov23.tsv, you can save the dataset with the name marketing_dept_users_Nov_2023.tsv. 
