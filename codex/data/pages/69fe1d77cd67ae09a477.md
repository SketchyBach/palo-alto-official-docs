---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/get-started-with-the-pan-os-rest-api/configure-ethernet-interface-rest-api.html
...
Updated on 
 ...
 curl -X POST https://<firewall>/restapi/v10.0/network/interfacemanagementnetworkprofiles?name=ping-and-response-pages'
 -H 'X-PAN-KEY: <api key>
 -d '{
 "entry": {
 ...
 curl -X POST https://<firewall>/restapi/v10.0/network/ethernetinterfaces?name=ethernet1/3'
 -H 'X-PAN-KEY: <api key>
 -d '{
 "entry": {
 "@name": "ethernet1/3",
 ...
 vsys1 with the Ethernet
 interface you configured in step 2. 

 curl -X POST https://<firewall>/restapi/v10.0/device/virtualsystems?name=vsys1'
 -H 'X-PAN-KEY: <api key>
 -d '{
 "entry": [
 {
