---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/overview-reporting
fetched_at: 2026-09-16T07:25:26Z
source: palo-alto-main
---

# Reporting Overview Clear
...
Updated on 
 ...
 Next-Gen Trust Security includes a centralized reporting feature, Custom Reports , that helps you understand certificate activity across your organization. Use it to review certificate usage, monitor trends, and identify potential issues. 

 Accessing Custom Reports 

 To open Custom Reports , go to Insights > Custom Reports in the left navigation menu. 

 Only users with the Superuser role can access and create reports. What a report covers follows the workspace selected when it was created: reports created under Tenant cover the whole tenant, and reports created inside a workspace cover that workspace. See Workspace-Scoped Resources . 

 What You Can Do with Custom Reports 

 Custom Reports helps you: 

 Review certificate usage and expiration trends 

 Identify patterns or anomalies in certificate activity 

 Analyze certificate-related data directly in the UI 

 Key Capabilities 

 Centralized reporting: View certificate-related reports in one place 

 Interactive filters: Refine report results to focus on specific data 

 Role-based access control: Limit access to reports based on permissions 
