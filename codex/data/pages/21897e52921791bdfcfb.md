---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/next-gen-trust-security/next-gen-trust-security/about-vaas/integrations-overview
fetched_at: 2026-09-16T11:15:22Z
source: palo-alto-main
---

# Welcome to Integrations Clear
...
Updated on 
 ...
 As organizations adopt multi-cloud and hybrid environments, managing digital identities, securing keys, and automating certificate lifecycles is critical. Next-Gen Trust Security is at the forefront, enabling secure-by-design architectures through deep integrations with leading identity providers, cloud platforms, and certificate authorities. 
 ...
 Notification providers : Receive real-time alerts and updates through collaboration tools and incident management platforms. 

 Authentication and Identity Provider Integrations 

 Integrate with your enterprise identity providers or credential managers to enable secure, automated authentication and access control within your Next-Gen Trust Security workflows. 

 Configure CyberArk Connection 

 Certificate Authority Integrations 

 Next-Gen Trust Security supports a broad range of public, private, and custom certificate authorities. These integrations simplify certificate issuance and help enforce policy across all your workloads. 
 ...
 Add GlobalSign MSSL CA 

 Add GoDaddy CA 

 Add HID PKIaaS CA 

 Add Let's Encrypt (ACMEv2) CA 
 ...
 Add Google Cloud Platform Private CA 

 Add Certificate Manager - Self-Hosted 

 Add Microsoft AD CS CA 

 Add Zero Touch PKI CA 
 ...
 Machines are endpoint systems—such as load balancers, web servers, and cloud services—where certificates are provisioned and installed. These integrations allow Next-Gen Trust Security to connect directly to application keystores, helping you manage the full certificate lifecycle across your infrastructure. 
 ...
 Configure A10 Thunder ADC 

 Configure Citrix ADC 

 Configure Cloudflare 

 Configure Common KeyStore 

 Configure F5 BIG IP LTM 

 Configure Imperva WAF 

 Configure Kemp Virtual LoadMaster 

 Configure Microsoft Azure Application Registration 

 Configure Microsoft Azure Key Vault 

 Configure Microsoft IIS 

 Configure Microsoft SQL Server 

 Configure Microsoft Windows (PowerShell) 

 Configure Palo Alto Networks Panorama 

 Configure Radware Alteon 

 Configure VMware NSX (AVI) 

 Notification Provider Integrations 

 Integrate with notification providers to receive real-time alerts about certificate lifecycle events and system health. These integrations enable you to route notifications to your preferred communication and incident management platforms. 
