---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-1013/addressed-issues-in-vm-series-plugin-1013.html
fetched_at: 2026-09-16T12:59:18Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 1.0.13 Clear
...
in the VM-Series plugin version 1.0.13. 
...
Plugin 1.0.11 to 1.0.12, the user interface shows a plugin mismatch. 
 ...
 Reboot the passive firewall. After it boots the active
firewall detects 1.0.12 installed and shows a match. 

 Reboot the active firewall. After it boots it detects 1.0.12
on the passive firewall and shows the plugins match. 
