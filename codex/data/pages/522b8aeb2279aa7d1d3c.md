---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/configure-the-cortex-agentic-assistant/agents-hub/manage-knowledge-sources-preview
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add, manage, and sync Knowledge Center knowledge sources to ground Cortex AgentiX Agentic Assistant agents with trusted organizational and system knowledge. 

 Use the Knowledge Center (preview) in the Agentic Assistant Hub to manage AI agent knowledge sources. Ground Agentic Assistant agents with trusted organizational and Cortex system knowledge. This provides more precise, context-aware investigation and analysis results. 
 ...
 Knowledge source auditing and citations provide transparency for AI agent decision-making. 
 ...
 Manage Knowledge Center sources 

 In the Knowledge Center, manage capacity, source settings, and indexing status: 
 ...
 Add a knowledge source by uploading a file or linking to external documentation. You can also attach Cortex system knowledge. 

 File formats can be MD, JSON, JSONL, CSV, DOC, or DOCX. 

 File size can be up to 5MB. 

 In Agentic Assistant Hub → Knowledge Center , click + New Source . 
...
The Source name is by default the knowledge source you are linking to. You can change it. 
 ...
 Previous Build agents 

 Next Expand agent capabilities with MCP integrations 
