---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/monitor-tenant-branches.html
fetched_at: 2026-09-16T12:47:36Z
source: palo-alto-main
---

# Monitor Tenant Branches Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn how to monitor tenant branches in the Strata Multitenant Cloud Manager . 

 If you activate a SASE license or a Prisma SD-WAN license for your tenant,
 you can view detailed reports on the branches in your Prisma SD-WAN tenants. To view this information, access the Strata Multitenant Cloud Manager and select Monitor Branches . 

 You can view the branch information for a specific tenant and all its children. 

 Select Monitor Branches . 

 The Branch and Branch Link Health widget
displays the link health for all branches. 
...
a health score>80. 
 ...
 The Tenant Branch Metrics widget
displays branch health and link health for branches for individual
tenants. 

 (Optional) Click a Tenant name to view the dashboard
for a tenant. 
