---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/detect-and-respond-to-threats/incidents-and-indicators-investigation/manage-indicators
fetched_at: 2026-09-16T09:13:32Z
source: cortex-platform
---

# Manage indicators | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You need a TIM license to investigate the indicator on the Indicator page, and use the Unit 42 features such as Sample Analysis, and Sessions and Submissions. For more information, see Indicator investigation . 
