---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-101/addressed-issues-in-panorama-plugin-for-vmware-nsx-101
fetched_at: 2026-09-16T07:43:41Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 1.0.1 Clear
...
in the Panorama plugin for VMware NSX 1.0.1. 

 PLUG-216 

 Fixed an issue where the output of the show object registered-IP all CLI command
does not include the Source of IP tag (service profile name and
ID). 
