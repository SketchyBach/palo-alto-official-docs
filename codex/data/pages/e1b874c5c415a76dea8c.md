---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.3/cortex-xdr-agent-for-macos/configure-cortex-xdr-agent-for-mac
fetched_at: 2026-09-16T08:51:32Z
source: cortex-platform
---

# Configure Cortex XDR Agent for Mac | 9.3 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In the installer, from the Installation Check option, select Continue to launch the Cortex XDR Configuration Wizard. 
 ...
 In the Summary page, if all permissions were added successfully, select Done . If permissions were not added correctly, select Go Back to adjust the settings. 
