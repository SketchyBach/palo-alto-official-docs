---
url: https://docs.paloaltonetworks.com/ngfw/help/10-2/network/network-interfaces-vlan
...
the current NetFlow server assignment from the interface. 
 ...
 Select a VLAN or click VLAN to define
...
(CIDR) notation: ip_address / mask (for
...
(on a best-case basis). 
 ...
 VLAN Interface IPv6 Router Advertisement 
...
via DHCPv6. 
 ...
 VLAN Interface IPv6 Router Advertisement (cont) 
...
the type is ipv6nd . 
 ...
 VLAN Interface IPv6 DNS Support 
...
(NPTv6). 
 ...
 If you Enable NDP Proxy , you can
