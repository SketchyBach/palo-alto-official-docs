---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-10/vm-series-plugin-109/addressed-issues-in-vm-series-plugin-109.html
fetched_at: 2026-09-16T12:59:18Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 1.0.9 Clear
...
in the VM-Series plugin 1.0.9. 

 PLUG-3567 

 Fixed an issue with the VM-Series firewall
for Azure that caused the HA failover to fail due to an Azure HA
configuration push error from Panorama. 

 PLUG-3749 

 Fixed an issue where the VM-Series firewall
15 character serial number is incorrectly replaced with a 24 character
serial number when the AWS instance type is changes to C5. 
