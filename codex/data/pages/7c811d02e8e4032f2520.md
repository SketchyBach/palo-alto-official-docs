---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/parsing-rules/create-parsing-rules
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Parsing Rules to normalize ingested data. 
 ...
 In Cortex XDR , select Settings → Configurations → Data Management → Parsing Rules . 
