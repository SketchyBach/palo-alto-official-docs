---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/engines/configure-engines/configure-the-engine-to-call-the-server-without-using-a-proxy/use-nginx-as-a-reverse-proxy
fetched_at: 2026-09-16T09:15:05Z
source: cortex-platform
---

# Use NGINX as a reverse proxy | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use NGINX as a reverse proxy for Cortex XSOAR On-prem 8.7 (EoL). 
