---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/cases-and-issues-configuration/create-issue-exceptions/create-an-issue-exception-rule
fetched_at: 2026-09-16T08:50:58Z
source: cortex-platform
---

# Create an issue exception rule | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Cortex AgentiX issue exception rules to defer remediation for matching issues. 
