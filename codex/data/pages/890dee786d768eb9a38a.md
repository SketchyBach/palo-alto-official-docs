---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/integrations/add-an-integration-instance
fetched_at: 2026-09-06T10:24:44Z
source: cortex-platform
---

# Add an integration instance |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up an integration instance to ingest incidents and indicators in Cortex XSOAR 8.14 On-prem. 
 ...
 If a classifier does not exist, specify an incident type. If a classifier is specified, it takes precedence when assigning an incident type to the fetched incident. Incident types determine which playbooks run on the fetched incident. 
