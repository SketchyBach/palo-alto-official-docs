---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-24
fetched_at: 2026-09-16T09:11:17Z
source: cortex-platform
---

# Asana Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Asana Key grants access to task management, project data, and sensitive configurations. 

 Exposure allows an attacker to exfiltrate proprietary project information, manipulate project timelines, or cause operational disruption. 
 ...
 Previous Alibaba Cloud Key detected in code 

 Next Atlassian Oauth2 Key detected in code 
