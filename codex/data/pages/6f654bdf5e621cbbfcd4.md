...
# Configure an engine to use custom certificates | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure custom engine certificates in Cortex XSOAR 8.9 On-prem. 
