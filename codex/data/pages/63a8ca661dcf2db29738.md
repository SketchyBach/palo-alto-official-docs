---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/storage/appsec-gcp-29
fetched_at: 2026-09-06T11:14:17Z
source: cortex-platform
---

# GCP cloud storage bucket with uniform bucket-level access disabled misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 761e3fae-4a27-41bb-a9ea-ab063b35d574 
 ...
 Arguments: uniform_bucket_level_access is set to true, [source,go] 

 resource "google_storage_bucket" "examplea" { name = "terragoat-${var.environment}" bucket_policy_only = true 

 uniform_bucket_level_access = true } 

 Previous GCP SQL database instance does not have backup configuration enabled misconfiguration detected in co 

 Next GCP VM disks not encrypted with Customer-Supplied Encryption Keys (CSEK) misconfiguration detected i 
