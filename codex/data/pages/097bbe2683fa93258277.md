---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/data-management/dataset-management/monitor-datasets-and-dataset-views-activity
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Monitor dataset and dataset view activity in Cortex AgentiX. 
 ...
 Cortex AgentiX logs entries for events related to datasets and dataset views monitored activities. Cortex AgentiX stores the logs for 365 days. To view the datasets and dataset views audit logs, select Settings → Management Audit Logs . 
