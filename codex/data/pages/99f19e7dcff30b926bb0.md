---
url: https://docs.paloaltonetworks.com/saas-security/sspm/onboard-saas-apps-supported-by-sspm/onboard-a-qodo-app-to-sspm
fetched_at: 2026-08-13T17:34:19Z
source: palo-alto-main
---

# Onboard a Qodo App to SSPM Clear
...
Onboard a Qodo App to SSPM 
 ...
 The onboarding process for Qodo is different from most applications,
 ...
 Log in to Qodo as an administrator. 
 ...
 Select Configuration SaaS Security Posture Security Applications Add Application and click the Qodo tile. 

 On the Posture Security tab, Add New instance. 

 SSPM displays the onboarding page, which lists the Qodo configuration
 settings and our recommended configuration values. 

 From your Qodo instance, identify the configuration values, and provide these
 configuration values to SSPM. 

 To avoid triggering rule violations in SSPM, you can update the values in
 Qodo to match our recommended values. 
 ...
 SSPM adds a tile on the Applications page to represent your Qodo instance.
 Based on the values that you entered, SSPM will determine if your Qodo
 instance has any rule violations. 

 Because SSPM is not scanning your Qodo instance, you must ensure that the
 information that SSPM has about your Qodo instance remains accurate. If you
 change a setting value in Qodo, manually update that value in SSPM. To do
 this, complete the following steps: 

 Select Configuration SaaS Security Posture Security Applications . 

 Locate the Qodo instance's tile and View
 Details . 
