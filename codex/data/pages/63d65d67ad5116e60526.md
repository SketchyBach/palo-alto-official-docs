---
url: https://docs.koi.ai/guides/audit-logs
fetched_at: 2026-09-06T09:13:37.114Z
...
"Extension ms-vscode.PowerShell version 2024.2.2 installed on device Amits-MacBook-Pro.local"
...
Amits-MacBook-Pro.local

timestamp

UTC timestamp (if available)

2025-08-29T09:45:00Z
...
"Mitigated 105 extensions searched by Lirons-MacBook-Pro.local."

hostname

Originating device

"Lirons-MacBook-Pro.local"

mitigated

Count of items blocked

105

created_by

User initiating search

"lironkaykov"

searchTerm

(Optional) Term searched
...
"Guardrail Scan-first protection was enabled"

created_by

Actor making the change (user/email)
...
Human-readable event message describing notification

"Malware Protection notification sent to eitan@koi.security"

recipient

Target recipient (email or integration endpoint)

"eitan@koi.security"

context

Notification type or alert category (inferred from message)

"Malware Protection", "Test alerting for 'High Severity' findings"

timestamp

[If available] UTC timestamp of the log

2025-08-29T12:15:00Z
...
Username of actor who initiated or was subject to remediation
...
"Extension save-to-pocket version 4.0.6 remediated on device LT-IttayD"

hostname

Endpoint where remediation occurred

"LT-ItayD"

extension.version

Version of the remediated item

"4.0.6"

extension.extensionId

Unique ID of the remediated item

"niloccemoadcdkdjlinkgdfekeahmflj"

timestamp

[If present] UTC timestamp

2025-08-29T13:20:00Z
...
"itay@extensiontotal.com"

timestamp

[If present] UTC timestamp

2025-08-29T14:10:00Z
...
Message describing the policy action

"Policy Block GPT Code created"
