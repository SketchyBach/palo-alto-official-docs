---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/cloud-service-provider-csp-onboarding/outpost-onboarding
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn about outposts, which are a dedicated set of infrastructure resources that extends the reach of Cortex XDR into your environment. 
 ...
 An outpost is a dedicated set of infrastructure resources that extends the reach of Cortex XDR into your environment. It serves as a secure, localized point for scanning assets across cloud providers and on-premises workloads. 
 ...
 Basic, standard outposts are the recommended deployment path for most organizations. Cortex XDR generates a Terraform template tailored to the values you enter in the outpost creation wizard, and you run that template in your CSP account to provision every resource the outpost needs, such as VPC or VNet, subnets, storage, secret vault, IAM roles or service accounts, scanner managed identities, and the trust relationship back to Cortex XDR. 
 ...
 Trust establishment. The template configures the trust relationship between your CSP account and Cortex XDR automatically, using federated identity credentials rather than long-lived secrets. 

 Registration. Once the Terraform apply completes for both the outpost and the CSP onboarding overall, your cloud environment sends a registration callback to Cortex XDR, and the outpost transitions from Pending to Connected . 
