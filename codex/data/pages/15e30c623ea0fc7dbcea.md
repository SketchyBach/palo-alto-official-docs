---
url: https://docs.paloaltonetworks.com/prisma-access/release-notes/5-1/cloud-services-plugin-for-panorama/upgrade-cloud-services-plugin
...
plugin. 
 ...
 example, to upgrade from a 3.0 Preferred plugin to a 5.1 plugin, you must
 first perform interim upgrades to 3.1, 4.0, 4.1, and 5.0 before upgrading to
 5.1. 
