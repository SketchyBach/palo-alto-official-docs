---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-312/known-issues-in-kubernetes-plugin-312.html
fetched_at: 2026-09-16T13:01:02Z
source: palo-alto-main
---

# Known Issues in Kubernetes Plugin 3.1.2 Clear
...
Updated on 
 ...
 Kubernetes version 3.1.2: 

 PLUG-21505 

 In Panorama Kubernetes Plugin 3.1.2, you may encounter an issue where
 attempting to onboard a public cluster using the Panorama web interface results in the
 Managed Device remaining stuck in an Initialization state. This issue is specific
 to the GUI workflow in version 3.1.2. 

 Workaround : You are advised to perform the onboarding process via the
 Panorama CLI as a workaround, where the functionality remains fully operational. 
