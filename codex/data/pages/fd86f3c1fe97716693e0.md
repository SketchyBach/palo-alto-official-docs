---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-release-notes/pan-os-9-1-addressed-issues/pan-os-9-1-5-addressed-issues
fetched_at: 2026-08-13T17:14:22Z
source: palo-alto-main
---

# PAN-OS 9.1.5 Addressed Issues Clear
...
PAN-OS 9.1.5 Addressed Issues 
 ...
 Added an enhancement that provides an option
...
certain GTPv1 Update PDP Context packets. 
 ...
 Fixed an issue where logs weren't able to
...
5. 
 ...
 Fixed an issue where after a successful
...
to fail the API call. 
 ...
 Fixed an issue with debug file handling
that led to a process ( mgmtsrvr ) restart. 

 PAN-149480 

 Fixed an issue where, if Panorama was connected
...
up on Panorama appliances in Management Only mode. 
 ...
 Fixed an issue where the CLI command Show config running following
...
forward URL logs from the Panorama Log Collector. 
 ...
 Fixed an issue where the object identifier
...
events did not return any events. 
 ...
 Fixed an issue where, after a policy commit
...
on certificate-based authentication ( CVE-2020-2050 ). 
 ...
 Fixed an issue where a GlobalProtect client
...
to PDF or CSV files did not include all policies and contained duplicates. 
 ...
 Fixed an issue where Application Command
...
tunnel traffic. 
 ...
 Fixed an issue on Panorama where creating
...
displayed the following error messages: `tcam full` and pan_plfm_fe_cp_arp_delete . 
 ...
 Fixed an issue where a Panorama log query
...
to the following error: Link speed mismatch . 
 ...
 Fixed an issue that prevented GTP tunnel
...
management did not take effect in the SSH management server profile. 
 ...
 Fixed an issue where a large certificate
...
failure on the Log Processing Card (LPC). 
 ...
 Fixed an issue where a high number of groups
in group mapping caused a process ( useridd ) to exit. 

 PAN-140100 

 Fixed an issue where Detailed
...
with the following error message: Timed out while getting config lock . 
 ...
 Fixed an issue where the serial number was
...
management interface. 
 ...
 Fixed an issue that caused a daemon ( snmpd )
...
a Panorama appliance in Management Only mode. 
 ...
 Fixed an issue where mounting failure occurred
...
web interface did not present HSTS headers to your web browser. 
 ...
 Fixed an issue where, when defining the
