---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/users-and-roles-management/manage-access-to-objects/manage-access-to-custom-dashboards
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage custom dashboard sharing, role permissions, ownership, widget visibility, and data access in Cortex AgentiX. 
 ...
 System Widgets : Standard system widgets provided by Cortex AgentiX remain Public and accessible to all users by default; their access cannot be restricted. 
 ...
 Previous Manage access to objects 

 Next Manage access to report templates 
