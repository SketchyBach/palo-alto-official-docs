---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-security/data-classification/how-to-create-and-validate-a-custom-data-profile
fetched_at: 2026-09-06T10:51:04Z
source: cortex-platform
---

# How to create and validate a custom data profile | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center note-sticky
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Deleting a data profile deletes all past data associated with it in all modules using Cortex Data Classification after a warning notification is displayed. 
 ...
 Note: For more information, see How to disable and enable data profiles in Cortex Data Classification . 

 Previous How to disable and enable data patterns in Data Classification 

 Next How to disable and enable data profiles in Cortex Data Classification 
