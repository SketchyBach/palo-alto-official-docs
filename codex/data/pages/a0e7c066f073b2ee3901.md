---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-99
fetched_at: 2026-09-06T11:15:26Z
source: cortex-platform
---

# NuGet API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 A NuGet API Key is a token used for publishing packages and managing the NuGet gallery. 

 Compromise enables an attacker to perform unauthorized package management operations, including injecting malicious payloads into packages consumed by the .NET ecosystem. 
 ...
 Previous Flutterwave API Key detected in code 

 Next Checkout.com API Key detected in code 
