---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-image-installations/set-up-broker-vm-on-google-cloud-platform-gcp
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn more about how to set up your Cortex Data Security Broker VM on Google Cloud Platform. 
 ...
 To set up the Broker VM on the Google Cloud Platform, install the VMDK image provided in Cortex Data Security. 
