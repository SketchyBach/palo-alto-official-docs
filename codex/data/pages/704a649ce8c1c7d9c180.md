---
url: https://docs.paloaltonetworks.com/enterprise-dlp/release-notes/known-issues-in-enterprise-dlp-plugin-50/known-issues-in-enterprise-dlp-plugin-504
fetched_at: 2026-09-15T15:10:50Z
source: palo-alto-main
---

# Known Issues in Enterprise DLP Plugin 5.0.4 Clear
...
Updated on 
 ...
 Known issues in Enterprise Data Loss Prevention (E-DLP) plugin 5.0.4. 
 ...
 This is addressed in Enterprise DLP plugin 5.0.5. 

 On the Panorama management server, Enterprise Data Loss Prevention (E-DLP) allows you to
 create a data filtering profile ( Objects DLP Data Filtering Profile ) with an invalid configuration. 
 ...
 This issue is addressed in Enterprise DLP plugin 5.0.5. 

 The Enterprise Data Loss Prevention (E-DLP) plugin doesn't prevent you from cloning a
 non-file data filtering profile ( Objects DLP Data Filtering Profile ) if the Application List Excluded From Non-File 
 doesn't include at least one app. 
