---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/product-usage/metric-dt-pu-85.html
fetched_at: 2026-09-16T11:04:24Z
source: palo-alto-main
---

# Severity Based Log Forwarding Clear
...
Updated on 
 ...
 Indicates whether the device is configured to forward system logs with a severity of Critical using either the email or syslog formats. Also indicates if Wildfire logs with a Malicious verdict are emailed to security administrators. 
