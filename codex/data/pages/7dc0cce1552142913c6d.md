---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes.html
fetched_at: 2026-09-16T13:01:09Z
source: palo-alto-main
---

# Panorama Plugin for Kubernetes Clear
...
Updated on 
 ...
 Review the release information for the Panorama plugin
for Kubernetes. 

 The Kubernetes plugin for Panorama enables
you to establish connectivity with the Kubernetes clusters, manage
licensing, and configure policies for visibility, control, and threat
inspection of traffic between pods or services, and for inbound
or outbound traffic for applications or services deployed on Kubernetes
clusters. 

 This Kubernetes plugin is required to manage the CN-Series firewalls.
Panorama provides a consistent management solution to incorporate
Kubernetes context into policies, and allows the other Palo Alto
Networks firewalls in the environment to use these context-infused
