---
url: https://docs.paloaltonetworks.com/hardware/pa-7000-hardware-reference/pa-7000-series-firewall-overview/pa-7050-front-and-back-panel-descriptions/pa-7050-back-panel-dc
fetched_at: 2026-08-13T16:35:17Z
source: palo-alto-main
---

# PA-7050 Back Panel (DC) Clear
...
PA-7050 Back Panel (DC) 
 ...
 The following image shows the back panel of the PA-7050 firewall
(with DC power supplies installed). The AC inlets and switches are
not functional and must remain covered using the provided cover
plate. 

 The only differences between the back panel of the AC model and
the back panel of the DC model is that the DC model does not have
a Power Entry Modules (PEM); the DC power source connects directly
to the front of the power supplies. For descriptions of the back
panel components, see PA-7050
Back Panel (AC) . 
