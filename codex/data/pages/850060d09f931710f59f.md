---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/engines/configure-engines/configure-an-engine-to-use-custom-certificates
fetched_at: 2026-09-16T09:14:37Z
source: cortex-platform
---

# Configure an engine to use custom certificates | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure engine certificates in Cortex XSOAR On-prem 8.6 (EoL). 
