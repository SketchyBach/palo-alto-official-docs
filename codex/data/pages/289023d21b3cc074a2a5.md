---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/configure-cortex-xsoar/engines/configure-engines/configure-the-engine-to-use-a-web-proxy
fetched_at: 2026-09-16T09:14:21Z
source: cortex-platform
---

# Configure the engine to use a web proxy | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure an engine web proxy in Cortex XSOAR 8.8 On-prem. 
