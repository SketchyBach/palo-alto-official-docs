---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/reference/microsoft-windows-security-auditing-setup/enable-security-auditing-event-ids/enable-security-auditing-event-ids-with-gpo
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use Group Policy to enable Windows security auditing event IDs for Cortex XSIAM data collection. 
