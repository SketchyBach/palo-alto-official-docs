---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/engines/configure-engines/configure-the-engine-to-use-a-web-proxy
fetched_at: 2026-09-16T09:14:32Z
source: cortex-platform
---

# Configure the engine to use a web proxy | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure an engine web proxy for Cortex XSOAR On-prem 8.7 (EoL). 
