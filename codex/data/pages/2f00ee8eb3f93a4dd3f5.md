---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/engines/install-an-engine/docker/configure-docker-pull-rate-limit
fetched_at: 2026-09-06T11:28:09Z
source: cortex-platform
---

# Configure Docker pull rate limit | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Docker pull limits in Cortex XSOAR On-prem 8.6 (EoL). 
