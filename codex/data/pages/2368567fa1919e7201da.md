---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-new-features/upgrade-pan-os/upgrade-the-firewall-pan-os/determine-the-upgrade-path.html
fetched_at: 2026-09-16T10:53:06Z
source: palo-alto-main
---

# Determine the Upgrade Path to PAN-OS 10.0 Clear
...
Updated on 
 ...
 Upgrade path planning for PAN-OS 10.0. 
...
release through which you pass as part of your upgrade path. 
 ...
 Installed PAN-OS Version Recommended Upgrade Path to PAN-OS 10.0 

 9.1.x 

 If you are already
running a PAN-OS 9.1 release, download and install the latest preferred PAN-OS 9.1 maintenance
release and reboot. 

 Proceed to Upgrade the Firewall to PAN-OS 10.0 . 
