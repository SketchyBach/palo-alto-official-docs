...
Creating a Request Policy 
 ...
 Important: Request policies are parent TSG resources. Only users with the Superuser role in the parent TSG can create or modify request policies. Request policies must be explicitly shared with child TSGs for users in those TSGs to request certificates using the request policy. 
