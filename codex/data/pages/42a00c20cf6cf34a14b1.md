---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/onboard-cortex-agentix/post-deployment-steps/log-forwarding/forward-logs-and-data-from-cortex-agentix-to-external-services/set-up-email-notifications-for-tenant-updates
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Cortex AgentiX email notifications for tenant upgrades, hotfixes, downtime warnings, and Management Audit Log events. 
