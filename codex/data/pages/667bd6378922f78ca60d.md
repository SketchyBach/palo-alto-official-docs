---
url: https://docs.paloaltonetworks.com/dns-security/administration/dns-security-service-domains
...
Regional Service Domains 
 ...
 Palo Alto Networks maintains global service domains that provides real-time query
 analysis, machine learning-driven threat detection, and access to a cloud-delivered
 signatures. 
 ...
 Palo Alto Networks operates a global network of service domains that provide Advanced DNS Security and cloud-delivered DNS operations. These domains perform real-time
 analysis of DNS queries using machine learning to detect threats such as tunneling and
 DGA, while providing the NGFW with immediate access to a cloud-based
 signature database. This infrastructure offloads complex analytics to the cloud to
 maintain high-performance protection against evolving DNS-based attacks. 
