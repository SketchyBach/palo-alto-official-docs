---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-trustsec/panorama-plugin-for-cisco-trustsec-201/addressed-issues-in-panorama-plugin-for-cisco-trustsec-201.html
fetched_at: 2026-09-16T13:00:38Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco TrustSec 2.0.1 Clear
...
Updated on 
 ...
 The following list describes issues addressed in the Panorama plugin for Cisco
 TrustSec 2.0.1. 

 PLUG-15024 

 Fixed an issue that caused a Cisco TrustSec monitoring definition to return a 500
 Internal Server Error when connecting to Cisco ISE 3.2 patch 4. 

 PLUG-14929 

 Fixed an issue where the Panorama plugin for Cisco Trustsec configuration cannot be
 committed on Panorama with FIPS mode enabled. 

 PLUG-12633 

 Fixed an issue that prevented the Panorama plugin for Cisco TrustSec from correctly
 replicating the configuration, after an HA failover event, from the previously active
 Panorama instance. 
