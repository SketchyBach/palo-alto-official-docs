---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-your-azure-account/edit-onboarded-account
fetched_at: 2026-09-16T13:34:58Z
source: prisma-cloud
---

# View and Edit a Connected Azure Account | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Edit Cloud Account page allows you to add or change Security Capabilities & Permissions . You can also opt in or out of ingesting flow logs. Reference Connect your Azure Tenant for more information. 

 Previous Update Azure Application Permissions 

 Next Troubleshoot Azure Account Onboarding 
