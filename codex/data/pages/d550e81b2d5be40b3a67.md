...
CASB for Prisma Access and NGFW (CASB-X) license 
 ...
 Forward Email for Approval to End User's Manager action is based on the transport for manager
 approval rule . 
 ...
 The action Microsoft Exchange takes on a
 Forward Email for Approval to Admin action is based on the transport for admin
 approval rule . 
