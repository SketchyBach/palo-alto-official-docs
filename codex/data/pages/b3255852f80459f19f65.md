---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/protect-your-endpoints/endpoint-security/endpoint-protection/guidelines-for-keeping-cortex-xdr-agents-and-content-updated
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Plan phased Cortex XDR agent and content updates to maintain endpoint protection in Cortex XSIAM. 
 ...
 When you delay content updates, the Cortex XDR agent will retrieve the content according to the configured delay. For example, if you configure a delay period of two days, the agent will not use any content released in the last 48 hou 
