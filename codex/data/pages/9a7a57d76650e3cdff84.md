---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-20/vm-series-plugin-207/addressed-issues-in-vm-series-plugin-207.html
fetched_at: 2026-09-16T12:59:08Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.0.7 Clear
...
issue in VM-Series plugin 2.0.7. 
...
set to 1 and the model type is VM-300, VM-500, or VM-700. 
 ...
 Fixed an issue that caused high VM-Series
firewall management plane CPU usage after upgrading to VM-Series
plugin 2.0.x. 

 PLUG-7879 

 Fixed in an issue that caused the VM-Series
firewall on AWS to become stuck in a boot loop after changing the
instance size. 
