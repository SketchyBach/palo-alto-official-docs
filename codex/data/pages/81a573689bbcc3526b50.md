---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/cloud-service-provider-csp-onboarding/alibaba-cloud-cloud-onboarding/prerequisites-for-onboarding-alibaba-cloud
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Enter alibaba-cortex-wif-<accountID> as the audience value for the new client ID where <accountID> corresponds to the Cortex XDR Project ID. Save the changes. 
