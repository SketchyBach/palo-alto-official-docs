---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/cloud-service-provider-csp-onboarding/outpost-onboarding/outpost-cloud-service-provider-csp-permissions/google-cloud-platform-gcp-outpost-permissions
fetched_at: 2026-09-06T09:41:10Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 List of Google Cloud Platform (GCP) permissions for use during Cortex XDR onboarding outposts to enable continuous monitoring in your cloud environment. 

 When onboarding Google Cloud Platform (GCP), Cortex XDR creates an authentication template that requests the permissions needed for monitoring your cloud outpost environment. Depending on which security capabilities you select in the onboarding wizard, different permissions are requested. 
