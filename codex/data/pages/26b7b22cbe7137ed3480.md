---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-200.html
fetched_at: 2026-09-16T13:00:25Z
source: palo-alto-main
---

# Panorama Plugin for Cisco ACI 2.0.0 Clear
...
introduces two new features—two new monitored attributes and the
Panorama Plugin for Cisco ACI Dashboard. 

 The Panorama plugin for Cisco ACI 2.0.0 requires Panorama 9.0.x
or later. For more information on installing and configuring the
Panorama plugin for Cisco ACI 2.0.0, see the VM-Series Deployment
