---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-37
fetched_at: 2026-09-06T11:15:10Z
source: cortex-platform
---

# DroneCI Token detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The DroneCI Token is used to authorize requests and grant access to the CI/CD service API. 

 A compromised token can lead to unauthorized execution of build jobs, exposure of repository credentials, and potential manipulation of deployment processes. 
 ...
 Previous Doppler API Key detected in code 

 Next Dropbox App Credential detected in code 
