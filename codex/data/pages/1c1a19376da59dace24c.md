---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-165
fetched_at: 2026-09-06T11:15:40Z
source: cortex-platform
---

# AMQP Password detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The AMQP Password grants High Risk access to the message queuing system. 

 Exposure enables unauthorized parties to read sensitive messages, insert malicious commands, or cause service disruption by deleting or purging queues. 
 ...
 Previous AMQP User Name detected in code 

 Next Stripe Webhook Secret detected in code 
