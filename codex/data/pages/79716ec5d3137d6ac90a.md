---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/configure-cortex-xsoar/engines/install-an-engine/docker/docker-hardening-guide
fetched_at: 2026-09-16T08:53:59Z
source: cortex-platform
---

# Docker hardening guide | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, harden Docker for secure engine operations. 
 ...
 If swap limit capabilities is enabled, configure the memory limitation. To test the memory, see Step 5 in Configure the memory limitation . 
