---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-301.html
fetched_at: 2026-09-16T13:00:23Z
source: palo-alto-main
---

# Panorama Plugin for Cisco ACI 3.0.1 Clear
...
Updated on 
 ...
 Learn what's new in Panorama plugin for Cisco ACI 3.0.1. 

 The Panorama plugin for Cisco ACI can now process Endpoint Security Group (ESG)
 information and convert it into a set of tags that can be used as match criteria for
 placing IP addresses in dynamic address groups. ESG tags are constructed in the
 following format. 

 cisco.cl_<cluster>.tn_<tenant>.ap_<app-profile>.esg_<ESG> 

 See the VM-Series Deployment Guide to learn more about
 what tags can be used to secure your Cisco ACI environment. 
