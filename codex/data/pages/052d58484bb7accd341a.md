---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-55.html
fetched_at: 2026-09-16T11:03:39Z
source: palo-alto-main
---

# Session Table Usage Clear
...
Updated on 
 ...
 Collects session statistics for each dataplane, such as the maximum number of supported sessions, the number of active sessions broken down by session type (TCP, HTTP, SCTP, and so forth), session timeout values, and so forth. Also collects system information, such as model number, hostname, MAC and IP address, amount of device uptime, software versions and release dates. 
 ...
 show session info show system info 
