---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/playbooks/develop-your-playbook/task-3.-add-tasks/configure-script-error-handling-in-a-playbook
fetched_at: 2026-09-16T09:15:06Z
source: cortex-platform
---

# Configure script error handling in a playbook | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure playbook script error handling in Cortex XSOAR On-prem 8.6 (EoL). 
