---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/remote-repository-management/cortex-agentix-development-tenant
fetched_at: 2026-09-16T08:50:44Z
source: cortex-platform
---

# Cortex AgentiX development tenant | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Develop, test, and synchronize Cortex AgentiX content safely before deploying it to production. 
 ...
 Cortex AgentiX content types 

 Content includes integrations, automation scripts, playbooks, and other components that enhance Cortex AgentiX capabilities for case response and threat intelligence management. There are two types of content: 
 ...
 Cortex AgentiX development tenants 
 ...
 Manage Cortex AgentiX content with a remote repository 

 In Cortex AgentiX you can use a content management system with a remote repository to develop and test content. You can choose which type of remote repository you want to use, either the Cortex AgentiX built-in remote repository (default), or you can add any private content repository that is Git-based, including GitHub, GitLab, and Bitbucket. In addition, on-premise repositories are also supported. 
 ...
 Push and pull Cortex AgentiX content between tenants 
 ...
 Push and pull Cortex AgentiX system content 
 ...
 Push and pull Cortex AgentiX custom content 
 ...
 Next Set up a remote repository 
