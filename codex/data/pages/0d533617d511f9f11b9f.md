---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/latest
fetched_at: 2026-09-06T10:58:29Z
source: cortex-platform
---

# latest | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field from which you want to retrieve the chronologically latest value. 
 ...
 An optional name for the output column. 
 ...
 Optional fields used to group rows; the latest value is calculated independently for each group. 
 ...
 When set to true, includes a column listing the raw events contributing to the aggregate result. 
 ...
 "Client C2 hit rate limit on /data endpoint." 
