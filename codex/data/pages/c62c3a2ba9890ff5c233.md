---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/pan-os-xml-api-request-types/get-version-info-api.html
fetched_at: 2026-09-16T11:04:44Z
source: palo-alto-main
---

# Get Version Info (API) Clear
...
XML API Request Types 
 ...
 type to show the PAN-OS version for a firewall or Panorama. In addition
 to the PAN-OS version, this request provides a direct way to obtain
 the serial number and model number.

 Make a request to the PAN-OS XML API and with
 type=version along
 with your API key:

 curl -X GET "https://<firewall>/api/?type=version&key=<apikey>" 

 Confirm that the XML response contains the software version,
 model, serial number, and whether multi-vsys mode is on: 
