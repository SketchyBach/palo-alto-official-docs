...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can forward firewall data from your Cloud Next-Generation Firewall (CNGFW) to Cortex XDR. During onboarding or by editing an existing instance, you can select specific log types to ingest to optimize data consumption and reduce costs. 
