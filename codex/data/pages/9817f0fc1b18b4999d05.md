---
url: https://docs.paloaltonetworks.com/pan-os/9-1/pan-os-panorama-api/pan-os-xml-api-request-types/get-version-info-api
fetched_at: 2026-09-16T13:56:53Z
...
XML API Request Types 
 ...
 Use the type=version request type
...
the serial number and model number. 
 ...
 Make a request to the PAN-OS XML API and with type=version along
with your API key: 

 curl -X POST 'https://firewall/api?type=version&key=<apikey>" 

 Confirm that the XML response contains the software version, model,
serial number, and whether multi-vsys mode is on: 
