---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-panorama-api/about-the-pan-os-xml-api/structure-of-a-pan-os-xml-api-request/api-authentication-and-security.html
...
Updated on 
 ...
 To use the API (XML or REST), you must enable API access for
your administrators and get your API key . By default, the
firewall and Panorama support API requests over HTTPS. To make API
...
Base64 encoding in an Authorization header field. 
 ...
 You cannot use basic authentication when you Get
Your API Key . 

 To enforce key rotation set an API key lifetime ; you
