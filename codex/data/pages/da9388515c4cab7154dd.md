---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/configure-and-deploy-cortex-xdr/cortex-mcp-server
fetched_at: 2026-09-06T09:39:19Z
source: cortex-platform
---

# About the Cortex MCP server | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install, configure, use, and extend the Cortex MCP server. 
 ...
 Next Install the Cortex MCP sever 
