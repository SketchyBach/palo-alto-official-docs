---
url: https://docs.paloaltonetworks.com/ai-runtime-security/ai-model-security/ai-supply-chain-security/model-security-to-secure-your-ai-models/manage-ai-model-versions-using-content-based-fingerprinting
