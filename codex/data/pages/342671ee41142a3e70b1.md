---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/asset-classes/compute-assets/vm-images-assets
fetched_at: 2026-09-06T09:43:17Z
source: cortex-platform
---

# VM images assets | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and manage virtual machine image assets. 
 ...
 List of scanners that have successfully scanned the Core Image asset. As the core image can be scanned by multiple scanners, the values are stored as a concatenated string of all scanner types. If no scanner data exists in the database, the default value is an empty array. This column is hidden from the default view. 
 ...
 The Last Scan time reflects the most recent scan across all scanners for a Core Image. If no scan data is available in the database, the default value is 0. This column is hidden from the default view. 
 ...
 Previous Serverless functions assets 
