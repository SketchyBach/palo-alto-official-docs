...
Track Inventory with Custom Reports 
 ...
 Only users with the Superuser role can access and use Custom Reports. Parent TSG users see data across the entire TSG hierarchy, while child TSG users see data scoped to their assigned TSG. 
