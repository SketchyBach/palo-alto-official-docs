---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/PA-7000-series-firewall-installation/install-the-pa-7080-EMI-filter.html
fetched_at: 2026-09-16T12:08:37Z
source: palo-alto-main
---

# Install the PA-7080 Firewall EMI Filter Clear
...
when you install the following hardware components: 
 ...
 If the last five digits of your PA-7080 firewall serial number are greater than 10,000, or the
 ...
 vents to determine if the internal filter is installed. 

 Slide the top tabs of the EMI filter into the
top row of air vents on the back of the firewall and then lower
the filter until it is flush with the chassis. 

 Secure the filter to the chassis using the four captive
