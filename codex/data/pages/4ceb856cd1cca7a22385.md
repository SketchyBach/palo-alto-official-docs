---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/onboard-and-configure/post-deployment-steps/manage-user-roles-and-access-management/manage-user-scope
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage user scope in Cortex Cloud to limit access to the appropriate data and resources. 
