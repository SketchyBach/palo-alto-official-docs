---
url: https://cortex-docs.paloaltonetworks.com/cortex-xpanse/inventory/asset-types/websites
fetched_at: 2026-09-06T10:52:29Z
source: cortex-platform
---

# Websites | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Navigate to Inventory → Websites. 
 ...
 Navigate to Dashboards → Websites to view the dashboard. 

 Like the other Cortex Xpansedashboards, you can download the the Websites dashboard as a report. 

 Enable Alerts for Websites 

 Cortex Xpanse provides Attack Surface Rules that detect website security best practice failures. These are the best practices that are assessed in the Security Best Practices Analysis section of website details pages in the Inventory . 

 The attack surface rules for websites are disabled by default. Enable these attack surface rules to enable Cortex Xpanse to start creating alerts for websites. 
 ...
 In the Select Field dropdown menu, select ASM Alert Categories . 

 In the Value field dropdown menu, select the two attack surface rule categories for websites: Web Security Assessments . 
 ...
 Previous Owned IPv6 Ranges 

 Next Unified Inventory 
