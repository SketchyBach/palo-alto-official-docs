---
url: https://docs.paloaltonetworks.com/ngfw/help/10-1/policies/policies-tunnel-inspection/building-blocks-in-a-tunnel-inspection-policy
...
for the Tunnel Inspection policy. 
 ...
 ( Optional ) Enter one or more tags
...
a protocol inside the tunnel that the firewall cannot identify. 
 ...
 ( Optional ) Enable this option to
...
logs and reports. 
 ...
 ( Optional ) Enter a monitor tag
number that can group similar traffic together for logging and reporting (range
is 1 to 16,777,215). The tag number is globally defined. 
...
the session. 
 ...
 Tunnel logs are stored separately from traffic
...
the session. 
 ...
 ( Optional ) Select a Log Forwarding
...
inspected. 
 ...
 If you configure a VXLAN ID you can use it as a matching
criteria to restrict traffic inspection to specific VNIs. 

 ( Optional ) A name beginning with
