---
url: https://docs.paloaltonetworks.com/wildfire/u-v/wildfire-whats-new/latest-wildfire-cloud-features/advanced-wildfire-government-cloud
...
Advanced WildFire Government Cloud 
 ...
 Palo Alto Networks offers access to a high-security Advanced WildFire Government
 Cloud in US regions to Federal, Department of Defense, and approved Defense Industrial Base
 (DIB) customers that need to operate within a high-security environment. 

 Palo Alto Networks now offers access to a high-security Advanced WildFire Government Cloud in US
 regions to Federal, Department of Defense, and approved Defense Industrial Base (DIB)
 customers that need to operate within a high-security environment. The Advanced WildFire
 Government Cloud complies with Federal Encryption Standards (FIPS 140-2) and meets
 FedRAMP High Baseline / Impact standards, while operating using a newer codebase,
 similar to that of the current Advanced WildFire Commercial Public Cloud, for up-to-date
 analysis capabilities. 

 To access the new High U.S. Government Cloud, you must have a valid SKU
 (contact your Palo Alto Networks sales contact for info about upgrade SKUs) associated
 with your Advanced WildFire subscription and configure your NGFW and Prisma Access
 devices to forward unknown files and email links for analysis to the following: 
 https://gov-cloud.wildfire.paloaltonetworks.com. 
