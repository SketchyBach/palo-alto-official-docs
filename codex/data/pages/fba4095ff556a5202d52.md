---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/asset-classes/application-assets
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and manage application assets. 
 ...
 Application Builder: Manually build an application by selecting starting assets from either the code side (VCS repositories) or the run side (cloud providers, Kubernetes clusters, or VPCs). Cortex XDR automatically identifies and adds related assets based on their connections. 
 ...
 You can export application security data for reporting, sharing metrics, or audit evidence. Cortex XDR offers two export workflows: a portfolio-level overview or an application-level deep dive. Data is downloaded to your local host in a .tsv file format. 
