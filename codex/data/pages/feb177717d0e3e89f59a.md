---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/cloud-service-provider-csp-onboarding/outpost-onboarding/working-with-standard-outposts/create-a-standard-outpost
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create an outpost to deploy a Cortex XDR outpost using infrastructure that Cortex XDR creates for a fast, consistent deployment with minimal manual configuration. 
 ...
 Important : If you want to deploy a Cortex XDR Azure outpost using your own pre-created Entra ID app registration, follow the instructions for Bringing your own Azure app (BYOA) . This type of outpost is designed for organizations with strict governance policies that require control over Entra ID tenant-level resources. 
 ...
 Check Cortex XDR : The outpost should appear as Pending in the Cortex XDR Outposts page at Settings → Data Sources & Integrations → Outposts . 

 The necessary permissions are granted and a notification is sent to Cortex XDR with the execution details. 
