---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-3-0-11/addressed-issues-in-vm-series-plugin-3-0-11.html
fetched_at: 2026-09-16T12:58:51Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 3.0.11 Clear
...
Updated on 
 ...
 Fixed an issue that caused failure to fetch device certificate during the bootstrap of
 VM-Series firewall. 

 PLUG-18554 

 Failover on Azure HA was observed to be failing an error
 NetworkingInternalOperationError due to the failing of secondary IP
 on the NICs. This issue is now resolved by serializing the Azure API calls. 

 PLUG-18084 

 The root partition of the PA-VM is reaching 98% utilization due to Microsoft
 WAAgent when unsupported extensions are installed from azure portal. 
