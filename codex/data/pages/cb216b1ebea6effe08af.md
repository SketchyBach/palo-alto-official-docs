---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/manage-services-and-devices/allocate-devices.html
fetched_at: 2026-09-16T13:54:37Z
source: palo-alto-main
---

# Allocate Hardware Devices Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn about allocating a hardware device through the Strata Multitenant Cloud Manager . 

 Get a quote for your device, and then place
an order that includes the details for the support, quantity, and
bandwidth. After your order is fulfilled and you activate a SASE
license or a Prisma SD-WAN license for your tenant, the Strata Multitenant Cloud Manager enables you to manage devices . 

 To
allocate a hardware device, complete the following steps. 

 In the Strata Multitenant Cloud Manager , select Manage Devices . 
...
multiple devices to a single client tenant. 
 ...
 The Prisma SD-WAN administrator can claim the device in the Prisma SD-WAN controller. 
