---
url: https://docs.paloaltonetworks.com/prisma-access/incidents-and-alerts/ai-powered-adem-incidents/incident-inc-globalprotect-portal-auth-timeout-failures-count-exceeded-above-baseline-all-pa-locations
fetched_at: 2026-08-13T17:25:54Z
source: palo-alto-main
---

# INC_GLOBALPROTECT_PORTAL_AUTH_ TIMEOUT_FAILURES_COUNT_EXCEEDED_
...
INC_GLOBALPROTECT_PORTAL_AUTH_ TIMEOUT_FAILURES_COUNT_EXCEEDED_
 ...
 Learn about the INC_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED_ABOVE_
 BASELINE_ALL_PA_LOCATIONS incident. 

 Synopsis 

 Portal authentication timeout failures are higher than twice the baseline for all Prisma Access locations. 

 Incident Code—INC_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED_ABOVE_
 ...
 AL_GLOBALPROTECT_PORTAL_AUTH_SUCCESS_COUNT_DROPPED_BELOW_BASELINE_
 ALL_PA_LOCATIONS 

 AL_GLOBALPROTECT_PORTAL_AUTH_SUCCESS_COUNT_DROPPED_BELOW_BASELINE_
 PER_PA_LOCATION 

 AL_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED_
 ABOVE_BASELINE_ALL_PA_LOCATIONS 

 AL_GLOBALPROTECT_PORTAL_AUTH_TIMEOUT_FAILURES_COUNT_EXCEEDED
 _ABOVE_BASELINE_PER_PA_LOCATION 
