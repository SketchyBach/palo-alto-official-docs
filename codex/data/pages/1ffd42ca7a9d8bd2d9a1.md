...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Control removable devices and peripheral access on managed endpoints. 
 ...
 Assign a profile name. You can add a description. Cortex XDR sets the profile type and platform. 
 ...
 You cannot edit or delete default Cortex XDR profiles. 
 ...
 You cannot edit or delete predefined Cortex XDR profiles. 

 Apply the device control profiles to your endpoints. 

 Apply device control profiles to your endpoints 

 After defining configuration and exceptions profiles, configure Device Control policies and enforce them on endpoints. Cortex XDR evaluates policies in page order. The first matching policy applies. If none match, the default policy enables all devices. 
 ...
 After the policy reaches agents, Cortex XDR enforces it. 
 ...
 The new class is available with other Cortex XDR device classes. 
