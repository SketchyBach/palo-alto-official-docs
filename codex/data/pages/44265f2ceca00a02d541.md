---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aiops/aiops-plugin-110.html
fetched_at: 2026-09-16T12:59:23Z
source: palo-alto-main
---

# Panorama Plugin for AIOps 1.1.0 Clear
...
Updated on 
 ...
 What's new for Panorama Plugin for AIOps 1.1.0. 

 Panorama Plugin for AIOps 1.1.0 enables policy analyzer in AIOps for NGFW. With
 policy analyzer , you can check if a new
 security rule meets your intended purpose, and does not duplicate, shadow, or conflict
 with your existing rules (pre-commit). You can also check for duplication and other
 anamolies across your current security policy rulebases (post-commit). 

 You can download this version of the Panorama CloudConnector Pluginon Panorama
 10.2.3 or later from the Customer Support Portal or directly from Panorama Plugins . 
