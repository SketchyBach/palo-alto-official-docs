---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/_release-notes
fetched_at: 2026-09-16T07:24:29Z
source: palo-alto-main
---

# Release Notes: vsatctl Tool Clear
...
Updated on 
 ...
 vsatctl is a command line tool used for managing VSatellite operations. It provides various commands to perform tasks such as installing and restarting VSatellites and upgrading K3s used by VSatellites. 

 Come back here to learn about current and past releases of vsatctl. 

 Release 2.0.36 

 21 March 2025 

 Changed port requirements for outbound communication from VSatellites 

 When you upgrade to this version of VSatellite, you no longer need to ask for a network exception for port 9443. All upgraded and new installations of VSatellite will use port 443. 

 Release 2.0.32 

 11 February 2025 

 Improved TLS security validation for registry connections 

 A new update enhances TLS security validation for registry connections, strengthening security best practices. This update is automatically applied to new installations. If you hnve an existing VSatellite server, update it to apply these security enhancements. Learn more . 

 Release 2.0.25 

 20 November 2024 

 This release focuses on enhancing VSatellite's K3s component, providing improved performance and security. 

 Key Features 

 K3s Version Upgrade : Updated the K3s version to the latest stable release, ensuring compatibility with recent Kubernetes features and security patches. 

 Enhanced Security : Implemented stricter access controls for the VSatellite cluster credentials file, limiting access to root users and members of the root group to protect sensitive information. 

 Improved Upgrade Process : Streamlined the K3s upgrade procedure, allowing administrators to execute the upgrade with a single command, reducing downtime and complexity. 

 For more information, see Upgrade vsatctl to access new K3s upgrade functionality . 
