---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/configure-cortex-xsoar/integrations/add-an-integration-instance/receive-notifications-on-an-incident-fetch-error
fetched_at: 2026-09-16T08:55:30Z
source: cortex-platform
---

# Receive notifications on an incident fetch error | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Receive incident fetch error notifications in Cortex XSOAR 8.9 On-prem. 
