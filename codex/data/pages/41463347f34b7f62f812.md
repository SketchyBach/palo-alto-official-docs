---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/investigate-and-respond-to-threats/day-to-day-tasks-in-cortex-xsoar/indicator-management/indicator-query
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Search, create, edit, export, and delete threat indicators in Cortex XSOAR 6.14. 
 ...
 Export the selected indicators to a CSV file. You can also export indicators in UTF8-BOM format . 
