---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/authenticate-users-using-sso
fetched_at: 2026-09-16T09:14:23Z
source: cortex-platform
---

# Authenticate users using SSO | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Authenticate users with SSO in Cortex XSOAR 8.8 On-prem. 
