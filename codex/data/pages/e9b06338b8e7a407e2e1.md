---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/data-management/parsing-rules/parsing-rules-file-structure-and-syntax/const
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the CONST command to define constant values. 
 ...
 CONST syntax is derived from XQL, but includes the modifications explained in Parsing Rules file structure and syntax . 
