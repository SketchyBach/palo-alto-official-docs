---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-147
fetched_at: 2026-09-16T09:11:32Z
source: cortex-platform
---

# Adobe API ID detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Adobe API ID (Client ID) is the unique identifier for authentication. 

 Combined with the Client Secret, exposure enables unauthorized API access, compromising the application's identity and control over licensed services or content. 
 ...
 Previous reCAPTCHA key detected in code 

 Next Adobe API Secret detected in code 
