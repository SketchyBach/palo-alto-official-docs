---
url: https://docs.paloaltonetworks.com/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-119
fetched_at: 2026-08-13T17:16:32Z
source: palo-alto-main
---

# EDL Capacities Clear
...
EDL Capacities 
 ...
 Collects consumption and maximum size limits for various External Dynamic List (EDL) lists on the device. Current usage and maximum list size is collected for IP, Domain, URL, and Predefined-IP lists. The contents of these lists are not collected; rather just the total number of elements in each list is retrieved, as well as the maximum number of elements allowed for the list type. 
