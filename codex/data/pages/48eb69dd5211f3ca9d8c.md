---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-zero-touch-provisioning/panorama-plugin-for-zero-touch-provisioning-10/features-introduced-in-zero-touch-provisioning-10.html
fetched_at: 2026-09-16T13:00:56Z
source: palo-alto-main
---

# Features Introduced in Zero Touch Provisioning 1.0 Clear
...
Updated on 
 ...
 Next-Generation Firewalls for Zero Touch
Provisioning 

 ( PAN-OS 9.1.3 and later releases ) 

 Zero Touch Provisioning (ZTP) is an SD-WAN
functionality that permits a hands-off approach to firewall installation
and configuration. ZTP-enabled versions of the PA-220, PA-220R, PA-820,
PA-850, and PA-3200 firewalls enable easy communication between
the registration portal and Panorama. This feature ensures a safe,
quick, and hands-free setup, allowing you to begin securing your
wide area network as soon as possible. 

 See the Hardware Features for
more information on supported ZTP firewalls. 
