---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-panorama-api/pan-os-xml-api-use-cases/upgrade-pan-os-on-multiple-ha-firewalls-through-panorama-api.html
fetched_at: 2026-09-16T13:53:51Z
...
Include the firewall serial number in your request: 
 ...
 The
response contains an array of results sorted to show the latest version
first: 
...
to ensure that the system update download completes successfully: 
...
response should include the following: 
 ...
 curl -X POST 'https://panorama/api?type=op&cmd=<show><devices><connected></connected></devices></show>&key=<apikey>" 
...
response confirms the active firewall has been suspended: 
 ...
 Install the latest software update on the suspended HA pair. 

 After suspending the active HA firewall, install the system update
on it: 
...
response should include the following: 
 ...
 After installing the latest system update, reboot the suspended HA
peer: 
 ...
 Show system information on your upgraded HA peer to ensure it
has the latest system update and is operational: 
