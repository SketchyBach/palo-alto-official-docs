---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/administration-and-troubleshooting/manage-instances/add-a-new-data-source-or-instance
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 When adding XDR data sources, the Data Source Onboarder is not available. However, you can still enable the data source; Cortex XDR creates an instance and lists it on the Data Sources & Integrations page. 
 ...
 Cortex XDR automatically installs content packs with required dependencies and updates any pre-installed optional content packs. You can also Select additional content packs with optional dependencies to be configured during connection. 
