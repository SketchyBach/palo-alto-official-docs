---
url: https://docs.prismacloud.io/content-collections/administration/configure-external-integrations-on-prisma-cloud/prisma-cloud-integrations
fetched_at: 2026-09-16T13:35:07Z
source: prisma-cloud
---

# Prisma Cloud Integrations | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can check status updates on demand in Settings > Integrations by clicking the Get Status icon for the relevant integration. The status check displays red if the integration fails validation checks for accessibility or credentials; or green when the integration is working and all templates are valid. To review the list of integrations that do not support the status checks see Prisma Cloud Integrations—Supported Capabilities . Status errors are displayed to help you find and fix potential issues. 
 ...
 When you Send Prisma Cloud Alert Notifications to Third-Party Tools , the value of the cloud service provider in the cloudType field for the resource that generated the alert the values is in lowercase letters, for example aws or alibaba-cloud. 

 Previous Configure External Integrations on Prisma Cloud 

 Next Integrate Prisma Cloud with Amazon GuardDuty 
