---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-100.html
fetched_at: 2026-09-16T13:00:28Z
source: palo-alto-main
---

# Panorama Plugin for Cisco ACI 1.0.0 Clear
...
Updated on 
 ...
 The Panorama Plugin for Cisco ACI allows
you to build security policy for your Cisco ACI cluster using Dynamic
Address Groups (DAGs). The plugin monitors for changes in an Application
Policy Infrastructure Controller (APIC) cluster in your Cisco ACI deployment
and shares that information with Panorama. You can then use these DAGs
to enforce security policy on all managed firewalls. 

 The Panorama Plugin for Cisco ACI version 1.0.0 requires Panorama
8.1.6 or later. 
