---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.8/configure-cortex-xsoar/engines/configure-engines/configure-the-engine-to-call-the-server-without-using-a-proxy/configure-an-engine-to-use-custom-certificates
fetched_at: 2026-09-16T09:14:22Z
source: cortex-platform
---

# Configure an engine to use custom certificates | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure custom engine certificates in Cortex XSOAR 8.8 On-prem. 
