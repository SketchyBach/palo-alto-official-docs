---
url: https://docs.paloaltonetworks.com/prisma-sd-wan/ion-cli-reference/use-cli-commands/clear-commands/clear-user-id-agent-statistics
fetched_at: 2026-08-13T17:29:43Z
source: palo-alto-main
---

# clear user-id agent statistics Clear
...
clear user-id agent statistics 
 ...
 Use the clear user-id agent statistics command to clear the agent
 statistics of the User-ID service. 
 ...
 all Enter all to clear statistics
 for all the User-ID agents on the device. 
