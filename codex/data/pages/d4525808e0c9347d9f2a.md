---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-110/known-issues-in-openconfig-plugin-110.html
fetched_at: 2026-09-16T13:01:41Z
source: palo-alto-main
---

# Known Issues in OpenConfig Plugin 1.1.0 Clear
...
on a named policy-id returns data not found for forwarding-policy
'default' (network-instances:policies) if example doesn’t
exist at on all network-instances. 
...
doing a delete at /network-instances/.../protocol/bgp causes
a failed commit. To delete a BGP configuration, you must both delete
the BGP instance and then disable it. 

 PLUG-8928 

 Doing a get using the ... wildcard
returns only config leaf-nodes. 
