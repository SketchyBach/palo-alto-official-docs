...
# Manage nodes in a cluster |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage cluster nodes in Cortex XSOAR 8.14 On-prem. 

 If your Cortex XSOAR environment has at least three nodes, use the VM textual UI to add, taint, remove, drain, or uncordon nodes. 
 ...
 If you remove one of the original three nodes in the cluster (one of the control planes), you cannot perform actions such as upgrading or scaling up. When you add a new node, Cortex XSOAR automatically assigns the new node as a control plane with the same IP address as the node that was removed. 
