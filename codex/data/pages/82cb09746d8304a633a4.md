---
url: https://cortex-docs.paloaltonetworks.com/8.x/8.3ce/cortex-xdr-agent-8.3-ce-release-information/changes-to-default-behavior-in-cortex-xdr-agent-8.3
fetched_at: 2026-09-06T11:22:17Z
source: cortex-platform
---

# Changes to Default Behavior in Cortex XDR Agent 8.3 |  8.3ce (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Next Addressed Issues in Cortex XDR Agent 8.3-CE 
