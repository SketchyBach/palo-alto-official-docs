---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/values
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The field whose distinct values will be collected into an array. 
 ...
 An alias for the output field. If not specified, the output field name defaults to values_<field> . 
 ...
 Functions : list() , count() , count_distinct() 
