---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/configure-cortex-xsoar/dashboards-and-reports/widgets/create-a-custom-widget-using-a-script
fetched_at: 2026-09-16T08:54:12Z
source: cortex-platform
---

# Create a custom widget using a script | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, create custom dashboard and report widgets using scripts. 

 You can use scripts in custom widgets to create dynamic widgets for more complex calculations. 
 ...
 The following are sample arguments/scripts to create a widget. After creating the widget from a script, add the widget to a dashboard or report. 
 ...
 Example 30. Display filtered incident and indicator data in a widget with a line graph 
