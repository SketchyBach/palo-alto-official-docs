---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/tunnel-inspection-log-fields
fetched_at: 2026-08-13T17:00:33Z
source: palo-alto-main
---

# Tunnel Inspection Log Fields Clear
...
the log. 
 ...
 Type of log as it pertains to the session:
START or END. 
...
dependency handling. Available in PAN-OS 5.0.0 and above. 
 ...
 0x00000800 —symmetric return was used to forward traffic
for this session 
...
session. 
 ...
 Number of packets the firewall dropped because
...
packet queue. 
 ...
 tcp-fin—One host or both hosts in the connection sent a TCP
FIN message to close the session. 
...
PAN-OS release or after the logs are loaded onto the firewall. 
...
the session began. 
 ...
 Name of the tunnel inspection rule matching
...
rule. 
 ...
 Unique packet capture ID that defines the
...
Slice ID. 
 ...
 Session ID for the collection of L4 segments
inside a tunnel. 
