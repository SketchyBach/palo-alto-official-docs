---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/comp
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The aggregation function to apply (for example, count , sum , avg , max , min , values ). 
 ...
 An optional name for the resulting aggregated field. If omitted, a default name is generated (usually function_field ). 
 ...
 The field(s) used to group the results. All records with the same value in the group_field are calculated together. 
 ...
 Functions : count , sum , min , max , values 
