---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/co-overview-issuing-certs/certificate-issuing-templates
fetched_at: 2026-08-13T16:38:57Z
source: palo-alto-main
---

# Overview: Request Policies Clear
...
Next-Gen Trust Security includes a default request policy as an example. This policy should only be used for testing or evaluation and is not intended for production use . In Production, create your own request policy instead. 
 ...
 Learn how to set up a new request policy 
