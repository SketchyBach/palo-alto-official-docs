---
url: https://docs.prismacloud.io/content-collections/runtime-security/waas/log-scrubbing
fetched_at: 2026-09-16T13:35:28Z
source: prisma-cloud
---

# WAAS Sensitive Data | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Scrubbing logs based on patterns only affect HTTP requests and not the responses. The data from HTTP responses that appear in WAAS audits will not be scrubbed and replaced by the placeholder. 
