---
url: https://docs.paloaltonetworks.com/ai-runtime-security/administration/api-intercept-create-configure-security-profile
fetched_at: 2026-08-13T14:04:30Z
source: ai-security
---

# Defend: Create and Configure API Security Profile Clear
...
Defend: Create and Configure API Security Profile 
 ...
 Language Support 
 Prompt injection detection: English, Spanish, Russian, German, French,
 Japanese, Portuguese, Italian, and Simplified Chinese. 

 Hindi and Traditional Chinese are offered as
 previews . 

 Toxic content detection is supported in English, Spanish, Russian, German,
 French, Japanese, Portuguese, Italian,and simplified Chinese. 

 Contextual grounding is supported in English, Spanish, Russian, German,
 ...
 To update an existing API security profile, navigate to AI Security API Applications or AI Sessions . 
