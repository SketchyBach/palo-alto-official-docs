---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-282
fetched_at: 2026-09-16T09:11:49Z
source: cortex-platform
---

# MSSQL Connection String detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The MSSQL Connection String exposes cleartext user credentials (UID/PWD). 

 This is a Catastrophic Risk providing an attacker with all components needed for a full, unauthenticated database takeover. 
 ...
 Previous MSSQL Credentials detected in code 

 Next Cloudinary API Key URL detected in code 
