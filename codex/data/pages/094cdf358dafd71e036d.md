---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-gcp/gcp-plugin-100.html
fetched_at: 2026-09-16T13:00:05Z
source: palo-alto-main
---

# Panorama Plugin for GCP 1.0.0 Clear
...
Updated on 
 ...
 The Panorama™ plugin for Google Cloud
Platform (GCP) establishes a connection between your GCP deployment
and Panorama. Version 1.0 of the plugin allows you to globally manage
the firewalls securing services running in a GKE deployment. The GCP
plugin on Panorama retrieves the port numbers for the publically
exposed Kubernetes services in your GKE cluster and creates NAT
rules and service objects that it pushes to the managed firewalls
running PAN-OS 8.0 and later .
Refer to the VM-Series Deployment Guide for
details on how to secure Kubernetes services in a Google Kubernetes
Engine cluster. 

 You can download the Panorama plugin for GCP from the Customer
Support Portal or directly from Panorama Plugins . 
