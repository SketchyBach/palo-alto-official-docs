---
url: https://docs.paloaltonetworks.com/pan-os/10-1/pan-os-release-notes/pan-os-10-1-1-known-and-addressed-issues/pan-os-10-1-1-known-issues
fetched_at: 2026-08-13T17:03:32Z
source: palo-alto-main
---

# PAN-OS 10.1.1 Known Issues Clear
...
specific to PAN-OS ® 10.1.1. This list includes issues
...
identified by an issue ID. 
 ...
 the logs to Strata Logging Service and Panorama. This
 workaround does not support Panorama virtual appliances in Management Only mode . 
...
URL exceptions for specific web sites— 
 ...
 Traffic, threat, and URL logs are not viewable
from the firewall web interface ( Monitor Logs ) and CLI after upgrade
to PAN-OS 10.1.1. 
...
the former chassis. 
 ...
 ( PA-800 and PA-7000 Series firewalls
