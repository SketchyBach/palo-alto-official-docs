---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-32
fetched_at: 2026-09-16T09:11:20Z
source: cortex-platform
---

# Confluent Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Confluent Key grants access to managed Kafka services. 

 Exposure can lead to unauthorized access to streaming data, data breaches, or misuse of real-time data pipelines (e.g., publishing malicious data). 
 ...
 Previous Coinbase Key detected in code 

 Next Databricks Authentication Token detected in code 
