---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-45
fetched_at: 2026-09-16T09:11:19Z
source: cortex-platform
---

# Google API Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Google API Key is used for accessing public data and associating requests with a project for billing. 

 Exposure can lead to unauthorized API usage and unexpected billing charges on your account. 
 ...
 Previous GitLab Token detected in code 

 Next Grafana Token detected in code 
