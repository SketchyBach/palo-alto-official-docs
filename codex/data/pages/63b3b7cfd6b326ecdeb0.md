---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aiops/aiops-plugin-100.html
fetched_at: 2026-09-16T12:59:23Z
source: palo-alto-main
---

# Panorama Plugin for AIOps 1.0.0 Clear
...
Updated on 
 ...
 What's new for Panorama Plugin for AIOps 1.0.0. 

 Panorama Plugin for AIOps 1.0.0 enables you to proactively enforce best practices by
 validating your commits and letting you know if a policy needs work before pushing it to
 your Panorama. You can download the Panorama Plugin for AIOps 1.0.0 on Panorama 10.2.1
 or later from the Customer Support Portal or directly from Panorama Plugins . 

 See what you can do with the plugin and what you
 need to get started . 

 Discover new plugin features in the AIOps for NGFW release notes . 

 The Panorama AIOps plugin has been renamed to Panorama
 CloudConnector plugin in later versions. We recommend installing the latest
 version of the Panorama CloudConnector plugin. 
