---
url: https://docs.paloaltonetworks.com/prisma-agent/user-guide/prisma-agent-for-desktop-devices/use-single-sign-on-with-prisma-agent/use-single-sign-on-with-prisma-agent-windows
