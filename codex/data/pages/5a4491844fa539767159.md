---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-101.html
fetched_at: 2026-09-16T13:00:27Z
source: palo-alto-main
---

# Panorama Plugin for Cisco ACI 1.0.1 Clear
...
Updated on 
 ...
 The Panorama plugin for Cisco ACI now supports multiple
IP addresses per endpoint. If an endpoint has more that one IP address,
the plugin retrieves all the IP addresses associated with that endpoint. 

 Additionally, the Panorama plugin for Cisco ACI 1.0.1 introduces
support for Cisco ACI 4.0 and later. 

 Review important information about fixed and known
