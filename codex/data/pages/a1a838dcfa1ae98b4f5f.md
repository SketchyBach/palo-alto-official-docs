...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Collect BeyondTrust Privilege Management Cloud data with Cortex XSIAM. 
 ...
 After Cortex XSIAM begins receiving data from BeyondTrust Privilege Management Cloud, you can use XQL Search to search your logs using the beyondtrust_privilege_management_raw dataset that you configured when setting up your Amazon S3 data collector. 
