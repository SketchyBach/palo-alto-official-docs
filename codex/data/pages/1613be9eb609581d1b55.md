---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-112
fetched_at: 2026-09-06T11:15:29Z
source: cortex-platform
---

# Azure Functions HTTP Trigger Key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 An Azure Functions HTTP Trigger Key is essential for securing serverless resources and restricting public access to HTTP-triggered Azure Functions. 

 Exposure of this key grants an attacker unauthorized access to function execution, potentially leading to data exposure, denial of service (DoS) via resource exhaustion, or unauthorized backend operations. 
 ...
 Previous Microsoft Teams webhook detected in code 

 Next MonkeyLearn API Key detected in code 
