---
url: https://docs.paloaltonetworks.com/cloud-ngfw-azure/release-notes/cloud-ngfw-for-azure-known-issues
...
Updated on 
 ...
 Microsoft Azure is experiencing datacenter capacity
 constraints that impact Cloud NGFW operations in the West Europe and
 South Central US regions. While active traffic processing remains
 unaffected, you may encounter temporary failures when deploying new
 resources, autoscaling, or migrating to Panorama or Premium SKUs.
 Scheduled software upgrades for these regions are currently
 postponed. 

 Workaround: Maintain current resource and traffic
 baselines to avoid autoscaling, and defer new deployments or
 migrations in these regions until Azure capacity is restored. 
