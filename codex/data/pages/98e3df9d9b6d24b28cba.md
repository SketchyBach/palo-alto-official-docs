---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/endpoint-security/install-and-manage-endpoints/set-up-endpoint-protection/set-up-endpoint-profiles-and-exception-rules/set-up-malware-prevention-profiles
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 From Cortex XDR, select Endpoints → Policy Management → Prevention → Profiles . Click +Add Profile , and select whether to create a new profile, or to import a profile from a file. 
 ...
 When a file type is enabled, the Cortex XDR agent monitors for malicious files during the on-write process, and if it finds any, it sends alerts and quarantines the files. 
 ...
 When set to Report , an alert is generated, but no action is taken. 
 ...
 When enabled, the Cortex XDR agent monitors for malicious ELF files during the on-write process, and if it finds any, it generates alerts and quarantines the files. 
 ...
 When enabled, the Cortex XDR agent monitors for portable executable files during the on-write process, and if it finds any, it generates alerts. It can also perform these actions: 
