...
# Run a Script using an Engine | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run scripts using an engine in Cortex XSOAR 6.12. 
