---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/automations/playbooks/build-your-playbook/configure-script-error-handling-in-a-playbook
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure script error handling to manage failures in Cortex AgentiX playbooks. 
 ...
 You may want to create a separate path when an analyst manually reviews the issue and research is needed outside Cortex AgentiX. Once an analysis is complete, you can add a task to consider escalating to a customer and, if so, generate a report that can be attached to a ticket system such as Jira or ServiceNow. 
 ...
 You can set up script error handling only when running a script in a Standard task or a Conditional task. For more information, see Create a standard task or Create a conditional task . 
