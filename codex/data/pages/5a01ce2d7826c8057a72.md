---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/permissions-queries/permissions-query-examples
fetched_at: 2026-09-16T13:35:11Z
source: prisma-cloud
---

# Permissions Query Examples | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Review examples that show you how to use Permissions Query Attributes for investigating general permisssion issues and specific on the following cloud platforms: 
 ...
 Previous Permissions Query Attributes 

 Next Permissions Query Conditions 
