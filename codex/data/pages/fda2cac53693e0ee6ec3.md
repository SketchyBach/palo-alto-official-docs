...
# Set up Okta as the Identity Provider Using SAML 2.0 |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Okta as a SAML 2.0 identity provider for Cortex XSOAR 8.14 On-prem. 
 ...
 Previous Authenticate users using Active Directory or OpenLDAP 
