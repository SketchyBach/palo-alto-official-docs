---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/detect-investigate-and-respond-to-threats/agentic-assistant-chat/get-started-with-agentic-assistant-chat
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Enable and access Agentic Assistant chat in Cortex AgentiX. 
 ...
 The Cortex Agentic Assistant is currently available in limited regions. If your tenant is outside these regions, you can access Cortex Assistant. 
 ...
 To open the chat window, click the Agentic Assistant icon in the upper right hand corner, or from the AgentiX Command Center dashboard click Start Investigation . 
