---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.11/onboard-cortex-xsoar/cortex-xsoar-installation/install-cortex-xsoar-on-a-vm-deployed-on-hyper-v
fetched_at: 2026-09-06T10:32:11Z
source: cortex-platform
---

# Install Cortex XSOAR on a VM deployed on Hyper-V | 8.11 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install Cortex XSOAR 8.11 On-prem on a VM deployed on Hyper-V. 
 ...
 To install a Cortex XSOAR 8 tenant, you need to log into Cortex Gateway, which is a portal for downloading the relevant image file and license. Downloading an image file from Cortex Gateway ensures you have the latest pre-configured software package for easy deployment and updates. If you have multiple or development tenants, you must repeat these tasks for each tenant. 
 ...
 You need to configure network and IP settings in each node in a cluster. For a standalone, there is just a single node. 
