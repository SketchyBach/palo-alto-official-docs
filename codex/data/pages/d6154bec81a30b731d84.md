---
url: https://docs.prismacloud.io/content-collections/alerts/create-an-alert-rule-cloud-infrastructure
fetched_at: 2026-09-16T13:35:06Z
source: prisma-cloud
---

# Create an Alert Rule for Cloud Infrastructure | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To create an alert rule for workload protection, see Workload Protection . 
 ...
 Select the policies for which you want this alert rule to trigger alerts and, optionally, automatically remediate alerts . 
 ...
 (tt:[Optional]) Send Prisma Cloud Alert Notifications to Third-Party Tools . 
 ...
 Previous Risk Prioritization and Remediation 

 Next Create an Alert Rule for Cloud Workloads 
