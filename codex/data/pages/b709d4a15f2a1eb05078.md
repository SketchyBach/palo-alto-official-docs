---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-21/vm-series-plugin-2114/addressed-issues-in-vm-series-plugin-2-1-14.html
fetched_at: 2026-09-16T12:59:00Z
source: palo-alto-main
---

# Addressed Issues in VM-Series Plugin 2.1.14 Clear
...
Updated on 
 ...
 The following list describes the issue fixed in the VM-Series plugin 2.1.14. 

 PLUG-13362 

 Fixed an issue where upgrading to PAN-OS 10.0.9 resulted in downtime of the data
 interface (igb) until the DPDK was disabled on the firewall. 

 PLUG-14009 

 Fixed an issue where the firewall would go into maintenance mode due to
 brdagent crash. 
