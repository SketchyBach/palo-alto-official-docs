---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-upgrade/upgrade-panorama/install-content-and-software-updates-for-panorama/install-updates-for-panorama-with-ha-configuration
...
and managed devices in FIPS-CC mode to PAN-OS 11.1 from PAN-OS 10.2
...
because the peers are no longer running the same software release. 
 ...
 endpoints on upgrade to PAN-OS 11.0. 

 If you do not install the device certificate prior to upgrade to PAN-OS
 11.0, Panorama continues to use the existing logging service
...
Upgrade the remaining Log Collectors in the Collector Group. 
 ...
 mode to PAN-OS 11.1, Palo Alto Networks recommends increasing the memory of
 ...
 management while running a PAN-OS 11.1 release. You need to re-onboard the
 following managed devices to Panorama management: 
