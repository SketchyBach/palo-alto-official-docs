---
url: https://docs.paloaltonetworks.com/ai-runtime-security/administration/prevent-network-security-threats/detect-mcp-threats.html
fetched_at: 2026-08-13T14:06:49Z
source: ai-security
---
...
Detect MCP Threats 
 ...
 Navigate to Insights > Prisma AIRS > Prisma AIRS AI Runtime: API
 intercept . 
 ...
 Example MCP Threats Detection Use Case 

 This section includes a use case for MCP Threats Detection. The use case includes
 sample code, the API security profile configuration and the expected
 response. 

 Detect MCP Threats Detection
 Scan 
...
--data '{
 ...
 Detect MCP Threats Detection Scan Response 
