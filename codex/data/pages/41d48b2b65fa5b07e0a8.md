---
url: https://docs.prismacloud.io/content-collections/runtime-security/vulnerability-management/registry-scanning/scan-ecr
fetched_at: 2026-09-16T13:35:21Z
source: prisma-cloud
---

# Amazon Elastic Container Registry | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Tag , enter an image tag. Leave this field blank to scan all tags. 

 Configure how Prisma Cloud authenticates with AWS . 
 ...
 Previous Alibaba Cloud Container Registry 
