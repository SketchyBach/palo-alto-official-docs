---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure data sources and connectors for supported technology vendors. 

 Cortex XDR enables you to ingest data from a wide range of third-party vendors and security services. For many popular vendors, you can choose between distinct types of ingestion methods to fit your organizational needs: 
 ...
 Choose this for streamlined discovery of your cloud environments. 
 ...
 Includes: Data ingestion, parsing, normalization, plus built-in commands and automations, such as playbooks, scripts and correlation rules. 
