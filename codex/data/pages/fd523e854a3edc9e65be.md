---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/engines/run-a-script-using-an-engine
fetched_at: 2026-09-06T11:22:07Z
source: cortex-platform
---

# Run a script using an engine | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Run scripts using engines in Cortex XSOAR On-prem 8.7 (EoL). 
