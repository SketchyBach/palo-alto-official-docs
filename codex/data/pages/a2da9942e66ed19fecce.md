...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Understand Cortex Cloud license plans, protected workload metering, add-ons, usage, and capacity overflow rules. 
 ...
 Cortex Cloud Posture Management and Cortex Cloud Runtime Security are available in multiple license configurations, either individually or as part of a bundled package. For more information on bundling options with other Cortex products, see Cortex XSIAM license tiers and product licenses . 
 ...
 Extended Threat Intelligence (XTI) - XTI is available as an add-on for Cortex Cloud Runtime Security; it is not available for Cloud Posture Management. 
