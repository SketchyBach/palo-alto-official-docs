---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/provision-certificates/provision-certificates-imperva-waf
fetched_at: 2026-09-16T07:25:18Z
source: palo-alto-main
---

# Provision to an Imperva WAF Clear
...
Updated on 
 ...
 Use this procedure to provision a certificate from Next-Gen Trust Security to an Imperva WAF machine. You can provision a certificate to an existing SSL server on the Imperva WAF. The target virtual server must already exist and have a site ID. 

 Sign in to Next-Gen Trust Security. 

 Click Insights > Certificate Installations > Machines . 

 Select the Imperva WAF machine where you want to provision the certificate. 
 ...
 In Site ID , enter the numeric site identifier from your Imperva account. 

 (Optional) To prevent the certificate from being pushed immediately, set Push upon saving to No . 

 Click Save . 

 After saving, Next-Gen Trust Security provisions the certificate to the specified Imperva WAF site and creates an installation record on the Installations tab. 
