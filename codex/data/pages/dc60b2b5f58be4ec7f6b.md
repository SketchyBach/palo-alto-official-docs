---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-501/addressed-issues-in-panorama-plugin-for-vmware-nsx-501
fetched_at: 2026-09-16T07:43:57Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 5.0.1 Clear
...
Updated on 
 ...
 The following issues are addressed in the Panorama plugin for VMware NSX 5.0.1. 

 PLUG-12192 

 Fixed an issue that caused NSX-T service definitions to show "out of sync" in the
 Panorama plugin for NSX UI due to a pagination error. 

 PLUG-11756 

 Fixed an issue that prevented Panorama from receiving dynamic address group updates from
 NSX-T Manager when a custom certificate was configured in an SSL/TLS Service
 Profile on Panorama. 

 PLUG-11700 

 Fixed an issue that prevented a Panorama
deployed in Azure from sending its IP address for NSX-T Manager
to form the service manager connection. 

 PLUG-11165 

 Fixed a display issue that prevented the Panorama plugin for NSX from displaying NSX
 services under Panorama VMware NSX-T Network Introspection Rule . 
