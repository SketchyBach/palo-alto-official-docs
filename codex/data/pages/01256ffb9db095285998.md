---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/users-and-roles-management/user-management
fetched_at: 2026-09-06T10:24:37Z
source: cortex-platform
---

# User management |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Invite users and assign roles and groups in Cortex XSOAR 8.14 On-prem. 

 To access Cortex XSOAR, users must either be added to Cortex XSOAR locally, via SSO, or via LDAP login. When logging into Cortex XSOAR users must have an assigned role. If no role is assigned either directly or via a user group, users can log in but can't access the tenant. 

 Note 

 When a user successfully logs in for the first time via an SSO or LDAP connection, they are automatically added to the Cortex XSOAR Users table. The user will automatically inherit the role and permissions of the Cortex XSOAR user group that their SAML or LDAP group was mapped to. 
 ...
 Indicates whether the user was Local (added in Cortex XSOAR), SSO (single sign-on) using your organization’s IdP, an LDAP user, or a combination of both Local/SSO . 
