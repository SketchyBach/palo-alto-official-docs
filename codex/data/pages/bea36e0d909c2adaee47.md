...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure agent settings profiles for Cortex XDR endpoints. 
 ...
 Configure the User Interface options for Cortex XDR. 
...
To restore the default value, select Use Default (Disabled). 
 ...
 Previous Set up exploit prevention profiles 
