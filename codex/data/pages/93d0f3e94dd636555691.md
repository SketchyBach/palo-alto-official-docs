---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/install-cortex-xsoar/install-cortex-xsoar-on-a-vm-deployed-on-vsphere
fetched_at: 2026-09-16T08:52:49Z
source: cortex-platform
---

# Install Cortex XSOAR on a VM deployed on VSphere |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install Cortex XSOAR 8.14 On-prem on a virtual machine deployed on vSphere. 
...
If you use a custom TLS certificate, it must cover the cluster, API, and external addresses either in the Common Name (CN) or, preferably as Subject Alternative Names (SANs). Using a wildcard certificate (such as *.mycompany.com ) is the simplest option. 
 ...
 Previous Task 8. Verify you can log in to Cortex XSOAR 
