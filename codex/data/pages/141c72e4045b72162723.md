---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/remote-repository-management/push-and-pull-content
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Push and pull Cortex AgentiX content between development and production tenants using remote repositories. 
 ...
 Pushing content from the development tenant 
 ...
 When pulling content from a remote repository, Cortex AgentiX handles ownership differently depending on whether the content is new or already exists in the environment: 
 ...
 Any existing Editor permissions (set before the tenant was configured for remote repository synchronization) are effectively treated as Viewer access. These capabilities are removed from Cortex AgentiX and blocked by the system regardless of role-level permissions. 
