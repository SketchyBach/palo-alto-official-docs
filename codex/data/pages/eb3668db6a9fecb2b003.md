...
Create SLAs for case and issue resolution | Cortex Documentation Portal 
 ...
 Create SLA rules to set and track issue-resolution timers and time goals. 
 ...
 The case header shows all active SLAs for a case. In addition to the built-in Resolution SLA, you can create additional SLAs to measure separate milestones. For more information, see Create additional case timers and SLAs . 
...
These filters support filtering of whole days only, for example Resolution SLA > 1 filters for cases that have a Resolution SLA of greater than one day. 
 ...
 Previous Create rules for issue layouts Next Create additional case timers and SLAs 
