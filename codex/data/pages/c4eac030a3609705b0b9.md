---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-7-known-and-addressed-issues/pan-os-11-2-7-known-issues
fetched_at: 2026-09-16T07:40:41Z
source: palo-alto-main
---

# PAN-OS 11.2.7 Known Issues Clear
...
Updated on 
 ...
 11.2.7. This list includes issues specific to Panorama™, GlobalProtect™, VM-Series
 ...
 This issue affects PAN-OS 11.2.7-h12, 11.2.7-h13, and
 11.2.7-h14 
 ...
 See PAN-OS 11.2.11 Addressed Issues and PAN-OS 11.2.7-h8 Addressed Issues 
 ...
 PAN-291288 This issue is now resolved. See 
 PAN-OS 11.2.8 Addressed Issues and PAN-OS 11.2.7-h3 Addressed Issues 
 ...
 PAN-290449 This issue is now resolved. See PAN-OS 11.2.8 Addressed Issues and PAN-OS 11.2.7-h3 Addressed Issues 
 ...
 some URLs due to issues involving the accumulation proxy and the
 ...
 A cumulative memory leak in the devsrvr process gets
 progressively worse whenever the CLI command show running
 application statistics is issued. This memory leak
 will gradually consume system memory and produce an out-of-memory
 (OOM) condition, leading to an eventual firewall reboot. 
 ...
 ( PA-3260 firewalls only ) An interface unexpectedly moves out
 of Link Aggregation Control Protocol (LACP), which causes an
 out-of-memory (OOM) condition on the *logrcvr* process, resulting in
 the interface going down and then automatically coming back up
