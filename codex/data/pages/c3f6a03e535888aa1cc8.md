---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines/create-a-new-machine/cloudflare
fetched_at: 2026-09-16T07:25:13Z
source: palo-alto-main
---

# Create a Cloudflare Machine Clear
...
Updated on 
 ...
 Creating a machine enables Next-Gen Trust Security to connect to Cloudflare so certificates can be provisioned to supported Cloudflare resources. After creating the machine, you can provision certificates to it. 

 Before You Begin 

 An active Cloudflare account. 

 Credentials with sufficient permissions to manage certificates in Cloudflare. 
 ...
 If you selected Enter Credentials , enter the required Cloudflare credential value. 
