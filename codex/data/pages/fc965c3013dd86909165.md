---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/engines/install-an-engine/docker/docker-faqs
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Find Docker answers for Cortex XSOAR 8 SaaS engines. 
 ...
 The default Docker settings include 14 kernel capabilities and exclude 23. Refer to Docker’s full list of runtime privileges and Linux capabilities . 
 ...
 Cortex XSOAR does not disable inter-container communication by default. Some use cases require it. For example, a script communicating with a long-running integration that listens on a port may require inter-container communication. If it is not required, disable it by modifying the Docker daemon configuration . 
