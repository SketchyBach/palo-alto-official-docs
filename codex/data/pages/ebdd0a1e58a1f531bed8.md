---
url: https://docs.paloaltonetworks.com/pan-os/11-0/pan-os-upgrade/upgrade-panorama/deploy-updates-to-firewalls-log-collectors-and-wildfire-appliances-using-panorama/supported-updates
fetched_at: 2026-09-16T07:38:21Z
source: palo-alto-main
---

# What Updates Can Panorama Push to Other Devices? Clear
...
Appliances Using Panorama 
 ...
 The software and content updates you can install vary
based on which subscriptions are active on each firewall, Log Collector,
and WildFire® appliance and appliance cluster: 
 ...
 Applications (Log Collectors don’t need
Threats signatures) 
