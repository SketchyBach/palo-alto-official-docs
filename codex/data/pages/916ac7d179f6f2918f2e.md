---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/endpoint-security/install-and-manage-endpoints/harden-endpoint-security/device-control
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Assign a profile name. You can add a description. Cortex Cloud sets the profile type and platform. 
 ...
 You cannot edit or delete default Cortex Cloud profiles. 
 ...
 You cannot edit or delete predefined Cortex Cloud profiles. 

 Apply the device control profiles to your endpoints. 

 Apply device control profiles to your endpoints 

 After defining configuration and exceptions profiles, configure Device Control policies and enforce them on endpoints. Cortex Cloud evaluates policies in page order. The first matching policy applies. If none match, the default policy enables all devices. 
 ...
 After the policy reaches agents, Cortex Cloud enforces it. 
 ...
 The new class is available with other Cortex Cloud device classes. 

 Add a custom user notification 

 Personalize the Cortex Cloud endpoint notification shown when users connect blocked USB devices. You can also customize notifications for read-only devices. 
