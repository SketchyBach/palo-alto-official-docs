---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/multi-tenant/child-tenant-management/content-management-in-multi-tenant
fetched_at: 2026-09-16T08:52:42Z
source: cortex-platform
---

# Content management in multi-tenant | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage Cortex XSOAR 8 SaaS multi-tenant content using propagation labels and dependency-aware synchronization. 
 ...
 When syncing content from the main tenant, you can use propagation labels to decide what content to push and which child tenant you want to push content to. You can add propagation labels to the following: 
