---
url: https://docs.prismacloud.io/content-collections/compliance/compliance-standards
fetched_at: 2026-09-16T13:35:01Z
source: prisma-cloud
---

# Built-in Compliance Standards | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 To help you easily identify the gaps and measure how you’re doing against the compliance standards, create a custom dashboard with the compliance widgets. You can also create compliance reports and run them immediately, or schedule them on a recurring basis to measure your compliance over time. 

 Previous Compliance 

 Next Add a New Compliance Report 
