---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/configure-the-agent/configure-forwarding-profiles-to-manage-agent-traffic/configure-forwarding-profiles-to-manage-agent-traffic-panorama
...
Updated on 
 ...
 the forwarding rule. Prisma Agent sends these applications
 ...
 (macOS, Windows, and Linux agents only) , Best Available - Fail Open , or your own
 ...
 */bin/curl — path starts with a
 ...
 available on Arch Linux ARM64. On Arch Linux ARM64, Prisma Agent cannot identify which application
 ...
 requires Prisma Agent 26.2.2 or later. On Linux
 ...
 Prisma Agent also offers predefined
 ...
 *.example.*.com (wildcard
 ...
 traffic management. 
 ( macOS, Windows, and iOS agents only ) For IPv6 addresses, you can enter: 
 ...
 *.*.*.* (full wildcard IP
 ...
 ( macOS, Windows, and Linux agents only ) Best Available - Fail
 ...
 is unsupported, such as proxy-only UDP traffic. Linux
 agents require Prisma Access Agent 26.3 or later. 
 ...
 Tunnel and Proxy .
 Prisma Agent will send traffic through the tunnel, and if
 ...
 that allows traffic such as DHCP, loopback, Prisma Agent management plane, ADEM, and Remote Browser Isolation
 ...
 forwarding profile. This means that when Prisma Agent 
 ...
 connect to Prisma Access using the Prisma Agent . The default
 setting is disabled. 
 ...
 selection in the Prisma Agent Setup page.
