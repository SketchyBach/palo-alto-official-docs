---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.6-eol/introduction.md
...
> For the complete documentation index, see [llms.txt](https://cortex-docs.paloaltonetworks.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.6-eol/introduction.md).
...
For compatibility with operating systems per agent release versions see the [Cortex XDR Compatibility Matrix](/compatibility-matrix/where-can-i-install-the-cortex-xdr-agent/endpoint-operating-systems-supported.md).
...
```
GET https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.6-eol/introduction.md?ask=<question>&goal=<endgoal>
```
