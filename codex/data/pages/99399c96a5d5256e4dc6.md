---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/onboard-cortex-xsoar/cortex-xsoar-installation/install-cortex-xsoar-on-a-vm-deployed-on-aws/task-5.-optional-configure-proxy-settings
fetched_at: 2026-09-16T08:54:58Z
source: cortex-platform
---

# Task 5. (Optional) Configure proxy settings | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure optional proxy settings for Cortex XSOAR 8.10 On-prem. 
 ...
 Bypass the proxy for the following IPs and domain: 
 ...
 Bypass the proxy for the following MSSP IPs and domains: 
