---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/build-xql-queries/legacy-query-builder/create-process-query
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create XQL queries for process data. 
