---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/network-security/security-policy/administration/identify-users-connected-through-a-proxy-server/add-xff-values-to-url-filtering-logs.html
