---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/configurations-overview/acme-server-overview/configure-acme-server-connection
fetched_at: 2026-09-16T07:25:07Z
source: palo-alto-main
---

# Configure ACMEv2 Server Connection in Next-Gen Trust Security Clear
...
Updated on 
 ...
 At least one configured Request Policy . 
 ...
 Issue certificates based on request policies so that certificate requests follow defined policies. 
 ...
 Click Configuration > Certificate Configuration > ACME Servers . 

 Select New . 

 Enter a Name for the ACMEv2 server. 

 Select a Request Policy . For more information, see Creating request policies . 

 Note: Request policies that do not allow CSRs do not appear in the Request Policy list. 
