---
url: https://docs.prismacloud.io/admin-guide/32/authentication/oauth2-openshift
fetched_at: 2026-09-16T13:37:24Z
source: prisma-cloud
---

# OpenShift (OAuth 2.0) | 32 | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In OpenShift, register Prisma Cloud as an OAuth client . Set the redirect URL to: 
 ...
 In User Info API URL , enter the TCP endpoint for the OpenShift API server. For example, https://openshift.default.svc.cluster.local . 
 ...
 Previous GitHub (OAuth 2.0) 

 Next Active Directory Non-default UPN suffixes 
