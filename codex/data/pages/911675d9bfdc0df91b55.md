---
url: https://docs.prismacloud.io/content-collections/get-started/access-prisma-cloud
fetched_at: 2026-09-16T13:34:54Z
source: prisma-cloud
---

# Access Prisma Cloud | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Log into Prisma Cloud directly and view dashboards and complete other recommended workflows as mentioned in the Get Started section. 
 ...
 Navigate to {BASE_URL}/login. Use the domain-list list above for domain specific BASE_URLs. 

 Enter your username and password. 

 Sign in using one of the following options: 

 Sign-in with OIDC SSO - Authenticate using OpenID Connect (OIDC) Service Provider (SP) initiated SSO. 

 Sign-in with Palo Alto Networks SSO login 

 Sign-in using SAML SSO - Authenticate using SSO login using an Identity Provider (IdP) that supports Security Assertion Markup Language (SAML), such as Okta, Microsoft Active Directory Federation Services (AD FS), Azure Active Directory (AD), Google, or OneLogin. 
 ...
 Previous Prisma Cloud Console Prerequisites 

 Next Prisma Cloud API Access Keys 
