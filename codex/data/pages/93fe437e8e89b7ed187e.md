---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-203/addressed-issues-in-panorama-plugin-for-azure-203.html
fetched_at: 2026-09-16T12:59:36Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Azure 2.0.3 Clear
...
in the Panorama plugin for Azure 2.0.3. 

 PLUG-4477 

 Fixed an issue that caused the Panorama
plugin for Azure to print the error message Aroxy server not
set in configuration when using the Validate button.
The plugin logs on Panorama show that the validation is successful
in spite of the printed error message. 
