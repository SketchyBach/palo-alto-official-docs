---
url: https://docs.paloaltonetworks.com/hardware/pa-7000-hardware-reference/PA-7000-series-firewall-installation/pa-7000-series-firewall-rack-install/install-the-7050-firewall-mid-mount
fetched_at: 2026-08-13T16:35:13Z
source: palo-alto-main
---

# Install the PA-7050 Firewall in the Mid-Mount Position Clear
...
the PA-7050 firewall in a mid-mount position. 

 The PA-7050
chassis and the front slot cards (SMC, LPC or LFC, NPC) ship in
separate boxes and it is recommended that you install the cards
...
Series Firewall Rack Install Safety Information . 
 ...
 ( Optional ) Install the mid-mount cable management
brackets using the fives screws included with the bracket. 
...
of the chassis with the holes on the rack rail, ensuring that the chassis
is level. 

 Attach the rack-mount brackets to the rack using rack-mount
screws (not provided) and tighten with a screwdriver. Install four
