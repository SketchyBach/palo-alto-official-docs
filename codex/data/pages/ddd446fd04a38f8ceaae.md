---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/engines/upgrade-an-engine
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Upgrade an engine on Cortex XDR or directly on the remote machine. 

 Whenever there is a Cortex XDR major version change or a change in tenant-engine protocol version, your engines require an upgrade. On the Engines page, the Status column shows those engines that require upgrades. You can upgrade an engine by doing the following: 
 ...
 When the upgrade finishes, the version appears in the Cortex XDR Version column. The upgrade procedure can take several minutes. 
