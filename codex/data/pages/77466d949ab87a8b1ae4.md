---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.14/configure-cortex-xsoar/dashboards-and-reports/reports/manage-reports
fetched_at: 2026-09-06T10:25:29Z
source: cortex-platform
---

# Manage reports |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage report widgets, schedules, timezones, and formats in Cortex XSOAR 8.14 On-prem. 
 ...
 Cron view : Schedules a report according to a Cron time string format, which consists of five fields that Cron converts into a time interval. Use this view to schedule a report on certain hours, days, months, years, and so on. For examples of Cron strings, see the report scheduling examples. 
