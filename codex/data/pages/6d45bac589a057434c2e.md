---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/manage-bulk-configurations/view-bulk-config-job-status.html
fetched_at: 2026-09-16T09:55:02Z
source: palo-alto-main
---

# View Bulk Config Job Status Through the Strata Multitenant Cloud Manager Clear
...
Updated on 
 ...
 Learn how to view bulk config job status through the Strata Multitenant Cloud Manager 
 ...
 After you assign and push snippets to your tenants, you can view
 their job status. 

 Access the 
 Strata Multitenant Cloud Manager , and select Manage Bulk Configuration Job Status . 

 Use the filter to select a time range for displaying results. 
 ...
 Displays the total number of jobs for the selected time
 range. 

 Failed Jobs 

 Displays the number of failed jobs for the selected time
 range. 

 Jobs in Progress 

 Displays the number of jobs in progress for the selected
 time range. 

 Jobs Completed 

 Displays the number of jobs completed for the selected
 time range. 
 ...
 Job Number: Select the job ID to see the job
 details, such as which tenants are included in the
 job. 

 Job Type: 

 Initiated By: Name of the admin who assigned and
 pushed the snippet. 

 Number of Tenants: Number of tenants the snippet is
 applied to. 

 Job Status: Commit successful or commit failed. 

 Push time: How long ago the snippet was pushed. 
