---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/_release-notes/vsatctl
fetched_at: 2026-09-16T07:24:33Z
...
Updated on 
 ...
 diag - Troubleshoot your VSatellite 

 export - Export Data Encryption Keys 

 install - Install a single node Venafi VSatellite cluster 

 preflight - Run prerequisite checks for installing VSatellite 

 recover - Recover lost VSatellites when all are lost and you have DEK backup 

 restart - Restart VSatellite Services 

 support-bundle - Collect VSatellite logs for diagnosis 

 uninstall - Uninstall a single node Venafi VSatellite cluster 

 update - Update one of proxy-config 

 upgrade - Upgrade one of k3s 

 upgrade k3s - Upgrade existing k3s version 

 version - Print the version 

 Options 

 -h, --help help for vsatctl 
