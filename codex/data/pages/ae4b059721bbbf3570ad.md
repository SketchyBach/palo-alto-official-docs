---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-gcp/enable-flow-logs-for-gcp-project
fetched_at: 2026-09-16T13:34:59Z
source: prisma-cloud
---

# Enable Flow Logs for GCP Project | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create an inclusion filter to determine the logs you want to include in the routing sink.+ In Build inclusion filter do the following: 
 ...
 Add the name of the Cloud Storage bucket you referenced above in Flow Logs Storage Bucket when you Onboard Your GCP Project . 
 ...
 Previous Enable Flow Logs for GCP Organization 

 Next Update an Onboarded GCP Account 
