---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.12/configure-cortex-xsoar/customize-and-configure-cortex-xsoar/widgets/create-a-custom-widget-using-a-json-file
fetched_at: 2026-09-16T08:57:46Z
source: cortex-platform
---

# Create a Custom Widget Using a JSON File | 6.12 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create custom JSON widgets in Cortex XSOAR 6.12. 
