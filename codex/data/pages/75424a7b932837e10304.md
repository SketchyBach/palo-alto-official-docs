---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/authenticate-users-using-sso
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up SSO authentication for a Cortex XSOAR 8 SaaS tenant. 
 ...
 If you add additional SSO providers, you must provide the email Domain in the SSO Integration settings for all providers except the first. Cortex XSOAR uses this domain to determine to which identity provider to send the user for authentication. 
