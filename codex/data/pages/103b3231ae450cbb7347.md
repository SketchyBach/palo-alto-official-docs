---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/configure-cortex-xdr/cortex-xdr-data-sources/vendor-specific-data-sources/api-security/ingest-data-for-api-security/ingest-azure-apim
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Ingest Azure API Management traffic for Cortex XDR API security analysis. 
...
Add the following inside the <outbound> element, at the end, after the other child elements: 
 ...
 3. Click Save. Your APIM traffic collection is now configured. Request and response data for the configured endpoints are sent to Cortex XDR for inspection by API security modules. 
