---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/customize-indicator-types-fields-and-layouts
fetched_at: 2026-09-06T10:38:45Z
source: cortex-platform
---

# Customize indicator types, fields, and layouts | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Customize indicator types and layouts in Cortex XSOAR 8.9 On-prem. 
 ...
 The script dynamically changes the field value when its conditions are met. The script must have the field-change-triggered-indicator tag. For more information, see Indicator field trigger scripts . 

 Add to all indicator types 

 This option is selected by default. The field is available for all indicator types. Clear the checkbox to associate it with selected indicator types. 
 ...
 If you later edit the field, select Don't show in the indicators layout as needed. The field remains available in context data. 

 (Optional) Add the custom field to a section in the indicator layout. 

 Fields marked Don't show in the indicators layout do not appear in the layout. 
