---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/slas/automate-changes-to-incident-fields-using-sla-scripts
fetched_at: 2026-09-06T11:24:31Z
source: cortex-platform
---

# Automate changes to incident fields using SLA scripts | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Automate SLA field changes in Cortex XSOAR On-prem 8.7 (EoL). 
