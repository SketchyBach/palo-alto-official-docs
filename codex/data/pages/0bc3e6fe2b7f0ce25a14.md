---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/managing-discovered-certificates/working-with-trusted-ca-certificates
fetched_at: 2026-09-16T07:25:25Z
source: palo-alto-main
---

# Working with Trusted CA Certificates Clear
...
Updated on 
 ...
 Note: Trusted CA Certificates is available only when Tenant is selected in the workspace switcher. Inside a workspace the menu entry isn't shown and the page can't be opened, even by a user who holds the permission set. The trusted CA certificates you add under Tenant apply in every workspace. See Workspace Availability by Page . 
 ...
 Click Insights > Certificate Inventory > Trusted CA Certificates . 

 In the left navigation pane, click a trusted CA certificate. 
 ...
 Using either Paste Base64 encoded text or Upload files , paste or upload the CA certificates you want to add. 
 ...
 In the left navigation pane, click the trusted CA certificate you want to download. 
 ...
 In the left navigation pane, select the trusted CA certificate you want to delete. 
