---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/engines/podman/install-podman
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Install and configure Podman to run Cortex AgentiX engines. 
 ...
 When you want to migrate from Docker to Podman for an existing Cortex AgentiX engine. 
 ...
 Podman by default uses the fedoraproject.org, redhat.com, and docker.io unqualified search registries. SinceCortex AgentiX images use only the docker.io registry, you can speed up download times for container images by setting unqualified-search-registries to just docker.io. 
