---
url: https://docs.paloaltonetworks.com/pan-os/11-2/pan-os-release-notes/pan-os-11-2-7-known-and-addressed-issues/pan-os-11-2-7-h4-addressed-issues
fetched_at: 2026-08-13T17:13:36Z
source: palo-alto-main
---

# PAN-OS 11.2.7-h4 Addressed Issues Clear
...
PAN-OS 11.2.7-h4 Addressed Issues 
 ...
 PAN-OS 11.2.7-h7 Addressed Issues 
 ...
 Fixed an issue where, after upgrading, the Visible Virtual
 ...
 Fixed an issue where the mprelay process repeatedly
 restarted. 

 PAN-294161 

 Fixed an issue where the firewall rebooted unexpectedly due to the
 useridd process restarting and causing an HA
 failover. This occurred due to the configd process
 timing out when running the CLI command show user
 user-id-agent config all . 
 ...
 configd process occurred during commits, which
 caused the configd process to restart and the commit to
 fail. 
