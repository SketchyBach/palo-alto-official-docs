---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/cloud-security/rules-and-policies/cloud-workload-policies-and-rules/cloud-workload-rules/custom-user-defined-rules
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Cortex XSIAM custom cloud workload rules for organization-specific security, compliance, and misconfiguration checks. 
