---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-kubernetes/panorama-plugin-for-kubernetes-202/whats-new-in-panorama-plugin-for-kubernetes-202.html
fetched_at: 2026-09-16T13:01:16Z
source: palo-alto-main
---

# What’s New in Panorama Plugin for Kubernetes 2.0.2 Clear
...
Updated on 
 ...
 The Panorama plugin for Kubernetes version 2.0.2 creates a new template
 K8S-Network-Setup-V1-125 with 250 virtual wire (vwire) interfaces and 125
 vwires. 

 On installing kubernetes plugin 2.0.2 or during the PAN-OS upgrade, if the new template
 K8S-Network Setup-V1-125 is not created, run the following CLI command to
 manually create the required template: 

 request plugins kubernetes create-default-template template-name
 K8S-Network-Setup-V1-125 

 When upgrading to CN-Series 10.1.9, the K8S-Network-Setup-V1-125 template appears
 on Panorama only after you install the Kubernetes 2.0.2 plugin before completing this
 upgrade. 
