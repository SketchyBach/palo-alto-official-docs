---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-0/pan-os-new-features/panorama-features/enhanced-performance-for-panorama-query-and-reporting.html
fetched_at: 2026-09-16T10:53:11Z
source: palo-alto-main
---

# Enhanced Performance for Panorama Query and Reporting Clear
...
reports in order to cache a new report. 
 ...
 Generate a custom threat report for
the last seven days. 

 Review the generated custom threat custom report. 

 Generate a custom threat report using
identical report parameters as in Step 2 . 

 To leverage enhanced performance for Panorama query and
reporting, the report parameters must be identical but the time
frame does not. 

 Review the cached log storage quota to understand how
much storage is available before Panorama begins overwriting the
oldest cached queries to storage new queries. 
