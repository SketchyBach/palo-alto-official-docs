...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure macOS host firewall rules and settings for managed endpoints. 
 ...
 After you define the required host firewall profiles, configure the Protection Policies and enforce them on your endpoints. Cortex XDR applies Protection policies on endpoints from top to bottom, as you’ve ordered them on the page. The first policy that matches the endpoint is applied. If no policies match, the default policy that enables all communication to and from the endpoint is applied. 
