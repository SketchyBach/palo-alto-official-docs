---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-trustsec/panorama-plugin-for-cisco-trustsec-203/addressed-issues-in-panorama-plugin-for-cisco-trustsec-203.html
fetched_at: 2026-09-16T13:00:39Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco TrustSec 2.0.3 Clear
...
Updated on 
 ...
 Fixed an issue that caused a 40 to 50 minute delay in updating the dynamic address groups
 with IP changes in the Cisco TrustSec environment. 

 PLUG-20335 

 Fixed an issue that caused the connection between Panorama and the Cisco ISE server to be
 reset with a PubSub error. 
