---
url: https://docs.paloaltonetworks.com/oss-listings/traps-oss-listings
fetched_at: 2026-08-13T16:58:20Z
source: palo-alto-main
---

# Traps OSS Listings Clear
...
Traps OSS Listings 
 ...
 Open-Source Software (OSS) licensing lists for the Traps™
agent and Endpoint Security Manager (ESM) releases and for the Traps
management service. 

 The following sections display Open-Source Software
(OSS) licenses specific to each Traps™ agent and Traps Endpoint
Security Manager (ESM) release and to the Traps management service: 

 Traps Management Service OSS
Listing 

 Due to the large number of licenses used
in the Traps Management Service, this OSS listing is not included
in this book; instead, it is available in a standalone HTML file
(with a corresponding PDF) on the TechDocs website. 

 Traps
Agent 5.0 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 4.2 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 4.1 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 4.0 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 3.4 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 3.3 OSS Listing 

 Traps
Agent and Traps Endpoint Security Manager 3.2 OSS Listing 
