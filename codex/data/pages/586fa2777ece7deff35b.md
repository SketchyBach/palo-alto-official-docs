---
url: https://docs.paloaltonetworks.com/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-plugin-for-adem
fetched_at: 2026-09-16T07:42:20Z
source: palo-alto-main
---

# PAN-OS Plugin for ADEM Clear
...
Updated on 
 ...
 Learn about the updates related to the ADEM plugin for PAN-OS. 

 Review important information about new features, open issues and workarounds, and issues
 that are addressed in each version of the PAN-OS plugin for ADEM. Review the compatibility matrix to know the supported
 PAN-OS versions for each of the ADEM plugin. 

 ADEM plugin is
 supported on all VM-Series firewall except VMs with ARM based instances. 
