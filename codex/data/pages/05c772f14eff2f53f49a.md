---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/asc-support-view/monitor-performance-asc-throughput.html
fetched_at: 2026-09-16T13:54:36Z
source: palo-alto-main
---

# Monitor Performance of Throughput Through the ASC Support View Clear
...
Updated on 
 ...
 If you have the necessary roles, you can view throughput performance of the tenants,
 ...
 Displays the incoming traffic throughput per tunnel for the selected
 time range. You can select to view them all or you can select to
 view by individual tunnel. 

 Egress Throughput 

 Displays the outgoing traffic throughput per tunnel for the selected
 time range. You can select to view them all or you can select to
 view by individual tunnel. 
