---
url: https://docs.paloaltonetworks.com/prisma-agent/release-notes/prisma-agent-release-information/prisma-agent-known-issues/prisma-agent-25-6-known-issues
fetched_at: 2026-09-16T08:21:23Z
source: palo-alto-main
---

# Prisma Agent 25.6 Known Issues Clear
...
Updated on 
 ...
 Review the known issues in Prisma Agent 25.6. 

 Prisma Agent version 25.6 has the following known issues: 

 Issue ID Description 

 PANG-9334 

 An issue exists where the Prisma Agent user interface is cut
 ...
 Prisma Agent application, where portions of the interface
 ...
 difficult to use the Prisma Agent functionality. 

 PANG-9282 

 An issue exists where the Prisma Agent 's embedded browser
 throws a "Server Error" dialog when users attempt to sign into the
 Prisma Agent Manager (EPM) server using Windows Hello PRT
 ...
 subsequently try to access the EPM server through the Prisma Agent , the embedded browser fails to properly handle the Primary
 ...
 An issue exists where the Prisma Agent fails to remove the
 ...
 Prisma Agents on macOS and Windows, and occurs when the agent
 ...
 An issue exists where the Prisma Agent on Windows reports
 ...
 support is not available in current Prisma Agent releases.
