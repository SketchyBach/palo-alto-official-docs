---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-azure/azure-plugin-511.html
fetched_at: 2026-09-16T12:59:40Z
source: palo-alto-main
---

# Panorama Plugin for Azure 5.1.1 Clear
...
Updated on 
 ...
 The Panorama plugin for Azure version 5.1.1 introduces enhancements and fixes
 to known issues. 

 You can download the Azure plugin for Panorama from the Customer
 ...
 The Cloud NGFW page displays the version incompatible banner for unsupported Panorama
 versions. 

 When you perform CLI registration string operations on unsupported Panorama versions,
 the CLI displays not supported error message. 

 You must execute the following command to fetch the raw logs from Azure cloud
 for monitoring. 

 debug plugins azure fetch-raw-data monitoring-definition
 "monitoring-definition-name" 
