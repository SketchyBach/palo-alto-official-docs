---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/asset-config-queries/asset-config-query-attributes
fetched_at: 2026-09-16T13:35:10Z
source: prisma-cloud
---

# Asset Configuration Query Attributes | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Asset Configuration Queries 

 Next Asset Configuration Query Examples 
