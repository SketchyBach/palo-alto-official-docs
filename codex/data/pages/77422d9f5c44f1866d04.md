---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorama-plugin-for-aws-5-4-2/addressed-issues-in-panorama-plugin-for-aws-5-4-2.html
fetched_at: 2026-09-16T12:59:55Z
source: palo-alto-main
---

# Addressed issues in Panorama Plugin for AWS 5.4.2 Clear
...
Updated on 
 ...
 The following is an addressed issue in the Panorama plugin for AWS 5.4.2: 

 PLUG-17471 

 Fixed an issue where redeploying a VM-Series instance would trigger the disassociation of
 existing route tables and the association of new ones, causing downtime with complex
 Transit Gateway (TGW) propagations. You can now maintain existing route table
 associations and propagations during a redeployment. 
