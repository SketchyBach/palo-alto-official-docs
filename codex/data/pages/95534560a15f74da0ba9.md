---
url: https://docs.paloaltonetworks.com/oss-listings/globalprotect-app-oss-listings
fetched_at: 2026-08-13T16:57:57Z
source: palo-alto-main
---

# GlobalProtect App OSS Listings Clear
...
GlobalProtect App OSS Listings 
 ...
 Open-Source Software (OSS) licensing for GlobalProtect™ app software. 

 The following sections display Open-Source Software (OSS) licenses specific to each
 feature release of the GlobalProtect™ app. It is our goal to capture and provide here
 the version of each component used in the latest maintenance release for each feature
 release. We recommend that, if you haven't already, you upgrade to the latest
 recommended maintenance release of your current feature release to ensure that you have
 all available fixes, enhancements, and vulnerability updates for your products. 
