---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/investigate-and-respond-to-threats/threat-intel-management/indicator-configuration/indicator-classification-and-mapping
fetched_at: 2026-09-06T10:23:02Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Classify and map indicators in Cortex XSOAR 8 SaaS. 
 ...
 Under Get data , select where you want to import the indicator data. You will classify the indicator type based on this information. 
 ...
 In the Classification & Mapping page, the mapping does not indicate for which indicator types they are configured. When creating a mapper, it is best practice to add the mapper name and the indicator type the mapper is for. For example, Mail Listener - Phishing. 
