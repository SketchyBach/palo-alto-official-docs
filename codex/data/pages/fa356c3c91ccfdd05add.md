---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/storage/appsec-gcp-80
fetched_at: 2026-09-16T09:10:39Z
source: cortex-platform
---

# GCP Big Query Tables are not encrypted with Customer Supplied Encryption Keys (CSEK) misconfiguratio | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Arguments: encryption_configuration.kms_key_name resource "google_bigquery_table" "pass" { dataset_id = google_bigquery_dataset.default.dataset_id table_id = "sheet" 

 external_data_configuration { autodetect = true source_format = "GOOGLE_SHEETS" 

 google_sheets_options { skip_leading_rows = 1 } 

 source_uris = [ "https://docs.google.com/spreadsheets/d/123456789012345", ] } 

 encryption_configuration { kms_key_name = var.kms_key_name } } 

 Previous GCP Cloud storage does not have versioning enabled misconfiguration detected in code 

 Next GCP Big Query Datasets are not encrypted with Customer Supplied Encryption Keys (CSEK) misconfigurat 
