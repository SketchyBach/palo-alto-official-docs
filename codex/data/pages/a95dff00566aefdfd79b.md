---
url: https://docs.paloaltonetworks.com/iot/new-features/by-date/device-security/may-2026#ca06734dc0cb13c8402eeb919b420bd9
fetched_at: 2026-09-15T15:14:46Z
source: palo-alto-main
---

# New Features - Device Security - May 2026 Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear Clear
...
Focus 
 ...
 Role-Based Access Control for Device Security 

 Release Date: May 2026 
 | 
 Last Updated: August 2026 

 When multiple teams share the same Device Security tenant, you can now use role-based access control (RBAC) to grant each user only the permissions they need for the entities they own. For example, a security operations analyst can triage alerts without changing network configuration, and a network administrator can maintain sites and networks without resolving vulnerabilities. 

 You define RBAC roles in Identity & Access Management in Strata Cloud Manager and assign one or more roles to each user. Each role sets a permission level of Read Write, Read Only, or No Access for each Device Security entity, including devices, alerts, vulnerabilities, networks, policies, integrations, and dashboards. Device Security also supports two predefined roles: Superuser grants full access to every entity, and View Only Administrator grants Read Only access to every entity. 

 When a user has multiple roles assigned, Device Security applies the union of their permissions, so you can combine predefined and custom roles to grant exactly the access each user needs. Users with No Access on an entity do not see it in the navigation, and related pages, widgets, and API responses return no data. 
