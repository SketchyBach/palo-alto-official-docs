---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/8.8-eol/cortex-xdr-agent-for-linux/cortex-xdr-agent-for-linux-requirements
fetched_at: 2026-09-06T11:23:50Z
source: cortex-platform
---

# Cortex XDR Agent for Linux Requirements | 8.8 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For ARM 64 architecture (ARM 64 bit) see Cortex XDR Agent for Linux Requirements for details. 
...
User space operation mode requires Kubernetes node to run one of the supported operation systems with kernel version 5.0 or later. 
 ...
 glibc—Required for exploit protection for containerized processes using the ROP Mitigation and Brute Force Protection modules. If glibc is not installed, these modules are disabled but all other exploit and malware protection functionality work as expected. 
 ...
 Import the certificates: cp XDR-certificates.crt /etc/pki/ca-trust/source/anchors/. 
