---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/public-exposure/appsec2-aws-51
fetched_at: 2026-09-16T09:10:03Z
source: cortex-platform
---

# AWS API Gateway endpoints without client certificate authentication misconfiguration detected in cod | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 994d466e-fd3a-4a28-8c03-46f017447251 
 ...
 resource "aws_api_gateway_stage" "example" { stage_name = "prod" rest_api_id = aws_api_gateway_rest_api.example.id deployment_id = aws_api_gateway_deployment.example.id 

 client_certificate_id = aws_api_gateway_client_certificate.example.id } 

 resource "aws_api_gateway_client_certificate" "example" { certificate_body = filebase64("client_certificate.pem") certificate_chain = filebase64("certificate_chain.pem") private_key = filebase64("private_key.pem") } 

 Previous AWS Database Migration Service endpoint do not have SSL configured misconfiguration detected in code 

 Next AWS API gateway request parameter is not validated misconfiguration detected in code 
