---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent-ios-guide/8.4/administrator-tasks/add-a-malware-security-profile-administrator-task
fetched_at: 2026-09-06T10:21:05Z
source: cortex-platform
---

# Add a Malware Security Profile (Administrator Task) | 8.4 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 From the Cortex XDR or Cortex XSIAM tenant, administrators can configure what action Cortex XDR agents on iOS devices take for known malicious URLs and spam numbers. 
 ...
 Configure a malware security profile on the Cortex XDR or Cortex XSIAM tenant. 
