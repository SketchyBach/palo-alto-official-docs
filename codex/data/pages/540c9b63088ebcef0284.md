---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/configure-cortex-xsoar/engines/use-an-engine-in-an-integration
fetched_at: 2026-09-06T10:37:35Z
source: cortex-platform
---

# Use an engine in an integration | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use an engine with an integration in Cortex XSOAR 8.9 On-prem. 
