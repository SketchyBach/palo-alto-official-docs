---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/onboard-cortex-xsoar/cortex-xsoar-installation/load-balancing-for-cortex-xsoar
fetched_at: 2026-09-06T10:34:36Z
source: cortex-platform
---

# Load balancing for Cortex XSOAR | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure load balancing for reliable Cortex XSOAR 8.10 On-prem operation. 
 ...
 If you deploy a cluster of three nodes and set the Cortex XSOAR IP address access to either a virtual IP or the reverse proxy/ingress controller IP, the system implements built-in load balancing. This enables traffic distribution across the nodes and continuous operation in case one node fails. 
