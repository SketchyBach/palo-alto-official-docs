---
url: https://docs.paloaltonetworks.com/openconfig/1-3/openconfig-admin/openconfig-models/routing-policy/routing-policy-behavior
...
router on the OSPFv2 tab: 
 ...
 "updates": [
 {
 "Path": "routing-policy/defined-sets/prefix-sets/prefix-set[name=VR_OC+bgpimp+test_import]/state/mode",
 "values": {
 "routing-policy/defined-sets/prefix-sets/prefix-set/state/mode": "IPV4"
 }
 }
 ] 
