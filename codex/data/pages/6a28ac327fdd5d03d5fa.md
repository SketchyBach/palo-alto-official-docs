---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/onboard-cortex-xdr/deployment-steps/activate-cortex-xdr
fetched_at: 2026-09-06T09:38:34Z
source: cortex-platform
---

# Activate Cortex XDR | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Geographic location where your tenant will be hosted. For more information about supported regions, see Cortex XDR supported regions . 
 ...
 Activation can take about an hour and does not require you to remain on the activation page. Cortex XDR sends a notification to your email when the process is complete. 
 ...
 If you want to change your tenant's name or the subdomain, on the right-hand side, click the ellipsis. 
 ...
 Previous Cortex XDR onboarding checklist 

 Next Cortex XDR supported regions 
