---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/t-cloud-predict-dashboard/tagging-certificates/tagging-edit-delete
fetched_at: 2026-09-16T07:25:30Z
source: palo-alto-main
---

# Editing and Deleting Tags Clear
...
Updated on 
 ...
 The Tags page provides a central place for administrators to manage tags in Next-Gen Trust Security. From this page, you can view existing tags, add new tags, and delete tags that are no longer needed. 

 Add a New Tag 

 Click Configuration > Certificate Configuration > Certificate Tags . 

 Click Add . 

 Enter the Key , which is the first part of the tag. 

 Optional: Enter one or more Values , and then click Add . 

 Tip: Press Enter in the Values field to recognize the current text as a value. This allows you to add multiple values quickly. 
 ...
 Locate the tag or tags you want to delete. 

 Select the checkbox next to each tag you want to remove. 

 Click Delete . 

 In the confirmation dialog, verify the tags you selected, and then click Delete . 

 If a deleted tag is assigned to one or more certificates, the tag is removed from those certificates. The certificates themselves remain unchanged. 

 If you delete a key, all values associated with that key are also deleted. 

 Related Links 

 Tagging certificates 

 Tagging features in the certificate inventory 
