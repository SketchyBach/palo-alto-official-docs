---
url: https://docs.paloaltonetworks.com/prisma-browser/deployment/troubleshoot-the-prisma-browser
...
Updated on 
 ...
 Installer: 
 Visit the Prisma Browser Official Download
 page . 
 ...
 Terminate any running PrismaBrowser processes: 
 Press CTRL+SHIFT+ESC to open the Task Manager. 

 Look for any processes named PrismaBrowser*. 
 ...
 Check your firewall to make sure that these URLs are not blocked. If you
 ...
 Under certain circumstances, users have been receiving Error 500. This is a
 server error, and is not caused by Prisma Browser. It may be the result of an
 error on the Microsoft server. 
