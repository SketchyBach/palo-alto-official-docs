---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-11.html
...
Updated on 
 ...
 Captures logging output related to device boot up activity. Contains information on installing updated software packages and their installation location, filesystem mounts, and commands run during package installation and device boot up. Occaisonally might contain warnings related to missing "best practice" configuration advice, such as a missing user/group which forces the system to use "root" instead. 
