---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/data-management/broker-vm/set-up-and-configure-broker-vm/broker-vm-image-installations/set-up-broker-vm-on-nutanix-hypervisor
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how to set up your Cortex Data Security Broker virtual machine (VM) on Nutanix Hypervisor. 

 After you download your Cortex Data Security Broker virtual machine (VM) QCOW2 image, you need to upload it to a Nutanix hypervisor. Nutanix AHV 10.3 or later is supported. 
