---
url: https://cortex-docs.paloaltonetworks.com/data-security-documentation/cortex-data-security-data-sources-and-connectors/standard-data-sources
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure standard data sources to ingest telemetry into Cortex Data Security. 

 Standard data sources are built-in ingestion mechanisms in Cortex Data Security primarily focused on ingesting raw logs and security events. While Cortex Data Security is introducing a unified Connector approach, many third-party services and file-based ingestions continue to use standard data sources for core security analysis and normalization. 
