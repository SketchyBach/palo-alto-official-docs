---
url: https://docs.prismacloud.io/content-collections/administration/prisma-cloud-licenses
fetched_at: 2026-09-16T13:35:06Z
source: prisma-cloud
---

# License Types | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Cloud Security —Plans for the runtime security offerings are available with a combination of VM-based and developer-based metering. You can choose from the bundles for Cloud Security Foundations and Cloud Security Advanced, and you can take advantage of additional capabilities as add-ons, which are not part of the above bundles. Features include, Data Security , Software Composition Analysis (SCA), Secrets Security, CI/CD Security . 
 ...
 If there is less than 30 days of data available, the average is calculated using the days that were available. 
 ...
 Previous Manage your Prisma Cloud Profile 

 Next Subscribe to Discovery and Exposure Management 
