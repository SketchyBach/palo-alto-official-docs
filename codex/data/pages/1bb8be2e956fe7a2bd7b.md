---
url: https://docs.paloaltonetworks.com/hardware/pa-7500-hardware-reference/pa-7500-series-firewall-overview/pa-7500-series-module-and-interface-card-descriptions/pa-7500-series-firewall-switch-fabric-card-sfc
fetched_at: 2026-09-15T15:14:32Z
source: palo-alto-main
---

# PA-7500 Series Firewall Switch Fabric Card (SFC) Clear
...
Updated on 
 ...
 Learn about the PA-7500 Series Firewall Switch Fabric Card. 

 The Switch Fabric Card (SFC) provides data plane connectivity to the other interface
 cards. It also acts like a control plane processor for the chassis. An SFC can be
 installed in one or both of the two back slots of the chassis. The second SFC is used
 for redundancy. 

 The following image shows the PA-7500 SFC and the table below describes each
 labeled component. 
 ...
 Use the console port to connect a management computer to the firewall
 ...
 Use the console port to connect a management computer to the firewall
 using a standard Type-A USB-to-micro USB cable and terminal
 emulation software. The console connection provides access to
 firewall boot messages, the Maintenance Recovery Tool (MRT), and the
 SFC Debug Mode tool. 
 ...
 Four LEDs that indicate the status of various hardware components.
 For details on the LEDs, see Interpret the PA-7500 Series Firewall LEDs . 

 3 

 Reset Button 

 A small button that, with the help of a pin, can be used to reset the
 SFC and its associated front slot cards. 

 4 

 Ejector Handles 

 Handles that are used to insert or replace the
 interface card. 
