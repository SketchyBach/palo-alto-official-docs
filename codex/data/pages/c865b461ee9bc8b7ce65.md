---
url: https://docs.prismacloud.io/content-collections/search-and-investigate/permissions-queries/permissions-query-attributes
fetched_at: 2026-09-16T13:35:11Z
source: prisma-cloud
---

# Permissions Query Attributes | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Permissions Queries 

 Next Permissions Query Examples 
