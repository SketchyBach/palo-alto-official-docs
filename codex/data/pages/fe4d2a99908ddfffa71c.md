...
# Limit Access to Investigations using RBAC | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Limit Cortex XSOAR 6.14 investigation access with role-based controls. 
