---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.5/configure-cortex-xsoar/users-and-roles-management/roles-management/manage-roles-in-the-cortex-xsoar-tenant
fetched_at: 2026-09-16T09:15:01Z
source: cortex-platform
---

# Manage roles in the Cortex XSOAR tenant | 8.5 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Select the default dashboards that the user sees when logging into the tenant. If users have not modified their dashboards, these dashboards are added automatically, otherwise, users can add these dashboards to their existing dashboards. They can add or remove the dashboard, but cannot delete it. 
