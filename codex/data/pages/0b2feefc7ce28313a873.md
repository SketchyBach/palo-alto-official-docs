---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent-ios-guide/9.0/get-started/cortex-xdr-agent-app-for-ios-overview
fetched_at: 2026-09-16T08:51:49Z
source: cortex-platform
---

# Cortex XDR Agent App for iOS Overview | 9.0 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 This is a brief overview. For detailed steps, refer to Prepare for Installation (Administrator Task) . 
 ...
 If the Network Shield or the Safari Safeguard module is not activated, the widget must be used. 

 Note 

 If the Network Shield or the Safari Safeguard module is not used, the widget must be used, preferably also on the lock screen, in order to ensure that heartbeats continue in the background, even following a device restart. 
