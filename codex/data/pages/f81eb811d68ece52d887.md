---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/monitoring/appsec-azure-79
fetched_at: 2026-09-06T11:12:51Z
source: cortex-platform
---

# Azure Microsoft Defender for Cloud is set to Off for SQL servers on machines misconfiguration detect | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Azure Microsoft Defender for Cloud is set to Off for SQL servers on machines misconfiguration detect 
 ...
 d0d41a3f-5c0d-4d6e-8559-2d44298a36ed 
 ...
 Arguments: resource_type - (Required) The resource type this setting affects. Ensure that SqlServers and SqlServerVirtualMachines are declared to pass this check. [source,go] 
 ...
 Previous Azure Microsoft Defender for Cloud is set to Off for Azure SQL Databases misconfiguration detected i 

 Next Azure Microsoft Defender for Cloud is set to Off for Storage misconfiguration detected in code 
