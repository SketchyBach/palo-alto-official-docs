---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/automation/playbooks/build-your-playbook/add-objects-from-the-task-library
fetched_at: 2026-09-06T09:44:14Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Add tasks and objects from the Task Library. 
 ...
 Add tasks containing a natural language AI prompt with inputs and outputs that interact with the Cortex XDR built-in LLM as part of your automation. 
 ...
 See Add manual and blank tasks . 
 ...
 AI tasks use natural language prompts to interact with the Cortex XDR built-in LLM. You provide the inputs and the LLM generates the outputs. 
