---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/functions/sec
fetched_at: 2026-09-16T09:05:15Z
source: cortex-platform
---

# sec | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The angle in radians for which to calculate the secant. The value must not be an odd multiple of p/2. 
 ...
 Functions : cos() , csc() , sech() , cot() 

 Datasets : xdr_data 

 Previous safe_subtract 
