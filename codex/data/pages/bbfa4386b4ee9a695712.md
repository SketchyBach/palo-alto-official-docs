---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/device-health-and-performance/metric-dt-dhp-97.html
fetched_at: 2026-09-16T11:03:56Z
source: palo-alto-main
---

# Log Receiver Statistics Clear
...
Updated on 
 ...
 Collects resource information for the log receiver daemon, such as the incoming log rate, the number of logs written by the daemon, number of logs written for each log type (traffic, threat, sctp, and so forth), number of corrupted packets, and URL cache counts. Also collects statistics on log external forwarding, such as the number of logs (for a given type) that are in the send queue, the send count, drop count, and send rate. 
