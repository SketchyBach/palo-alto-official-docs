---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-2/pan-os-upgrade/upgrade-pan-os/downgrade-pan-os/downgrade-a-windows-agent.html
fetched_at: 2026-09-16T10:42:28Z
source: palo-alto-main
---

# Downgrade a Windows Agent Clear
...
Updated on 
 ...
 After you uninstall the PAN-OS 10.2 Windows-based
User-ID agent, perform the following steps before you install an
earlier agent release. 
...
double-click User-ID Agent . 
 ...
 Select Log On , select This
account , and specify the username for the User-ID agent
account. 
