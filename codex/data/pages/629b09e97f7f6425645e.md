---
url: https://docs.prismacloud.io/content-collections/runtime-security/waas/waas-app-firewall
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 For further details on configuring API protection, refer to the API Protection help page. 
 ...
 In the App firewall menu click on the icon for one of the OWASP Top-10 protection. 
