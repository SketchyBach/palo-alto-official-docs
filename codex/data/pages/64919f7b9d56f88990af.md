---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/sase/prisma-sase-multitenant-platform/prisma-sase-app-overview/download-and-install-servicenow-app.html
fetched_at: 2026-09-16T09:57:14Z
source: palo-alto-main
---

# Download and Install the ServiceNow App Clear
...
Updated on 
 ...
 Contains the steps to download and install the Prisma SASE ServiceNow
 app. 

 Before you begin, ensure that you have the ServiceNow instance username and password
 with the system admin role. 

 Open ServiceNow Store . 

 Search for Prisma SASE App . 

 From the app listing, click Prisma SASE App and
 thenclick Get . 

 When prompted, enter the ServiceNow user ID and password to log in. 

 In your ServiceNow instance, go to Applications All Available Applications All . 

 Search for Prisma SASE App and click
 Install . 
