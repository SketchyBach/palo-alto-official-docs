---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-cisco-aci/cisco-aci-plugin-101/addressed-issues-in-panorama-plugin-for-cisco-aci-101.html
fetched_at: 2026-09-16T13:01:18Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for Cisco ACI 1.0.1 Clear
...
issues in the Panorama plugin for Cisco ACI 1.0.1. 

 PLUG-2319 

 Fixed an issue that generated errors
when running the command show plugins counters filter delta yes . 

 PLUG-2276 

 Fixed an issue that prevent ACI objects
from appearing in the Panorama web interface after a successful
retrieval retry when Panorama is configured in an HA pair. 

 PLUG-2162 

 The Panorama plugin for Cisco ACI now
retrieves all IP addresses from endpoints that have more than one
IP address. 

 PLUG-1979 

 The Panorama plugin for Cisco ACI now
works with a proxy configured. 

 PAN-115158 

 Fixed an issue where the Panorama plugin
for Cisco ACI configuration elements were not displayed in web interface
of the Panorama M-600 appliance. 
