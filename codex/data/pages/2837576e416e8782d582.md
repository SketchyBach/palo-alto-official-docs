---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cortex-cloud-data-sources-and-connectors/vendor-specific-data-sources/onelogin/ingest-logs-and-data-from-onelogin
fetched_at: 2026-09-06T10:00:29Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure OneLogin log and directory data collection for Cortex Cloud. 
 ...
 In the credential details page, copy the Client ID and the Client Secret, and save them somewhere safe. You will need to provide these keys when you configure the OneLogin data collector in Cortex Cloud . 
