---
url: https://docs.prismacloud.io/content-collections/application-security/risk-management/monitor-and-manage-code-build/software-composition-analysis
fetched_at: 2026-09-16T13:35:46Z
source: prisma-cloud
---

# Software Composition Analysis (SCA) | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Previous Unused Resources 

 Next License Compliance in Software Composition Analysis (SCA) 
