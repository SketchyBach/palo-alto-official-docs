---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.9/configure-cortex-xsoar/integrations/add-an-integration-instance/fetch-incidents-from-an-integration-instance
fetched_at: 2026-09-16T08:55:30Z
source: cortex-platform
---

# Fetch incidents from an integration instance | 8.9 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Fetch incidents with an integration in Cortex XSOAR 8.9 On-prem. 
