---
url: https://docs.prismacloud.io/content-collections/runtime-security/vulnerability-management/registry-scanning/scan-acr
fetched_at: 2026-09-16T13:35:21Z
source: prisma-cloud
---

# Azure Container Registry | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Azure Service Principle is assigned the Contributor role. Azure Credentials for details. 
 ...
 Previous Amazon Elastic Container Registry 

 Next Docker Registry v2 (including Docker Hub) 
