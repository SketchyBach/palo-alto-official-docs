---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/reference-and-developer-docs/cortex-agentix-xql/build-xql-queries/legacy-query-builder/create-image-load-query
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create legacy image load queries in Cortex XSIAM. 
