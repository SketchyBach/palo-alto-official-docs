---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/9-1/pan-os-admin/decryption/configure-ssl-inbound-inspection.html
...
does not support Captive Portal redirect .
To use Captive Portal redirect and decryption, you must use SSL Forward Proxy . 
...
exchange algorithm and the server’s certificate chain (if
