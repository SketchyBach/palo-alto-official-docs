---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-205/addressed-issues-in-panorama-plugin-for-vmware-nsx-205.html
fetched_at: 2026-09-16T13:00:12Z
source: palo-alto-main
---

# Addressed Issues in Panorama Plugin for VMware NSX 2.0.5 Clear
...
in the Panorama plugin for VMware NSX 2.0.5. 
 ...
 Fixed an issue that prevented plugin
database synchronization from occurring when a when a passive Panorama
HA peer is connected to the active Panorama HA peer for the first
time. 

 PLUG-1650 

 Introduced a new log error message that displays when
a curl call failure to NSX Manager occurs. 

 2019-05-23 06:50:15.780 -0700 ERROR: Curl call to NSX Manager failed 

 The full log message also includes the curl request, reason,
return code, response, and additional information to help you determine
the cause for the failure. 

 PLUG-1572 

 Panorama can now process the following
special characters — ’<>&” — when included in the NSX
Manager password. 
