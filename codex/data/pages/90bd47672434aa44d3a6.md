---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/vm-series-plugin/vm-series-plugin-30/vm-series-plugin-301/whats-new-in-vm-series-plugin-301.html
fetched_at: 2026-09-16T12:59:00Z
source: palo-alto-main
---

# What’s New in VM-Series Plugin 3.0.1 Clear
...
Updated on 
 ...
 The VM-Series plugin version 3.0.1 introduces
Bundle 3(BND3) PAYG images on AWS, OCI, GCP and Azure which includes
licensing for Advanced URL filtering and Advanced Threat Protection(TP).
You can now deploy the VM-Series firewall from the AWS, GCP, Azure,
and Oracle Cloud Infrastructure Marketplace with a Pay-As-You-Go
(PAYG) license. This allows you to deploy a VM-300, VM-500, or VM-700
VM-Series firewall with Bundle 3 PAYG images. 

 The Bundle 3 (BND3) PAYG images are currently available
only for PAN OS 10.2.1. 

 Downgrade from PAN OS 10.2.1 to PAN OS 10.2.0 is not allowed
on PAYG Bundle3. 
