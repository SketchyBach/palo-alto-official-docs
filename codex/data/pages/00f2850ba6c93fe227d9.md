---
url: https://cortex-docs.paloaltonetworks.com/xql-command-reference-guide/readme/stages/union
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The name of the existing dataset to combine with the current query's result set. 
 ...
 An inner XQL subquery defined inline, whose results will be combined with the current query's result set. 
 ...
 Stages : dedup , fields , filter , join , sort , target 
