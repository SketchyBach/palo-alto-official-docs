---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/automations/ai-prompts/create-a-prompt
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create and configure AI prompts for agents and playbooks in Cortex AgentiX. 
...
A nested “type” must be one of the following 
 ...
 11. (Optional) Click and select Register new Action to register the prompt as an action and make it available for agents. For more information, see Manage actions . 
...
The prompt appears in the playbook editor. 
 ...
 Previous Use existing prompts 

 Next Write effective prompts 
