---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/panorma-plugin-for-aws-301.html
fetched_at: 2026-09-16T12:59:53Z
source: palo-alto-main
---

# Panorama Plugin for AWS 3.0.1 Clear
...
Updated on 
 ...
 The Panorama plugin for AWS version 3.0.1 includes one
feature enhancement—CLI commands to set, show, and clear AWS regions
during IAM role validation, and bug fixes. 

 The Panorama plugin for AWS version 3.0.1 includes one
feature enhancement—CLI commands to set, show, and clear AWS regions
during IAM role validation, and bug fixes. 

 You can download the AWS plugin for Panorama from the Customer Support Portal or directly from Panorama Plugins . Panorama
can push the virtual machine attributes that it retrieves to firewalls
running the versions detailed in the plugin Compatibility Matrix
for public clouds . 
