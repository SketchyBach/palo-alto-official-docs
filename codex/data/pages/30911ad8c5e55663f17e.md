---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/marketplace/cortex-marketplace
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Browse, search, and manage content packs for security orchestration in Cortex AgentiX. 
 ...
 Analyzes the correlation of multiple events from multiple sources by using the Cortex AgentiX XQL-based engine for creating these correlation (scheduled) rules. Issues can then be triggered based on these rules with a defined time frame and schedule. 

 Dashboards 

 Dashboards consist of visualized data powered by fully customizable widgets, which enable you to analyze data from inside or outside Cortex AgentiX, in different formats such as line charts, tables, text, etc. 
 ...
 All issues that are ingested into Cortex AgentiX are assigned an issue type when they are classified. After you classify the issue, you can then map the relevant fields to the issue. 
 ...
 Reports contain statistical data in the form of widgets (from a dashboard), which enable you to analyze data from inside or outside Cortex AgentiX, in different formats such as line charts, tables, text from information, etc. 
