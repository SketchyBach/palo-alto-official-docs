---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aws/aws-plugin-522/addressed-issues-in-panorama-plugin-for-aws-522.html
fetched_at: 2026-09-16T12:59:45Z
source: palo-alto-main
---

# Addressed issues in Panorama Plugin for AWS 5.2.2 Clear
...
Updated on 
 ...
 The following are the fixed issues in the Panorama plugin for AWS 5.2.2: 

 PAN-243989 

 A fix was made to address CVE-2022-23491 . 

 PLUG-15003 

 Fixed an issue that prevented the Panorama plugin for AWS from listing the Jakarta
 (ap-southeast-3) region as an option on the Monitoring Definition configuration
 menu. 

 PLUG-14830 

 Fixed an issue that prevented the Panorama plugin for AWS from listing the Zurich
 (eu-central-2) region as an option on the deployment profile configuration menu. 
