...
# Task 1. Download the QCOW2 image and license from Cortex Gateway |  8.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Download the QCOW2 image and license for Cortex XSOAR 8.14 On-prem. 
 ...
 Select the QCOW2 image format to download. 

 QCOW2 is supported by Oracle Cloud Infrastructure (OCI) and KVM. 

 (Optional) Select Version Override to download a specific version instead of the default (latest) version. 

 Note 

 Enter the exact version of the build you want, ensure the version syntax and numbering is correct. 
 ...
 Two files download: A zipped license file containing one or more JSON license files with instructions, and a zipped image file of the type you selected (.qcow2). 

 Extract (unzip) the license and image files. 

 Previous Install Cortex XSOAR on a VM deployed on KVM 
