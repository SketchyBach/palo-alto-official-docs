---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/pan-os-openconfig-plugin/openconfig-plugin-20/whats-new-in-the-openconfig-plugin-2-0.html
fetched_at: 2026-09-16T13:01:40Z
source: palo-alto-main
---

# Whats New in OpenConfig Plugin 2.0 Clear
...
Updated on 
 ...
 The OpenConfig plugin version 2.0.0 introduces the following
 capabilities: 
 ...
 The OpenConfig plugin is now supported on Panorama
 version 11.1 and above. 

 Prepackaged OpenConfig The OpenConfig plugin now comes prepackaged with all
 versions of PAN-OS above 11.1 as well as auto-upgrades on future plugin
 releases. 

 Custom PAN-OS Data models 

 The OpenConfig plugin now supports custom PAN-OS data models for
 logging, configuration, and PCAP information. 

 Dail-out Telemetry Streaming PAN-OS now automatically streams telemetry data to AIOPS
 through the OpenConfig plugin. 
