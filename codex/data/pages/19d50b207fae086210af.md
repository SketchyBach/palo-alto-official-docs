---
url: https://docs.paloaltonetworks.com/strata-cloud-manager/new-features/by-date/strata-cloud-manager/may-2025#983ef3cbe30d625b343435bba9202d6d
...
Focus 
 ...
 Transparent Proxy Support for Prisma Agent 

 Release Date: May 2025 
 | 
 Last Updated: August 2026 

 Prisma® Agent now supports transparent proxy connections , offering always-on internet security and private app access for your mobile users. This feature enables seamless coexistence with third-party VPN agents, enhancing your organization's security posture. You can use it to secure all internet traffic from browser and nonbrowser apps, even when users are disconnected from the tunnel. The solution forwards internet traffic to Prisma Access, preventing users from bypassing Prisma Access. 
