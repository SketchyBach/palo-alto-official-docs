---
url: https://docs.prismacloud.io/content-collections/runtime-security/waas/deploy-waas/vpc-mirroring
fetched_at: 2026-09-16T13:35:25Z
source: prisma-cloud
---

# Deploy WAAS Agentless | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Optionally, if you onboard your AWS accounts using Prisma Cloud, you can add the necessary WAAS agentless permissions to the same role used by Prisma Cloud. During the setup, provide the Prisma Cloud role as a parameter in the agentless_attach_to_role_cft.template . 
 ...
 * = Match all tags. 
 ...
 When enabled, the Observer inspects the mirrored traffic to and from the remote applications. The Observer reports a list of the endpoints and their resource path in Runtime Security > Monitor > WAAS > API discovery . 
 ...
 Continue to DoS protection tab and select DoS protection to enable. 
 ...
 Continue to Custom rules tab and select Custom rules to enable. 
 ...
 You must upgrade the VPC Observer through Runtime Security > Manage > Defenders . 
 ...
 Modify the account with the correct permissions as mentioned in the agentless_app_firewall_permissions_template.json file, and select Update to retry the deployment. 
 ...
 Previous Deploy WAAS for Serverless 

 Next Troubleshooting WAAS 
