---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/secrets-security/appsec-secret-88
fetched_at: 2026-09-06T11:15:24Z
source: cortex-platform
---

# Firebase Cloud Messaging API key detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 The Firebase Cloud Messaging API key authorizes server-to-server communication for sending messages. 

 Exposure can lead to unauthorized messaging and misuse of the notification services. 
 ...
 Previous SendGrid Key detected in code 

 Next Docker Swarm Join Token detected in code 
