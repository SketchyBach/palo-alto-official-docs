...
# Create a child tenant | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Cortex XSIAM child tenants in Cortex Gateway and allocate licensed employee, storage, and add-on resources. 
 ...
 Previous Step 1. Activate Cortex XSIAM (main account) 
