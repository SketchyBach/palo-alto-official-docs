---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-saas/configure-cortex-xsoar/dashboards-and-reports/dashboards/dashboard-actions
fetched_at: 2026-09-06T10:22:43Z
source: cortex-platform
---

# Dashboard actions | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage dashboard actions in Cortex XSOAR 8 SaaS. 
 ...
 In a production environment, an administrator defines the default dashboard for each user and selects the default dashboards that the user sees when logging into the tenant, depending on a user’s role. If a user has not modified their dashboard, these dashboards are added automatically, otherwise users can add these dashboards to their existing dashboards. Default dashboards can be removed but not deleted, and can be added again if required.
You cannot add default dashboards to out-of-the-box roles. 

 Important 

 Before adding a dashboard to a role's default dashboards, the dashboard must first be shared with that role, otherwise it will not appear in the dropdown. 
