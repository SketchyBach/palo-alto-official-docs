---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/logging/appsec-gcp-55
fetched_at: 2026-09-06T11:12:41Z
source: cortex-platform
---

# GCP PostgreSQL instance database flag log_min_messages is not set misconfiguration detected in code | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 34b9685e-8fc8-4504-b7fb-037b7733a2b0 
 ...
 Arguments: database_version = "POSTGRES_* " settings::database_flags: key:"log_min_messages", value: by default set to "ERROR" Argument value can be one of the following: DEBUG5 , DEBUG4 , DEBUG3 , DEBUG2 , DEBUG1 , INFO , NOTICE , WARNING , ERROR , LOG , FATAL , and PANIC [source,go] 
 ...
 Previous GCP PostgreSQL instance database flag log_lock_waits is disabled misconfiguration detected in code 

 Next GCP PostgreSQL instance database flag log_temp_files is not set to 0 misconfiguration detected in co 
