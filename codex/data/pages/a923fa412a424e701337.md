---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-300.html
fetched_at: 2026-09-16T13:00:08Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 3.0.0 Clear
...
Updated on 
 ...
 Panorama Plugin for VMware NSX
3.0.0 supports VMware NSX-T deployments only. Do not use the Panorama
plugin for VMware NSX 3.0.0 to manage the VM-Series firewall on
NSX-V. 

 The Panorama plugin for VMware NSX 3.0.0 introduces
support for the VM-Series Firewall for VMware NSX-T. The VM-Series
firewall on VMware NSX-T integrates the Palo Alto next-generation
firewalls and Panorama with ESXi host servers to provide comprehensive
visibility and safe application enablement of all north-south traffic
in your NSX-T software-defined data center. VMware NSX plugin 3.0.0
allows you to secure north-south traffic in NSX-T Data Center by
attaching the VM-Series firewall to Tier-0 and Tier-1 routers. 

 For more information about using the Panorama plugin to deploy
the VM-Series firewall on VMware NSX-T, refer to the VM-Series Deployment Guide for
PAN-OS 9.0 . 
