---
url: https://cortex-docs.paloaltonetworks.com/xsoar-6-administrator-guide/6.14/customize-cortex-xsoar/customize-and-configure-cortex-xsoar/playbooks/extend-context/use-dt-syntax-to-get-select-keys-from-a-list-of-dictionaries
fetched_at: 2026-09-16T08:56:20Z
source: cortex-platform
---

# Use DT syntax to get select keys from a list of dictionaries | 6.14 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use DT syntax in Cortex XSOAR 6.14 to select dictionary list keys. 
