---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/deploy-prisma-agents/deploy-prisma-agents-using-jamf-pro/deploy-agents-to-macos-endpoints-using-jamf/deploy-the-agent-using-a-unified-config-profile-v2
