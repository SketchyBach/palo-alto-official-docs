---
url: https://docs.prismacloud.io/content-collections/runtime-security/cloud-service-providers/cloud-discovery
fetched_at: 2026-09-16T13:35:19Z
source: prisma-cloud
---

# Cloud Discovery | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 3 Auto-defend is currently not yet available for these services. Auto-defend utilizes rule-based policies to automatically deploy Prisma Cloud Defenders to protect resources in your environment. 
 ...
 Prisma Cloud needs an additional set of permissions to enable protection for these workloads. For example, to deploy Defenders automatically on undefended VM machines. Review the permissions by feature table to learn about the needed permissions and protection for the onboarding template. 
 ...
 Next Use Cloud Service Provider Accounts 
