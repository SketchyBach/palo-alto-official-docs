---
url: https://docs.prismacloud.io/content-collections/administration/configure-iam-security/context-used-to-calculate-effective-permissions
fetched_at: 2026-09-16T13:35:09Z
source: prisma-cloud
---

# Context Used to Calculate Effective Permissions | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 AWS Net Effective Permissions Calculation : AWS IAM roles, policies, groups, and service control policies (SCPs). 

 Azure Net Effective Permissions Calculation : Azure managed groups, Azure subscriptions, Azure resources and Active Directory (AD). 

 GCP Net Effective Permissions Calculation : GCP users, service accounts, groups, and roles. 
 ...
 Previous Remediate Alerts for IAM Security 
