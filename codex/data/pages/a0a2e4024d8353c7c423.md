---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-3.x/cortex-xdr-3.x-documentation/investigate-and-respond-to-incidents/response-actions/initiate-a-live-terminal-session
fetched_at: 2026-09-06T09:49:21Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 You can initiate a Live Terminal session from the All Endpoints page. Right-click an endpoint and select Security Operations → Initiate Live Terminal. It might take the Cortex XDR agent a few minutes to facilitate the connection. 
 ...
 Navigate through the file directory on the endpoint and manage your files. To locate a specific file, you can search for any filename rows on the screen from the search bar, or you can double-click a folder to explore its contents. 

 Perform basic management actions on a file, such as: 
 ...
 Investigate files for malware. Right-click a file to see the available actions: 
 ...
 Run commands to manage the endpoint. For example, you can manage files or launch batch files. 

 You can enter or paste the commands into the command line interface, or you can upload a script. To chain multiple commands together use && , as shown in the following example: 
 ...
 If you want to prevent Cortex XDR from initiating Live Terminal remote sessions on an endpoint that is running the Cortex XDR agent, you can disable this capability during agent installation or through Cortex XDR Endpoint Administration . Disabling script execution is irreversible. If you later want to re-enable this capability on the endpoint, you must re-install the Cortex XDR agent. 
