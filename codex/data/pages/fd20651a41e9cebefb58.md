---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/10-1/pan-os-upgrade/upgrade-pan-os/upgrade-the-firewall-pan-os/determine-the-upgrade-path.html
fetched_at: 2026-09-16T10:51:04Z
source: palo-alto-main
---

# Determine the Upgrade Path to PAN-OS 10.1 Clear
...
has a check mark in the Currently Installed column. 
 ...
 ( PAN-OS 10.1.4 and later 10.1 releases ) View the preferred
 releases. 

 From Panorama, click Panorama Software , and disable (clear) the Base
 Releases checkbox. 

 From the firewall, click Device Software , and disable (clear) the Base
 Releases checkbox. 

 Identify the upgrade path: 

 Review the known issues and changes
to default behavior in the Release Notes and Upgrade/Downgrade Considerations for each
release through which you pass as part of your upgrade path. 

 Installed PAN-OS Version Recommended Upgrade Path to PAN-OS 10.1 

 10.0.x 

 If you are already
running a PAN-OS 10.0 release, download and install the latest preferred PAN-OS 10.0 maintenance
release and reboot. 

 Proceed to Upgrade the Firewall to PAN-OS 10.1 . 
