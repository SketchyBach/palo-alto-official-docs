---
url: https://docs.prismacloud.io/content-collections/connect/connect-cloud-accounts/onboard-aws/manually-set-up-prisma-cloud-role-for-aws
fetched_at: 2026-09-16T13:34:56Z
source: prisma-cloud
---

# Manually Set Up Prisma Cloud Role for AWS Accounts | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 See Onboard Your AWS Account and follow the steps to Download IAM Role CFT . 
 ...
 Resume with the account onboarding flow in Onboard Your AWS Account 

 Previous Prisma Cloud on AWS China 

 Next Automate AWS Cloud Accounts Onboarding 
