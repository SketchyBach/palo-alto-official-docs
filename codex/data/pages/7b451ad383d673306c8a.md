---
url: https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-release-notes/pan-os-11-1-7-known-and-addressed-issues/pan-os-11-1-7-known-issues
fetched_at: 2026-09-16T07:40:26Z
source: palo-alto-main
---

# PAN-OS 11.1.7 Known Issues Clear
...
Updated on 
 ...
 11.1.7. This list includes issues specific to Panorama™, GlobalProtect™, VM-Series
 ...
 See 
 PAN-OS 11.1.13 Addressed Issues The reportd process experiences a memory
 ...
 using the following CLI command: set deviceconfig
 setting dns-over-https enable no . Alternatively,
 you can remove the DNS Security configuration used to handle DoH
 traffic. 
