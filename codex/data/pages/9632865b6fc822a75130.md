---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/investigate-and-respond-to-cases/investigate-endpoints/overview-of-the-action-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Use the Action Center to monitor and manage response actions. 

 The Action Center is a central location from which you can track the progress of all investigation, response, and maintenance actions performed on your Cortex XDR protected endpoints. To access the Action Center , go to Investigation & Response → Response → Action Center . 
