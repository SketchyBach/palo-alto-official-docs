---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.2/cortex-xdr-agent-for-linux/install-the-cortex-xdr-agent-for-linux
fetched_at: 2026-09-06T10:20:15Z
source: cortex-platform
---

# Install the Cortex XDR agent for Linux | 9.2 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
 ...
 * selinux-policy-devel ... OK 
 ...
 If the Cortex XDR agent does not connect, verify your internet connection and perform a check-in on the endpoint. If the agent still does not connect, verify the installation package has not been removed from the Cortex XDR management console. 
 ...
 cortex-xdr-agent-public-key.zip 
