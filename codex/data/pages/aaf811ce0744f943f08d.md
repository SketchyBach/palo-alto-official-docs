---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/c-VSatellite-Management-about/_release-notes/vsatctl_diag
...
Updated on 
 ...
 vsatctl diag [command] [flags] 

 Troubleshoot your VSatellites. 

 Options 

 -h, --help help for diag
 --image string supply your own image for the diagnostic tools container
 --reset destroys an existing namespace if one exists and creates a new one 
