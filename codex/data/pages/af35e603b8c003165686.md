---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-aiops/panorama-cloudconnector-plugin-200-for-aiops-and-cloud-ngfw-for-aws.html
fetched_at: 2026-09-16T12:59:22Z
source: palo-alto-main
---

# Panorama CloudConnector Plugin 2.0.0 Clear
...
Updated on 
 ...
 What's new for Panorama CloudConnector Plugin 2.0.0 (For AIOps and Cloud NGFW for
 AWS) 

 Panorama CloudConnector Plugin (Formerly, AIOps Plugin for Panorama) now enables you to
 use the Panorama AWS plugin 5.0.0 to author and push
 device group based policies to Cloud NGFW for AWS resources. 
 ...
 Please refer to the Panorama AWS plugin 5.0.0 
 documentation to see how you can enable this plugin for enabling
 management with Cloud NGFW for AWS 
 resources. 

 Panorama Versions 11.0.1 and above 

 To help customers, we have pre-installed this plugin with the newer
 Panorama versions. 
