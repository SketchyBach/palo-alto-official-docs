---
url: https://cortex-docs.paloaltonetworks.com/cortex-cloud-runtime-security/cases-and-issues/investigation-and-response/response-actions/manage-external-dynamic-lists
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Manage external dynamic lists used for enforcement. 
 ...
 curl https://edl- < tenant-nam e > .xdr. < regio n > .paloaltonetworks.com/block_list?type=ip -u < use r > : < passwor d > 
 ...
 Record the IP Addresses EDL URL and the Domains EDL URL . 
 ...
 Configure the firewall EDL 

 Set the Cortex Cloud EDL as the source for a firewall EDL. 
 ...
 Add the EDL to a security policy 

 Select Policies → Security and Add or edit a security policy rule to add the Cortex Cloud EDL as match criteria to a security policy rule. 
 ...
 You do not need to perform an additional commit or make any subsequent configuration changes for the firewall to enforce the EDL as part of your security policy; even as you update the EDL, the firewall will enforce the list most recently retrieved from Cortex Cloud. 
 ...
 You can add to your IP address or Domain lists as you triage alerts from the Action Center . 
 ...
 Navigate to Investigation & Response → Response → Action Center → Currently Applies Actions → External Dynamic List . 
