---
url: https://cortex-docs.paloaltonetworks.com/application-security/code-security/code-security-scanners/software-composition-analysis-sca-scanners/software-composition-analysis-sca-vulnerability-issues/investigate-and-remediate-cve-vulnerability-issues
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Open an issue and select Resolution . Use the recommended fix version. 

 Steps: 

 Navigate to Application Security > Issues > Vulnerabilities . 

 Select the issue row to open the issue side card. 
 ...
 Escalate to a Case when remediation requires cross-team coordination. 
