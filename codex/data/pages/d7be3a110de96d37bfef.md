---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsiam/protect-your-endpoints/endpoint-dlp
fetched_at: 2026-08-13T15:14:38Z
source: cortex-platform
---

# Endpoint DLP | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center

Endpoint DLP | Cortex Documentation Portal 
 ...
 Cortex Data Loss Prevention (DLP) module overview Personas workflow for DLP Best Practices Configure DLP end-to-end DLP status in all endpoints Cortex DLP threat detection and issues 

 Previous Monitor agent upgrade status Next Cortex Data Loss Prevention (DLP) module overview 
