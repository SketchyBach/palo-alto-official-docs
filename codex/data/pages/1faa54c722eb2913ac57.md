---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/asset-classes/compute-assets
fetched_at: 2026-09-06T09:43:14Z
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 View and manage compute assets. 
 ...
 Note that for the actual runtime units spawned from these blueprints, Cortex XDR generates CaaS Container Instance assets only when a runtime drift is detected, limiting creation to a maximum of 50 instances per workload. 
 ...
 Previous Code and Supply Chain Security assets 
