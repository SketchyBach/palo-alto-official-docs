---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.6/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/create-users-in-cortex-xsoar
fetched_at: 2026-09-16T09:13:41Z
source: cortex-platform
---

# Create users in Cortex XSOAR | 8.6 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create users in Cortex XSOAR On-prem 8.6 (EoL). 
