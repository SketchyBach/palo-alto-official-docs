---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-501/known-issues-in-panorama-plugin-for-vmware-nsx-501.html
fetched_at: 2026-09-16T12:59:58Z
source: palo-alto-main
---

# Known Issues in Panorama Plugin for VMware NSX 5.0.1 Clear
...
Updated on 
 ...
 VM-Series firewall on VMware NSX instances might still be listed in Managed Device
 Summary on Panorama after the firewalls are delicensed. 

 PLUG-10874 

 Service chain mapping information sent
from the Panorama plugin for VMware NSX is not read correctly by
the VM-Series firewall. 

 Workaround : Upgrade the VM-Series plugin on your VM-Series
firewalls to version 2.1.8 and later (for PAN-OS 10.1.x or older)
or version 3.0.3 and later (for PAN-OS 10.2.x). 
