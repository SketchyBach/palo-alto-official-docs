---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview/overview-machines
fetched_at: 2026-09-16T07:25:14Z
source: palo-alto-main
---

# About Machines Clear
...
Updated on 
 ...
 In the context of machine identity security, a machine is an endpoint where certificates are installed and managed. This can include physical servers, virtual machines, cloud instances, or other systems that require certificates for secure communication. 

 Key Points About Machines 

 Machine identity 
Each machine has a unique identity that is represented by the certificates installed on it. Next-Gen Trust Security uses this identity to manage certificate lifecycle events such as issuance, renewal, and replacement. 

 Certificate lifecycle management 
Machines are the primary targets for certificate provisioning and renewal. You can track certificate status and manage lifecycle operations for certificates associated with a machine. 

 Integration with keystores 
Machines connect to application or platform keystores where certificates are stored and used. This enables Next-Gen Trust Security to install and manage certificates directly on supported endpoints. 

 Discovery and provisioning 
Next-Gen Trust Security can discover certificates that already exist on machines and provision new certificates as needed, helping you maintain visibility and consistency across your environment. 

 Role in installations 
Creating a machine allows Next-Gen Trust Security to connect to the certificate locations used by applications, enabling automated installation and ongoing management of machine identities. 
