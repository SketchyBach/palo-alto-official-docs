---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/strata-cloud-manager/getting-started/command-center.html
...
Updated on 
 ...
 time periods: the past 1 hour, 3 hours, 7 days, or 30 days. The Strata Cloud Manager
 Essentials licensing tier supports data filtering only for 3 hours and 24 hours
 durations. In this tier, the command center updates every 15 minutes, and requires a
 manual refresh to view the most current metrics. 
 ...
 Platform Devices — Prisma Access, NGFW, Direct Access, Secure Direct Access 
