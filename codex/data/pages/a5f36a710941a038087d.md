---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-vmware-nsx/vmware-nsx-plugin-401.html
fetched_at: 2026-09-16T13:00:03Z
source: palo-alto-main
---

# Panorama Plugin for VMware NSX 4.0.1 Clear
...
Updated on 
 ...
 Panorama plugin for VMware NSX 4.0.1
adds support for VMware NSX-T 3.2.x. 

 For more information, see the Compatibility Matrix and
VM-Series Deployment Guides for 9.1 , 10.0 , 10.1 , or 10.2 . 

 Upgrading to Panorama Plugin for VMware NSX 4.0.1 
 ...
 Upgrading
to Panorama Plugin for VMware NSX 4.0.1 

 After upgrading
the Panorama plugin for VMware NSX 4.0.1, you must synchronize dynamic
objects to ensure that Panorama has the latest information about
dynamic objects in your NSX-T environment. 
