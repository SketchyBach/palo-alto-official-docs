---
url: https://docs.paloaltonetworks.com/next-gen-trust-security/next-gen-trust-security/about-vaas/installations-overview
fetched_at: 2026-09-16T07:25:10Z
source: palo-alto-main
---

# Welcome to Installations Clear
...
Updated on 
 ...
 From the Installations area, you can create machines, provision certificates to machines, add cloud keystores, and provision certificates to those cloud keystores. 

 Create a Machine and Provision Certificates to Machines 

 Need to create a machine or provision a certificate to a machine? Learn more: 

 Creating a machine 

 Provision certificates 

 Add a Cloud Keystore 

 Add a cloud keystore to AWS, Azure Key Vault, or Google Cloud Platform. 
 ...
 Provision Certificates to a Cloud Keystore 

 Need to provision a certificate to a cloud keystore? 
