---
url: https://docs.paloaltonetworks.com/prisma-browser/integrations/ip-based-enforcement
...
Updated on 
 ...
 the device Posture provider, click here . 

 Configure Idira IP-Based Enforcement 

 Follow these steps to limit access to all or specific applications to Prisma
 Browser when using Idira as the identity provider. 

 Create an Access Policy 

 Go to Manage Space Policies Access to Target . 

 Create an Application Policy. 

 Select the applications and identities to which the policy should
 apply. 

 Enable Prisma Browser Enforcement 

 In the Authentication and Security section, enable Enforce
 Prisma Access Browser . 

 Click Next and Save in Session controls. 
