---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/pan-os/u-v/pan-os-device-telemetry-metrics-reference/threat-prevention/metric-dt-tp-12.html
fetched_at: 2026-09-16T11:04:28Z
source: palo-alto-main
---

# File Identification Clear
...
Updated on 
 ...
 Contains information about file data that has been transferred across the network. Information includes the file name, the app that is performing the transfer, the action that the firewall took in response to this data, and the threat ID applied to the data. 
 ...
 pan_report_gen -t data -n 200 -ac threatid,action,app,misc -vc count -s count -c 'File Identification' -p last-24-hrs 
