---
url: https://docs.prismacloud.io/content-collections/administration/view-audit-logs
fetched_at: 2026-09-16T13:35:06Z
source: prisma-cloud
---

# View Audit Logs | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Choose the Add Integration option if you need to configure a new integration. 
 ...
 Previous Subscribe to Discovery and Exposure Management 

 Next Define Enterprise and Anomaly Settings 
