---
url: https://docs.prismacloud.io/content-collections/application-security/visibility/sbom
fetched_at: 2026-09-16T13:35:44Z
source: prisma-cloud
---

# SBOM | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Before you can access the 'SBOM' page and view its resources, you must subscribe to the SCA module. For more on SCA licenses, refer to Application Security Licenses . 
 ...
 Previous Pipeline Tools 

 Next Package Dependency Graph 
