---
url: https://docs.prismacloud.io/content-collections/dashboards/dashboards-discovery-exposure-management
fetched_at: 2026-09-16T13:35:05Z
source: prisma-cloud
---

# Discovery and Exposure Management Dashboard | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Navigate to Dashboards > Discovery and Exposure Management to get a comprehensive view of your attack surface through various Unmanaged Asset Widgets available on the dashboard. 
 ...
 If you have subscribed to CDEM but unable to view the dashboard, you must enable it. Go to Dashboards > Dashboards Menu > Manage Dashboards and make sure to enable Discovery and Exposure Management . 

 The dashboard availability is restricted to users with the System Administrator role on all stacks, with the exception of app.gov and app.cn . 
 ...
 Select one or multiple assets from the Inspect Unmanaged Assets side panel. 
 ...
 Previous Compliance Dashboard 

 Next Identity Dashboard 
