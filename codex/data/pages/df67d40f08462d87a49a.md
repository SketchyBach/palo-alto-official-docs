---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/best-practices/10-0/data-center-best-practices/data-center-best-practices-checklist/deploy-data-center-best-practices-checklist/internet-to-data-center-traffic-policies.html
...
IP addresses. For each rule, configure Log at Session
End on the Actions tab and set
...
access to only the required applications and servers. 
 ...
 Create Decryption policy rules for internet-to-data-centertraffic to
decrypt allowed traffic. 
...
Security policy rule. 
 ...
 Create Decryption
rules to match traffic that internet-to-data-center Security policy
rules allow. 
