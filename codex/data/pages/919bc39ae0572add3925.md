---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-agent/9.0/cortex-xdr-agent-for-macos/install-the-cortex-xdr-agent-for-mac/install-the-cortex-xdr-agent-using-jamf
fetched_at: 2026-09-06T11:26:50Z
source: cortex-platform
---

# Install the Cortex XDR Agent Using JAMF | 9.0 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Configure Application & Custom Settings and click Upload . 

 Select +Add to add the configuration details for each web browser: 
