...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Create Cortex XSIAM issue exception rules to defer remediation, pause SLA timers, and manage risk acceptance approvals. 
 ...
 Previous Update case timer and SLA fields 

 Next Configure the issue exception approval workflow 
