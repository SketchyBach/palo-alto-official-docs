---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/hardware/pa-7000-hardware-reference/PA-7000-series-firewall-installation/install-the-mandatory-pa-7000-series-firewall-front-slot-cards/install-pa-7000-series-firewall-log-card.html
fetched_at: 2026-09-16T12:08:15Z
source: palo-alto-main
---

# Install a PA-7000 Series Firewall Log Card Clear
...
Updated on 
 ...
 Learn how to install a PA-7000 Series firewall log card. 

 The PA-7000 Series firewall must have a log card installed
to operate. You can install a Log Processing Card (LPC) or a Log
Forwarding Card (LFC). To learn about the available log cards to
help you determine which card to install, see PA-7000
Series Firewall Log Cards . 

 The firewall must be running PAN-OS 9.0 or later to use
the LFC and you must install only one log card type (LPC or LFC). 
