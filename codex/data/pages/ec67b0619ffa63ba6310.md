---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.7/configure-cortex-xsoar/users-and-roles-management/set-up-authentication/set-up-okta-as-the-identity-provider-using-saml-2.0
fetched_at: 2026-09-06T11:20:50Z
source: cortex-platform
---

# Set up Okta as the Identity Provider Using SAML 2.0 | 8.7 (EoL) | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Set up Okta SAML authentication in Cortex XSOAR On-prem 8.7 (EoL). 
