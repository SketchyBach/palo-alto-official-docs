---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/asset-management/asset-inventory-overview
fetched_at: 2026-09-06T09:43:11Z
source: cortex-platform
---

# Asset inventory overview | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn about the core concepts, features, and lifecycle of assets within the Asset Inventory. 

 The Asset Inventory acts as a centralized repository and a single source of truth for all asset-related information in Cortex XDR. Designed to provide end-to-end asset visibility across the entire enterprise, the inventory covers code, cloud, and runtime in cloud, hybrid, and on-premise environments. Cortex collects, normalizes, and aggregates data from multiple sensors to create a single, holistic profile for each asset. 

 Asset classification hierarchy 

 Assets are organized into a strict hierarchy to facilitate filtering and management: 
 ...
 When Cortex XDR discovers an asset, it builds a comprehensive profile by stitching together data from multiple sources. This profile consists of: 
