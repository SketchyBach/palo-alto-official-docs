---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.10/configure-cortex-xsoar/engines/use-an-engine-in-an-integration
fetched_at: 2026-09-16T08:55:01Z
source: cortex-platform
---

# Use an engine in an integration | 8.10 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.10 On-prem, use engines to fetch alerts and run integration commands. 
