---
url: https://docs.paloaltonetworks.com/prisma-agent/administration/configure-the-agent/set-up-prisma-agent-user-authentication/set-up-ldap-authentication-for-prisma-agent
fetched_at: 2026-09-16T08:21:17Z
source: palo-alto-main
---

# Set Up LDAP Authentication for Prisma Agent Clear
...
Updated on 
 ...
 resources. Prisma Agent provides multiple authentication methods to verify
 user identities before granting access to protected resources. While Prisma Agent has traditionally relied on Cloud Identity Engine (CIE) for authentication
 ...
 The LDAP authentication capability for Prisma Agent enables organizations to
 ...
 existing deployments from GlobalProtect to Prisma Agent without having to
 reconfigure your authentication methods or adopt new authentication workflows. 

 When you enable LDAP authentication, Prisma Agent communicates with the
 ...
 name (FQDN) from the Prisma Agent management plane, connects to the Portal,
 and presents the user with credential prompts. Upon successful authentication
 against your LDAP directory, the Portal grants Prisma Agent an authentication
...
Prisma Access and NGFW deployments requires Prisma Access infrastructure
 6.1 or above. 

 Portal authentication for Panorama Managed
Prisma Access deployments requires Prisma Access infrastructure 6.1 or
 above. 
