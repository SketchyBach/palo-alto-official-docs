---
url: https://docs.paloaltonetworks.com/content/techdocs/en_US/plugins/vm-series-and-panorama-plugins-release-notes/panorama-plugin-for-zero-touch-provisioning/panorama-plugin-for-zero-touch-provisioning-20/known-issues-in-the-zero-touch-provisioning-200-release.html
fetched_at: 2026-09-16T13:01:24Z
source: palo-alto-main
---

# Known Issues in the Zero Touch Provisioning 2.0.0 Release Clear
...
Touch Provisioning and check (enable) ZTP . 
 ...
 This issue is resolved in PAN-OS 10.2.1 and Zero Touch Provisioning plugin
 2.0.1 

 On the Panorama management server, you must download and install the ZTP Plugin 2.0 after
 successful upgrade to PAN-OS 10.2. After upgrade to PAN-OS 10.2, the show
 plugins installed command does not display the ZTP plugin until you
 install ZTP Plugin 2.0. 

 Workaround: After Panorama successfully upgrades to PAN-OS 10.2, manually download and
 install the ZTP Plugin 2.0. 
 Log in to the Panorama web
 interface . 

 Select Panorama Plugins and search for the ztp plugin. 

 Download and Install ZTP Plugin
 2.0. 
