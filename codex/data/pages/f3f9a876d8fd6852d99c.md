---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/networking/appsec2-azure-24
fetched_at: 2026-09-06T11:13:09Z
source: cortex-platform
---

# Azure Automation account configured with overly permissive network access misconfiguration detected | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 d7518237-8ab1-4770-b6e6-6c8d4ca46839 
 ...
 In this Terraform example, an azurerm_automation_account resource is defined with public_network_access_enabled set explicitly to false. This setting ensures the automation account can only be accessed through private endpoints within the Azure network. [source,go] 
 ...
 Previous AWS Lambda function URL having overly permissive cross-origin resource sharing permissions misconfig 

 Next Azure MySQL Flexible Server not configured with private endpoint misconfiguration detected in code 
