---
url: https://cortex-docs.paloaltonetworks.com/appsec-rules/iac-security/logging/appsec2-gcp-17
fetched_at: 2026-09-06T11:12:47Z
source: cortex-platform
---

# GCP PostgreSQL instance database flag log_statement_stats is not set to off misconfiguration detecte | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 GCP PostgreSQL instance database flag log_statement_stats is not set to off misconfiguration detecte 
 ...
 ef360d7f-cd86-4c78-89f1-53c296853e2d 
 ...
 resource "google_sql_database_instance" "default" { name = "default" database_version = "POSTGRES_9_6" region = "us-central1" 

 settings { database_flags { name = "log_statement_stats" value = "off" } } } 

 Previous GCP PostgreSQL instance database flag log_planner_stats is not set to off misconfiguration detected 

 Next Logging is disabled for Dialogflow agents misconfiguration detected in code 
