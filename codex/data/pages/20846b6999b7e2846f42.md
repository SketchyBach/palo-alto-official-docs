---
url: https://cortex-docs.paloaltonetworks.com/cortex-agentix/configure-cortex-agentix/engines/troubleshoot-engines
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Troubleshoot Cortex AgentiX engines using logs, errors, and diagnostics. 
 ...
 Go to Settings → Configurations → Engines and verify that the engine is connected. 
 ...
 To check the connectivity from the engine to the Cortex AgentiX tenant, see Troubleshoot engine connectivity below. 
 ...
 This error might occur when a connection is established between an engine and the Cortex AgentiX tenant, because, by default, Linux does not allow processes to listen on low-level ports. 
 ...
 This error can occur in the engine logs relating to a bad handshake on the engine trying to connect to a Cortex AgentiX tenant. 
 ...
 Verify that time is synchronized on the engine to a reliable NTP source. When timing is off on the engine, this can cause a failure during the SSL/TLS handshake process. When time is resynced, connectivity from the engine to the parent server should 
