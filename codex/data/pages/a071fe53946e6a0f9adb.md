---
url: https://cortex-docs.paloaltonetworks.com/cortex-xsoar-8-on-prem/8.12/back-up-and-restore-cortex-xsoar/common-backup-and-restore-limitations-and-fixes
fetched_at: 2026-09-06T10:29:48Z
source: cortex-platform
---

# Common backup and restore limitations and fixes | 8.12 | Cortex Documentation Portal arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 In Cortex XSOAR 8.12 On-prem, troubleshoot common backup and restore issues. 
 ...
 The backup Cortex XSOAR version must be the same exact version as the currently installed version. For example, if the backup version is 8.12.0.28, you can restore only to 8.12.0.28. 
