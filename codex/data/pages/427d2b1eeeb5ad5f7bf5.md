---
url: https://cortex-docs.paloaltonetworks.com/cortex-xdr-5.x/detect-investigate-and-respond-to-threats/attack-surface-management/get-started-with-attack-surface-management/scanning
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Learn how Cortex XDR ASM scans internet-facing assets, monitors known assets, and identifies exposed services. 

 Attack Surface Management (ASM) in Cortex XDR uses data collected from global internet scans as well open-source intelligence about the internet to maintain a complete inventory of all the internet-facing assets that belong to an organization. The following topics describe the scans that Cortex XDR uses to map and monitor your attack surface. 

 Scanning cadences 

 Cortex XDR scans the internet to discover new services at varying cadences depending on several factors such as port, protocol, cloud provider ranges, and customer-attributed assets. All responsive services are monitored regularly. 
 ...
 Cortex XDR performs global scans twice a week on a limited set of ports by default. For customers who opt in, Cortex XDR performs targeted scanning of known assets daily. Known Assets Monitoring (KAM) brings three significant benefits to the data delivered by Cortex XDR: 
 ...
 Cortex XDR scans your external attack surface only, so we do not need any access inside your network. 
 ...
 Cortex XDR detects protocol-validated services on the IPv4 and IPv6 space of the internet through a series of specialized payloads that target specific port-protocol pairs. Following are examples of some of the protocols and ports on which Cortex XDR checks for active services throughout a standard global scan. 
 ...
 Palo Alto Networks Cortex ASM takes an outside-in approach to network security and asset management. We continuously scan the global internet to monitor our customers' internet-facing attack surface and discover emerging threats. 
 ...
 If you believe you have discovered abuse associated with Cortex ASM scans, please contact us at scaninfo@paloaltonetworks.com. 

 Previous Network mapping 

 Next GeoIP data collection 
