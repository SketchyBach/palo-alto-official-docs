---
url: https://docs.prismacloud.io/admin-guide/install/deploy-console/console-on-amazon-ecs
fetched_at: 2026-09-16T13:36:16Z
source: prisma-cloud
---

# Deploy the Prisma Cloud Console on Amazon ECS | Prisma Cloud arrow-up-right-and-arrow-down-left-from-center
...
For the complete documentation index, see llms.txt . This page is also available as Markdown . 
 ...
 Copy twistlock.cfg to the infrastructure node. 

 SSH to the infrastructure node. 

 Copy the twistlock.cfg file into place. 
 ...
 (Optional) Change the name of the task definition. By default, its name is pc-console . 
 ...
 Previous Deploy the Prisma Cloud Console on Kubernetes 

 Next Console on Fargate 
